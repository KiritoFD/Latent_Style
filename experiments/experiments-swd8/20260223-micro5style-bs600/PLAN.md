...
- Pack root: `I:\Github\Latent_Style\Cycle-NCE\experiments\20260223-micro5style-bs600`
- Total experiments: `10`

## Run Command

```powershell
uv run python src/launch_experiments.py --pack-root .\experiments\20260223-micro5style-bs600 --resume --rerun-failed --aggregate
```
...
|---|---|---|---|
| exp00 | phase1_60e | exp00-phase1_60e-baseline_bs600_lr2e4_bd64_sd256 | `runs\exp00-phase1_60e-baseline_bs600_lr2e4_bd64_sd256\config.json` |
...
| exp02 | phase1_60e | exp02-phase1_60e-capacity_ceiling_bd128_lc128_sd256 | `runs\exp02-phase1_60e-capacity_ceiling_bd128_lc128_sd256\config.json` |
| exp03 | phase1_60e | exp03-phase1_60e-style_ctrl_sd512 | `runs\exp03-phase1_60e-style_ctrl_sd512\config.json` |
...
- Batch size is set to 600 for all experiments in this pack.
- Use `src/launch_experiments.py` for run/resume/rerun/aggregate.
