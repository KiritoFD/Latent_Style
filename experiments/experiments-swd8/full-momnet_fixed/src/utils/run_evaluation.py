...
def main():
    ...
    if args.classifier_path:
        try:
            if LatentStyleClassifier is None:
                print("  WARNING: utils.style_classifier is unavailable; skip latent style classifier.")
                raise RuntimeError("latent style classifier module missing")
