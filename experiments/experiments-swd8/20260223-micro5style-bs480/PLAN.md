...
- Pack root: `I:\Github\Latent_Style\Cycle-NCE\experiments\20260223-micro5style-bs480`
- Total experiments: `10`

## Run Command

```powershell
powershell -NoProfile -ExecutionPolicy Bypass -File .\src\run_pack_20260223_micro5style_bs480.ps1
```
...
|---|---|---|---|
| exp00 | phase1_60e | exp00-phase1_60e-baseline_bs480_lr2e4_bd64_sd256 | `runs\exp00-phase1_60e-baseline_bs480_lr2e4_bd64_sd256\config.json` |
...
- Batch size is set to 480 for all experiments in this pack.
