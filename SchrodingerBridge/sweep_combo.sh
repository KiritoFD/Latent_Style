...
echo "================================================================="
echo "Starting combination sweeps (overdrive + latent affine) on: $CKPT"
echo "================================================================="

for strength in "135" "160"; do
    CONFIG_OVERRIDE="configs/aaai2027/phase2_eval_style_overdrive_s${strength}_lataff045_k070_e3.json"
    echo "-----------------------------------------------------------------"
    echo "Running evaluation with config override: $CONFIG_OVERRIDE"
    echo "-----------------------------------------------------------------"
    OUT_DIR="exp/aaai2027_phase2_smoe_fiber_sde_fiberwise_swd_k070/eval_sweep_combo_s${strength}_lataff045"
...
print(f'Results for strength = 1.${strength:1:2} + latent_affine = 0.45:')
