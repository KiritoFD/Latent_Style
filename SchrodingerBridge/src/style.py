...
class StyleConditioner(nn.Module):
    ...
    is the only source of style tokens. dino_dim remains the style-memory
    channel dimension for checkpoint compatibility.
    ...
    def __init__(
        ...
        *,
        ...
        # it is the channel dim of style_memory and patch_proj.
