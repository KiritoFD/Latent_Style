...
class ModelConfig:
    ...
    style_highpass_depthwise_strength: float = 0.0
    style_highpass_depthwise_hidden_mult: float = 1.0
    style_highpass_depthwise_tanh_scale: float = 0.5
    style_highpass_depthwise_zero_init: bool = True
    style_highpass_depthwise_support_gate: bool = False
    style_highpass_depthwise_support_gamma: float = 4.0
    style_highpass_depthwise_support_smooth_kernel: int = 3
    style_highpass_depthwise_support_floor: float = 0.0
    style_highpass_depthwise_semantic_gate: bool = False
    style_highpass_depthwise_semantic_gamma: float = 3.0
    style_highpass_depthwise_semantic_floor: float = 0.0
    style_highpass_depthwise_semantic_power: float = 1.0
    style_highpass_depthwise_region_gate: bool = False
    style_highpass_depthwise_region_bins: int = 4
    style_highpass_depthwise_region_gamma: float = 4.0
    style_highpass_depthwise_region_floor: float = 0.15
    style_highpass_depthwise_region_smooth_kernel: int = 7
    style_highpass_depthwise_region_hidden_mult: float = 0.5
    style_lowpass_affine_head: bool = False
    style_lowpass_affine_strength: float = 0.0
    style_lowpass_affine_kernel: int = 9
    style_lowpass_affine_tanh_scale: float = 0.5
    style_lowpass_affine_hidden_mult: float = 0.5
    style_lowpass_affine_zero_init: bool = True
    style_lowpass_mix_head: bool = False
    style_lowpass_mix_strength: float = 0.0
    style_lowpass_mix_kernel: int = 9
    style_lowpass_mix_tanh_scale: float = 0.35
    style_lowpass_mix_hidden_mult: float = 0.5
    style_lowpass_mix_zero_init: bool = True
    style_midband_operator_head: bool = False
    style_midband_operator_strength: float = 0.0
    style_midband_operator_kernel: int = 3
    style_midband_operator_inner_kernel: int = 5
    style_midband_operator_outer_kernel: int = 15
    style_midband_operator_tanh_scale: float = 0.45
    style_midband_operator_hidden_mult: float = 0.75
    style_midband_operator_channel_mix: bool = True
    style_midband_operator_mix_scale: float = 0.25
    style_midband_operator_zero_init: bool = True
    style_midband_operator_support_gate: bool = True
    style_midband_operator_support_gamma: float = 4.5
    style_midband_operator_support_floor: float = 0.15
    style_midband_operator_support_smooth_kernel: int = 5
    decoder_feature_style_operator_head: bool = False
    decoder_feature_style_operator_strength: float = 0.0
    decoder_feature_style_operator_kernel: int = 3
    decoder_feature_style_operator_tanh_scale: float = 0.35
    decoder_feature_style_operator_hidden_mult: float = 0.75
    decoder_feature_style_operator_affine: bool = True
    decoder_feature_style_operator_zero_init: bool = True
    decoder_feature_style_operator_support_gate: bool = True
    decoder_feature_style_operator_support_gamma: float = 4.5
    decoder_feature_style_operator_support_floor: float = 0.15
    decoder_feature_style_operator_support_smooth_kernel: int = 5
    ...
    style_blender_texton_style_scale: float = 0.35
    style_blender_texton_use_style_code: bool = True
    style_blender_texton_style_allocate: bool = False
    style_blender_texton_allocate_scale: float = 0.5
