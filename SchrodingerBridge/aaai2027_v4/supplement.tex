...
\begin{itemize}[leftmargin=1.5em,itemsep=0.2em]
  ...
  \item \path{configs/exp_brk_a_ll03_10ep.json}: paper training configuration.
  \item \path{exp/dino_s_break/brk_a_ll03_10ep/config.json}: frozen merged run configuration.
  \item \path{exp/dino_s_break/brk_a_ll03_10ep/logs/training_20260712_214129.csv}: training log.
  ...
  \item \path{docs/713/REPO_REMOTE_AUDIT_2026-07-13.md}: internal audit used to sanitize public paths.
\end{itemize}
...
\midrule
Config & \path{configs/exp_brk_a_ll03_10ep.json} \\
Base config & \path{configs/710_b0_weave_d5.json} \\
Seed & 42 \\
Epochs & 10 \\
Batch size & 96 \\
...
\bottomrule
\end{tabularx}
\caption{Inference-only operating points produced from the same trained checkpoint.}
