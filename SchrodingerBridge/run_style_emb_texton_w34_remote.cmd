...
set OUT_ROOT=exp\style_embedding_mainline_calibration\ema_transport_texton_w34_e6_fulltrain
if not exist "%OUT_ROOT%" mkdir "%OUT_ROOT%"

"C:\Program Files\Python312\python.exe" tools\experiments\run_style_embedding_mainline_calibration.py ^
  --checkpoint "exp\vae_backend\ema_transport_texton\ema_transport_texton_w34_guard\epoch_0006.pt" ^
