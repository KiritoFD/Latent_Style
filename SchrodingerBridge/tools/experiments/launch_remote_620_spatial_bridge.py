...
SYNC_PATHS = [
    ...
    "SchrodingerBridge/configs/620_spatial_bridge_targetproj.json",
...
CONFIG_BY_VARIANT = {
    ...
    "targetproj": "SchrodingerBridge/configs/620_spatial_bridge_targetproj.json",
...
def main() -> int:
    ...
    run_name = {
        ...
        "targetproj": "620_targetproj_swd8_sigma002_nfe8_b80",
