...
def main() -> int:
    ...
    parser.add_argument("--skip-queue-watch", action="store_true")
    ...
    if not bool(args.skip_queue_watch):
        ...
        _spawn_detached(
            ...
            stdout_log=SB_ROOT / "aaai2027" / "round1_queue_watch_20260610.stdout.log",
            stderr_log=SB_ROOT / "aaai2027" / "round1_queue_watch_20260610.stderr.log",
        )
