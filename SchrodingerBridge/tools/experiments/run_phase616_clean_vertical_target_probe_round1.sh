...
LOG_DIR="${ROOT_DIR}/docs/experiments/phase2_fiber_bundle/616/logs/clean_vertical_target_probe_round1"
...
CONFIGS=(
  "configs/aaai2027/phase616_clean_vertical_target_source_low_k085_b8a2_e24.json"
  "configs/aaai2027/phase616_clean_vertical_target_wavelet_k085_b8a2_e24.json"
)
...
for config in "${CONFIGS[@]}"; do
  ...
  echo "[phase616_clean_vertical_target_probe_round1] starting ${config}" | tee "${log_path}"
