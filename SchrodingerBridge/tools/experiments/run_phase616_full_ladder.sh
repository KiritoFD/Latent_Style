...
BASE_CONFIG_DIR="$(dirname "$BASE_CKPT")"
...
make_exp() {
    ...
    cp "$BASE_CKPT" "${exp_dir}/epoch_0001.pt"
...
EXP_H5_TOKENENTROPY=$(make_exp "h5_token_entropy" 8 8)
override_bridge "$EXP_H5_TOKENENTROPY" \
    'bridge_path_mode="vertical"' \
    'coupling_cost_composition="structure_only"' \
...
echo "H5_TOKEN:  $EXP_H5_TOKENENTROPY (tokenizer_entropy affinity)"
...
run_exp "$EXP_H5_TOKENENTROPY" "H5: Tokenizer entropy affinity"
