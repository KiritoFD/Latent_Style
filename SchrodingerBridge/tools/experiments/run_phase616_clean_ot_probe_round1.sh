...
LOG_DIR="${ROOT_DIR}/docs/experiments/phase2_fiber_bundle/616/logs/clean_ot_probe_round1"
...
CONFIGS=(
  "configs/aaai2027/phase616_clean_ot_probe_lowedge_b16a1_vlen010_e6.json"
  "configs/aaai2027/phase616_clean_ot_probe_selfaffgw_b16a1_vlen010_e6.json"
)
...
for config in "${CONFIGS[@]}"; do
  ...
  echo "[phase616_clean_ot_probe_round1] starting ${config}" | tee "${log_path}"
