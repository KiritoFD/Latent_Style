...
def _run(cmd: list[str]) -> int:
    print(
        "[launch_remote_knee_spatial_carriergate_bodydecoder_qedgegated_pattn_stylesig_fast_eval_watcher] "
        + " ".join(cmd),
        flush=True,
    )
...
def main() -> int:
    ...
    command = [
        ...
        str(launch),
        "--task-name",
        "knee-spatial-carriergate-bodydecoder-qedgegated-pattn-stylesig-fast-eval-watcher",
        "--remote-log-path",
        ...
        "--sync-path",
        "SchrodingerBridge/tools/experiments/build_inmortal_stage_summary.py",
        "--sync-path",
        "SchrodingerBridge/tools/experiments/build_inmortal_epoch_eval_table.py",
        "--sync-path",
        "SchrodingerBridge/docs/experiments/2026-06-10-current-decision-read-stylesig-vs-fourway-vlm.md",
        "--verify-python-file",
        ...
        (
            ...
            "--run-dir /mnt/i/Github/Latent_Style/exp/inmortal-exp/aaai2027_inmortal_knee_e13_spatial_carriergate_bodydecoder_qedgegated_pattn_stylesig_seed42_b8a2 "
            "--train-pattern aaai2027_inmortal_knee_e13_spatial_carriergate_bodydecoder_qedgegated_pattn_stylesig_seed42_b8a2 "
