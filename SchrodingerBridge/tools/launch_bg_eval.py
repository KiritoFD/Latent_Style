"""Launch CUT eval as detached process, then verify it's alive and capture errors."""
import sys
import subprocess
import time
...
EVAL_DIR = r'I:\GitHub\Latent_Style\SchrodingerBridge\exp\baseline_v2\eval\cut'
TEST_DIR = r'I:\wikiart_distinct5_samam_512_classview\test'
LOG_FILE = r'I:\GitHub\Latent_Style\SchrodingerBridge\exp\baseline_v2\eval\cut_eval.log'
ERR_FILE = r'I:\GitHub\Latent_Style\SchrodingerBridge\exp\baseline_v2\eval\cut_eval_err.log'
...
print(f"Launching CUT evaluation as detached process...")
