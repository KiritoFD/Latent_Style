...
OUT_ROOT = ROOT /"high_tension_phase_space_sweep"
...
def generate_configs() -> list[dict]:
    ...
    for exp in experiments:
        ...
        exp_name = exp["name"]
        cfg["checkpoint"]["save_dir"] = f"./high_tension_phase_space_sweep/{exp_name}"
        cfg["ablation"] = {
            "name": exp_name,
            "notes": exp["notes"],
        }
        ...
        manifests.append(
            {
                "name": exp_name,
                "notes": exp["notes"],
                "config_path": f"high_tension_phase_space_sweep/{exp_name}.json",
                "checkpoint_dir": f"high_tension_phase_space_sweep/{exp_name}",
                "checkpoint_path": f"high_tension_phase_space_sweep/{exp_name}/{checkpoint_name}",
                "eval_output": f"high_tension_phase_space_sweep/full_eval/{exp_name}",
            }
        )
