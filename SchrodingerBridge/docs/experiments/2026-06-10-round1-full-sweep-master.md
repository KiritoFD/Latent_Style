...
- Remote GPU live: `9515 / 12288 MiB`, `util=60%`, `band=in_band`
...
- Latest settled fast point: `epoch_0011` -> transfer `0.6888 / 0.4889`
- Convergence: `row_count=11, since_best=10, tail_flat=False, closure_band=open, converged=False`
