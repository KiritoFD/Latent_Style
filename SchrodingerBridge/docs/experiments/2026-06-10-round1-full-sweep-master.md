...
- Remote GPU live: `10102 / 12288 MiB`, `util=98%`, `band=in_band`
...
- Latest settled fast point: `epoch_0019` -> transfer `0.6909 / 0.4498`
- Convergence: `row_count=19, since_best=18, tail_flat=False, closure_band=open, converged=False`
