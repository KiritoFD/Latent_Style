...
- Remote GPU live: `9515 / 12288 MiB`, `util=97%`, `band=in_band`
...
- Latest settled fast point: `epoch_0009` -> transfer `0.6996 / 0.4421`
- Convergence: `row_count=9, since_best=8, tail_flat=False, closure_band=open, converged=False`
