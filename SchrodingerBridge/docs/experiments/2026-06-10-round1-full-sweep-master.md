...
- Remote GPU live: `9516 / 12288 MiB`, `util=20%`, `band=in_band`
...
- Latest settled fast point: `epoch_0010` -> transfer `0.6949 / 0.5085`
- Convergence: `row_count=10, since_best=9, tail_flat=False, closure_band=open, converged=False`
