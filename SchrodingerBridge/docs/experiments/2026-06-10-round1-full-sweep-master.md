...
- Remote GPU live: `9515 / 12288 MiB`, `util=95%`, `band=in_band`
...
- Latest settled fast point: `epoch_0012` -> transfer `0.6985 / 0.5078`
- Convergence: `row_count=12, since_best=11, tail_flat=False, closure_band=open, converged=False`
