...
| Dedicated tokenizer pretrain stage | not yet a separate round-1 launcher | partial | not yet scheduled | policy exists, but no dedicated standalone pretrain packet has been launched yet |
...
- Dedicated tokenizer pretrain / warm-start launcher is still missing as its own execution packet.
