...
- Latest settled point:
  - `epoch_0029`
  - transfer `style / lpips = 0.6895 / 0.5082`
  - full `style / lpips = 0.7080 / 0.4970`
  - wall `= 180.89s`
