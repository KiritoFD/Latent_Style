...
- Settled remote epochs:
  - `epoch_0001, epoch_0002, epoch_0003, epoch_0004, epoch_0005, epoch_0006, epoch_0007, epoch_0008`
...
- Best transfer `LPIPS`:
  - `epoch_0008`
  - `style / lpips = 0.6908 / 0.4693`
- Best all-pairs `CLIP-S`:
  - `epoch_0001`
  - `style / lpips = 0.7170 / 0.5552`
- Latest settled point:
  - `epoch_0008`
  - transfer `style / lpips = 0.6908 / 0.4693`
  - full `style / lpips = 0.7127 / 0.4596`
  - wall `= 179.90s`
