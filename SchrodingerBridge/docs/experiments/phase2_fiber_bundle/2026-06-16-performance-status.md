...
| I2SB low-anchor0.65 | `0.709417` | `0.449507` | running e1-e10; best balanced e4 is `0.706564 / 0.395071`; e9 reaches `0.692446 / 0.358758` but only after style falls below `0.700` |
...
| I2SB low-anchor0.65 | running, e1-e10 | stronger anchor improves early LPIPS, but over-anchors by e5 and drops style below `0.700`; e9 is LPIPS-good/style-bad | if e11 stays sub-`0.700`, close negative and scan milder `0.55-0.58` anchor |
