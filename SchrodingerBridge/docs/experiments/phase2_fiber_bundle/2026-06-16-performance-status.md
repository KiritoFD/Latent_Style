...
| I2SB low-anchor0.50 | `0.711470` | `0.472991` | running partial positive; e4 reaches `0.705008 / 0.412302`, preserving style better than hard lowpass anchor |
...
| I2SB low-anchor0.50 | running, e1-e4 | restores style relative to hard lowpass anchor; e4 is `0.705008 / 0.412302` | continue to convergence; promising but not in target band yet |
