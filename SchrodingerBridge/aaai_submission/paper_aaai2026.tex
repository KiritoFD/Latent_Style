...
\begin{itemize}
    ...
    \item \textbf{A semantic-aligned terminal-matching design used in the current mainline (SA-SWD)}, which converts cross-attention routing evidence into terminal distribution-matching axes while retaining the efficiency of SWD; semantic-axis necessity is evaluated separately by an ongoing matched control rather than treated as already closed.
