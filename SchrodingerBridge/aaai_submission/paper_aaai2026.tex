...
\begin{itemize}
    ...
    \item \textbf{A terminal-matching design used in the current mainline (SA-SWD)}, which converts cross-attention routing evidence into terminal distribution-matching axes while retaining the efficiency of SWD; the current paper evaluates this mechanism as a proposed mainline design rather than treating semantic-axis necessity as already closed.
