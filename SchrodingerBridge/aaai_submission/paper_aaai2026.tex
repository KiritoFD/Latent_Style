...
\begin{itemize}
    ...
    \item \textbf{A semantic-aligned terminal-matching design used in the current mainline (SA-SWD)}, which converts cross-attention routing evidence into terminal distribution-matching axes while retaining the efficiency of SWD; its semantic-axis necessity is not taken as closed here and is evaluated separately by an ongoing matched control.
