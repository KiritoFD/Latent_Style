# 712 Phase StyleInject Stage 2: nonzero_init + SAT
# 组合两个已验证安全的组件，测试协同效应
...
$cfg = @{name="stage2_sat"; config="configs\exp_sty_stage2_sat.json"; ckpt="exp\sty_inject\stage2_sat\epoch_0005.pt"}
...
Write-Output ""
Write-Output "=== STAGE2 SAT EXPERIMENT COMPLETE $(Get-Date -Format 'yyyy-MM-dd HH:mm:ss') ==="
