"""Extract CLIP-S and LPIPS from D1 + baseline summary.json files."""
import json
from pathlib import Path

base = Path(r"I:\Github\Latent_Style\SchrodingerBridge\exp")
exps = ["hp_simple_swd12_15ep", "d1_gram_hf1_15ep"]
dino_dir = base / "_dino_results"

print(f"{'config':<25} {'clip_s':>8} {'lpips_1m':>9} {'dino_sty':>9} {'dino_con':>9} {'dino_str':>9}")
print("-" * 80)
...
for exp in exps:
    ...
    print(f"{exp:<25} {clip_s:>8} {lpips_1m:>9} {dino_sty:>9} {dino_con:>9} {dino_str:>9}")
