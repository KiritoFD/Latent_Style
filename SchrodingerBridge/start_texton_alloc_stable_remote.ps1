...
$action = New-ScheduledTaskAction -Execute 'cmd.exe' -Argument '/c I:\Github\Latent_Style\SchrodingerBridge\run_ema_transport_texton_alloc_stable_remote.cmd'
...
if (Test-Path 'exp\vae_backend\ema_transport_texton_alloc_stable\task.log') {
    Get-Content 'exp\vae_backend\ema_transport_texton_alloc_stable\task.log' -Tail 20
}
