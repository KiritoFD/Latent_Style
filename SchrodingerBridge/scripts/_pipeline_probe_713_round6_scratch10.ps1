# Pipeline: Round 6 forced pivot — train target_hf_subband from scratch for 10 epochs
...
$Name = "target_hf_subband_scratch_10ep"
$Config = "$Root\configs\exp_probe_target_hf_subband_scratch_10ep.json"
$RunDir = "$Root\exp\model_probe\target_hf_subband_scratch_10ep"
$LogDir = "$RunDir\logs"
