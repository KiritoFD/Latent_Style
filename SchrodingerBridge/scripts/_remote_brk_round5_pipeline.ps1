# Round 5 pipeline: 4 architecture liberation experiments
# brk_u_hh_head, brk_v_train_adain, brk_w_hf_wct, brk_x_dim96
# Run sequentially on remote RTX 3060 12GB

$ErrorActionPreference = "Continue"
$base = "I:\Github\Latent_Style\SchrodingerBridge"
$exp_names = @("brk_u_hh_head", "brk_v_train_adain", "brk_w_hf_wct", "brk_x_dim96")
...
Write-Host "=========================================="
Write-Host "[$(Get-Date -Format 'yyyy-MM-dd HH:mm:ss')] ALL ROUND 5 EXPERIMENTS COMPLETE"
Write-Host "=========================================="
