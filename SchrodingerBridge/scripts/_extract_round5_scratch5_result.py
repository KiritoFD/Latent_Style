...
RUN = "target_hf_subband_scratch_5ep"
...
print(f"{RUN:30s}  DINO-S={dino['dino_style']:.4f}  CLIP-S={apo['clip_style']:.4f}  LPIPS={apo['content_lpips']:.4f}  DINO-C={dino['dino_content']:.4f}")
