# Pipeline: Round 5 forced pivot — train target_hf_subband from scratch for 5 epochs
...
$Name = "target_hf_subband_scratch_5ep"
$Config = "$Root\configs\exp_probe_target_hf_subband_scratch_5ep.json"
$RunDir = "$Root\exp\model_probe\target_hf_subband_scratch_5ep"
$LogDir = "$RunDir\logs"
