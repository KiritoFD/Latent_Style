# 712 Phase StyleInject Stage 3: 阶段2 + DWT route(0.5) + HH head
...
$cfg = @{name="stage3_arch"; config="configs\exp_sty_stage3_arch.json"; ckpt="exp\sty_inject\stage3_arch\epoch_0005.pt"}
...
Write-Output ""
Write-Output "=== STAGE3 ARCH EXPERIMENT COMPLETE $(Get-Date -Format 'yyyy-MM-dd HH:mm:ss') ==="
