# Pipeline: Round8 — Latent-space target blending gamma=0.15 + AdaIN=2.0 eval
...
$Name = "latent_blend_g15"
$Config = "$Root\configs\exp_latent_blend.json"
$RunDir = "$Root\exp\model_probe\latent_blend_g15"
$LogDir = "$RunDir\logs"
