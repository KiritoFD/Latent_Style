# Phase T1: Adaptive Style Gate 10 epochs — train + full_eval + DINO
# Usage: powershell -File _run_t1_asg_10ep.ps1
...
$ckpt = "exp\$exp\epoch_0010.pt"
$evalDir = "exp\$exp\full_eval\epoch_0010"
