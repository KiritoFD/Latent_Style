# Style-Contrastive SWD ablation
...
$logOut = "C:\Users\Administrator\logs\contrastive_swd_ablation.out"
$epoch = "epoch_0005"

$name = "contrastive_swd"
...
if (-not (Test-Path $ckpt)) {
    Write-Output "  STEP 1: Training (style-contrastive SWD, w=8.0, margin=0.05)"
