# Pipeline: Round 4 forced pivot — longer fine-tuning of target_hf_subband architecture
# Train 10ep from brk_a_ll03_10ep, evaluate with AdaIN 1.5, compute DINO
...
$Name = "target_hf_subband_ft10"
$Config = "$Root\configs\exp_probe_target_hf_subband_ft10.json"
$RunDir = "$Root\exp\model_probe\target_hf_subband_ft10"
$LogDir = "$RunDir\logs"
