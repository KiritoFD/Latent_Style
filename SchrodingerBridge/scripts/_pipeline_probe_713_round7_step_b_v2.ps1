# Pipeline: Round7 Step B v2 — phase-anchored HF transport (latent space) + AdaIN=2.0 eval
...
$Name = "phase_anchored_hf_v2"
$Config = "$Root\configs\exp_phase_anchored_hf_v2.json"
$RunDir = "$Root\exp\model_probe\phase_anchored_hf_v2"
$LogDir = "$RunDir\logs"
