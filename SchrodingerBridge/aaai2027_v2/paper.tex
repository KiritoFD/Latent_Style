...
\end{equation}
Heun gives a structural degree of freedom that Euler does not: switching Euler$\to$Heun improves CLIP-S by +0.0056 at fixed $\alpha$, and switching Heun$\to$RK4 adds nothing (saturation). The solver order is a Pareto-breaking knob; schedule shape, $\alpha$, and capacity are not.
