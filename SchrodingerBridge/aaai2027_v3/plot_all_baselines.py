...
GROUP_STYLE = {
    ...
    "training_free": {"face": "#7DD3A8", "edge": "#2F855A", "marker": "s", "size": 156, "z": 3},
    "peft": {"face": "#F4A6D7", "edge": "#B83280", "marker": "s", "size": 156, "z": 3},
...
def main() -> None:
    ...
    legend_handles = [
        ...
        Line2D(
            ...
            marker="s",
            color="none",
            markerfacecolor=GROUP_STYLE["training_free"]["face"],
            markeredgecolor=GROUP_STYLE["training_free"]["edge"],
            markersize=8.0,
