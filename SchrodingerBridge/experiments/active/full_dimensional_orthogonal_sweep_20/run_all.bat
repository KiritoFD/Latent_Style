...
python run.py --config "experiments\active\full_dimensional_orthogonal_sweep_20\g0_golden_pedestal.json"
...
python run.py --config "experiments\active\full_dimensional_orthogonal_sweep_20\g1_micro_only.json"
set "TRAIN_RC=!ERRORLEVEL!"
...
python run.py --config "experiments\active\full_dimensional_orthogonal_sweep_20\g2_macro_only.json"
set "TRAIN_RC=!ERRORLEVEL!"
...
python run.py --config "experiments\active\full_dimensional_orthogonal_sweep_20\g3_bimodal_split.json"
set "TRAIN_RC=!ERRORLEVEL!"
...
python run.py --config "experiments\active\full_dimensional_orthogonal_sweep_20\g4_high_tension.json"
set "TRAIN_RC=!ERRORLEVEL!"
...
python run.py --config "experiments\active\full_dimensional_orthogonal_sweep_20\g5_low_tension.json"
set "TRAIN_RC=!ERRORLEVEL!"
...
python run.py --config "experiments\active\full_dimensional_orthogonal_sweep_20\g6_zero_friction.json"
set "TRAIN_RC=!ERRORLEVEL!"
...
python run.py --config "experiments\active\full_dimensional_orthogonal_sweep_20\g7_sharp_ot.json"
set "TRAIN_RC=!ERRORLEVEL!"
...
python run.py --config "experiments\active\full_dimensional_orthogonal_sweep_20\g8_soft_ot.json"
set "TRAIN_RC=!ERRORLEVEL!"
...
python run.py --config "experiments\active\full_dimensional_orthogonal_sweep_20\g9_strict_l1.json"
set "TRAIN_RC=!ERRORLEVEL!"
...
python run.py --config "experiments\active\full_dimensional_orthogonal_sweep_20\g10_loose_l1.json"
set "TRAIN_RC=!ERRORLEVEL!"
...
python run.py --config "experiments\active\full_dimensional_orthogonal_sweep_20\g11_cycle_drop.json"
set "TRAIN_RC=!ERRORLEVEL!"
