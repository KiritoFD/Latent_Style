...
def main() -> int:
    ...
    parser.add_argument("--batch-size", type=int, default=108, help="Training batch size injected into the suite base config.")
    parser.add_argument("--eval-batch-size", type=int, default=20, help="Eval generation batch size stored in the suite base config.")
