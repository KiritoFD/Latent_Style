...
ckpt = Path(r"G:/GitHub/Latent_Style/Related_Works/S2WAT-main/pre_trained_models/checkpoint_bs1_safe/checkpoint_5_epoch.pkl")
styles_root = Path(r"G:/GitHub/Latent_Style/style_data/train")
style_names = ["photo", "cezanne", "Hayao", "monet", "vangogh"]
out_dir = Path(r"G:/GitHub/Latent_Style/Related_Works/runs/s2wat_bs1_safe_e5_5x5")
img_dir = out_dir / "images"
img_dir.mkdir(parents=True, exist_ok=True)

# pick one representative image per style
chosen = {}
...
encoder = S2WAT(
    img_size=224, patch_size=2, in_chans=3, embed_dim=192,
