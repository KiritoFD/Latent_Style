...
DEFAULT_PATHS = [
    ...
    Path("Related_Works/repos/SaMam/ARCHI"),
    Path("Related_Works/repos/SaMam/LOSS"),
    Path("Related_Works/repos/SaMam/MODEL"),
    Path("Related_Works/repos/SaMam/TRAIN/lightning_module"),
