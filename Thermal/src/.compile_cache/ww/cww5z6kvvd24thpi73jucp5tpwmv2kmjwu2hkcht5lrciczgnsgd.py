...
#   %add_tensor_39 : Tensor "f32[6, 1024][1024, 1]cuda:0"[num_users=2] = call_function[target=torch.ops.aten.add.Tensor](args = (%mm_default_39, %arg2_1), kwargs = {})
#   %sigmoid : Tensor "f32[6, 1024][1024, 1]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.sigmoid.default](args = (%add_tensor_39,), kwargs = {})
#   %mul_2 : Tensor "f32[6, 1024][1024, 1]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%add_tensor_39, %sigmoid), kwargs = {})
#   return %mul_2
...
#   %add_tensor_28 : Tensor "f32[6, 256][256, 1]cuda:0"[num_users=2] = call_function[target=torch.ops.aten.add.Tensor](args = (%mm_default_28, %arg81_1), kwargs = {})
#   %sigmoid_17 : Tensor "f32[6, 256][256, 1]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.sigmoid.default](args = (%add_tensor_28,), kwargs = {})
#   %mul_34 : Tensor "f32[6, 256][256, 1]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%add_tensor_28, %sigmoid_17), kwargs = {})
...
#   h_8 => mul_28, sigmoid_16
#   h_9 => convolution_15
#   input_26 => add_tensor_27, slice_tensor_2
#   input_27 => sigmoid_18
#   out_22 => add_tensor_29, view_118
#   out_23 => add_30
#   out_24 => add_31, add_32, clone_29, mul_32, mul_33, rsqrt_7, sub_12, var_mean_7
...
#   %view_119 : Tensor "f32[6, 512, 8, 8][32768, 1, 4096, 512]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.reshape.default](args = (%permute_62, [6, 512, 8, 8]), kwargs = {})
#   %convolution_15 : Tensor "f32[6, 256, 16, 16][65536, 1, 4096, 256]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.convolution.default](args = (%view_119, %arg78_1, %arg79_1, [2, 2], [1, 1], [1, 1], True, [0, 0], 1), kwargs = {})
#   %add_tensor_27 : Tensor "f32[8, 256][256, 1]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.add.Tensor](args = (%mm_default_27, %arg83_1), kwargs = {})
#   %slice_tensor_2 : Tensor "f32[6, 256][256, 1]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.slice.Tensor](args = (%add_tensor_27, 0, 0, -2), kwargs = {})
...
# kernel path: ./.compile_cache/za/czawnkcdv64j5vprn7rzqhwjpuwzqkid6pp5xuhjpkb7xzpdmwx2.py
...
triton_red_fused_add_convolution_div_mul_silu_std_sub_69 = async_compile.triton('triton_red_fused_add_convolution_div_mul_silu_std_sub_69', '''
import triton
import triton.language as tl
...
@triton_heuristics.reduction(
    ...
    inductor_meta={'grid_type': 'Grid1D', 'autotune_hints': set(), 'kernel_name': 'triton_red_fused_add_convolution_div_mul_silu_std_sub_69', 'mutated_arg_names': ['in_out_ptr0'], 'optimize_mem': True, 'no_x_dim': False, 'num_load': 6, 'num_reduction': 2, 'backend_hash': 'D54CF9E23D08230976451A78161C34C47AAE433535668E89333E7039B8F7F720', 'are_deterministic_algorithms_enabled': False, 'assert_indirect_indexing': True, 'autotune_local_cache': True, 'autotune_pointwise': True, 'autotune_remote_cache': None, 'force_disable_caches': False, 'dynamic_scale_rblock': True, 'max_autotune': False, 'max_autotune_pointwise': False, 'min_split_scan_rblock': 256, 'spill_threshold': 16, 'store_cubin': False, 'add_persistent_rblock': True, 'tiling_scores': {'x': 0, 'r0_': 393232}}
)
@triton.jit
def triton_red_fused_add_convolution_div_mul_silu_std_sub_69(in_out_ptr0, in_ptr0, in_ptr1, xnumel, r0_numel, XBLOCK : tl.constexpr, R0_BLOCK : tl.constexpr):
    xnumel = 6
    r0_numel = 4096
    rnumel = r0_numel
    RBLOCK: tl.constexpr = R0_BLOCK
...
# kernel path: ./.compile_cache/os/cosot5zz64m7l56g2olauyzuaiv4zx2tgaiyb2oqfwt2iv5bklkg.py
...
#   return %add_167
triton_poi_fused_add_70 = async_compile.triton('triton_poi_fused_add_70', '''
import triton
import triton.language as tl
...
@triton_heuristics.pointwise(
    ...
    filename=__file__,
    triton_meta={'signature': {'in_ptr0': '*fp32', 'in_ptr1': '*fp32', 'out_ptr0': '*fp32', 'ynumel': 'i32', 'xnumel': 'i32', 'YBLOCK': 'constexpr', 'XBLOCK': 'constexpr'}, 'device': DeviceProperties(type='cuda', index=0, multi_processor_count=36, cc=89, major=8, regs_per_multiprocessor=65536, max_threads_per_multi_processor=1536, warp_size=32), 'constants': {}, 'configs': [{(0,): [['tt.divisibility', 16]], (1,): [['tt.divisibility', 16]], (2,): [['tt.divisibility', 16]], (4,): [['tt.divisibility', 16]]}]},
    inductor_meta={'grid_type': 'Grid2D', 'autotune_hints': set(), 'kernel_name': 'triton_poi_fused_add_70', 'mutated_arg_names': [], 'optimize_mem': True, 'no_x_dim': False, 'num_load': 2, 'num_reduction': 0, 'backend_hash': 'D54CF9E23D08230976451A78161C34C47AAE433535668E89333E7039B8F7F720', 'are_deterministic_algorithms_enabled': False, 'assert_indirect_indexing': True, 'autotune_local_cache': True, 'autotune_pointwise': True, 'autotune_remote_cache': None, 'force_disable_caches': False, 'dynamic_scale_rblock': True, 'max_autotune': False, 'max_autotune_pointwise': False, 'min_split_scan_rblock': 256, 'spill_threshold': 16, 'store_cubin': False, 'tiling_scores': {'y': 98304, 'x': 294912}},
    min_elem_per_thread=0
)
@triton.jit
def triton_poi_fused_add_70(in_ptr0, in_ptr1, out_ptr0, ynumel, xnumel, YBLOCK : tl.constexpr, XBLOCK : tl.constexpr):
    ynumel = 24
    xnumel = 1024
    yoffset = tl.program_id(1) * YBLOCK
    yindex = yoffset + tl.arange(0, YBLOCK)[:, None]
...
def partition_0(args):
    ...
    with torch.cuda._DeviceGuard(0):
        ...
        # Topologically Sorted Source Nodes: [input_43, input_44, std_target, input_87, input_88, sub, mul_28, v_pred, std_pred, add_121, rescale_factor, v_pred_rescaled, mul_30, mul_31, v_guided, mul_32], Original ATen: [aten.silu, aten.convolution, aten.std, aten.sub, aten.mul, aten.add, aten.div]
        stream0 = get_raw_stream(0)
        triton_red_fused_add_convolution_div_mul_silu_std_sub_69.run(buf697, buf686, arg153_1, 6, 4096, stream=stream0)
        del arg153_1
        buf698 = reinterpret_tensor(buf686, (6, 4, 32, 32), (4096, 1024, 32, 1), 0); del buf686  # reuse
        # Topologically Sorted Source Nodes: [x_next], Original ATen: [aten.add]
        stream0 = get_raw_stream(0)
        triton_poi_fused_add_70.run(arg25_1, buf697, buf698, 24, 1024, stream=stream0)
        del arg25_1
        del buf697
