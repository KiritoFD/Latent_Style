...
# Source node to ATen node mapping:
#   input_1 => add_tensor_40, slice_tensor_1
...
#   %add_tensor_40 : Tensor "f32[8, 1024][1024, 1]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.add.Tensor](args = (%mm_default_39, %arg2_1), kwargs = {})
#   %slice_tensor_1 : Tensor "f32[6, 1024][1024, 1]cuda:0"[num_users=2] = call_function[target=torch.ops.aten.slice.Tensor](args = (%add_tensor_40, 0, 0, -2), kwargs = {})
...
#   %view_119 : Tensor "f32[6, 512, 8, 8][32768, 1, 4096, 512]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.reshape.default](args = (%permute_62, [6, 512, 8, 8]), kwargs = {})
#   %convolution_15 : Tensor "f32[6, 256, 16, 16][65536, 1, 4096, 256]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.convolution.default](args = (%view_119, %arg78_1, %arg79_1, [2, 2], [1, 1], [1, 1], True, [0, 0], 1), kwargs = {})
#   %add_tensor_28 : Tensor "f32[6, 256][256, 1]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.add.Tensor](args = (%mm_default_27, %arg83_1), kwargs = {})
#   %sigmoid_18 : Tensor "f32[6, 256][256, 1]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.sigmoid.default](args = (%add_tensor_28,), kwargs = {})
...
# kernel path: ./.compile_cache/wr/cwrlnnpi55uvbm5yoiyfo4w5w3hfmijlqptswugthwlmds5u7ryy.py
...
# kernel path: ./.compile_cache/lf/clfylswqh5rq6ucoj2ex7kjw7vejfmtqyi6ch7ruyyw2nuxbjvwd.py
...
def partition_0(args):
    ...
    with torch.cuda._DeviceGuard(0):
        ...
        # Topologically Sorted Source Nodes: [input_43, input_44, std_target, input_87, input_88, sub_1, v_pred, std_pred], Original ATen: [aten.silu, aten.convolution, aten.std, aten.sub, aten.add]
        stream0 = get_raw_stream(0)
        triton_red_fused_add_convolution_silu_std_sub_68.run(buf686, arg153_1, buf693, buf688, buf695, s57, 6, 4096, stream=stream0)
        buf698 = empty_strided_cuda((6, 4, 32, 32), (4096, 1024, 32, 1), torch.float32)
        # Topologically Sorted Source Nodes: [input_43, input_44, std_target, input_87, input_88, sub_1, v_pred, std_pred, add_121, rescale_factor, v_pred_rescaled, mul_31, mul_32, v_guided, mul_33, x_next], Original ATen: [aten.silu, aten.convolution, aten.std, aten.sub, aten.add, aten.div, aten.mul]
        stream0 = get_raw_stream(0)
        triton_poi_fused_add_convolution_div_mul_silu_std_sub_69.run(buf693, arg153_1, buf686, buf688, buf695, arg25_1, buf698, s57, 6144, 4, stream=stream0)
        del arg153_1
        del arg25_1
        del buf686
        del buf688
