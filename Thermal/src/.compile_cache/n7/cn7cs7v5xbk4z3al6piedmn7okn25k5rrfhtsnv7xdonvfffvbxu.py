...
# kernel path: ./.compile_cache/s3/cs3goaqf7prtzvwjfg3ufcrrq5pyschzwgezugafuwfh3qhumyd4.py
...
# Graph fragment:
#   %mm_default_39 : Tensor "f32[6, 1024][1024, 1]cuda:0" = PlaceHolder[target=mm_default_39]
#   %arg2_1 : Tensor "f32[1024][1]cuda:0" = PlaceHolder[target=arg2_1]
#   %add_tensor_40 : Tensor "f32[6, 1024][1024, 1]cuda:0"[num_users=2] = call_function[target=torch.ops.aten.add.Tensor](args = (%mm_default_39, %arg2_1), kwargs = {})
#   %sigmoid : Tensor "f32[6, 1024][1024, 1]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.sigmoid.default](args = (%add_tensor_40,), kwargs = {})
#   %mul_2 : Tensor "f32[6, 1024][1024, 1]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%add_tensor_40, %sigmoid), kwargs = {})
#   return %mul_2
...
# kernel path: ./.compile_cache/67/c67m2tsoaugdee43o43fgtgshydxjwt5f2pa5pt3rsrbrbqrckrh.py
# Topologically Sorted Source Nodes: [input_1, input_2, input_3], Original ATen: [aten.addmm, aten.silu]
# Source node to ATen node mapping:
#   input_1 => add_tensor_40
#   input_2 => mul_2, sigmoid
#   input_3 => constant_pad_nd_default_3
# Graph fragment:
#   %mul_2 : Tensor "f32[6, 1024][1024, 1]cuda:0" = PlaceHolder[target=mul_2]
#   %add_tensor_40 : Tensor "f32[6, 1024][1024, 1]cuda:0"[num_users=2] = call_function[target=torch.ops.aten.add.Tensor](args = (%mm_default_39, %arg2_1), kwargs = {})
#   %sigmoid : Tensor "f32[6, 1024][1024, 1]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.sigmoid.default](args = (%add_tensor_40,), kwargs = {})
#   %mul_2 : Tensor "f32[6, 1024][1024, 1]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%add_tensor_40, %sigmoid), kwargs = {})
#   %constant_pad_nd_default_3 : Tensor "f32[8, 1024][1024, 1]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.constant_pad_nd.default](args = (%mul_2, [0, 0, 0, 2]), kwargs = {})
...
@triton_heuristics.pointwise(
    ...
    filename=__file__,
    triton_meta={'signature': {'in_ptr0': '*fp32', 'out_ptr0': '*fp32', 'xnumel': 'i32', 'XBLOCK': 'constexpr'}, 'device': DeviceProperties(type='cuda', index=0, multi_processor_count=36, cc=89, major=8, regs_per_multiprocessor=65536, max_threads_per_multi_processor=1536, warp_size=32), 'constants': {}, 'configs': [{(0,): [['tt.divisibility', 16]], (1,): [['tt.divisibility', 16]], (2,): [['tt.divisibility', 16]]}]},
    inductor_meta={'grid_type': 'Grid1D', 'autotune_hints': set(), 'kernel_name': 'triton_poi_fused_addmm_silu_7', 'mutated_arg_names': [], 'optimize_mem': True, 'no_x_dim': False, 'num_load': 1, 'num_reduction': 0, 'backend_hash': 'D54CF9E23D08230976451A78161C34C47AAE433535668E89333E7039B8F7F720', 'are_deterministic_algorithms_enabled': False, 'assert_indirect_indexing': True, 'autotune_local_cache': True, 'autotune_pointwise': True, 'autotune_remote_cache': None, 'force_disable_caches': False, 'dynamic_scale_rblock': True, 'max_autotune': False, 'max_autotune_pointwise': False, 'min_split_scan_rblock': 256, 'spill_threshold': 16, 'store_cubin': False, 'tiling_scores': {'x': 98304}},
    min_elem_per_thread=0
)
@triton.jit
def triton_poi_fused_addmm_silu_7(in_ptr0, out_ptr0, xnumel, XBLOCK : tl.constexpr):
    xnumel = 8192
    xoffset = tl.program_id(0) * XBLOCK
    xindex = xoffset + tl.arange(0, XBLOCK)[:]
    xmask = tl.full([XBLOCK], True, tl.int1)
...
# kernel path: ./.compile_cache/o6/co67lh3duk34alnqzs5jwcq77o3ujtwr6dzz4fgi2qilh4z5lanm.py
# Topologically Sorted Source Nodes: [input_3, s_emb, cat_1], Original ATen: [aten.addmm, aten.embedding, aten.cat]
# Source node to ATen node mapping:
#   cat_1 => cat_1
#   input_3 => slice_tensor_3
#   s_emb => embedding
# Graph fragment:
#   %addmm_default_3 : Tensor "f32[8, 256][256, 1]cuda:0" = PlaceHolder[target=addmm_default_3]
#   %arg6_1 : Tensor "i64[6][1]cuda:0" = PlaceHolder[target=arg6_1]
#   %arg5_1 : Tensor "f32[4, 256][256, 1]cuda:0" = PlaceHolder[target=arg5_1]
#   %slice_tensor_3 : Tensor "f32[6, 256][256, 1]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.slice.Tensor](args = (%addmm_default_3, 0, 0, -2), kwargs = {})
...
#   %cat_1 : Tensor "f32[6, 512][512, 1]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.cat.default](args = ([%slice_tensor_3, %embedding], -1), kwargs = {})
#   return %cat_1
triton_poi_fused_addmm_cat_embedding_8 = async_compile.triton('triton_poi_fused_addmm_cat_embedding_8', '''
import triton
import triton.language as tl
...
@triton_heuristics.pointwise(
    size_hints={'x': 4096}, 
    filename=__file__,
    triton_meta={'signature': {'in_ptr0': '*fp32', 'in_ptr1': '*i64', 'in_ptr2': '*fp32', 'out_ptr0': '*fp32', 'xnumel': 'i32', 'XBLOCK': 'constexpr'}, 'device': DeviceProperties(type='cuda', index=0, multi_processor_count=36, cc=89, major=8, regs_per_multiprocessor=65536, max_threads_per_multi_processor=1536, warp_size=32), 'constants': {}, 'configs': [{(0,): [['tt.divisibility', 16]], (1,): [['tt.divisibility', 16]], (2,): [['tt.divisibility', 16]], (3,): [['tt.divisibility', 16]], (4,): [['tt.divisibility', 16]]}]},
    inductor_meta={'grid_type': 'Grid1D', 'autotune_hints': set(), 'kernel_name': 'triton_poi_fused_addmm_cat_embedding_8', 'mutated_arg_names': [], 'optimize_mem': True, 'no_x_dim': False, 'num_load': 2, 'num_reduction': 0, 'backend_hash': 'D54CF9E23D08230976451A78161C34C47AAE433535668E89333E7039B8F7F720', 'are_deterministic_algorithms_enabled': False, 'assert_indirect_indexing': True, 'autotune_local_cache': True, 'autotune_pointwise': True, 'autotune_remote_cache': None, 'force_disable_caches': False, 'dynamic_scale_rblock': True, 'max_autotune': False, 'max_autotune_pointwise': False, 'min_split_scan_rblock': 256, 'spill_threshold': 16, 'store_cubin': False},
    min_elem_per_thread=0
)
@triton.jit
def triton_poi_fused_addmm_cat_embedding_8(in_ptr0, in_ptr1, in_ptr2, out_ptr0, xnumel, XBLOCK : tl.constexpr):
    xnumel = 3072
    xoffset = tl.program_id(0) * XBLOCK
    xindex = xoffset + tl.arange(0, XBLOCK)[:]
    xmask = xindex < xnumel
    ...
    tl.device_assert(((0 <= tl.broadcast_to(tmp13, [XBLOCK])) & (tl.broadcast_to(tmp13, [XBLOCK]) < 4)) | ~(tmp6 & xmask), "index out of bounds: 0 <= tl.broadcast_to(tmp13, [XBLOCK]) < 4")
    tmp15 = tl.load(in_ptr2 + (256*tmp13 + ((-256) + x0)), tmp6 & xmask, eviction_policy='evict_last', other=0.0)
...
#   %add_tensor_39 : Tensor "f32[6, 512][512, 1]cuda:0"[num_users=2] = call_function[target=torch.ops.aten.add.Tensor](args = (%mm_default_38, %arg8_1), kwargs = {})
#   %sigmoid_1 : Tensor "f32[6, 512][512, 1]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.sigmoid.default](args = (%add_tensor_39,), kwargs = {})
#   %mul_3 : Tensor "f32[6, 512][512, 1]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%add_tensor_39, %sigmoid_1), kwargs = {})
#   return %mul_3
...
#   %add_tensor_38 : Tensor "f32[6, 256][256, 1]cuda:0"[num_users=2] = call_function[target=torch.ops.aten.add.Tensor](args = (%mm_default_37, %arg12_1), kwargs = {})
#   %sigmoid_2 : Tensor "f32[6, 256][256, 1]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.sigmoid.default](args = (%add_tensor_38,), kwargs = {})
#   %mul_4 : Tensor "f32[6, 256][256, 1]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%add_tensor_38, %sigmoid_2), kwargs = {})
#   return %mul_4
...
#   x_norm => add, mul_7, rsqrt, sub, var_mean, view, view_1
# Graph fragment:
#   %buf25 : Tensor "f32[6, 128, 32, 32][131072, 1, 4096, 128]cuda:0" = PlaceHolder[target=buf25]
...
#   view_10 => view_14
# Graph fragment:
#   %buf40 : Tensor "f32[6, 256, 16, 16][65536, 1, 4096, 256]cuda:0" = PlaceHolder[target=buf40]
...
#   %mul_tensor_40 : Tensor "f32[6, 4, 256, 1][1024, 256, 1, 1]cuda:0"[num_users=2] = call_function[target=torch.ops.aten.mul.Tensor](args = (%view_22, 1), kwargs = {})
#   %amax_default_19 : Tensor "f32[6, 4, 256, 1][1024, 256, 1, 1]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.amax.default](args = (%mul_tensor_40, [-1], True), kwargs = {})
#   %sub_tensor_19 : Tensor "f32[6, 4, 256, 1][1024, 256, 1, 1]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.sub.Tensor](args = (%mul_tensor_40, %amax_default_19), kwargs = {})
#   %mul_tensor_41 : Tensor "f32[6, 4, 256, 1][1024, 256, 1, 1]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%sub_tensor_19, 0.125), kwargs = {})
#   %exp_1 : Tensor "f32[6, 4, 256, 1][1024, 256, 1, 1]cuda:0"[num_users=2] = call_function[target=torch.ops.aten.exp.default](args = (%mul_tensor_41,), kwargs = {})
...
#   %convolution_5 : Tensor "f32[6, 256, 16, 16][65536, 256, 16, 1]cuda:0"[num_users=3] = call_function[target=torch.ops.aten.convolution.default](args = (%mul_12, %arg34_1, %arg35_1, [2, 2], [1, 1], [1, 1], False, [0, 0], 1), kwargs = {})
#   %add_tensor_37 : Tensor "f32[1536, 256][256, 1]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.add.Tensor](args = (%mm_default_36, %arg39_1), kwargs = {})
#   %view_28 : Tensor "f32[6, 256, 256][65536, 256, 1]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.reshape.default](args = (%add_tensor_37, [6, 256, 256]), kwargs = {})
...
# Graph fragment:
#   %buf53 : Tensor "f32[6, 256, 16, 16][65536, 1, 4096, 256]cuda:0" = PlaceHolder[target=buf53]
...
#   %buf55 : Tensor "f32[6, 32, 1, 1][32, 1, 192, 192]cuda:0" = PlaceHolder[target=buf55]
#   %convolution_5 : Tensor "f32[6, 256, 16, 16][65536, 256, 16, 1]cuda:0"[num_users=3] = call_function[target=torch.ops.aten.convolution.default](args = (%mul_12, %arg34_1, %arg35_1, [2, 2], [1, 1], [1, 1], False, [0, 0], 1), kwargs = {})
#   %add_tensor_37 : Tensor "f32[1536, 256][256, 1]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.add.Tensor](args = (%mm_default_36, %arg39_1), kwargs = {})
#   %view_28 : Tensor "f32[6, 256, 256][65536, 256, 1]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.reshape.default](args = (%add_tensor_37, [6, 256, 256]), kwargs = {})
#   %permute_21 : Tensor "f32[6, 256, 256][65536, 1, 256]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.permute.default](args = (%view_28, [0, 2, 1]), kwargs = {})
...
#   x_norm_2 => add_9, mul_14, rsqrt_2, sub_3, var_mean_2, view_30, view_31
# Graph fragment:
#   %buf65 : Tensor "f32[6, 256, 16, 16][65536, 1, 4096, 256]cuda:0" = PlaceHolder[target=buf65]
...
#   %sigmoid_10 : Tensor "f32[6, 256, 16, 16][65536, 256, 16, 1]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.sigmoid.default](args = (%add_12,), kwargs = {})
#   %mul_16 : Tensor "f32[6, 256, 16, 16][65536, 256, 16, 1]cuda:0"[num_users=3] = call_function[target=torch.ops.aten.mul.Tensor](args = (%add_12, %sigmoid_10), kwargs = {})
#   %add_tensor_35 : Tensor "f32[1536, 256][256, 1]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.add.Tensor](args = (%mm_default_34, %arg47_1), kwargs = {})
#   %view_51 : Tensor "f32[6, 256, 256][65536, 256, 1]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.reshape.default](args = (%add_tensor_35, [6, 256, 256]), kwargs = {})
...
# Graph fragment:
#   %buf87 : Tensor "f32[6, 256, 16, 16][65536, 1, 4096, 256]cuda:0" = PlaceHolder[target=buf87]
...
#   view_30 => view_60
# Graph fragment:
#   %buf91 : Tensor "f32[6, 512, 8, 8][32768, 1, 4096, 512]cuda:0" = PlaceHolder[target=buf91]
...
#   %mul_tensor_36 : Tensor "f32[6, 8, 64, 1][512, 64, 1, 1]cuda:0"[num_users=2] = call_function[target=torch.ops.aten.mul.Tensor](args = (%view_68, 1), kwargs = {})
#   %amax_default_17 : Tensor "f32[6, 8, 64, 1][512, 64, 1, 1]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.amax.default](args = (%mul_tensor_36, [-1], True), kwargs = {})
#   %sub_tensor_17 : Tensor "f32[6, 8, 64, 1][512, 64, 1, 1]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.sub.Tensor](args = (%mul_tensor_36, %amax_default_17), kwargs = {})
#   %mul_tensor_37 : Tensor "f32[6, 8, 64, 1][512, 64, 1, 1]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%sub_tensor_17, 0.125), kwargs = {})
#   %exp_3 : Tensor "f32[6, 8, 64, 1][512, 64, 1, 1]cuda:0"[num_users=2] = call_function[target=torch.ops.aten.exp.default](args = (%mul_tensor_37,), kwargs = {})
...
#   %mul_20 : Tensor "f32[6, 256, 16, 16][65536, 256, 16, 1]cuda:0"[num_users=2] = call_function[target=torch.ops.aten.mul.Tensor](args = (%add_17, %sigmoid_12), kwargs = {})
#   %convolution_10 : Tensor "f32[6, 512, 8, 8][32768, 64, 8, 1]cuda:0"[num_users=3] = call_function[target=torch.ops.aten.convolution.default](args = (%mul_20, %arg52_1, %arg53_1, [2, 2], [1, 1], [1, 1], False, [0, 0], 1), kwargs = {})
#   %add_tensor_34 : Tensor "f32[384, 512][512, 1]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.add.Tensor](args = (%mm_default_33, %arg57_1), kwargs = {})
#   %view_74 : Tensor "f32[6, 64, 512][32768, 512, 1]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.reshape.default](args = (%add_tensor_34, [6, 64, 512]), kwargs = {})
...
# Graph fragment:
#   %buf104 : Tensor "f32[6, 512, 8, 8][32768, 1, 4096, 512]cuda:0" = PlaceHolder[target=buf104]
...
#   %buf106 : Tensor "f32[6, 32, 1, 1][32, 1, 192, 192]cuda:0" = PlaceHolder[target=buf106]
#   %sigmoid_12 : Tensor "f32[6, 256, 16, 16][65536, 256, 16, 1]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.sigmoid.default](args = (%add_17,), kwargs = {})
#   %mul_20 : Tensor "f32[6, 256, 16, 16][65536, 256, 16, 1]cuda:0"[num_users=2] = call_function[target=torch.ops.aten.mul.Tensor](args = (%add_17, %sigmoid_12), kwargs = {})
#   %convolution_10 : Tensor "f32[6, 512, 8, 8][32768, 64, 8, 1]cuda:0"[num_users=3] = call_function[target=torch.ops.aten.convolution.default](args = (%mul_20, %arg52_1, %arg53_1, [2, 2], [1, 1], [1, 1], False, [0, 0], 1), kwargs = {})
#   %add_tensor_34 : Tensor "f32[384, 512][512, 1]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.add.Tensor](args = (%mm_default_33, %arg57_1), kwargs = {})
...
#   x_norm_4 => add_19, mul_22, rsqrt_4, sub_7, var_mean_4, view_76, view_77
# Graph fragment:
#   %buf116 : Tensor "f32[6, 512, 8, 8][32768, 1, 4096, 512]cuda:0" = PlaceHolder[target=buf116]
...
#   %sigmoid_14 : Tensor "f32[6, 512, 8, 8][32768, 64, 8, 1]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.sigmoid.default](args = (%add_22,), kwargs = {})
#   %mul_24 : Tensor "f32[6, 512, 8, 8][32768, 64, 8, 1]cuda:0"[num_users=3] = call_function[target=torch.ops.aten.mul.Tensor](args = (%add_22, %sigmoid_14), kwargs = {})
#   %add_tensor_32 : Tensor "f32[384, 512][512, 1]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.add.Tensor](args = (%mm_default_31, %arg65_1), kwargs = {})
#   %view_97 : Tensor "f32[6, 64, 512][32768, 512, 1]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.reshape.default](args = (%add_tensor_32, [6, 64, 512]), kwargs = {})
...
# Graph fragment:
#   %buf137 : Tensor "f32[6, 512, 8, 8][32768, 1, 4096, 512]cuda:0" = PlaceHolder[target=buf137]
...
#   %buf140 : Tensor "f32[6, 64, 1][64, 1, 384]cuda:0" = PlaceHolder[target=buf140]
...
#   %add_tensor_31 : Tensor "f32[384, 1536][1536, 1]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.add.Tensor](args = (%mm_default_30, %arg73_1), kwargs = {})
#   %view_108 : Tensor "f32[6, 64, 1536][98304, 1536, 1]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.reshape.default](args = (%add_tensor_31, [6, 64, 1536]), kwargs = {})
...
#   %mul_tensor_32 : Tensor "f32[6, 8, 64, 64][32768, 4096, 64, 1]cuda:0"[num_users=2] = call_function[target=torch.ops.aten.mul.Tensor](args = (%view_112, 1), kwargs = {})
#   %amax_default_15 : Tensor "f32[6, 8, 64, 1][512, 64, 1, 1]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.amax.default](args = (%mul_tensor_32, [-1], True), kwargs = {})
#   %sub_tensor_15 : Tensor "f32[6, 8, 64, 64][32768, 4096, 64, 1]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.sub.Tensor](args = (%mul_tensor_32, %amax_default_15), kwargs = {})
#   %mul_tensor_33 : Tensor "f32[6, 8, 64, 64][32768, 4096, 64, 1]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%sub_tensor_15, 0.125), kwargs = {})
#   %exp_5 : Tensor "f32[6, 8, 64, 64][32768, 4096, 64, 1]cuda:0"[num_users=2] = call_function[target=torch.ops.aten.exp.default](args = (%mul_tensor_33,), kwargs = {})
...
#   %buf155 : Tensor "f32[6, 64, 1][64, 1, 384]cuda:0" = PlaceHolder[target=buf155]
...
#   %view_106 : Tensor "f32[6, 512, 64][32768, 64, 1]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.reshape.default](args = (%mul_28, [6, 512, 64]), kwargs = {})
#   %permute_56 : Tensor "f32[6, 64, 512][32768, 1, 64]cuda:0"[num_users=2] = call_function[target=torch.ops.aten.permute.default](args = (%view_106, [0, 2, 1]), kwargs = {})
#   %add_tensor_30 : Tensor "f32[384, 512][512, 1]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.add.Tensor](args = (%mm_default_29, %arg75_1), kwargs = {})
#   %view_118 : Tensor "f32[6, 64, 512][32768, 512, 1]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.reshape.default](args = (%add_tensor_30, [6, 64, 512]), kwargs = {})
...
# kernel path: ./.compile_cache/sn/csnzpgdfmfjh77h2gsyfmjyb3q5rdt63ftdva5rsigus2z6uzzcd.py
# Topologically Sorted Source Nodes: [input_24, input_25, input_26], Original ATen: [aten.addmm, aten.silu]
# Source node to ATen node mapping:
#   input_24 => add_tensor_29
#   input_25 => mul_34, sigmoid_17
#   input_26 => constant_pad_nd_default_2
# Graph fragment:
#   %mul_34 : Tensor "f32[6, 256][256, 1]cuda:0" = PlaceHolder[target=mul_34]
#   %add_tensor_29 : Tensor "f32[6, 256][256, 1]cuda:0"[num_users=2] = call_function[target=torch.ops.aten.add.Tensor](args = (%mm_default_28, %arg81_1), kwargs = {})
#   %sigmoid_17 : Tensor "f32[6, 256][256, 1]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.sigmoid.default](args = (%add_tensor_29,), kwargs = {})
#   %mul_34 : Tensor "f32[6, 256][256, 1]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%add_tensor_29, %sigmoid_17), kwargs = {})
#   %constant_pad_nd_default_2 : Tensor "f32[8, 256][256, 1]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.constant_pad_nd.default](args = (%mul_34, [0, 0, 0, 2]), kwargs = {})
#   return %constant_pad_nd_default_2
triton_poi_fused_addmm_silu_50 = async_compile.triton('triton_poi_fused_addmm_silu_50', '''
import triton
import triton.language as tl
...
@triton_heuristics.pointwise(
    ...
    filename=__file__,
    triton_meta={'signature': {'in_ptr0': '*fp32', 'out_ptr0': '*fp32', 'xnumel': 'i32', 'XBLOCK': 'constexpr'}, 'device': DeviceProperties(type='cuda', index=0, multi_processor_count=36, cc=89, major=8, regs_per_multiprocessor=65536, max_threads_per_multi_processor=1536, warp_size=32), 'constants': {}, 'configs': [{(0,): [['tt.divisibility', 16]], (1,): [['tt.divisibility', 16]], (2,): [['tt.divisibility', 16]]}]},
    inductor_meta={'grid_type': 'Grid1D', 'autotune_hints': set(), 'kernel_name': 'triton_poi_fused_addmm_silu_50', 'mutated_arg_names': [], 'optimize_mem': True, 'no_x_dim': False, 'num_load': 1, 'num_reduction': 0, 'backend_hash': 'D54CF9E23D08230976451A78161C34C47AAE433535668E89333E7039B8F7F720', 'are_deterministic_algorithms_enabled': False, 'assert_indirect_indexing': True, 'autotune_local_cache': True, 'autotune_pointwise': True, 'autotune_remote_cache': None, 'force_disable_caches': False, 'dynamic_scale_rblock': True, 'max_autotune': False, 'max_autotune_pointwise': False, 'min_split_scan_rblock': 256, 'spill_threshold': 16, 'store_cubin': False, 'tiling_scores': {'x': 24576}},
    min_elem_per_thread=0
)
@triton.jit
def triton_poi_fused_addmm_silu_50(in_ptr0, out_ptr0, xnumel, XBLOCK : tl.constexpr):
    xnumel = 2048
    xoffset = tl.program_id(0) * XBLOCK
    xindex = xoffset + tl.arange(0, XBLOCK)[:]
    xmask = xindex < xnumel
...
# kernel path: ./.compile_cache/ek/ceko7n6zjn4enb3kw3qeouyjn36ywjn2lk7ion2y74ajjaqrlhij.py
...
#   h_8 => mul_28, sigmoid_16
#   h_9 => convolution_15
#   input_26 => add_tensor_28, slice_tensor_2
#   input_27 => sigmoid_18
#   out_22 => add_tensor_30, view_118
#   out_23 => add_30
#   out_24 => add_31, add_32, clone_29, mul_32, mul_33, rsqrt_7, sub_12, var_mean_7
...
#   x_flat_6 => permute_56
# Graph fragment:
#   %buf160 : Tensor "f32[6, 256, 16, 16][65536, 1, 4096, 256]cuda:0" = PlaceHolder[target=buf160]
...
#   %mm_default_27 : Tensor "f32[8, 256][256, 1]cuda:0" = PlaceHolder[target=mm_default_27]
...
#   %view_119 : Tensor "f32[6, 512, 8, 8][32768, 1, 4096, 512]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.reshape.default](args = (%permute_62, [6, 512, 8, 8]), kwargs = {})
#   %convolution_15 : Tensor "f32[6, 256, 16, 16][65536, 1, 4096, 256]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.convolution.default](args = (%view_119, %arg78_1, %arg79_1, [2, 2], [1, 1], [1, 1], True, [0, 0], 1), kwargs = {})
#   %add_tensor_28 : Tensor "f32[8, 256][256, 1]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.add.Tensor](args = (%mm_default_27, %arg83_1), kwargs = {})
#   %slice_tensor_2 : Tensor "f32[6, 256][256, 1]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.slice.Tensor](args = (%add_tensor_28, 0, 0, -2), kwargs = {})
#   %sigmoid_18 : Tensor "f32[6, 256][256, 1]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.sigmoid.default](args = (%slice_tensor_2,), kwargs = {})
...
#   return %add_33
triton_poi_fused_add_addmm_convolution_mul_native_layer_norm_sigmoid_silu_transpose_unsqueeze_view_51 = async_compile.triton('triton_poi_fused_add_addmm_convolution_mul_native_layer_norm_sigmoid_silu_transpose_unsqueeze_view_51', '''
import triton
import triton.language as tl
...
@triton_heuristics.pointwise(
    ...
    inductor_meta={'grid_type': 'Grid2D', 'autotune_hints': set(), 'kernel_name': 'triton_poi_fused_add_addmm_convolution_mul_native_layer_norm_sigmoid_silu_transpose_unsqueeze_view_51', 'mutated_arg_names': [], 'optimize_mem': True, 'no_x_dim': False, 'num_load': 5, 'num_reduction': 0, 'backend_hash': 'D54CF9E23D08230976451A78161C34C47AAE433535668E89333E7039B8F7F720', 'are_deterministic_algorithms_enabled': False, 'assert_indirect_indexing': True, 'autotune_local_cache': True, 'autotune_pointwise': True, 'autotune_remote_cache': None, 'force_disable_caches': False, 'dynamic_scale_rblock': True, 'max_autotune': False, 'max_autotune_pointwise': False, 'min_split_scan_rblock': 256, 'spill_threshold': 16, 'store_cubin': False, 'tiling_scores': {'y': 3145728, 'x': 3153920}},
    min_elem_per_thread=0
)
@triton.jit
def triton_poi_fused_add_addmm_convolution_mul_native_layer_norm_sigmoid_silu_transpose_unsqueeze_view_51(in_ptr0, in_ptr1, in_ptr2, in_ptr3, in_ptr4, out_ptr0, ynumel, xnumel, YBLOCK : tl.constexpr, XBLOCK : tl.constexpr):
    ynumel = 1536
    xnumel = 256
    yoffset = tl.program_id(1) * YBLOCK
    yindex = yoffset + tl.arange(0, YBLOCK)[:, None]
...
# kernel path: ./.compile_cache/kw/ckwixjwn5kdmnmt5y22nz2nrcr6kqjd6imshnnx67t3q6qzbbjsj.py
...
#   return %buf166
triton_poi_fused_mm_t_transpose_view_52 = async_compile.triton('triton_poi_fused_mm_t_transpose_view_52', '''
import triton
import triton.language as tl
...
@triton_heuristics.pointwise(
    ...
    filename=__file__,
    triton_meta={'signature': {'in_ptr0': '*fp32', 'out_ptr0': '*fp32', 'xnumel': 'i32', 'XBLOCK': 'constexpr'}, 'device': DeviceProperties(type='cuda', index=0, multi_processor_count=36, cc=89, major=8, regs_per_multiprocessor=65536, max_threads_per_multi_processor=1536, warp_size=32), 'constants': {}, 'configs': [{(0,): [['tt.divisibility', 16]], (1,): [['tt.divisibility', 16]], (2,): [['tt.divisibility', 16]]}]},
    inductor_meta={'grid_type': 'Grid1D', 'autotune_hints': set(), 'kernel_name': 'triton_poi_fused_mm_t_transpose_view_52', 'mutated_arg_names': [], 'optimize_mem': True, 'no_x_dim': False, 'num_load': 1, 'num_reduction': 0, 'backend_hash': 'D54CF9E23D08230976451A78161C34C47AAE433535668E89333E7039B8F7F720', 'are_deterministic_algorithms_enabled': False, 'assert_indirect_indexing': True, 'autotune_local_cache': True, 'autotune_pointwise': True, 'autotune_remote_cache': None, 'force_disable_caches': False, 'dynamic_scale_rblock': True, 'max_autotune': False, 'max_autotune_pointwise': False, 'min_split_scan_rblock': 256, 'spill_threshold': 16, 'store_cubin': False, 'tiling_scores': {'x': 4718592}},
    min_elem_per_thread=0
)
@triton.jit
def triton_poi_fused_mm_t_transpose_view_52(in_ptr0, out_ptr0, xnumel, XBLOCK : tl.constexpr):
    xnumel = 393216
    xoffset = tl.program_id(0) * XBLOCK
    xindex = xoffset + tl.arange(0, XBLOCK)[:]
    xmask = tl.full([XBLOCK], True, tl.int1)
...
# kernel path: ./.compile_cache/wr/cwr4rmcnwqd6navqk2pwktnbkpypfwhybvf2kebxvahglikwh6fb.py
...
#   %add_tensor_27 : Tensor "f32[1536, 256][256, 1]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.add.Tensor](args = (%mm_default_26, %arg87_1), kwargs = {})
#   %view_134 : Tensor "f32[6, 256, 256][65536, 256, 1]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.reshape.default](args = (%add_tensor_27, [6, 256, 256]), kwargs = {})
...
#   return %add_34
triton_poi_fused_add_addmm_transpose_view_53 = async_compile.triton('triton_poi_fused_add_addmm_transpose_view_53', '''
import triton
import triton.language as tl
...
@triton_heuristics.pointwise(
    ...
    inductor_meta={'grid_type': 'Grid2D', 'autotune_hints': set(), 'kernel_name': 'triton_poi_fused_add_addmm_transpose_view_53', 'mutated_arg_names': ['in_out_ptr0'], 'optimize_mem': True, 'no_x_dim': False, 'num_load': 3, 'num_reduction': 0, 'backend_hash': 'D54CF9E23D08230976451A78161C34C47AAE433535668E89333E7039B8F7F720', 'are_deterministic_algorithms_enabled': False, 'assert_indirect_indexing': True, 'autotune_local_cache': True, 'autotune_pointwise': True, 'autotune_remote_cache': None, 'force_disable_caches': False, 'dynamic_scale_rblock': True, 'max_autotune': False, 'max_autotune_pointwise': False, 'min_split_scan_rblock': 256, 'spill_threshold': 16, 'store_cubin': False, 'tiling_scores': {'y': 1572864, 'x': 4719616}},
    min_elem_per_thread=0
)
@triton.jit
def triton_poi_fused_add_addmm_transpose_view_53(in_out_ptr0, in_ptr0, in_ptr1, ynumel, xnumel, YBLOCK : tl.constexpr, XBLOCK : tl.constexpr):
    ynumel = 1536
    xnumel = 256
    yoffset = tl.program_id(1) * YBLOCK
    yindex = yoffset + tl.arange(0, YBLOCK)[:, None]
...
# kernel path: ./.compile_cache/tn/ctn4fikgryfvupv22xqheycew3nddgdxoqai353fykutpbpkg7kr.py
...
@triton.jit
def triton_poi_fused_add_addmm_clone_convolution_native_group_norm_silu_split_with_sizes_transpose_view_54(in_ptr0, in_ptr1, in_ptr2, out_ptr0, ynumel, xnumel, YBLOCK : tl.constexpr, XBLOCK : tl.constexpr):
    ynumel = 1536
    xnumel = 256
    yoffset = tl.program_id(1) * YBLOCK
    yindex = yoffset + tl.arange(0, YBLOCK)[:, None]
...
# kernel path: ./.compile_cache/yy/cyyss7uas34aev7kxpnjxacax5b3permbnuvxd6rve3h22gqfhct.py
...
#   %sigmoid_20 : Tensor "f32[6, 256, 16, 16][65536, 256, 16, 1]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.sigmoid.default](args = (%add_38,), kwargs = {})
#   %mul_39 : Tensor "f32[6, 256, 16, 16][65536, 256, 16, 1]cuda:0"[num_users=3] = call_function[target=torch.ops.aten.mul.Tensor](args = (%add_38, %sigmoid_20), kwargs = {})
#   %add_tensor_26 : Tensor "f32[1536, 256][256, 1]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.add.Tensor](args = (%mm_default_25, %arg95_1), kwargs = {})
#   %view_157 : Tensor "f32[6, 256, 256][65536, 256, 1]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.reshape.default](args = (%add_tensor_26, [6, 256, 256]), kwargs = {})
...
@triton_heuristics.pointwise(
    ...
    inductor_meta={'grid_type': 'Grid2D', 'autotune_hints': set(), 'kernel_name': 'triton_poi_fused_add_addmm_clone_convolution_native_group_norm_silu_split_with_sizes_transpose_view_55', 'mutated_arg_names': ['in_out_ptr0'], 'optimize_mem': True, 'no_x_dim': False, 'num_load': 5, 'num_reduction': 0, 'backend_hash': 'D54CF9E23D08230976451A78161C34C47AAE433535668E89333E7039B8F7F720', 'are_deterministic_algorithms_enabled': False, 'assert_indirect_indexing': True, 'autotune_local_cache': True, 'autotune_pointwise': True, 'autotune_remote_cache': None, 'force_disable_caches': False, 'dynamic_scale_rblock': True, 'max_autotune': False, 'max_autotune_pointwise': False, 'min_split_scan_rblock': 256, 'spill_threshold': 16, 'store_cubin': False, 'tiling_scores': {'y': 1572864, 'x': 6293504}},
    min_elem_per_thread=0
)
@triton.jit
def triton_poi_fused_add_addmm_clone_convolution_native_group_norm_silu_split_with_sizes_transpose_view_55(in_out_ptr0, in_ptr0, in_ptr1, in_ptr2, in_ptr3, ynumel, xnumel, YBLOCK : tl.constexpr, XBLOCK : tl.constexpr):
    ynumel = 1536
    xnumel = 256
    yoffset = tl.program_id(1) * YBLOCK
    yindex = yoffset + tl.arange(0, YBLOCK)[:, None]
...
# kernel path: ./.compile_cache/dr/cdrkxpta7jiccuawlmxnixjavx2z7rlxwcmhtloriawlurpoq7pv.py
...
@triton.jit
def triton_poi_fused_add_addmm_clone_convolution_native_group_norm_silu_split_with_sizes_transpose_view_56(in_out_ptr0, in_ptr0, in_ptr1, in_ptr2, in_ptr3, out_ptr0, xnumel, XBLOCK : tl.constexpr):
    xnumel = 393216
    xoffset = tl.program_id(0) * XBLOCK
    xindex = xoffset + tl.arange(0, XBLOCK)[:]
    xmask = tl.full([XBLOCK], True, tl.int1)
...
# kernel path: ./.compile_cache/lw/clwmeq4z47l5crgamszxa3jzyuppjmplgnpz4dojjy7pkkifmyek.py
...
#   %sigmoid_22 : Tensor "f32[6, 256, 16, 16][65536, 256, 16, 1]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.sigmoid.default](args = (%add_43,), kwargs = {})
#   %mul_43 : Tensor "f32[6, 256, 16, 16][65536, 256, 16, 1]cuda:0"[num_users=3] = call_function[target=torch.ops.aten.mul.Tensor](args = (%add_43, %sigmoid_22), kwargs = {})
#   %add_tensor_25 : Tensor "f32[1536, 256][256, 1]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.add.Tensor](args = (%mm_default_24, %arg103_1), kwargs = {})
#   %view_180 : Tensor "f32[6, 256, 256][65536, 256, 1]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.reshape.default](args = (%add_tensor_25, [6, 256, 256]), kwargs = {})
...
#   return %add_44
triton_poi_fused_add_addmm_silu_transpose_view_57 = async_compile.triton('triton_poi_fused_add_addmm_silu_transpose_view_57', '''
import triton
import triton.language as tl
...
@triton_heuristics.pointwise(
    ...
    filename=__file__,
    triton_meta={'signature': {'in_out_ptr0': '*fp32', 'in_ptr0': '*fp32', 'in_ptr1': '*fp32', 'xnumel': 'i32', 'XBLOCK': 'constexpr'}, 'device': DeviceProperties(type='cuda', index=0, multi_processor_count=36, cc=89, major=8, regs_per_multiprocessor=65536, max_threads_per_multi_processor=1536, warp_size=32), 'constants': {}, 'configs': [{(0,): [['tt.divisibility', 16]], (1,): [['tt.divisibility', 16]], (2,): [['tt.divisibility', 16]], (3,): [['tt.divisibility', 16]]}]},
    inductor_meta={'grid_type': 'Grid1D', 'autotune_hints': set(), 'kernel_name': 'triton_poi_fused_add_addmm_silu_transpose_view_57', 'mutated_arg_names': ['in_out_ptr0'], 'optimize_mem': True, 'no_x_dim': False, 'num_load': 3, 'num_reduction': 0, 'backend_hash': 'D54CF9E23D08230976451A78161C34C47AAE433535668E89333E7039B8F7F720', 'are_deterministic_algorithms_enabled': False, 'assert_indirect_indexing': True, 'autotune_local_cache': True, 'autotune_pointwise': True, 'autotune_remote_cache': None, 'force_disable_caches': False, 'dynamic_scale_rblock': True, 'max_autotune': False, 'max_autotune_pointwise': False, 'min_split_scan_rblock': 256, 'spill_threshold': 16, 'store_cubin': False, 'tiling_scores': {'x': 6292480}},
    min_elem_per_thread=0
)
@triton.jit
def triton_poi_fused_add_addmm_silu_transpose_view_57(in_out_ptr0, in_ptr0, in_ptr1, xnumel, XBLOCK : tl.constexpr):
    xnumel = 393216
    xoffset = tl.program_id(0) * XBLOCK
    xindex = xoffset + tl.arange(0, XBLOCK)[:]
    xmask = tl.full([XBLOCK], True, tl.int1)
...
# kernel path: ./.compile_cache/ir/cir5ypd572x232lbuigeepsxdlnlfwds5cir4shzhxowa5t5ro5e.py
...
@triton_heuristics.pointwise(
    ...
    inductor_meta={'grid_type': 'Grid1D', 'autotune_hints': set(), 'kernel_name': 'triton_poi_fused_add_addmm_clone_convolution_native_group_norm_silu_split_with_sizes_transpose_view_58', 'mutated_arg_names': [], 'optimize_mem': True, 'no_x_dim': False, 'num_load': 3, 'num_reduction': 0, 'backend_hash': 'D54CF9E23D08230976451A78161C34C47AAE433535668E89333E7039B8F7F720', 'are_deterministic_algorithms_enabled': False, 'assert_indirect_indexing': True, 'autotune_local_cache': True, 'autotune_pointwise': True, 'autotune_remote_cache': None, 'force_disable_caches': False, 'dynamic_scale_rblock': True, 'max_autotune': False, 'max_autotune_pointwise': False, 'min_split_scan_rblock': 256, 'spill_threshold': 16, 'store_cubin': False, 'tiling_scores': {'x': 6292480}},
    min_elem_per_thread=0
)
@triton.jit
def triton_poi_fused_add_addmm_clone_convolution_native_group_norm_silu_split_with_sizes_transpose_view_58(in_ptr0, in_ptr1, in_ptr2, out_ptr0, xnumel, XBLOCK : tl.constexpr):
    xnumel = 393216
    xoffset = tl.program_id(0) * XBLOCK
    xindex = xoffset + tl.arange(0, XBLOCK)[:]
    xmask = tl.full([XBLOCK], True, tl.int1)
...
# kernel path: ./.compile_cache/cy/ccyp7qdeqi2e6kmawcj3ai5w63rkqvkw5lcrwhvj3vtf7j3mcokv.py
...
#   %sigmoid_24 : Tensor "f32[6, 256, 16, 16][65536, 256, 16, 1]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.sigmoid.default](args = (%add_48,), kwargs = {})
#   %mul_47 : Tensor "f32[6, 256, 16, 16][65536, 256, 16, 1]cuda:0"[num_users=3] = call_function[target=torch.ops.aten.mul.Tensor](args = (%add_48, %sigmoid_24), kwargs = {})
#   %add_tensor_24 : Tensor "f32[1536, 256][256, 1]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.add.Tensor](args = (%mm_default_23, %arg111_1), kwargs = {})
#   %view_203 : Tensor "f32[6, 256, 256][65536, 256, 1]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.reshape.default](args = (%add_tensor_24, [6, 256, 256]), kwargs = {})
...
@triton.jit
def triton_poi_fused_add_addmm_convolution_native_group_norm_silu_split_with_sizes_transpose_view_59(in_out_ptr0, in_ptr0, in_ptr1, in_ptr2, in_ptr3, xnumel, XBLOCK : tl.constexpr):
    xnumel = 393216
    xoffset = tl.program_id(0) * XBLOCK
    xindex = xoffset + tl.arange(0, XBLOCK)[:]
    xmask = tl.full([XBLOCK], True, tl.int1)
...
# kernel path: ./.compile_cache/tw/ctwz727utexjvmmfbxz5t4heo7daruqom5uxoggktbclbzttrbbl.py
...
triton_poi_fused_add_addmm_clone_convolution_native_group_norm_silu_split_with_sizes_transpose_view_60 = async_compile.triton('triton_poi_fused_add_addmm_clone_convolution_native_group_norm_silu_split_with_sizes_transpose_view_60', '''
import triton
import triton.language as tl
...
@triton_heuristics.pointwise(
    ...
    filename=__file__,
    triton_meta={'signature': {'in_out_ptr0': '*fp32', 'in_ptr0': '*fp32', 'in_ptr1': '*fp32', 'in_ptr2': '*fp32', 'in_ptr3': '*fp32', 'out_ptr0': '*fp32', 'xnumel': 'i32', 'XBLOCK': 'constexpr'}, 'device': DeviceProperties(type='cuda', index=0, multi_processor_count=36, cc=89, major=8, regs_per_multiprocessor=65536, max_threads_per_multi_processor=1536, warp_size=32), 'constants': {}, 'configs': [{(0,): [['tt.divisibility', 16]], (1,): [['tt.divisibility', 16]], (2,): [['tt.divisibility', 16]], (3,): [['tt.divisibility', 16]], (4,): [['tt.divisibility', 16]], (5,): [['tt.divisibility', 16]], (6,): [['tt.divisibility', 16]]}]},
    inductor_meta={'grid_type': 'Grid1D', 'autotune_hints': set(), 'kernel_name': 'triton_poi_fused_add_addmm_clone_convolution_native_group_norm_silu_split_with_sizes_transpose_view_60', 'mutated_arg_names': ['in_out_ptr0'], 'optimize_mem': True, 'no_x_dim': False, 'num_load': 5, 'num_reduction': 0, 'backend_hash': 'D54CF9E23D08230976451A78161C34C47AAE433535668E89333E7039B8F7F720', 'are_deterministic_algorithms_enabled': False, 'assert_indirect_indexing': True, 'autotune_local_cache': True, 'autotune_pointwise': True, 'autotune_remote_cache': None, 'force_disable_caches': False, 'dynamic_scale_rblock': True, 'max_autotune': False, 'max_autotune_pointwise': False, 'min_split_scan_rblock': 256, 'spill_threshold': 16, 'store_cubin': False, 'tiling_scores': {'x': 11012096}},
    min_elem_per_thread=0
)
@triton.jit
def triton_poi_fused_add_addmm_clone_convolution_native_group_norm_silu_split_with_sizes_transpose_view_60(in_out_ptr0, in_ptr0, in_ptr1, in_ptr2, in_ptr3, out_ptr0, xnumel, XBLOCK : tl.constexpr):
    xnumel = 393216
    xoffset = tl.program_id(0) * XBLOCK
    xindex = xoffset + tl.arange(0, XBLOCK)[:]
    xmask = tl.full([XBLOCK], True, tl.int1)
...
# kernel path: ./.compile_cache/zk/czkhzajnzdsbvbyktqjetc7qjrucio4dns3idudfvtgfbrkpyil4.py
...
#   %sigmoid_26 : Tensor "f32[6, 256, 16, 16][65536, 256, 16, 1]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.sigmoid.default](args = (%add_53,), kwargs = {})
#   %mul_51 : Tensor "f32[6, 256, 16, 16][65536, 256, 16, 1]cuda:0"[num_users=3] = call_function[target=torch.ops.aten.mul.Tensor](args = (%add_53, %sigmoid_26), kwargs = {})
#   %add_tensor_23 : Tensor "f32[1536, 256][256, 1]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.add.Tensor](args = (%mm_default_22, %arg119_1), kwargs = {})
#   %view_226 : Tensor "f32[6, 256, 256][65536, 256, 1]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.reshape.default](args = (%add_tensor_23, [6, 256, 256]), kwargs = {})
...
@triton_heuristics.pointwise(
    ...
    filename=__file__,
    triton_meta={'signature': {'in_out_ptr0': '*fp32', 'in_ptr0': '*fp32', 'in_ptr1': '*fp32', 'xnumel': 'i32', 'XBLOCK': 'constexpr'}, 'device': DeviceProperties(type='cuda', index=0, multi_processor_count=36, cc=89, major=8, regs_per_multiprocessor=65536, max_threads_per_multi_processor=1536, warp_size=32), 'constants': {}, 'configs': [{(0,): [['tt.divisibility', 16]], (1,): [['tt.divisibility', 16]], (2,): [['tt.divisibility', 16]], (3,): [['tt.divisibility', 16]]}]},
    inductor_meta={'grid_type': 'Grid1D', 'autotune_hints': set(), 'kernel_name': 'triton_poi_fused_add_addmm_convolution_native_group_norm_silu_split_with_sizes_transpose_view_61', 'mutated_arg_names': ['in_out_ptr0'], 'optimize_mem': True, 'no_x_dim': False, 'num_load': 3, 'num_reduction': 0, 'backend_hash': 'D54CF9E23D08230976451A78161C34C47AAE433535668E89333E7039B8F7F720', 'are_deterministic_algorithms_enabled': False, 'assert_indirect_indexing': True, 'autotune_local_cache': True, 'autotune_pointwise': True, 'autotune_remote_cache': None, 'force_disable_caches': False, 'dynamic_scale_rblock': True, 'max_autotune': False, 'max_autotune_pointwise': False, 'min_split_scan_rblock': 256, 'spill_threshold': 16, 'store_cubin': False, 'tiling_scores': {'x': 6292480}},
    min_elem_per_thread=0
)
@triton.jit
def triton_poi_fused_add_addmm_convolution_native_group_norm_silu_split_with_sizes_transpose_view_61(in_out_ptr0, in_ptr0, in_ptr1, xnumel, XBLOCK : tl.constexpr):
    xnumel = 393216
    xoffset = tl.program_id(0) * XBLOCK
    xindex = xoffset + tl.arange(0, XBLOCK)[:]
    xmask = tl.full([XBLOCK], True, tl.int1)
...
# kernel path: ./.compile_cache/q6/cq6at6c4fayr2sd2w7phiwwwo32fhnfibbnomr7il2tc3gyluqnl.py
...
#   return %buf278
triton_poi_fused_add_addmm_convolution_native_group_norm_silu_split_with_sizes_transpose_view_62 = async_compile.triton('triton_poi_fused_add_addmm_convolution_native_group_norm_silu_split_with_sizes_transpose_view_62', '''
import triton
import triton.language as tl
...
@triton_heuristics.pointwise(
    ...
    filename=__file__,
    triton_meta={'signature': {'in_ptr0': '*fp32', 'out_ptr0': '*fp32', 'ynumel': 'i32', 'xnumel': 'i32', 'YBLOCK': 'constexpr', 'XBLOCK': 'constexpr'}, 'device': DeviceProperties(type='cuda', index=0, multi_processor_count=36, cc=89, major=8, regs_per_multiprocessor=65536, max_threads_per_multi_processor=1536, warp_size=32), 'constants': {}, 'configs': [{(0,): [['tt.divisibility', 16]], (1,): [['tt.divisibility', 16]], (2,): [['tt.divisibility', 16]], (3,): [['tt.divisibility', 16]]}]},
    inductor_meta={'grid_type': 'Grid2D', 'autotune_hints': set(), 'kernel_name': 'triton_poi_fused_add_addmm_convolution_native_group_norm_silu_split_with_sizes_transpose_view_62', 'mutated_arg_names': [], 'optimize_mem': True, 'no_x_dim': False, 'num_load': 1, 'num_reduction': 0, 'backend_hash': 'D54CF9E23D08230976451A78161C34C47AAE433535668E89333E7039B8F7F720', 'are_deterministic_algorithms_enabled': False, 'assert_indirect_indexing': True, 'autotune_local_cache': True, 'autotune_pointwise': True, 'autotune_remote_cache': None, 'force_disable_caches': False, 'dynamic_scale_rblock': True, 'max_autotune': False, 'max_autotune_pointwise': False, 'min_split_scan_rblock': 256, 'spill_threshold': 16, 'store_cubin': False, 'tiling_scores': {'y': 4194304, 'x': 2097152}},
    min_elem_per_thread=0
)
@triton.jit
def triton_poi_fused_add_addmm_convolution_native_group_norm_silu_split_with_sizes_transpose_view_62(in_ptr0, out_ptr0, ynumel, xnumel, YBLOCK : tl.constexpr, XBLOCK : tl.constexpr):
    ynumel = 32768
    xnumel = 16
    yoffset = tl.program_id(1) * YBLOCK
    yindex = yoffset + tl.arange(0, YBLOCK)[:, None]
...
# kernel path: ./.compile_cache/w2/cw2sily3bkt6zprnrt2w7e4svdvqif4w2thojnwy775tunxs2dzv.py
...
#   %mul_55 : Tensor "f32[6, 256, 16, 16][65536, 256, 16, 1]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%add_58, %sigmoid_28), kwargs = {})
#   %convolution_26 : Tensor "f32[6, 128, 32, 32][131072, 1024, 32, 1]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.convolution.default](args = (%mul_55, %arg124_1, %arg125_1, [2, 2], [1, 1], [1, 1], True, [0, 0], 1), kwargs = {})
#   %add_tensor_21 : Tensor "f32[6, 128][128, 1]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.add.Tensor](args = (%mm_default_20, %arg129_1), kwargs = {})
#   %sigmoid_30 : Tensor "f32[6, 128][128, 1]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.sigmoid.default](args = (%add_tensor_21,), kwargs = {})
...
#   return %add_59
triton_poi_fused_add_addmm_convolution_mul_native_group_norm_sigmoid_silu_split_with_sizes_transpose_unsqueeze_view_63 = async_compile.triton('triton_poi_fused_add_addmm_convolution_mul_native_group_norm_sigmoid_silu_split_with_sizes_transpose_unsqueeze_view_63', '''
import triton
import triton.language as tl
...
@triton_heuristics.pointwise(
    ...
    filename=__file__,
    triton_meta={'signature': {'in_out_ptr0': '*fp32', 'in_ptr0': '*fp32', 'in_ptr1': '*fp32', 'in_ptr2': '*fp32', 'in_ptr3': '*fp32', 'xnumel': 'i32', 'XBLOCK': 'constexpr'}, 'device': DeviceProperties(type='cuda', index=0, multi_processor_count=36, cc=89, major=8, regs_per_multiprocessor=65536, max_threads_per_multi_processor=1536, warp_size=32), 'constants': {}, 'configs': [{(0,): [['tt.divisibility', 16]], (1,): [['tt.divisibility', 16]], (2,): [['tt.divisibility', 16]], (3,): [['tt.divisibility', 16]], (4,): [['tt.divisibility', 16]], (5,): [['tt.divisibility', 16]]}]},
    inductor_meta={'grid_type': 'Grid1D', 'autotune_hints': set(), 'kernel_name': 'triton_poi_fused_add_addmm_convolution_mul_native_group_norm_sigmoid_silu_split_with_sizes_transpose_unsqueeze_view_63', 'mutated_arg_names': ['in_out_ptr0'], 'optimize_mem': True, 'no_x_dim': False, 'num_load': 5, 'num_reduction': 0, 'backend_hash': 'D54CF9E23D08230976451A78161C34C47AAE433535668E89333E7039B8F7F720', 'are_deterministic_algorithms_enabled': False, 'assert_indirect_indexing': True, 'autotune_local_cache': True, 'autotune_pointwise': True, 'autotune_remote_cache': None, 'force_disable_caches': False, 'dynamic_scale_rblock': True, 'max_autotune': False, 'max_autotune_pointwise': False, 'min_split_scan_rblock': 256, 'spill_threshold': 16, 'store_cubin': False, 'tiling_scores': {'x': 12587008}},
    min_elem_per_thread=0
)
@triton.jit
def triton_poi_fused_add_addmm_convolution_mul_native_group_norm_sigmoid_silu_split_with_sizes_transpose_unsqueeze_view_63(in_out_ptr0, in_ptr0, in_ptr1, in_ptr2, in_ptr3, xnumel, XBLOCK : tl.constexpr):
    xnumel = 786432
    xoffset = tl.program_id(0) * XBLOCK
    xindex = xoffset + tl.arange(0, XBLOCK)[:]
    xmask = tl.full([XBLOCK], True, tl.int1)
...
# kernel path: ./.compile_cache/aa/caamwlxzlddsxrf6rf2zjhyyfwvsjo55gzput4cdbnvwdi2hrycz.py
...
triton_red_fused_add_convolution_native_group_norm_silu_split_with_sizes_view_64 = async_compile.triton('triton_red_fused_add_convolution_native_group_norm_silu_split_with_sizes_view_64', '''
import triton
import triton.language as tl
...
# kernel path: ./.compile_cache/sl/csls2vndbcbbwdhivvesp77gxf6rpraarkavsss62dudmnnillfx.py
# Topologically Sorted Source Nodes: [input_47, unsqueeze_13, s_emb_1, cat_3], Original ATen: [aten.addmm, aten.unsqueeze, aten.expand, aten.cat]
# Source node to ATen node mapping:
#   cat_3 => cat_3
#   input_47 => slice_tensor_1
#   s_emb_1 => expand_40
#   unsqueeze_13 => unsqueeze_23
# Graph fragment:
#   %addmm_default_1 : Tensor "f32[8, 256][256, 1]cuda:0" = PlaceHolder[target=addmm_default_1]
#   %arg154_1 : Tensor "f32[256][1]cuda:0" = PlaceHolder[target=arg154_1]
#   %slice_tensor_1 : Tensor "f32[6, 256][256, 1]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.slice.Tensor](args = (%addmm_default_1, 0, 0, -2), kwargs = {})
...
#   %cat_3 : Tensor "f32[6, 512][512, 1]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.cat.default](args = ([%slice_tensor_1, %expand_40], -1), kwargs = {})
#   return %cat_3
triton_poi_fused_addmm_cat_expand_unsqueeze_65 = async_compile.triton('triton_poi_fused_addmm_cat_expand_unsqueeze_65', '''
import triton
import triton.language as tl
...
@triton_heuristics.pointwise(
    ...
    filename=__file__,
    triton_meta={'signature': {'in_ptr0': '*fp32', 'in_ptr1': '*fp32', 'out_ptr0': '*fp32', 'xnumel': 'i32', 'XBLOCK': 'constexpr'}, 'device': DeviceProperties(type='cuda', index=0, multi_processor_count=36, cc=89, major=8, regs_per_multiprocessor=65536, max_threads_per_multi_processor=1536, warp_size=32), 'constants': {}, 'configs': [{(0,): [['tt.divisibility', 16]], (1,): [['tt.divisibility', 16]], (2,): [['tt.divisibility', 16]], (3,): [['tt.divisibility', 16]]}]},
    inductor_meta={'grid_type': 'Grid1D', 'autotune_hints': set(), 'kernel_name': 'triton_poi_fused_addmm_cat_expand_unsqueeze_65', 'mutated_arg_names': [], 'optimize_mem': True, 'no_x_dim': False, 'num_load': 2, 'num_reduction': 0, 'backend_hash': 'D54CF9E23D08230976451A78161C34C47AAE433535668E89333E7039B8F7F720', 'are_deterministic_algorithms_enabled': False, 'assert_indirect_indexing': True, 'autotune_local_cache': True, 'autotune_pointwise': True, 'autotune_remote_cache': None, 'force_disable_caches': False, 'dynamic_scale_rblock': True, 'max_autotune': False, 'max_autotune_pointwise': False, 'min_split_scan_rblock': 256, 'spill_threshold': 16, 'store_cubin': False, 'tiling_scores': {'x': 38912}},
    min_elem_per_thread=0
)
@triton.jit
def triton_poi_fused_addmm_cat_expand_unsqueeze_65(in_ptr0, in_ptr1, out_ptr0, xnumel, XBLOCK : tl.constexpr):
    xnumel = 3072
    xoffset = tl.program_id(0) * XBLOCK
    xindex = xoffset + tl.arange(0, XBLOCK)[:]
    xmask = xindex < xnumel
    ...
    tmp7 = tl.full([1], 512, tl.int64)
    tmp8 = tmp0 < tmp7
    tmp9 = tl.load(in_ptr1 + ((-256) + x0), tmp6 & xmask, eviction_policy='evict_last', other=0.0)
    tmp10 = tl.where(tmp4, tmp5, tmp9)
    tl.store(out_ptr0 + (x2), tmp10, xmask)
''', device_str='cuda')


# kernel path: ./.compile_cache/sp/csp7f3m6b65clye2c4g22owht5ypfgw537wc3cxfsych7b2myxq7.py
...
#   %full_default_3 : Tensor "f32[6][1]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.full.default](args = ([6], 0), kwargs = {dtype: torch.float32, layout: torch.strided, device: cuda:0, pin_memory: False})
#   %full_default_4 : Tensor "f32[6][1]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.full.default](args = ([6], 0.3), kwargs = {dtype: torch.float32, layout: torch.strided, device: cuda:0, pin_memory: False})
#   %where : Tensor "f32[6][1]cuda:0"[num_users=2] = call_function[target=torch.ops.aten.where.self](args = (%lt, %full_default_3, %full_default_4), kwargs = {})
#   return %where
triton_poi_fused_full_like_lt_where_zeros_like_66 = async_compile.triton('triton_poi_fused_full_like_lt_where_zeros_like_66', '''
import triton
import triton.language as tl
...
@triton_heuristics.pointwise(
    ...
    inductor_meta={'grid_type': 'Grid1D', 'autotune_hints': set(), 'kernel_name': 'triton_poi_fused_full_like_lt_where_zeros_like_66', 'mutated_arg_names': [], 'optimize_mem': True, 'no_x_dim': False, 'num_load': 1, 'num_reduction': 0, 'backend_hash': 'D54CF9E23D08230976451A78161C34C47AAE433535668E89333E7039B8F7F720', 'are_deterministic_algorithms_enabled': False, 'assert_indirect_indexing': True, 'autotune_local_cache': True, 'autotune_pointwise': True, 'autotune_remote_cache': None, 'force_disable_caches': False, 'dynamic_scale_rblock': True, 'max_autotune': False, 'max_autotune_pointwise': False, 'min_split_scan_rblock': 256, 'spill_threshold': 16, 'store_cubin': False, 'tiling_scores': {'x': 54}},
    min_elem_per_thread=0
)
@triton.jit
def triton_poi_fused_full_like_lt_where_zeros_like_66(in_ptr0, out_ptr0, xnumel, XBLOCK : tl.constexpr):
    xnumel = 6
    xoffset = tl.program_id(0) * XBLOCK
    xindex = xoffset + tl.arange(0, XBLOCK)[:]
    xmask = xindex < xnumel
...
# kernel path: ./.compile_cache/v5/cv53llgr3hhqlwscdodjejrblclbijpjr3k4aio4efdkc4m7bvbv.py
...
triton_poi_fused_add_convolution_native_group_norm_silu_split_with_sizes_view_67 = async_compile.triton('triton_poi_fused_add_convolution_native_group_norm_silu_split_with_sizes_view_67', '''
import triton
import triton.language as tl
...
@triton_heuristics.pointwise(
    ...
    inductor_meta={'grid_type': 'Grid1D', 'autotune_hints': set(), 'kernel_name': 'triton_poi_fused_add_convolution_native_group_norm_silu_split_with_sizes_view_67', 'mutated_arg_names': ['in_out_ptr0', 'in_out_ptr1'], 'optimize_mem': True, 'no_x_dim': False, 'num_load': 11, 'num_reduction': 0, 'backend_hash': 'D54CF9E23D08230976451A78161C34C47AAE433535668E89333E7039B8F7F720', 'are_deterministic_algorithms_enabled': False, 'assert_indirect_indexing': True, 'autotune_local_cache': True, 'autotune_pointwise': True, 'autotune_remote_cache': None, 'force_disable_caches': False, 'dynamic_scale_rblock': True, 'max_autotune': False, 'max_autotune_pointwise': False, 'min_split_scan_rblock': 256, 'spill_threshold': 16, 'store_cubin': False, 'tiling_scores': {'x': 25167360}},
    min_elem_per_thread=0
)
@triton.jit
def triton_poi_fused_add_convolution_native_group_norm_silu_split_with_sizes_view_67(in_out_ptr0, in_out_ptr1, in_ptr0, in_ptr1, in_ptr2, in_ptr3, in_ptr4, in_ptr5, in_ptr6, in_ptr7, in_ptr8, xnumel, XBLOCK : tl.constexpr):
    xnumel = 786432
    xoffset = tl.program_id(0) * XBLOCK
    xindex = xoffset + tl.arange(0, XBLOCK)[:]
    xmask = tl.full([XBLOCK], True, tl.int1)
...
# kernel path: ./.compile_cache/v4/cv4r6wjji3mpra6i4xlrln6e4eizeaek5ulc3wzncevlb7qe27rl.py
...
triton_poi_fused_convolution_silu_68 = async_compile.triton('triton_poi_fused_convolution_silu_68', '''
import triton
import triton.language as tl
...
@triton_heuristics.pointwise(
    ...
    inductor_meta={'grid_type': 'Grid2D', 'autotune_hints': set(), 'kernel_name': 'triton_poi_fused_convolution_silu_68', 'mutated_arg_names': [], 'optimize_mem': True, 'no_x_dim': False, 'num_load': 1, 'num_reduction': 0, 'backend_hash': 'D54CF9E23D08230976451A78161C34C47AAE433535668E89333E7039B8F7F720', 'are_deterministic_algorithms_enabled': False, 'assert_indirect_indexing': True, 'autotune_local_cache': True, 'autotune_pointwise': True, 'autotune_remote_cache': None, 'force_disable_caches': False, 'dynamic_scale_rblock': True, 'max_autotune': False, 'max_autotune_pointwise': False, 'min_split_scan_rblock': 256, 'spill_threshold': 16, 'store_cubin': False, 'tiling_scores': {'y': 73728, 'x': 18432}},
    min_elem_per_thread=0
)
@triton.jit
def triton_poi_fused_convolution_silu_68(in_ptr0, out_ptr0, out_ptr1, ynumel, xnumel, YBLOCK : tl.constexpr, XBLOCK : tl.constexpr):
    ynumel = 512
    xnumel = 9
    yoffset = tl.program_id(1) * YBLOCK
    yindex = yoffset + tl.arange(0, YBLOCK)[:, None]
...
# kernel path: ./.compile_cache/jv/cjv4cjzblxbpf7jg5ndxab6cihiuetdtu6rttrmh6peyforh5jrj.py
...
#   %mul_151 : Tensor "f32[6, 128, 32, 32][131072, 1024, 32, 1]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%add_163, %sigmoid_83), kwargs = {})
#   %convolution_75 : Tensor "f32[6, 4, 32, 32][4096, 1024, 32, 1]cuda:0"[num_users=2] = call_function[target=torch.ops.aten.convolution.default](args = (%mul_151, %arg152_1, %arg153_1, [1, 1], [1, 1], [1, 1], False, [0, 0], 1), kwargs = {})
#   %sub_59 : Tensor "f32[6, 4, 32, 32][4096, 1024, 32, 1]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.sub.Tensor](args = (%convolution_37, %convolution_75), kwargs = {})
...
#   %mul_tensor_1 : Tensor "f32[6, 4, 32, 32][4096, 1024, 32, 1]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%sub_59, %convert_element_type_default_1), kwargs = {})
#   %add_164 : Tensor "f32[6, 4, 32, 32][4096, 1024, 32, 1]cuda:0"[num_users=3] = call_function[target=torch.ops.aten.add.Tensor](args = (%convolution_75, %mul_tensor_1), kwargs = {})
...
#   return %buf688,%buf695
triton_red_fused_add_convolution_silu_std_sub_69 = async_compile.triton('triton_red_fused_add_convolution_silu_std_sub_69', '''
import triton
import triton.language as tl
...
@triton_heuristics.reduction(
    ...
    inductor_meta={'grid_type': 'Grid1D', 'autotune_hints': set(), 'kernel_name': 'triton_red_fused_add_convolution_silu_std_sub_69', 'mutated_arg_names': [], 'optimize_mem': True, 'no_x_dim': False, 'num_load': 3, 'num_reduction': 2, 'backend_hash': 'D54CF9E23D08230976451A78161C34C47AAE433535668E89333E7039B8F7F720', 'are_deterministic_algorithms_enabled': False, 'assert_indirect_indexing': True, 'autotune_local_cache': True, 'autotune_pointwise': True, 'autotune_remote_cache': None, 'force_disable_caches': False, 'dynamic_scale_rblock': True, 'max_autotune': False, 'max_autotune_pointwise': False, 'min_split_scan_rblock': 256, 'spill_threshold': 16, 'store_cubin': False, 'tiling_scores': {'x': 72, 'r0_': 196624}}
)
@triton.jit
def triton_red_fused_add_convolution_silu_std_sub_69(in_ptr0, in_ptr1, in_ptr2, out_ptr0, out_ptr1, ks0, xnumel, r0_numel, XBLOCK : tl.constexpr, R0_BLOCK : tl.constexpr):
    xnumel = 6
    r0_numel = 4096
    rnumel = r0_numel
    RBLOCK: tl.constexpr = R0_BLOCK
...
# kernel path: ./.compile_cache/ja/cja5mwkamgxddf6a6bnu5omojir4gcvdg3kpuoxb7owsozrnp6bw.py
...
#   %arg25_1 : Tensor "f32[6, 4, 32, 32][4096, 1024, 32, 1]cuda:0" = PlaceHolder[target=arg25_1]
#   %mul_154 : Tensor "f32[6, 4, 32, 32][4096, 1, 128, 4]cuda:0" = PlaceHolder[target=mul_154]
#   %sigmoid_41 : Tensor "f32[6, 128, 32, 32][131072, 1024, 32, 1]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.sigmoid.default](args = (%add_81,), kwargs = {})
#   %mul_75 : Tensor "f32[6, 128, 32, 32][131072, 1024, 32, 1]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%add_81, %sigmoid_41), kwargs = {})
#   %convolution_37 : Tensor "f32[6, 4, 32, 32][4096, 1024, 32, 1]cuda:0"[num_users=2] = call_function[target=torch.ops.aten.convolution.default](args = (%mul_75, %arg152_1, %arg153_1, [1, 1], [1, 1], [1, 1], False, [0, 0], 1), kwargs = {})
#   %var : Tensor "f32[6, 1, 1, 1][1, 1, 1, 1]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.var.correction](args = (%convolution_37, [1, 2, 3]), kwargs = {correction: 1.0, keepdim: True})
...
#   %mul_154 : Tensor "f32[6, 4, 32, 32][4096, 1024, 32, 1]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%add_164, %div_22), kwargs = {})
#   %mul_155 : Tensor "f32[6, 4, 32, 32][4096, 1024, 32, 1]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%mul_154, 0.7), kwargs = {})
#   %mul_156 : Tensor "f32[6, 4, 32, 32][4096, 1024, 32, 1]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%add_164, 0.30000000000000004), kwargs = {})
#   %add_166 : Tensor "f32[6, 4, 32, 32][4096, 1024, 32, 1]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.add.Tensor](args = (%mul_155, %mul_156), kwargs = {})
#   %mul_157 : Tensor "f32[6, 4, 32, 32][4096, 1024, 32, 1]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%add_166, 0.06666666666666667), kwargs = {})
#   %add_167 : Tensor "f32[6, 4, 32, 32][4096, 1024, 32, 1]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.add.Tensor](args = (%arg25_1, %mul_157), kwargs = {})
#   return %mul_154,%add_167
triton_poi_fused_add_convolution_div_mul_silu_std_sub_70 = async_compile.triton('triton_poi_fused_add_convolution_div_mul_silu_std_sub_70', '''
import triton
import triton.language as tl
...
# kernel path: ./.compile_cache/qg/cqgu6um3a5kpcrex6tgb6kgtbfpg72xusbpptdyteunbndtmuvmx.py
...
#   return %any_1
triton_poi_fused_any_gt_71 = async_compile.triton('triton_poi_fused_any_gt_71', '''
import triton
import triton.language as tl
...
@triton_heuristics.pointwise(
    ...
    inductor_meta={'grid_type': 'Grid1D', 'autotune_hints': set(), 'kernel_name': 'triton_poi_fused_any_gt_71', 'mutated_arg_names': [], 'optimize_mem': True, 'no_x_dim': False, 'num_load': 6, 'num_reduction': 0, 'backend_hash': 'D54CF9E23D08230976451A78161C34C47AAE433535668E89333E7039B8F7F720', 'are_deterministic_algorithms_enabled': False, 'assert_indirect_indexing': True, 'autotune_local_cache': True, 'autotune_pointwise': True, 'autotune_remote_cache': None, 'force_disable_caches': False, 'dynamic_scale_rblock': True, 'max_autotune': False, 'max_autotune_pointwise': False, 'min_split_scan_rblock': 256, 'spill_threshold': 16, 'store_cubin': False},
    min_elem_per_thread=0
)
@triton.jit
def triton_poi_fused_any_gt_71(in_ptr0, out_ptr0, xnumel, XBLOCK : tl.constexpr):
    xnumel = 1
    xoffset = tl.program_id(0) * XBLOCK
    xindex = xoffset + tl.arange(0, XBLOCK)[:]
    xmask = tl.full([XBLOCK], True, tl.int1)
...
def partition_0(args):
    ...
    with torch.cuda._DeviceGuard(0):
        ...
        buf10 = empty_strided_cuda((6, 1024), (1024, 1), torch.float32)
        ...
        # Topologically Sorted Source Nodes: [input_1, input_2], Original ATen: [aten.addmm, aten.silu]
        stream0 = get_raw_stream(0)
        triton_poi_fused_addmm_silu_6.run(buf11, arg2_1, 6144, stream=stream0)
        buf12 = empty_strided_cuda((8, 1024), (1024, 1), torch.float32)
        # Topologically Sorted Source Nodes: [input_1, input_2, input_3], Original ATen: [aten.addmm, aten.silu]
        stream0 = get_raw_stream(0)
        triton_poi_fused_addmm_silu_7.run(buf11, buf12, 8192, stream=stream0)
        buf13 = empty_strided_cuda((8, 256), (256, 1), torch.float32)
        ...
        buf14 = empty_strided_cuda((6, 512), (512, 1), torch.float32)
        # Topologically Sorted Source Nodes: [input_3, s_emb, cat_1], Original ATen: [aten.addmm, aten.embedding, aten.cat]
        stream0 = get_raw_stream(0)
        triton_poi_fused_addmm_cat_embedding_8.run(buf13, arg6_1, arg5_1, buf14, 3072, stream=stream0)
        del arg5_1
        del arg6_1
        buf15 = empty_strided_cuda((6, 512), (512, 1), torch.float32)
        # Topologically Sorted Source Nodes: [input_3, s_emb, cat_1, input_4], Original ATen: [aten.addmm, aten.embedding, aten.cat, aten.t]
        extern_kernels.mm(buf14, reinterpret_tensor(arg7_1, (512, 512), (1, 512), 0), out=buf15)
        buf16 = buf15; del buf15  # reuse
        # Topologically Sorted Source Nodes: [input_4, input_5], Original ATen: [aten.addmm, aten.silu]
        stream0 = get_raw_stream(0)
        triton_poi_fused_addmm_silu_9.run(buf16, arg8_1, 3072, stream=stream0)
        ...
        buf18 = empty_strided_cuda((6, 256), (256, 1), torch.float32)
        ...
        # Topologically Sorted Source Nodes: [input_7, input_8], Original ATen: [aten.addmm, aten.silu]
        stream0 = get_raw_stream(0)
        triton_poi_fused_addmm_silu_10.run(buf19, arg12_1, 1536, stream=stream0)
        buf20 = empty_strided_cuda((6, 3200), (3200, 1), torch.float32)
        ...
        buf21 = empty_strided_cuda((6, 32, 4, 1024), (131072, 4096, 1024, 1), torch.float32)
        # Topologically Sorted Source Nodes: [x, x_norm], Original ATen: [aten.convolution, aten.native_group_norm]
        stream0 = get_raw_stream(0)
        triton_poi_fused_convolution_native_group_norm_11.run(buf5, arg27_1, buf6, buf7, buf21, 768, 1024, stream=stream0)
        buf22 = empty_strided_cuda((6, 12, 1024), (12288, 1024, 1), torch.float32)
        ...
        extern_kernels.bmm(reinterpret_tensor(buf20, (6, 12, 128), (3200, 1, 12), 1536), reinterpret_tensor(buf21, (6, 128, 1024), (131072, 1024, 1), 0), out=buf22)
        buf23 = reinterpret_tensor(buf5, (6, 128, 1024), (131072, 1024, 1), 0); del buf5  # reuse
        # Topologically Sorted Source Nodes: [split, u_1, mixed], Original ATen: [aten.split_with_sizes, aten.view, aten.bmm]
        extern_kernels.bmm(reinterpret_tensor(buf20, (6, 128, 12), (3200, 12, 1), 0), buf22, out=buf23)
        buf24 = empty_strided_cuda((6, 128, 32, 32), (131072, 1, 4096, 128), torch.float32)
        # Topologically Sorted Source Nodes: [x, x_norm, split, x_flat, out, view_4, shift_1, out_1, x_1], Original ATen: [aten.convolution, aten.native_group_norm, aten.split_with_sizes, aten.view, aten.add, aten.silu]
        stream0 = get_raw_stream(0)
        triton_poi_fused_add_convolution_native_group_norm_silu_split_with_sizes_view_12.run(buf21, buf23, buf20, buf24, 768, 1024, stream=stream0)
        del buf21
        del buf23
        ...
        assert_size_stride(buf25, (6, 128, 32, 32), (131072, 1, 4096, 128), 'torch.ops.aten.convolution.default')
        buf26 = buf25; del buf25  # reuse
        # Topologically Sorted Source Nodes: [x, x_norm, split, x_flat, out, view_4, shift_1, out_1, x_1, x_2, add_2, h_1], Original ATen: [aten.convolution, aten.native_group_norm, aten.split_with_sizes, aten.view, aten.add, aten.silu]
        stream0 = get_raw_stream(0)
        triton_poi_fused_add_convolution_native_group_norm_silu_split_with_sizes_view_13.run(buf26, arg29_1, buf3, 786432, stream=stream0)
        ...
        assert_size_stride(buf28, (6, 128, 32, 32), (131072, 1, 4096, 128), 'torch.ops.aten.convolution.default')
        ...
        stream0 = get_raw_stream(0)
        triton_red_fused_convolution_native_group_norm_4.run(buf28, arg31_1, buf29, buf30, 192, 4096, stream=stream0)
        ...
        buf33 = reinterpret_tensor(buf3, (6, 32, 4, 1024), (131072, 4096, 1024, 1), 0); del buf3  # reuse
        # Topologically Sorted Source Nodes: [x_3, x_norm_1], Original ATen: [aten.convolution, aten.native_group_norm]
        stream0 = get_raw_stream(0)
        triton_poi_fused_convolution_native_group_norm_11.run(buf28, arg31_1, buf29, buf30, buf33, 768, 1024, stream=stream0)
        ...
        extern_kernels.bmm(reinterpret_tensor(buf20, (6, 12, 128), (3200, 1, 12), 1536), reinterpret_tensor(buf33, (6, 128, 1024), (131072, 1024, 1), 0), out=buf34)
        buf35 = reinterpret_tensor(buf28, (6, 128, 1024), (131072, 1024, 1), 0); del buf28  # reuse
        # Topologically Sorted Source Nodes: [split_1, u_3, mixed_1], Original ATen: [aten.split_with_sizes, aten.view, aten.bmm]
        extern_kernels.bmm(reinterpret_tensor(buf20, (6, 128, 12), (3200, 12, 1), 0), buf34, out=buf35)
        ...
        stream0 = get_raw_stream(0)
        triton_poi_fused_add_convolution_native_group_norm_silu_split_with_sizes_view_12.run(buf33, buf35, buf20, buf36, 768, 1024, stream=stream0)
        del buf33
        del buf35
        ...
        assert_size_stride(buf37, (6, 128, 32, 32), (131072, 1, 4096, 128), 'torch.ops.aten.convolution.default')
        del buf36
        ...
        stream0 = get_raw_stream(0)
        triton_poi_fused_add_convolution_native_group_norm_silu_split_with_sizes_view_13.run(buf38, arg33_1, buf26, 786432, stream=stream0)
        del buf26
        buf39 = empty_strided_cuda((256, 128, 3, 3), (1152, 1, 384, 128), torch.float32)
        # Topologically Sorted Source Nodes: [h_3], Original ATen: [aten.convolution]
        stream0 = get_raw_stream(0)
        triton_poi_fused_convolution_14.run(arg34_1, buf39, 32768, 9, stream=stream0)
        # Topologically Sorted Source Nodes: [h_3], Original ATen: [aten.convolution]
        ...
        assert_size_stride(buf40, (6, 256, 16, 16), (65536, 1, 4096, 256), 'torch.ops.aten.convolution.default')
        buf41 = empty_strided_cuda((6, 256, 256), (65536, 256, 1), torch.float32)
        # Topologically Sorted Source Nodes: [h_3, view_10, q, q_1], Original ATen: [aten.convolution, aten.view, aten.transpose, aten.clone]
        stream0 = get_raw_stream(0)
        triton_poi_fused_clone_convolution_transpose_view_15.run(buf40, arg35_1, buf41, 393216, stream=stream0)
        buf42 = empty_strided_cuda((1536, 256), (256, 1), torch.float32)
        ...
        extern_kernels.mm(reinterpret_tensor(buf41, (1536, 256), (256, 1), 0), reinterpret_tensor(arg36_1, (256, 256), (1, 256), 0), out=buf42)
        buf43 = reinterpret_tensor(buf41, (6, 4, 256, 64), (65536, 16384, 64, 1), 0); del buf41  # reuse
        # Topologically Sorted Source Nodes: [q_1, view_11, q_2, matmul], Original ATen: [aten._unsafe_view, aten.view, aten.transpose, aten.clone]
        stream0 = get_raw_stream(0)
        triton_poi_fused__unsafe_view_clone_transpose_view_16.run(buf42, buf43, 393216, stream=stream0)
        buf44 = reinterpret_tensor(buf19, (6, 4, 64, 1), (256, 64, 1, 1), 0); del buf19  # reuse
        # Topologically Sorted Source Nodes: [kv, chunk, view_12, k_1, transpose_6, matmul], Original ATen: [aten.unsqueeze, aten.split, aten.view, aten.transpose, aten.clone]
        stream0 = get_raw_stream(0)
        triton_poi_fused_clone_split_transpose_unsqueeze_view_17.run(buf32, buf44, 1536, stream=stream0)
        buf45 = reinterpret_tensor(buf11, (24, 256, 1), (256, 1, 1), 0); del buf11  # reuse
        ...
        extern_kernels.bmm(reinterpret_tensor(buf43, (24, 256, 64), (16384, 64, 1), 0), reinterpret_tensor(buf44, (24, 64, 1), (64, 1, 0), 0), out=buf45)
        buf46 = reinterpret_tensor(buf45, (6, 4, 256, 1), (1024, 256, 1, 1), 0); del buf45  # reuse
        # Topologically Sorted Source Nodes: [matmul, attn_1], Original ATen: [aten.view, aten.mul, aten.amax, aten.sub, aten._softmax]
        stream0 = get_raw_stream(0)
        triton_poi_fused__softmax_amax_mul_sub_view_18.run(buf46, 6144, stream=stream0)
        buf47 = reinterpret_tensor(buf44, (6, 4, 1, 64), (256, 64, 64, 1), 0); del buf44  # reuse
        # Topologically Sorted Source Nodes: [kv, chunk, view_13, v_5, matmul_1], Original ATen: [aten.unsqueeze, aten.split, aten.view, aten.transpose, aten.clone]
        stream0 = get_raw_stream(0)
        triton_poi_fused_clone_split_transpose_unsqueeze_view_19.run(buf32, buf47, 1536, stream=stream0)
        buf48 = reinterpret_tensor(buf43, (24, 256, 64), (16384, 64, 1), 0); del buf43  # reuse
        ...
        extern_kernels.bmm(reinterpret_tensor(buf46, (24, 256, 1), (256, 1, 0), 0), reinterpret_tensor(buf47, (24, 1, 64), (64, 0, 1), 0), out=buf48)
        buf49 = reinterpret_tensor(buf42, (6, 256, 4, 64), (65536, 256, 64, 1), 0); del buf42  # reuse
        # Topologically Sorted Source Nodes: [matmul_1, transpose_7, out_4], Original ATen: [aten.view, aten.transpose, aten.clone]
        stream0 = get_raw_stream(0)
        triton_poi_fused_clone_transpose_view_20.run(buf48, buf49, 393216, stream=stream0)
        buf50 = reinterpret_tensor(buf48, (1536, 256), (256, 1), 0); del buf48  # reuse
        ...
        extern_kernels.mm(reinterpret_tensor(buf49, (1536, 256), (256, 1), 0), reinterpret_tensor(arg38_1, (256, 256), (1, 256), 0), out=buf50)
        buf51 = reinterpret_tensor(buf50, (6, 256, 16, 16), (65536, 1, 4096, 256), 0); del buf50  # reuse
        # Topologically Sorted Source Nodes: [h_3, input_16, transpose_8, out_5, x_6], Original ATen: [aten.convolution, aten.addmm, aten.view, aten.transpose, aten.add]
        stream0 = get_raw_stream(0)
        triton_poi_fused_add_addmm_convolution_transpose_view_21.run(buf51, buf40, arg35_1, arg39_1, 393216, stream=stream0)
        buf52 = empty_strided_cuda((256, 256, 3, 3), (2304, 1, 768, 256), torch.float32)
        # Topologically Sorted Source Nodes: [h_3, input_16, transpose_8, out_5, x_6, x_7], Original ATen: [aten.convolution, aten.addmm, aten.view, aten.transpose, aten.add]
        stream0 = get_raw_stream(0)
        triton_poi_fused_add_addmm_convolution_transpose_view_22.run(arg40_1, buf52, 65536, 9, stream=stream0)
        # Topologically Sorted Source Nodes: [h_3, input_16, transpose_8, out_5, x_6, x_7], Original ATen: [aten.convolution, aten.addmm, aten.view, aten.transpose, aten.add]
        ...
        assert_size_stride(buf53, (6, 256, 16, 16), (65536, 1, 4096, 256), 'torch.ops.aten.convolution.default')
        buf54 = buf30; del buf30  # reuse
        buf55 = buf29; del buf29  # reuse
        # Topologically Sorted Source Nodes: [h_3, input_16, transpose_8, out_5, x_6, x_7, x_norm_2], Original ATen: [aten.convolution, aten.addmm, aten.view, aten.transpose, aten.add, aten.native_group_norm]
        stream0 = get_raw_stream(0)
        triton_red_fused_add_addmm_convolution_native_group_norm_transpose_view_23.run(buf53, arg41_1, buf54, buf55, 192, 2048, stream=stream0)
        buf57 = reinterpret_tensor(buf47, (6, 256), (256, 1), 0); del buf47  # reuse
        ...
        stream0 = get_raw_stream(0)
        triton_poi_fused_addmm_silu_10.run(buf58, arg16_1, 1536, stream=stream0)
        buf59 = empty_strided_cuda((6, 6400), (6400, 1), torch.float32)
        ...
        buf61 = reinterpret_tensor(buf51, (6, 32, 8, 256), (65536, 2048, 256, 1), 0); del buf51  # reuse
        # Topologically Sorted Source Nodes: [h_3, input_16, transpose_8, out_5, x_6, x_7, x_norm_2], Original ATen: [aten.convolution, aten.addmm, aten.view, aten.transpose, aten.add, aten.native_group_norm]
        stream0 = get_raw_stream(0)
        triton_poi_fused_add_addmm_convolution_native_group_norm_transpose_view_24.run(buf53, arg41_1, buf54, buf55, buf61, 1536, 256, stream=stream0)
        buf62 = empty_strided_cuda((6, 12, 256), (3072, 256, 1), torch.float32)
        ...
        extern_kernels.bmm(reinterpret_tensor(buf59, (6, 12, 256), (6400, 1, 12), 3072), reinterpret_tensor(buf61, (6, 256, 256), (65536, 256, 1), 0), out=buf62)
        buf63 = reinterpret_tensor(buf53, (6, 256, 256), (65536, 256, 1), 0); del buf53  # reuse
        # Topologically Sorted Source Nodes: [split_2, u_5, mixed_2], Original ATen: [aten.split_with_sizes, aten.view, aten.bmm]
        extern_kernels.bmm(reinterpret_tensor(buf59, (6, 256, 12), (6400, 12, 1), 0), buf62, out=buf63)
        buf64 = reinterpret_tensor(buf49, (6, 256, 16, 16), (65536, 1, 4096, 256), 0); del buf49  # reuse
        # Topologically Sorted Source Nodes: [h_3, input_16, transpose_8, out_5, x_6, x_7, x_norm_2, split_2, x_flat_2, out_6, view_19, shift_5, out_7, x_8], Original ATen: [aten.convolution, aten.addmm, aten.view, aten.transpose, aten.add, aten.native_group_norm, aten.split_with_sizes, aten.silu]
        stream0 = get_raw_stream(0)
        triton_poi_fused_add_addmm_convolution_native_group_norm_silu_split_with_sizes_transpose_view_25.run(buf61, buf63, buf59, buf64, 1536, 256, stream=stream0)
        del buf61
        ...
        assert_size_stride(buf65, (6, 256, 16, 16), (65536, 1, 4096, 256), 'torch.ops.aten.convolution.default')
        buf66 = reinterpret_tensor(buf64, (6, 256, 256), (65536, 256, 1), 0); del buf64  # reuse
        # Topologically Sorted Source Nodes: [h_3, input_16, transpose_8, out_5, x_6, x_7, x_norm_2, split_2, x_flat_2, out_6, view_19, shift_5, out_7, x_8, x_9, add_9, h_4, view_20, q_3, q_4], Original ATen: [aten.convolution, aten.addmm, aten.view, aten.transpose, aten.add, aten.native_group_norm, aten.split_with_sizes, aten.silu, aten.clone]
        stream0 = get_raw_stream(0)
        triton_poi_fused_add_addmm_clone_convolution_native_group_norm_silu_split_with_sizes_transpose_view_26.run(buf65, arg43_1, buf40, arg35_1, buf66, 393216, stream=stream0)
        buf67 = reinterpret_tensor(buf63, (1536, 256), (256, 1), 0); del buf63  # reuse
        ...
        extern_kernels.mm(reinterpret_tensor(buf66, (1536, 256), (256, 1), 0), reinterpret_tensor(arg44_1, (256, 256), (1, 256), 0), out=buf67)
        buf68 = reinterpret_tensor(buf66, (6, 4, 256, 64), (65536, 16384, 64, 1), 0); del buf66  # reuse
        ...
        stream0 = get_raw_stream(0)
        triton_poi_fused__unsafe_view_clone_transpose_view_16.run(buf67, buf68, 393216, stream=stream0)
        buf69 = reinterpret_tensor(buf58, (6, 4, 64, 1), (256, 64, 1, 1), 0); del buf58  # reuse
        ...
        stream0 = get_raw_stream(0)
        triton_poi_fused_clone_split_transpose_unsqueeze_view_17.run(buf60, buf69, 1536, stream=stream0)
        buf70 = reinterpret_tensor(buf46, (24, 256, 1), (256, 1, 1), 0); del buf46  # reuse
        ...
        extern_kernels.bmm(reinterpret_tensor(buf68, (24, 256, 64), (16384, 64, 1), 0), reinterpret_tensor(buf69, (24, 64, 1), (64, 1, 0), 0), out=buf70)
        buf71 = reinterpret_tensor(buf70, (6, 4, 256, 1), (1024, 256, 1, 1), 0); del buf70  # reuse
        # Topologically Sorted Source Nodes: [matmul_2, attn_3], Original ATen: [aten.view, aten.mul, aten.amax, aten.sub, aten._softmax]
        stream0 = get_raw_stream(0)
        triton_poi_fused__softmax_amax_mul_sub_view_18.run(buf71, 6144, stream=stream0)
        buf72 = reinterpret_tensor(buf69, (6, 4, 1, 64), (256, 64, 64, 1), 0); del buf69  # reuse
        ...
        stream0 = get_raw_stream(0)
        triton_poi_fused_clone_split_transpose_unsqueeze_view_19.run(buf60, buf72, 1536, stream=stream0)
        buf73 = reinterpret_tensor(buf68, (24, 256, 64), (16384, 64, 1), 0); del buf68  # reuse
        ...
        extern_kernels.bmm(reinterpret_tensor(buf71, (24, 256, 1), (256, 1, 0), 0), reinterpret_tensor(buf72, (24, 1, 64), (64, 0, 1), 0), out=buf73)
        buf74 = reinterpret_tensor(buf67, (6, 256, 4, 64), (65536, 256, 64, 1), 0); del buf67  # reuse
        # Topologically Sorted Source Nodes: [matmul_3, transpose_15, out_8], Original ATen: [aten.view, aten.transpose, aten.clone]
        stream0 = get_raw_stream(0)
        triton_poi_fused_clone_transpose_view_20.run(buf73, buf74, 393216, stream=stream0)
        buf75 = reinterpret_tensor(buf73, (1536, 256), (256, 1), 0); del buf73  # reuse
        ...
        extern_kernels.mm(reinterpret_tensor(buf74, (1536, 256), (256, 1), 0), reinterpret_tensor(arg46_1, (256, 256), (1, 256), 0), out=buf75)
        buf76 = reinterpret_tensor(buf75, (6, 256, 16, 16), (65536, 1, 4096, 256), 0); del buf75  # reuse
        # Topologically Sorted Source Nodes: [h_3, input_16, transpose_8, out_5, x_6, x_7, x_norm_2, split_2, x_flat_2, out_6, view_19, shift_5, out_7, x_8, x_9, add_9, h_4, input_18, transpose_16, out_9, x_10], Original ATen: [aten.convolution, aten.addmm, aten.view, aten.transpose, aten.add, aten.native_group_norm, aten.split_with_sizes, aten.silu]
        stream0 = get_raw_stream(0)
        triton_poi_fused_add_addmm_convolution_native_group_norm_silu_split_with_sizes_transpose_view_27.run(buf76, buf65, arg43_1, buf40, arg35_1, arg47_1, 393216, stream=stream0)
        ...
        stream0 = get_raw_stream(0)
        triton_poi_fused_add_addmm_convolution_transpose_view_22.run(arg48_1, buf77, 65536, 9, stream=stream0)
        # Topologically Sorted Source Nodes: [h_3, input_16, transpose_8, out_5, x_6, x_7, x_norm_2, split_2, x_flat_2, out_6, view_19, shift_5, out_7, x_8, x_9, add_9, h_4, input_18, transpose_16, out_9, x_10, x_11], Original ATen: [aten.convolution, aten.addmm, aten.view, aten.transpose, aten.add, aten.native_group_norm, aten.split_with_sizes, aten.silu]
        ...
        assert_size_stride(buf78, (6, 256, 16, 16), (65536, 1, 4096, 256), 'torch.ops.aten.convolution.default')
        ...
        stream0 = get_raw_stream(0)
        triton_red_fused_add_addmm_convolution_native_group_norm_transpose_view_23.run(buf78, arg49_1, buf79, buf80, 192, 2048, stream=stream0)
        buf82 = reinterpret_tensor(buf71, (6, 1024), (1024, 1), 0); del buf71  # reuse
        ...
        buf83 = reinterpret_tensor(buf76, (6, 32, 8, 256), (65536, 2048, 256, 1), 0); del buf76  # reuse
        # Topologically Sorted Source Nodes: [h_3, input_16, transpose_8, out_5, x_6, x_7, x_norm_2, split_2, x_flat_2, out_6, view_19, shift_5, out_7, x_8, x_9, add_9, h_4, input_18, transpose_16, out_9, x_10, x_11, x_norm_3], Original ATen: [aten.convolution, aten.addmm, aten.view, aten.transpose, aten.add, aten.native_group_norm, aten.split_with_sizes, aten.silu]
        stream0 = get_raw_stream(0)
        triton_poi_fused_add_addmm_convolution_native_group_norm_transpose_view_24.run(buf78, arg49_1, buf79, buf80, buf83, 1536, 256, stream=stream0)
        ...
        extern_kernels.bmm(reinterpret_tensor(buf59, (6, 12, 256), (6400, 1, 12), 3072), reinterpret_tensor(buf83, (6, 256, 256), (65536, 256, 1), 0), out=buf84)
        buf85 = reinterpret_tensor(buf78, (6, 256, 256), (65536, 256, 1), 0); del buf78  # reuse
        # Topologically Sorted Source Nodes: [split_3, u_7, mixed_3], Original ATen: [aten.split_with_sizes, aten.view, aten.bmm]
        extern_kernels.bmm(reinterpret_tensor(buf59, (6, 256, 12), (6400, 12, 1), 0), buf84, out=buf85)
        buf86 = reinterpret_tensor(buf74, (6, 256, 16, 16), (65536, 1, 4096, 256), 0); del buf74  # reuse
        # Topologically Sorted Source Nodes: [h_3, input_16, transpose_8, out_5, x_6, x_7, x_norm_2, split_2, x_flat_2, out_6, view_19, shift_5, out_7, x_8, x_9, add_9, h_4, input_18, transpose_16, out_9, x_10, x_11, x_norm_3, split_3, x_flat_3, out_10, view_29, shift_7, out_11, x_12], Original ATen: [aten.convolution, aten.addmm, aten.view, aten.transpose, aten.add, aten.native_group_norm, aten.split_with_sizes, aten.silu]
        stream0 = get_raw_stream(0)
        triton_poi_fused_add_addmm_convolution_native_group_norm_silu_split_with_sizes_transpose_view_25.run(buf83, buf85, buf59, buf86, 1536, 256, stream=stream0)
        del buf83
        del buf85
        ...
        assert_size_stride(buf87, (6, 256, 16, 16), (65536, 1, 4096, 256), 'torch.ops.aten.convolution.default')
        del buf86
        buf88 = buf87; del buf87  # reuse
        buf89 = buf88; del buf88  # reuse
        # Topologically Sorted Source Nodes: [h_3, input_16, transpose_8, out_5, x_6, x_7, x_norm_2, split_2, x_flat_2, out_6, view_19, shift_5, out_7, x_8, x_9, add_9, h_4, input_18, transpose_16, out_9, x_10, x_11, x_norm_3, split_3, x_flat_3, out_10, view_29, shift_7, out_11, x_12, x_13, add_13, h_5], Original ATen: [aten.convolution, aten.addmm, aten.view, aten.transpose, aten.add, aten.native_group_norm, aten.split_with_sizes, aten.silu]
        stream0 = get_raw_stream(0)
        triton_poi_fused_add_addmm_convolution_native_group_norm_silu_split_with_sizes_transpose_view_28.run(buf89, arg51_1, buf65, arg43_1, buf40, arg35_1, 393216, stream=stream0)
        del buf40
        buf90 = empty_strided_cuda((512, 256, 3, 3), (2304, 1, 768, 256), torch.float32)
        # Topologically Sorted Source Nodes: [h_5, h_6], Original ATen: [aten.silu, aten.convolution]
        stream0 = get_raw_stream(0)
        triton_poi_fused_convolution_silu_29.run(arg52_1, buf90, 131072, 9, stream=stream0)
        # Topologically Sorted Source Nodes: [h_5, h_6], Original ATen: [aten.silu, aten.convolution]
        ...
        assert_size_stride(buf91, (6, 512, 8, 8), (32768, 1, 4096, 512), 'torch.ops.aten.convolution.default')
        del buf90
        buf92 = empty_strided_cuda((6, 64, 512), (32768, 512, 1), torch.float32)
        # Topologically Sorted Source Nodes: [h_5, h_6, view_30, q_6, q_7], Original ATen: [aten.silu, aten.convolution, aten.view, aten.transpose, aten.clone]
        stream0 = get_raw_stream(0)
        triton_poi_fused_clone_convolution_silu_transpose_view_30.run(buf91, arg53_1, buf92, 196608, stream=stream0)
        buf93 = empty_strided_cuda((384, 512), (512, 1), torch.float32)
        ...
        extern_kernels.mm(reinterpret_tensor(buf92, (384, 512), (512, 1), 0), reinterpret_tensor(arg54_1, (512, 512), (1, 512), 0), out=buf93)
        buf94 = reinterpret_tensor(buf92, (6, 8, 64, 64), (32768, 4096, 64, 1), 0); del buf92  # reuse
        # Topologically Sorted Source Nodes: [q_7, view_31, q_8, matmul_4], Original ATen: [aten._unsafe_view, aten.view, aten.transpose, aten.clone]
        stream0 = get_raw_stream(0)
        triton_poi_fused__unsafe_view_clone_transpose_view_31.run(buf93, buf94, 196608, stream=stream0)
        buf95 = reinterpret_tensor(buf60, (6, 8, 64, 1), (512, 64, 1, 1), 0); del buf60  # reuse
        # Topologically Sorted Source Nodes: [kv_2, chunk_2, view_32, k_5, transpose_22, matmul_4], Original ATen: [aten.unsqueeze, aten.split, aten.view, aten.transpose, aten.clone]
        stream0 = get_raw_stream(0)
        triton_poi_fused_clone_split_transpose_unsqueeze_view_32.run(buf82, buf95, 3072, stream=stream0)
        buf96 = reinterpret_tensor(buf14, (48, 64, 1), (64, 1, 1), 0); del buf14  # reuse
        ...
        extern_kernels.bmm(reinterpret_tensor(buf94, (48, 64, 64), (4096, 64, 1), 0), reinterpret_tensor(buf95, (48, 64, 1), (64, 1, 0), 0), out=buf96)
        buf97 = reinterpret_tensor(buf96, (6, 8, 64, 1), (512, 64, 1, 1), 0); del buf96  # reuse
        # Topologically Sorted Source Nodes: [matmul_4, attn_5], Original ATen: [aten.view, aten.mul, aten.amax, aten.sub, aten._softmax]
        stream0 = get_raw_stream(0)
        triton_poi_fused__softmax_amax_mul_sub_view_33.run(buf97, 3072, stream=stream0)
        buf98 = reinterpret_tensor(buf95, (6, 8, 1, 64), (512, 64, 64, 1), 0); del buf95  # reuse
        # Topologically Sorted Source Nodes: [kv_2, chunk_2, view_33, v_13, matmul_5], Original ATen: [aten.unsqueeze, aten.split, aten.view, aten.transpose, aten.clone]
        stream0 = get_raw_stream(0)
        triton_poi_fused_clone_split_transpose_unsqueeze_view_34.run(buf82, buf98, 3072, stream=stream0)
        buf99 = reinterpret_tensor(buf94, (48, 64, 64), (4096, 64, 1), 0); del buf94  # reuse
        ...
        extern_kernels.bmm(reinterpret_tensor(buf97, (48, 64, 1), (64, 1, 0), 0), reinterpret_tensor(buf98, (48, 1, 64), (64, 0, 1), 0), out=buf99)
        buf100 = reinterpret_tensor(buf93, (6, 64, 8, 64), (32768, 512, 64, 1), 0); del buf93  # reuse
        # Topologically Sorted Source Nodes: [matmul_5, transpose_23, out_12], Original ATen: [aten.view, aten.transpose, aten.clone]
        stream0 = get_raw_stream(0)
        triton_poi_fused_clone_transpose_view_35.run(buf99, buf100, 196608, stream=stream0)
        buf101 = reinterpret_tensor(buf99, (384, 512), (512, 1), 0); del buf99  # reuse
        ...
        extern_kernels.mm(reinterpret_tensor(buf100, (384, 512), (512, 1), 0), reinterpret_tensor(arg56_1, (512, 512), (1, 512), 0), out=buf101)
        buf102 = reinterpret_tensor(buf101, (6, 512, 8, 8), (32768, 1, 4096, 512), 0); del buf101  # reuse
        # Topologically Sorted Source Nodes: [h_5, h_6, input_20, transpose_24, out_13, x_14], Original ATen: [aten.silu, aten.convolution, aten.addmm, aten.view, aten.transpose, aten.add]
        stream0 = get_raw_stream(0)
        triton_poi_fused_add_addmm_convolution_silu_transpose_view_36.run(buf102, buf91, arg53_1, arg57_1, 196608, stream=stream0)
        buf103 = empty_strided_cuda((512, 512, 3, 3), (4608, 1, 1536, 512), torch.float32)
        # Topologically Sorted Source Nodes: [h_5, h_6, input_20, transpose_24, out_13, x_14, x_15], Original ATen: [aten.silu, aten.convolution, aten.addmm, aten.view, aten.transpose, aten.add]
        stream0 = get_raw_stream(0)
        triton_poi_fused_add_addmm_convolution_silu_transpose_view_37.run(arg58_1, buf103, 262144, 9, stream=stream0)
        # Topologically Sorted Source Nodes: [h_5, h_6, input_20, transpose_24, out_13, x_14, x_15], Original ATen: [aten.silu, aten.convolution, aten.addmm, aten.view, aten.transpose, aten.add]
        ...
        assert_size_stride(buf104, (6, 512, 8, 8), (32768, 1, 4096, 512), 'torch.ops.aten.convolution.default')
        buf105 = buf80; del buf80  # reuse
        buf106 = buf79; del buf79  # reuse
        # Topologically Sorted Source Nodes: [h_5, h_6, input_20, transpose_24, out_13, x_14, x_15, x_norm_4], Original ATen: [aten.silu, aten.convolution, aten.addmm, aten.view, aten.transpose, aten.add, aten.native_group_norm]
        stream0 = get_raw_stream(0)
        triton_per_fused_add_addmm_convolution_native_group_norm_silu_transpose_view_38.run(buf104, arg59_1, buf105, buf106, 192, 1024, stream=stream0)
        buf108 = reinterpret_tensor(buf72, (6, 256), (256, 1), 0); del buf72  # reuse
        ...
        stream0 = get_raw_stream(0)
        triton_poi_fused_addmm_silu_10.run(buf109, arg20_1, 1536, stream=stream0)
        buf110 = empty_strided_cuda((6, 12800), (12800, 1), torch.float32)
        ...
        buf112 = reinterpret_tensor(buf102, (6, 32, 16, 64), (32768, 1024, 64, 1), 0); del buf102  # reuse
        # Topologically Sorted Source Nodes: [h_5, h_6, input_20, transpose_24, out_13, x_14, x_15, x_norm_4], Original ATen: [aten.silu, aten.convolution, aten.addmm, aten.view, aten.transpose, aten.add, aten.native_group_norm]
        stream0 = get_raw_stream(0)
        triton_poi_fused_add_addmm_convolution_native_group_norm_silu_transpose_view_39.run(buf104, arg59_1, buf105, buf106, buf112, 3072, 64, stream=stream0)
        buf113 = reinterpret_tensor(buf1, (6, 12, 64), (768, 64, 1), 0); del buf1  # reuse
        ...
        extern_kernels.bmm(reinterpret_tensor(buf110, (6, 12, 512), (12800, 1, 12), 6144), reinterpret_tensor(buf112, (6, 512, 64), (32768, 64, 1), 0), out=buf113)
        buf114 = reinterpret_tensor(buf104, (6, 512, 64), (32768, 64, 1), 0); del buf104  # reuse
        # Topologically Sorted Source Nodes: [split_4, u_9, mixed_4], Original ATen: [aten.split_with_sizes, aten.view, aten.bmm]
        extern_kernels.bmm(reinterpret_tensor(buf110, (6, 512, 12), (12800, 12, 1), 0), buf113, out=buf114)
        buf115 = reinterpret_tensor(buf100, (6, 512, 8, 8), (32768, 1, 4096, 512), 0); del buf100  # reuse
        # Topologically Sorted Source Nodes: [h_5, h_6, input_20, transpose_24, out_13, x_14, x_15, x_norm_4, split_4, x_flat_4, out_14, view_39, shift_9, out_15, x_16], Original ATen: [aten.silu, aten.convolution, aten.addmm, aten.view, aten.transpose, aten.add, aten.native_group_norm, aten.split_with_sizes]
        stream0 = get_raw_stream(0)
        triton_poi_fused_add_addmm_convolution_native_group_norm_silu_split_with_sizes_transpose_view_40.run(buf112, buf114, buf110, buf115, 3072, 64, stream=stream0)
        del buf112
        ...
        assert_size_stride(buf116, (6, 512, 8, 8), (32768, 1, 4096, 512), 'torch.ops.aten.convolution.default')
        buf117 = reinterpret_tensor(buf115, (6, 64, 512), (32768, 512, 1), 0); del buf115  # reuse
        # Topologically Sorted Source Nodes: [h_5, h_6, input_20, transpose_24, out_13, x_14, x_15, x_norm_4, split_4, x_flat_4, out_14, view_39, shift_9, out_15, x_16, x_17, add_17, h_7, view_40, q_9, q_10], Original ATen: [aten.silu, aten.convolution, aten.addmm, aten.view, aten.transpose, aten.add, aten.native_group_norm, aten.split_with_sizes, aten.clone]
        stream0 = get_raw_stream(0)
        triton_poi_fused_add_addmm_clone_convolution_native_group_norm_silu_split_with_sizes_transpose_view_41.run(buf116, arg61_1, buf91, arg53_1, buf117, 196608, stream=stream0)
        buf118 = reinterpret_tensor(buf114, (384, 512), (512, 1), 0); del buf114  # reuse
        # Topologically Sorted Source Nodes: [h_5, h_6, input_20, transpose_24, out_13, x_14, x_15, x_norm_4, split_4, x_flat_4, out_14, view_39, shift_9, out_15, x_16, x_17, add_17, h_7, view_40, q_9, q_10], Original ATen: [aten.silu, aten.convolution, aten.addmm, aten.view, aten.transpose, aten.add, aten.native_group_norm, aten.split_with_sizes, aten.clone, aten._unsafe_view, aten.t, aten.mm]
        extern_kernels.mm(reinterpret_tensor(buf117, (384, 512), (512, 1), 0), reinterpret_tensor(arg62_1, (512, 512), (1, 512), 0), out=buf118)
        buf119 = reinterpret_tensor(buf117, (6, 8, 64, 64), (32768, 4096, 64, 1), 0); del buf117  # reuse
        ...
        stream0 = get_raw_stream(0)
        triton_poi_fused__unsafe_view_clone_transpose_view_31.run(buf118, buf119, 196608, stream=stream0)
        buf120 = reinterpret_tensor(buf98, (6, 8, 64, 1), (512, 64, 1, 1), 0); del buf98  # reuse
        ...
        stream0 = get_raw_stream(0)
        triton_poi_fused_clone_split_transpose_unsqueeze_view_32.run(buf111, buf120, 3072, stream=stream0)
        buf121 = reinterpret_tensor(buf97, (48, 64, 1), (64, 1, 1), 0); del buf97  # reuse
        ...
        extern_kernels.bmm(reinterpret_tensor(buf119, (48, 64, 64), (4096, 64, 1), 0), reinterpret_tensor(buf120, (48, 64, 1), (64, 1, 0), 0), out=buf121)
        buf122 = reinterpret_tensor(buf121, (6, 8, 64, 1), (512, 64, 1, 1), 0); del buf121  # reuse
        # Topologically Sorted Source Nodes: [matmul_6, attn_7], Original ATen: [aten.view, aten.mul, aten.amax, aten.sub, aten._softmax]
        stream0 = get_raw_stream(0)
        triton_poi_fused__softmax_amax_mul_sub_view_33.run(buf122, 3072, stream=stream0)
        buf123 = reinterpret_tensor(buf120, (6, 8, 1, 64), (512, 64, 64, 1), 0); del buf120  # reuse
        ...
        stream0 = get_raw_stream(0)
        triton_poi_fused_clone_split_transpose_unsqueeze_view_34.run(buf111, buf123, 3072, stream=stream0)
        buf124 = reinterpret_tensor(buf119, (48, 64, 64), (4096, 64, 1), 0); del buf119  # reuse
        ...
        extern_kernels.bmm(reinterpret_tensor(buf122, (48, 64, 1), (64, 1, 0), 0), reinterpret_tensor(buf123, (48, 1, 64), (64, 0, 1), 0), out=buf124)
        buf125 = reinterpret_tensor(buf118, (6, 64, 8, 64), (32768, 512, 64, 1), 0); del buf118  # reuse
        # Topologically Sorted Source Nodes: [matmul_7, transpose_31, out_16], Original ATen: [aten.view, aten.transpose, aten.clone]
        stream0 = get_raw_stream(0)
        triton_poi_fused_clone_transpose_view_35.run(buf124, buf125, 196608, stream=stream0)
        buf126 = reinterpret_tensor(buf124, (384, 512), (512, 1), 0); del buf124  # reuse
        ...
        extern_kernels.mm(reinterpret_tensor(buf125, (384, 512), (512, 1), 0), reinterpret_tensor(arg64_1, (512, 512), (1, 512), 0), out=buf126)
        buf127 = reinterpret_tensor(buf126, (6, 512, 8, 8), (32768, 1, 4096, 512), 0); del buf126  # reuse
        # Topologically Sorted Source Nodes: [h_5, h_6, input_20, transpose_24, out_13, x_14, x_15, x_norm_4, split_4, x_flat_4, out_14, view_39, shift_9, out_15, x_16, x_17, add_17, h_7, input_22, transpose_32, out_17, x_18], Original ATen: [aten.silu, aten.convolution, aten.addmm, aten.view, aten.transpose, aten.add, aten.native_group_norm, aten.split_with_sizes]
        stream0 = get_raw_stream(0)
        triton_poi_fused_add_addmm_convolution_native_group_norm_silu_split_with_sizes_transpose_view_42.run(buf127, buf116, arg61_1, buf91, arg53_1, arg65_1, 196608, stream=stream0)
        buf128 = buf103; del buf103  # reuse
        # Topologically Sorted Source Nodes: [h_5, h_6, input_20, transpose_24, out_13, x_14, x_15, x_norm_4, split_4, x_flat_4, out_14, view_39, shift_9, out_15, x_16, x_17, add_17, h_7, input_22, transpose_32, out_17, x_18, x_19], Original ATen: [aten.silu, aten.convolution, aten.addmm, aten.view, aten.transpose, aten.add, aten.native_group_norm, aten.split_with_sizes]
        stream0 = get_raw_stream(0)
        triton_poi_fused_add_addmm_convolution_silu_transpose_view_37.run(arg66_1, buf128, 262144, 9, stream=stream0)
        # Topologically Sorted Source Nodes: [h_5, h_6, input_20, transpose_24, out_13, x_14, x_15, x_norm_4, split_4, x_flat_4, out_14, view_39, shift_9, out_15, x_16, x_17, add_17, h_7, input_22, transpose_32, out_17, x_18, x_19], Original ATen: [aten.silu, aten.convolution, aten.addmm, aten.view, aten.transpose, aten.add, aten.native_group_norm, aten.split_with_sizes]
        ...
        assert_size_stride(buf129, (6, 512, 8, 8), (32768, 1, 4096, 512), 'torch.ops.aten.convolution.default')
        del buf128
        ...
        stream0 = get_raw_stream(0)
        triton_per_fused_add_addmm_convolution_native_group_norm_silu_transpose_view_38.run(buf129, arg67_1, buf130, buf131, 192, 1024, stream=stream0)
        buf133 = reinterpret_tensor(buf127, (6, 32, 16, 64), (32768, 1024, 64, 1), 0); del buf127  # reuse
        # Topologically Sorted Source Nodes: [h_5, h_6, input_20, transpose_24, out_13, x_14, x_15, x_norm_4, split_4, x_flat_4, out_14, view_39, shift_9, out_15, x_16, x_17, add_17, h_7, input_22, transpose_32, out_17, x_18, x_19, x_norm_5], Original ATen: [aten.silu, aten.convolution, aten.addmm, aten.view, aten.transpose, aten.add, aten.native_group_norm, aten.split_with_sizes]
        stream0 = get_raw_stream(0)
        triton_poi_fused_add_addmm_convolution_native_group_norm_silu_transpose_view_39.run(buf129, arg67_1, buf130, buf131, buf133, 3072, 64, stream=stream0)
        ...
        extern_kernels.bmm(reinterpret_tensor(buf110, (6, 12, 512), (12800, 1, 12), 6144), reinterpret_tensor(buf133, (6, 512, 64), (32768, 64, 1), 0), out=buf134)
        buf135 = reinterpret_tensor(buf129, (6, 512, 64), (32768, 64, 1), 0); del buf129  # reuse
        # Topologically Sorted Source Nodes: [split_5, u_11, mixed_5], Original ATen: [aten.split_with_sizes, aten.view, aten.bmm]
        extern_kernels.bmm(reinterpret_tensor(buf110, (6, 512, 12), (12800, 12, 1), 0), buf134, out=buf135)
        buf136 = reinterpret_tensor(buf125, (6, 512, 8, 8), (32768, 1, 4096, 512), 0); del buf125  # reuse
        ...
        stream0 = get_raw_stream(0)
        triton_poi_fused_add_addmm_convolution_native_group_norm_silu_split_with_sizes_transpose_view_40.run(buf133, buf135, buf110, buf136, 3072, 64, stream=stream0)
        del buf133
        del buf135
        ...
        assert_size_stride(buf137, (6, 512, 8, 8), (32768, 1, 4096, 512), 'torch.ops.aten.convolution.default')
        buf138 = buf137; del buf137  # reuse
        buf142 = reinterpret_tensor(buf136, (6, 64, 512), (32768, 512, 1), 0); del buf136  # reuse
        # Topologically Sorted Source Nodes: [h_5, h_6, input_20, transpose_24, out_13, x_14, x_15, x_norm_4, split_4, x_flat_4, out_14, view_39, shift_9, out_15, x_16, x_17, add_17, h_7, input_22, transpose_32, out_17, x_18, x_19, x_norm_5, split_5, x_flat_5, out_18, view_49, shift_11, out_19, x_20, x_21, add_21, h_8, view_50, x_flat_6, x_norm_6], Original ATen: [aten.silu, aten.convolution, aten.addmm, aten.view, aten.transpose, aten.add, aten.native_group_norm, aten.split_with_sizes, aten.native_layer_norm]
        stream0 = get_raw_stream(0)
        triton_per_fused_add_addmm_convolution_native_group_norm_native_layer_norm_silu_split_with_sizes_transpose_view_43.run(buf138, arg69_1, buf116, arg61_1, buf91, arg53_1, arg70_1, arg71_1, buf142, 384, 512, stream=stream0)
        buf143 = reinterpret_tensor(buf77, (384, 1536), (1536, 1), 0); del buf77  # reuse
        ...
        extern_kernels.mm(reinterpret_tensor(buf142, (384, 512), (512, 1), 0), reinterpret_tensor(arg72_1, (512, 1536), (1, 512), 0), out=buf143)
        buf144 = reinterpret_tensor(buf142, (6, 8, 64, 64), (32768, 4096, 64, 1), 0); del buf142  # reuse
        # Topologically Sorted Source Nodes: [qkv, qkv_1, qkv_2, q_12, matmul_8], Original ATen: [aten.addmm, aten.view, aten.permute, aten.select, aten.clone]
        stream0 = get_raw_stream(0)
        triton_poi_fused_addmm_clone_permute_select_view_44.run(buf143, arg73_1, buf144, 196608, stream=stream0)
        buf145 = reinterpret_tensor(buf91, (6, 8, 64, 64), (32768, 4096, 64, 1), 0); del buf91  # reuse
        # Topologically Sorted Source Nodes: [qkv, qkv_1, qkv_2, k_8, transpose_35, matmul_8], Original ATen: [aten.addmm, aten.view, aten.permute, aten.select, aten.transpose, aten.clone]
        stream0 = get_raw_stream(0)
        triton_poi_fused_addmm_clone_permute_select_transpose_view_45.run(buf143, arg73_1, buf145, 3072, 64, stream=stream0)
        buf146 = reinterpret_tensor(buf116, (48, 64, 64), (4096, 64, 1), 0); del buf116  # reuse
        ...
        extern_kernels.bmm(reinterpret_tensor(buf144, (48, 64, 64), (4096, 64, 1), 0), reinterpret_tensor(buf145, (48, 64, 64), (4096, 64, 1), 0), out=buf146)
        buf149 = reinterpret_tensor(buf146, (6, 8, 64, 64), (32768, 4096, 64, 1), 0); del buf146  # reuse
        # Topologically Sorted Source Nodes: [matmul_8, attn_9], Original ATen: [aten.view, aten.mul, aten.amax, aten.sub, aten._softmax]
        stream0 = get_raw_stream(0)
        triton_per_fused__softmax_amax_mul_sub_view_46.run(buf149, 3072, 64, stream=stream0)
        buf150 = buf145; del buf145  # reuse
        # Topologically Sorted Source Nodes: [qkv, qkv_1, qkv_2, v_20, out_20], Original ATen: [aten.addmm, aten.view, aten.permute, aten.select, aten.clone]
        stream0 = get_raw_stream(0)
        triton_poi_fused_addmm_clone_permute_select_view_47.run(buf143, arg73_1, buf150, 196608, stream=stream0)
        buf151 = reinterpret_tensor(buf144, (48, 64, 64), (4096, 64, 1), 0); del buf144  # reuse
        ...
        extern_kernels.bmm(reinterpret_tensor(buf149, (48, 64, 64), (4096, 64, 1), 0), reinterpret_tensor(buf150, (48, 64, 64), (4096, 64, 1), 0), out=buf151)
        del buf149
        buf152 = reinterpret_tensor(buf150, (6, 64, 8, 64), (32768, 512, 64, 1), 0); del buf150  # reuse
        # Topologically Sorted Source Nodes: [out_20, transpose_36, out_21], Original ATen: [aten.view, aten.transpose, aten.clone]
        stream0 = get_raw_stream(0)
        triton_poi_fused_clone_transpose_view_35.run(buf151, buf152, 196608, stream=stream0)
        buf153 = reinterpret_tensor(buf151, (384, 512), (512, 1), 0); del buf151  # reuse
        ...
        extern_kernels.mm(reinterpret_tensor(buf152, (384, 512), (512, 1), 0), reinterpret_tensor(arg74_1, (512, 512), (1, 512), 0), out=buf153)
        del buf152
        buf158 = reinterpret_tensor(buf138, (6, 64, 512), (32768, 512, 1), 0); del buf138  # reuse
        # Topologically Sorted Source Nodes: [h_8, view_50, x_flat_6, out_22, out_23, out_24], Original ATen: [aten.silu, aten.view, aten.transpose, aten.addmm, aten.add, aten.native_layer_norm]
        stream0 = get_raw_stream(0)
        triton_per_fused_add_addmm_native_layer_norm_silu_transpose_view_48.run(buf158, buf153, arg75_1, arg76_1, arg77_1, 384, 512, stream=stream0)
        del buf153
        buf157 = reinterpret_tensor(buf123, (6, 512), (512, 1), 0); del buf123  # reuse
        ...
        # Topologically Sorted Source Nodes: [h_8, view_50, x_flat_6, out_22, out_23, out_24, transpose_37, out_25, h_9], Original ATen: [aten.silu, aten.view, aten.transpose, aten.addmm, aten.add, aten.native_layer_norm, aten.convolution]
        stream0 = get_raw_stream(0)
        triton_poi_fused_add_addmm_convolution_native_layer_norm_silu_transpose_view_49.run(arg78_1, buf159, 131072, 16, stream=stream0)
        # Topologically Sorted Source Nodes: [h_8, view_50, x_flat_6, out_22, out_23, out_24, transpose_37, out_25, h_9], Original ATen: [aten.silu, aten.view, aten.transpose, aten.addmm, aten.add, aten.native_layer_norm, aten.convolution]
        buf160 = extern_kernels.convolution(reinterpret_tensor(buf158, (6, 512, 8, 8), (32768, 1, 4096, 512), 0), buf159, stride=(2, 2), padding=(1, 1), dilation=(1, 1), transposed=True, output_padding=(0, 0), groups=1, bias=None)
        assert_size_stride(buf160, (6, 256, 16, 16), (65536, 1, 4096, 256), 'torch.ops.aten.convolution.default')
        del buf158
        del buf159
        ...
        stream0 = get_raw_stream(0)
        triton_poi_fused_addmm_silu_10.run(buf162, arg81_1, 1536, stream=stream0)
        buf163 = buf13; del buf13  # reuse
        # Topologically Sorted Source Nodes: [input_24, input_25, input_26], Original ATen: [aten.addmm, aten.silu]
        stream0 = get_raw_stream(0)
        triton_poi_fused_addmm_silu_50.run(buf162, buf163, 2048, stream=stream0)
        buf164 = empty_strided_cuda((8, 256), (256, 1), torch.float32)
        ...
        buf165 = reinterpret_tensor(buf65, (6, 256, 16, 16), (65536, 256, 16, 1), 0); del buf65  # reuse
        # Topologically Sorted Source Nodes: [h_8, view_50, x_flat_6, out_22, out_23, out_24, transpose_37, out_25, h_9, input_26, input_27, unsqueeze_4, gate, h_16_gated, h_10], Original ATen: [aten.silu, aten.view, aten.transpose, aten.addmm, aten.add, aten.native_layer_norm, aten.convolution, aten.sigmoid, aten.unsqueeze, aten.mul]
        stream0 = get_raw_stream(0)
        triton_poi_fused_add_addmm_convolution_mul_native_layer_norm_sigmoid_silu_transpose_unsqueeze_view_51.run(buf160, arg79_1, buf89, buf164, arg83_1, buf165, 1536, 256, stream=stream0)
        buf166 = reinterpret_tensor(buf89, (1536, 256), (1, 1536), 0); del buf89  # reuse
        # Topologically Sorted Source Nodes: [view_52, q_13, q_14], Original ATen: [aten.view, aten.transpose, aten.t, aten.mm]
        stream0 = get_raw_stream(0)
        triton_poi_fused_mm_t_transpose_view_52.run(buf165, buf166, 393216, stream=stream0)
        buf167 = reinterpret_tensor(buf160, (1536, 256), (256, 1), 0); del buf160  # reuse
        # Topologically Sorted Source Nodes: [view_52, q_13, q_14], Original ATen: [aten.view, aten.transpose, aten.t, aten.mm]
        ...
        buf169 = reinterpret_tensor(buf162, (6, 4, 64, 1), (256, 64, 1, 1), 0); del buf162  # reuse
        ...
        stream0 = get_raw_stream(0)
        triton_poi_fused_clone_split_transpose_unsqueeze_view_17.run(buf157, buf169, 1536, stream=stream0)
        buf170 = reinterpret_tensor(buf111, (24, 256, 1), (256, 1, 1), 0); del buf111  # reuse
        ...
        stream0 = get_raw_stream(0)
        triton_poi_fused_clone_split_transpose_unsqueeze_view_19.run(buf157, buf172, 1536, stream=stream0)
        ...
        # Topologically Sorted Source Nodes: [input_28, transpose_44, out_27, x_22], Original ATen: [aten.addmm, aten.view, aten.transpose, aten.add]
        stream0 = get_raw_stream(0)
        triton_poi_fused_add_addmm_transpose_view_53.run(buf176, buf165, arg87_1, 1536, 256, stream=stream0)
        buf177 = reinterpret_tensor(buf143, (256, 256, 3, 3), (2304, 1, 768, 256), 0); del buf143  # reuse
        ...
        extern_kernels.bmm(reinterpret_tensor(buf59, (6, 12, 256), (6400, 1, 12), 3072), reinterpret_tensor(buf183, (6, 256, 256), (65536, 256, 1), 0), out=buf184)
        ...
        extern_kernels.bmm(reinterpret_tensor(buf59, (6, 256, 12), (6400, 12, 1), 0), buf184, out=buf185)
        ...
        stream0 = get_raw_stream(0)
        triton_poi_fused_add_addmm_convolution_native_group_norm_silu_split_with_sizes_transpose_view_25.run(buf183, buf185, buf59, buf186, 1536, 256, stream=stream0)
        del buf183
        ...
        # Topologically Sorted Source Nodes: [input_28, transpose_44, out_27, x_22, x_23, x_norm_7, split_6, x_flat_7, out_28, view_61, shift_13, out_29, x_24, x_25, add_27, h_11, view_62, q_16, q_17], Original ATen: [aten.addmm, aten.view, aten.transpose, aten.add, aten.convolution, aten.clone, aten.native_group_norm, aten.split_with_sizes, aten.silu]
        stream0 = get_raw_stream(0)
        triton_poi_fused_add_addmm_clone_convolution_native_group_norm_silu_split_with_sizes_transpose_view_54.run(buf187, arg91_1, buf165, buf188, 1536, 256, stream=stream0)
        ...
        # Topologically Sorted Source Nodes: [input_28, transpose_44, out_27, x_22, x_23, x_norm_7, split_6, x_flat_7, out_28, view_61, shift_13, out_29, x_24, x_25, add_27, h_11, input_30, transpose_52, out_31, x_26], Original ATen: [aten.addmm, aten.view, aten.transpose, aten.add, aten.convolution, aten.clone, aten.native_group_norm, aten.split_with_sizes, aten.silu]
        stream0 = get_raw_stream(0)
        triton_poi_fused_add_addmm_clone_convolution_native_group_norm_silu_split_with_sizes_transpose_view_55.run(buf198, buf187, arg91_1, buf165, arg95_1, 1536, 256, stream=stream0)
        ...
        extern_kernels.bmm(reinterpret_tensor(buf59, (6, 12, 256), (6400, 1, 12), 3072), reinterpret_tensor(buf205, (6, 256, 256), (65536, 256, 1), 0), out=buf206)
        ...
        extern_kernels.bmm(reinterpret_tensor(buf59, (6, 256, 12), (6400, 12, 1), 0), buf206, out=buf207)
        ...
        stream0 = get_raw_stream(0)
        triton_poi_fused_add_addmm_convolution_native_group_norm_silu_split_with_sizes_transpose_view_25.run(buf205, buf207, buf59, buf208, 1536, 256, stream=stream0)
        del buf205
        del buf207
        ...
        # Topologically Sorted Source Nodes: [input_28, transpose_44, out_27, x_22, x_23, x_norm_7, split_6, x_flat_7, out_28, view_61, shift_13, out_29, x_24, x_25, add_27, h_11, input_30, transpose_52, out_31, x_26, x_27, x_norm_8, split_7, x_flat_8, out_32, view_71, shift_15, out_33, x_28, x_29, add_31, h_12, view_72, q_19, q_20], Original ATen: [aten.addmm, aten.view, aten.transpose, aten.add, aten.convolution, aten.clone, aten.native_group_norm, aten.split_with_sizes, aten.silu]
        stream0 = get_raw_stream(0)
        triton_poi_fused_add_addmm_clone_convolution_native_group_norm_silu_split_with_sizes_transpose_view_56.run(buf210, arg99_1, buf187, arg91_1, buf165, buf211, 393216, stream=stream0)
        del buf165
        ...
        # Topologically Sorted Source Nodes: [h_12, input_32, transpose_60, out_35, x_30], Original ATen: [aten.silu, aten.addmm, aten.view, aten.transpose, aten.add]
        stream0 = get_raw_stream(0)
        triton_poi_fused_add_addmm_silu_transpose_view_57.run(buf221, buf210, arg103_1, 393216, stream=stream0)
        ...
        extern_kernels.bmm(reinterpret_tensor(buf59, (6, 12, 256), (6400, 1, 12), 3072), reinterpret_tensor(buf228, (6, 256, 256), (65536, 256, 1), 0), out=buf229)
        ...
        extern_kernels.bmm(reinterpret_tensor(buf59, (6, 256, 12), (6400, 12, 1), 0), buf229, out=buf230)
        ...
        stream0 = get_raw_stream(0)
        triton_poi_fused_add_addmm_convolution_native_group_norm_silu_split_with_sizes_transpose_view_25.run(buf228, buf230, buf59, buf231, 1536, 256, stream=stream0)
        del buf228
        ...
        # Topologically Sorted Source Nodes: [h_12, input_32, transpose_60, out_35, x_30, x_31, x_norm_9, split_8, x_flat_9, out_36, view_81, shift_17, out_37, x_32, x_33, add_35, h_13, view_82, q_22, q_23], Original ATen: [aten.silu, aten.addmm, aten.view, aten.transpose, aten.add, aten.convolution, aten.native_group_norm, aten.split_with_sizes, aten.clone]
        stream0 = get_raw_stream(0)
        triton_poi_fused_add_addmm_clone_convolution_native_group_norm_silu_split_with_sizes_transpose_view_58.run(buf232, arg107_1, buf210, buf233, 393216, stream=stream0)
        ...
        # Topologically Sorted Source Nodes: [h_12, input_32, transpose_60, out_35, x_30, x_31, x_norm_9, split_8, x_flat_9, out_36, view_81, shift_17, out_37, x_32, x_33, add_35, h_13, input_34, transpose_68, out_39, x_34], Original ATen: [aten.silu, aten.addmm, aten.view, aten.transpose, aten.add, aten.convolution, aten.native_group_norm, aten.split_with_sizes]
        stream0 = get_raw_stream(0)
        triton_poi_fused_add_addmm_convolution_native_group_norm_silu_split_with_sizes_transpose_view_59.run(buf243, buf232, arg107_1, buf210, arg111_1, 393216, stream=stream0)
        ...
        extern_kernels.bmm(reinterpret_tensor(buf59, (6, 12, 256), (6400, 1, 12), 3072), reinterpret_tensor(buf250, (6, 256, 256), (65536, 256, 1), 0), out=buf251)
        ...
        extern_kernels.bmm(reinterpret_tensor(buf59, (6, 256, 12), (6400, 12, 1), 0), buf251, out=buf252)
        ...
        stream0 = get_raw_stream(0)
        triton_poi_fused_add_addmm_convolution_native_group_norm_silu_split_with_sizes_transpose_view_25.run(buf250, buf252, buf59, buf253, 1536, 256, stream=stream0)
        del buf250
        del buf252
        ...
        # Topologically Sorted Source Nodes: [h_12, input_32, transpose_60, out_35, x_30, x_31, x_norm_9, split_8, x_flat_9, out_36, view_81, shift_17, out_37, x_32, x_33, add_35, h_13, input_34, transpose_68, out_39, x_34, x_35, x_norm_10, split_9, x_flat_10, out_40, view_91, shift_19, out_41, x_36, x_37, add_39, h_14, view_92, q_25, q_26], Original ATen: [aten.silu, aten.addmm, aten.view, aten.transpose, aten.add, aten.convolution, aten.native_group_norm, aten.split_with_sizes, aten.clone]
        stream0 = get_raw_stream(0)
        triton_poi_fused_add_addmm_clone_convolution_native_group_norm_silu_split_with_sizes_transpose_view_60.run(buf255, arg115_1, buf232, arg107_1, buf210, buf256, 393216, stream=stream0)
        del buf210
        ...
        stream0 = get_raw_stream(0)
        triton_poi_fused_add_addmm_silu_transpose_view_57.run(buf266, buf255, arg119_1, 393216, stream=stream0)
        ...
        extern_kernels.bmm(reinterpret_tensor(buf59, (6, 12, 256), (6400, 1, 12), 3072), reinterpret_tensor(buf272, (6, 256, 256), (65536, 256, 1), 0), out=buf273)
        ...
        extern_kernels.bmm(reinterpret_tensor(buf59, (6, 256, 12), (6400, 12, 1), 0), buf273, out=buf274)
        ...
        stream0 = get_raw_stream(0)
        triton_poi_fused_add_addmm_convolution_native_group_norm_silu_split_with_sizes_transpose_view_25.run(buf272, buf274, buf59, buf275, 1536, 256, stream=stream0)
        del buf272
        del buf274
        ...
        # Topologically Sorted Source Nodes: [h_14, input_36, transpose_76, out_43, x_38, x_39, x_norm_11, split_10, x_flat_11, out_44, view_101, shift_21, out_45, x_40, x_41, add_43, h_15], Original ATen: [aten.silu, aten.addmm, aten.view, aten.transpose, aten.add, aten.convolution, aten.native_group_norm, aten.split_with_sizes]
        stream0 = get_raw_stream(0)
        triton_poi_fused_add_addmm_convolution_native_group_norm_silu_split_with_sizes_transpose_view_61.run(buf277, arg123_1, buf255, 393216, stream=stream0)
        buf278 = empty_strided_cuda((256, 128, 4, 4), (2048, 1, 512, 128), torch.float32)
        # Topologically Sorted Source Nodes: [h_14, input_36, transpose_76, out_43, x_38, x_39, x_norm_11, split_10, x_flat_11, out_44, view_101, shift_21, out_45, x_40, x_41, add_43, h_15, h_16], Original ATen: [aten.silu, aten.addmm, aten.view, aten.transpose, aten.add, aten.convolution, aten.native_group_norm, aten.split_with_sizes]
        stream0 = get_raw_stream(0)
        triton_poi_fused_add_addmm_convolution_native_group_norm_silu_split_with_sizes_transpose_view_62.run(arg124_1, buf278, 32768, 16, stream=stream0)
        # Topologically Sorted Source Nodes: [h_14, input_36, transpose_76, out_43, x_38, x_39, x_norm_11, split_10, x_flat_11, out_44, view_101, shift_21, out_45, x_40, x_41, add_43, h_15, h_16], Original ATen: [aten.silu, aten.addmm, aten.view, aten.transpose, aten.add, aten.convolution, aten.native_group_norm, aten.split_with_sizes]
        ...
        # Topologically Sorted Source Nodes: [h_14, input_36, transpose_76, out_43, x_38, x_39, x_norm_11, split_10, x_flat_11, out_44, view_101, shift_21, out_45, x_40, x_41, add_43, h_15, h_16, input_40, input_41, unsqueeze_11, gate_1, h_32_gated, h_17], Original ATen: [aten.silu, aten.addmm, aten.view, aten.transpose, aten.add, aten.convolution, aten.native_group_norm, aten.split_with_sizes, aten.sigmoid, aten.unsqueeze, aten.mul]
        stream0 = get_raw_stream(0)
        triton_poi_fused_add_addmm_convolution_mul_native_group_norm_sigmoid_silu_split_with_sizes_transpose_unsqueeze_view_63.run(buf283, arg125_1, buf38, buf282, arg129_1, 786432, stream=stream0)
        buf284 = buf27; del buf27  # reuse
        ...
        extern_kernels.bmm(reinterpret_tensor(buf20, (6, 12, 128), (3200, 1, 12), 1536), reinterpret_tensor(buf289, (6, 128, 1024), (131072, 1024, 1), 0), out=buf290)
        ...
        extern_kernels.bmm(reinterpret_tensor(buf20, (6, 128, 12), (3200, 12, 1), 0), buf290, out=buf291)
        ...
        stream0 = get_raw_stream(0)
        triton_poi_fused_add_convolution_native_group_norm_silu_split_with_sizes_view_12.run(buf289, buf291, buf20, buf292, 768, 1024, stream=stream0)
        del buf289
        del buf291
        ...
        extern_kernels.bmm(reinterpret_tensor(buf20, (6, 12, 128), (3200, 1, 12), 1536), reinterpret_tensor(buf300, (6, 128, 1024), (131072, 1024, 1), 0), out=buf301)
        ...
        extern_kernels.bmm(reinterpret_tensor(buf20, (6, 128, 12), (3200, 12, 1), 0), buf301, out=buf302)
        ...
        stream0 = get_raw_stream(0)
        triton_poi_fused_add_convolution_native_group_norm_silu_split_with_sizes_view_12.run(buf300, buf302, buf20, buf303, 768, 1024, stream=stream0)
        del buf300
        del buf302
        ...
        extern_kernels.bmm(reinterpret_tensor(buf20, (6, 12, 128), (3200, 1, 12), 1536), reinterpret_tensor(buf311, (6, 128, 1024), (131072, 1024, 1), 0), out=buf312)
        ...
        extern_kernels.bmm(reinterpret_tensor(buf20, (6, 128, 12), (3200, 12, 1), 0), buf312, out=buf313)
        ...
        stream0 = get_raw_stream(0)
        triton_poi_fused_add_convolution_native_group_norm_silu_split_with_sizes_view_12.run(buf311, buf313, buf20, buf314, 768, 1024, stream=stream0)
        del buf311
        del buf313
        ...
        extern_kernels.bmm(reinterpret_tensor(buf20, (6, 12, 128), (3200, 1, 12), 1536), reinterpret_tensor(buf322, (6, 128, 1024), (131072, 1024, 1), 0), out=buf323)
        ...
        extern_kernels.bmm(reinterpret_tensor(buf20, (6, 128, 12), (3200, 12, 1), 0), buf323, out=buf324)
        ...
        stream0 = get_raw_stream(0)
        triton_poi_fused_add_convolution_native_group_norm_silu_split_with_sizes_view_12.run(buf322, buf324, buf20, buf325, 768, 1024, stream=stream0)
        del buf322
        del buf324
        ...
        extern_kernels.bmm(reinterpret_tensor(buf20, (6, 12, 128), (3200, 1, 12), 1536), reinterpret_tensor(buf333, (6, 128, 1024), (131072, 1024, 1), 0), out=buf334)
        ...
        extern_kernels.bmm(reinterpret_tensor(buf20, (6, 128, 12), (3200, 12, 1), 0), buf334, out=buf335)
        ...
        stream0 = get_raw_stream(0)
        triton_poi_fused_add_convolution_native_group_norm_silu_split_with_sizes_view_12.run(buf333, buf335, buf20, buf336, 768, 1024, stream=stream0)
        del buf333
        ...
        # Topologically Sorted Source Nodes: [x_54, x_norm_16, split_15, x_flat_16, out_54, view_126, shift_31, out_55, x_55, x_56, add_59, h_22, input_42], Original ATen: [aten.convolution, aten.native_group_norm, aten.split_with_sizes, aten.view, aten.add, aten.silu]
        stream0 = get_raw_stream(0)
        triton_red_fused_add_convolution_native_group_norm_silu_split_with_sizes_view_64.run(buf337, arg149_1, buf327, buf338, buf339, 192, 4096, stream=stream0)
        ...
        buf342 = reinterpret_tensor(buf134, (128, 4, 3, 3), (36, 1, 12, 4), 0); del buf134  # reuse
        # Topologically Sorted Source Nodes: [h_23], Original ATen: [aten.convolution]
        stream0 = get_raw_stream(0)
        ...
        buf351 = reinterpret_tensor(buf261, (6, 1024), (1024, 1), 0); del buf261  # reuse
        ...
        extern_kernels.mm(buf350, reinterpret_tensor(arg1_1, (256, 1024), (1, 256), 0), out=buf351)
        del arg1_1
        buf352 = buf351; del buf351  # reuse
        # Topologically Sorted Source Nodes: [input_45, input_46], Original ATen: [aten.addmm, aten.silu]
        stream0 = get_raw_stream(0)
        triton_poi_fused_addmm_silu_6.run(buf352, arg2_1, 6144, stream=stream0)
        del arg2_1
        buf353 = buf12; del buf12  # reuse
        # Topologically Sorted Source Nodes: [input_45, input_46, input_47], Original ATen: [aten.addmm, aten.silu]
        stream0 = get_raw_stream(0)
        triton_poi_fused_addmm_silu_7.run(buf352, buf353, 8192, stream=stream0)
        buf354 = buf164; del buf164  # reuse
        ...
        # Topologically Sorted Source Nodes: [input_47, unsqueeze_13, s_emb_1, cat_3], Original ATen: [aten.addmm, aten.unsqueeze, aten.expand, aten.cat]
        stream0 = get_raw_stream(0)
        triton_poi_fused_addmm_cat_expand_unsqueeze_65.run(buf354, arg154_1, buf355, 3072, stream=stream0)
        del arg154_1
        buf356 = reinterpret_tensor(buf122, (6, 512), (512, 1), 0); del buf122  # reuse
        # Topologically Sorted Source Nodes: [input_47, unsqueeze_13, s_emb_1, cat_3, input_48], Original ATen: [aten.addmm, aten.unsqueeze, aten.expand, aten.cat, aten.t]
        extern_kernels.mm(buf355, reinterpret_tensor(arg7_1, (512, 512), (1, 512), 0), out=buf356)
        del arg7_1
        buf357 = buf356; del buf356  # reuse
        # Topologically Sorted Source Nodes: [input_48, input_49], Original ATen: [aten.addmm, aten.silu]
        stream0 = get_raw_stream(0)
        triton_poi_fused_addmm_silu_9.run(buf357, arg8_1, 3072, stream=stream0)
        del arg8_1
        ...
        extern_kernels.addmm(arg10_1, buf357, reinterpret_tensor(arg9_1, (512, 256), (1, 512), 0), alpha=1, beta=1, out=buf358)
        del arg10_1
        del arg9_1
        buf359 = buf17; del buf17  # reuse
        # Topologically Sorted Source Nodes: [input_51], Original ATen: [aten.t, aten.addmm]
        extern_kernels.mm(buf358, reinterpret_tensor(arg11_1, (256, 256), (1, 256), 0), out=buf359)
        del arg11_1
        buf360 = buf359; del buf359  # reuse
        # Topologically Sorted Source Nodes: [input_51, input_52], Original ATen: [aten.addmm, aten.silu]
        stream0 = get_raw_stream(0)
        triton_poi_fused_addmm_silu_10.run(buf360, arg12_1, 1536, stream=stream0)
        del arg12_1
        buf361 = buf20; del buf20  # reuse
        # Topologically Sorted Source Nodes: [input_51, input_52, input_53], Original ATen: [aten.addmm, aten.silu, aten.t]
        extern_kernels.addmm(arg14_1, buf360, reinterpret_tensor(arg13_1, (256, 3200), (1, 256), 0), alpha=1, beta=1, out=buf361)
        del arg13_1
        del arg14_1
        buf362 = reinterpret_tensor(buf336, (6, 32, 4, 1024), (131072, 4096, 1024, 1), 0); del buf336  # reuse
        # Topologically Sorted Source Nodes: [x_57, x_norm_17], Original ATen: [aten.convolution, aten.native_group_norm]
        stream0 = get_raw_stream(0)
        triton_poi_fused_convolution_native_group_norm_11.run(buf346, arg27_1, buf347, buf348, buf362, 768, 1024, stream=stream0)
        del arg27_1
        ...
        extern_kernels.bmm(reinterpret_tensor(buf361, (6, 12, 128), (3200, 1, 12), 1536), reinterpret_tensor(buf362, (6, 128, 1024), (131072, 1024, 1), 0), out=buf363)
        buf364 = reinterpret_tensor(buf346, (6, 128, 1024), (131072, 1024, 1), 0); del buf346  # reuse
        # Topologically Sorted Source Nodes: [split_16, u_33, mixed_16], Original ATen: [aten.split_with_sizes, aten.view, aten.bmm]
        extern_kernels.bmm(reinterpret_tensor(buf361, (6, 128, 12), (3200, 12, 1), 0), buf363, out=buf364)
        buf365 = reinterpret_tensor(buf335, (6, 128, 32, 32), (131072, 1, 4096, 128), 0); del buf335  # reuse
        ...
        stream0 = get_raw_stream(0)
        triton_poi_fused_add_convolution_native_group_norm_silu_split_with_sizes_view_12.run(buf362, buf364, buf361, buf365, 768, 1024, stream=stream0)
        del buf362
        del buf364
        ...
        buf366 = extern_kernels.convolution(buf365, arg28_1, stride=(1, 1), padding=(0, 0), dilation=(1, 1), transposed=False, output_padding=(0, 0), groups=1, bias=None)
        assert_size_stride(buf366, (6, 128, 32, 32), (131072, 1, 4096, 128), 'torch.ops.aten.convolution.default')
        del arg28_1
        ...
        stream0 = get_raw_stream(0)
        triton_poi_fused_add_convolution_native_group_norm_silu_split_with_sizes_view_13.run(buf367, arg29_1, buf344, 786432, stream=stream0)
        del arg29_1
        buf368 = buf345; del buf345  # reuse
        # Topologically Sorted Source Nodes: [x_60], Original ATen: [aten.convolution]
        stream0 = get_raw_stream(0)
        triton_poi_fused_convolution_3.run(arg30_1, buf368, 16384, 9, stream=stream0)
        del arg30_1
        # Topologically Sorted Source Nodes: [x_60], Original ATen: [aten.convolution]
        ...
        assert_size_stride(buf369, (6, 128, 32, 32), (131072, 1, 4096, 128), 'torch.ops.aten.convolution.default')
        del buf368
        ...
        stream0 = get_raw_stream(0)
        triton_red_fused_convolution_native_group_norm_4.run(buf369, arg31_1, buf370, buf371, 192, 4096, stream=stream0)
        buf373 = buf357; del buf357  # reuse
        # Topologically Sorted Source Nodes: [linear_54], Original ATen: [aten.t, aten.mm]
        extern_kernels.mm(buf358, reinterpret_tensor(arg37_1, (256, 512), (1, 256), 0), out=buf373)
        del arg37_1
        buf374 = reinterpret_tensor(buf344, (6, 32, 4, 1024), (131072, 4096, 1024, 1), 0); del buf344  # reuse
        # Topologically Sorted Source Nodes: [x_60, x_norm_18], Original ATen: [aten.convolution, aten.native_group_norm]
        stream0 = get_raw_stream(0)
        triton_poi_fused_convolution_native_group_norm_11.run(buf369, arg31_1, buf370, buf371, buf374, 768, 1024, stream=stream0)
        del arg31_1
        ...
        extern_kernels.bmm(reinterpret_tensor(buf361, (6, 12, 128), (3200, 1, 12), 1536), reinterpret_tensor(buf374, (6, 128, 1024), (131072, 1024, 1), 0), out=buf375)
        buf376 = reinterpret_tensor(buf369, (6, 128, 1024), (131072, 1024, 1), 0); del buf369  # reuse
        # Topologically Sorted Source Nodes: [split_17, u_35, mixed_17], Original ATen: [aten.split_with_sizes, aten.view, aten.bmm]
        extern_kernels.bmm(reinterpret_tensor(buf361, (6, 128, 12), (3200, 12, 1), 0), buf375, out=buf376)
        del buf375
        ...
        stream0 = get_raw_stream(0)
        triton_poi_fused_add_convolution_native_group_norm_silu_split_with_sizes_view_12.run(buf374, buf376, buf361, buf377, 768, 1024, stream=stream0)
        del buf374
        del buf376
        ...
        buf378 = extern_kernels.convolution(buf377, arg32_1, stride=(1, 1), padding=(0, 0), dilation=(1, 1), transposed=False, output_padding=(0, 0), groups=1, bias=None)
        assert_size_stride(buf378, (6, 128, 32, 32), (131072, 1, 4096, 128), 'torch.ops.aten.convolution.default')
        del arg32_1
        del buf377
        ...
        stream0 = get_raw_stream(0)
        triton_poi_fused_add_convolution_native_group_norm_silu_split_with_sizes_view_13.run(buf379, arg33_1, buf367, 786432, stream=stream0)
        del arg33_1
        del buf367
        buf380 = buf39; del buf39  # reuse
        # Topologically Sorted Source Nodes: [h_26], Original ATen: [aten.convolution]
        stream0 = get_raw_stream(0)
        triton_poi_fused_convolution_14.run(arg34_1, buf380, 32768, 9, stream=stream0)
        del arg34_1
        # Topologically Sorted Source Nodes: [h_26], Original ATen: [aten.convolution]
        buf381 = extern_kernels.convolution(buf379, buf380, stride=(2, 2), padding=(1, 1), dilation=(1, 1), transposed=False, output_padding=(0, 0), groups=1, bias=None)
        assert_size_stride(buf381, (6, 256, 16, 16), (65536, 1, 4096, 256), 'torch.ops.aten.convolution.default')
        del buf380
        buf382 = reinterpret_tensor(buf277, (6, 256, 256), (65536, 256, 1), 0); del buf277  # reuse
        ...
        stream0 = get_raw_stream(0)
        triton_poi_fused_clone_convolution_transpose_view_15.run(buf381, arg35_1, buf382, 393216, stream=stream0)
        buf383 = reinterpret_tensor(buf255, (1536, 256), (256, 1), 0); del buf255  # reuse
        ...
        extern_kernels.mm(reinterpret_tensor(buf382, (1536, 256), (256, 1), 0), reinterpret_tensor(arg36_1, (256, 256), (1, 256), 0), out=buf383)
        del arg36_1
        buf384 = reinterpret_tensor(buf382, (6, 4, 256, 64), (65536, 16384, 64, 1), 0); del buf382  # reuse
        ...
        stream0 = get_raw_stream(0)
        triton_poi_fused__unsafe_view_clone_transpose_view_16.run(buf383, buf384, 393216, stream=stream0)
        buf385 = reinterpret_tensor(buf360, (6, 4, 64, 1), (256, 64, 1, 1), 0); del buf360  # reuse
        ...
        stream0 = get_raw_stream(0)
        triton_poi_fused_clone_split_transpose_unsqueeze_view_17.run(buf373, buf385, 1536, stream=stream0)
        buf386 = reinterpret_tensor(buf352, (24, 256, 1), (256, 1, 1), 0); del buf352  # reuse
        ...
        extern_kernels.bmm(reinterpret_tensor(buf384, (24, 256, 64), (16384, 64, 1), 0), reinterpret_tensor(buf385, (24, 64, 1), (64, 1, 0), 0), out=buf386)
        buf387 = reinterpret_tensor(buf386, (6, 4, 256, 1), (1024, 256, 1, 1), 0); del buf386  # reuse
        # Topologically Sorted Source Nodes: [matmul_20, attn_21], Original ATen: [aten.view, aten.mul, aten.amax, aten.sub, aten._softmax]
        stream0 = get_raw_stream(0)
        triton_poi_fused__softmax_amax_mul_sub_view_18.run(buf387, 6144, stream=stream0)
        buf388 = reinterpret_tensor(buf385, (6, 4, 1, 64), (256, 64, 64, 1), 0); del buf385  # reuse
        ...
        stream0 = get_raw_stream(0)
        triton_poi_fused_clone_split_transpose_unsqueeze_view_19.run(buf373, buf388, 1536, stream=stream0)
        buf389 = reinterpret_tensor(buf384, (24, 256, 64), (16384, 64, 1), 0); del buf384  # reuse
        ...
        extern_kernels.bmm(reinterpret_tensor(buf387, (24, 256, 1), (256, 1, 0), 0), reinterpret_tensor(buf388, (24, 1, 64), (64, 0, 1), 0), out=buf389)
        buf390 = reinterpret_tensor(buf383, (6, 256, 4, 64), (65536, 256, 64, 1), 0); del buf383  # reuse
        # Topologically Sorted Source Nodes: [matmul_21, transpose_90, out_60], Original ATen: [aten.view, aten.transpose, aten.clone]
        stream0 = get_raw_stream(0)
        triton_poi_fused_clone_transpose_view_20.run(buf389, buf390, 393216, stream=stream0)
        buf391 = reinterpret_tensor(buf389, (1536, 256), (256, 1), 0); del buf389  # reuse
        ...
        extern_kernels.mm(reinterpret_tensor(buf390, (1536, 256), (256, 1), 0), reinterpret_tensor(arg38_1, (256, 256), (1, 256), 0), out=buf391)
        del arg38_1
        buf392 = reinterpret_tensor(buf391, (6, 256, 16, 16), (65536, 1, 4096, 256), 0); del buf391  # reuse
        ...
        stream0 = get_raw_stream(0)
        triton_poi_fused_add_addmm_convolution_transpose_view_21.run(buf392, buf381, arg35_1, arg39_1, 393216, stream=stream0)
        del arg39_1
        buf393 = empty_strided_cuda((256, 256, 3, 3), (2304, 1, 768, 256), torch.float32)
        ...
        stream0 = get_raw_stream(0)
        triton_poi_fused_add_addmm_convolution_transpose_view_22.run(arg40_1, buf393, 65536, 9, stream=stream0)
        del arg40_1
        # Topologically Sorted Source Nodes: [h_26, input_60, transpose_91, out_61, x_63, x_64], Original ATen: [aten.convolution, aten.addmm, aten.view, aten.transpose, aten.add]
        ...
        assert_size_stride(buf394, (6, 256, 16, 16), (65536, 1, 4096, 256), 'torch.ops.aten.convolution.default')
        ...
        stream0 = get_raw_stream(0)
        triton_red_fused_add_addmm_convolution_native_group_norm_transpose_view_23.run(buf394, arg41_1, buf395, buf396, 192, 2048, stream=stream0)
        buf398 = reinterpret_tensor(buf388, (6, 256), (256, 1), 0); del buf388  # reuse
        # Topologically Sorted Source Nodes: [input_54], Original ATen: [aten.t, aten.addmm]
        extern_kernels.mm(buf358, reinterpret_tensor(arg15_1, (256, 256), (1, 256), 0), out=buf398)
        del arg15_1
        buf399 = buf398; del buf398  # reuse
        # Topologically Sorted Source Nodes: [input_54, input_55], Original ATen: [aten.addmm, aten.silu]
        stream0 = get_raw_stream(0)
        triton_poi_fused_addmm_silu_10.run(buf399, arg16_1, 1536, stream=stream0)
        del arg16_1
        buf400 = buf59; del buf59  # reuse
        # Topologically Sorted Source Nodes: [input_54, input_55, input_56], Original ATen: [aten.addmm, aten.silu, aten.t]
        extern_kernels.addmm(arg18_1, buf399, reinterpret_tensor(arg17_1, (256, 6400), (1, 256), 0), alpha=1, beta=1, out=buf400)
        del arg17_1
        del arg18_1
        buf401 = buf373; del buf373  # reuse
        # Topologically Sorted Source Nodes: [linear_57], Original ATen: [aten.t, aten.mm]
        extern_kernels.mm(buf358, reinterpret_tensor(arg45_1, (256, 512), (1, 256), 0), out=buf401)
        del arg45_1
        buf402 = reinterpret_tensor(buf392, (6, 32, 8, 256), (65536, 2048, 256, 1), 0); del buf392  # reuse
        # Topologically Sorted Source Nodes: [h_26, input_60, transpose_91, out_61, x_63, x_64, x_norm_19], Original ATen: [aten.convolution, aten.addmm, aten.view, aten.transpose, aten.add, aten.native_group_norm]
        stream0 = get_raw_stream(0)
        triton_poi_fused_add_addmm_convolution_native_group_norm_transpose_view_24.run(buf394, arg41_1, buf395, buf396, buf402, 1536, 256, stream=stream0)
        del arg41_1
        buf403 = buf273; del buf273  # reuse
        ...
        extern_kernels.bmm(reinterpret_tensor(buf400, (6, 12, 256), (6400, 1, 12), 3072), reinterpret_tensor(buf402, (6, 256, 256), (65536, 256, 1), 0), out=buf403)
        buf404 = reinterpret_tensor(buf394, (6, 256, 256), (65536, 256, 1), 0); del buf394  # reuse
        # Topologically Sorted Source Nodes: [split_18, u_37, mixed_18], Original ATen: [aten.split_with_sizes, aten.view, aten.bmm]
        extern_kernels.bmm(reinterpret_tensor(buf400, (6, 256, 12), (6400, 12, 1), 0), buf403, out=buf404)
        buf405 = reinterpret_tensor(buf390, (6, 256, 16, 16), (65536, 1, 4096, 256), 0); del buf390  # reuse
        ...
        stream0 = get_raw_stream(0)
        triton_poi_fused_add_addmm_convolution_native_group_norm_silu_split_with_sizes_transpose_view_25.run(buf402, buf404, buf400, buf405, 1536, 256, stream=stream0)
        del buf402
        ...
        buf406 = extern_kernels.convolution(buf405, arg42_1, stride=(1, 1), padding=(0, 0), dilation=(1, 1), transposed=False, output_padding=(0, 0), groups=1, bias=None)
        assert_size_stride(buf406, (6, 256, 16, 16), (65536, 1, 4096, 256), 'torch.ops.aten.convolution.default')
        del arg42_1
        buf407 = reinterpret_tensor(buf405, (6, 256, 256), (65536, 256, 1), 0); del buf405  # reuse
        ...
        stream0 = get_raw_stream(0)
        triton_poi_fused_add_addmm_clone_convolution_native_group_norm_silu_split_with_sizes_transpose_view_26.run(buf406, arg43_1, buf381, arg35_1, buf407, 393216, stream=stream0)
        buf408 = reinterpret_tensor(buf404, (1536, 256), (256, 1), 0); del buf404  # reuse
        # Topologically Sorted Source Nodes: [h_26, input_60, transpose_91, out_61, x_63, x_64, x_norm_19, split_18, x_flat_19, out_62, view_146, shift_37, out_63, x_65, x_66, add_69, h_27, view_147, q_31, q_32], Original ATen: [aten.convolution, aten.addmm, aten.view, aten.transpose, aten.add, aten.native_group_norm, aten.split_with_sizes, aten.silu, aten.clone, aten._unsafe_view, aten.t, aten.mm]
        extern_kernels.mm(reinterpret_tensor(buf407, (1536, 256), (256, 1), 0), reinterpret_tensor(arg44_1, (256, 256), (1, 256), 0), out=buf408)
        del arg44_1
        buf409 = reinterpret_tensor(buf407, (6, 4, 256, 64), (65536, 16384, 64, 1), 0); del buf407  # reuse
        ...
        stream0 = get_raw_stream(0)
        triton_poi_fused__unsafe_view_clone_transpose_view_16.run(buf408, buf409, 393216, stream=stream0)
        buf410 = reinterpret_tensor(buf399, (6, 4, 64, 1), (256, 64, 1, 1), 0); del buf399  # reuse
        ...
        stream0 = get_raw_stream(0)
        triton_poi_fused_clone_split_transpose_unsqueeze_view_17.run(buf401, buf410, 1536, stream=stream0)
        buf411 = reinterpret_tensor(buf387, (24, 256, 1), (256, 1, 1), 0); del buf387  # reuse
        ...
        extern_kernels.bmm(reinterpret_tensor(buf409, (24, 256, 64), (16384, 64, 1), 0), reinterpret_tensor(buf410, (24, 64, 1), (64, 1, 0), 0), out=buf411)
        buf412 = reinterpret_tensor(buf411, (6, 4, 256, 1), (1024, 256, 1, 1), 0); del buf411  # reuse
        # Topologically Sorted Source Nodes: [matmul_22, attn_23], Original ATen: [aten.view, aten.mul, aten.amax, aten.sub, aten._softmax]
        stream0 = get_raw_stream(0)
        triton_poi_fused__softmax_amax_mul_sub_view_18.run(buf412, 6144, stream=stream0)
        buf413 = reinterpret_tensor(buf410, (6, 4, 1, 64), (256, 64, 64, 1), 0); del buf410  # reuse
        ...
        stream0 = get_raw_stream(0)
        triton_poi_fused_clone_split_transpose_unsqueeze_view_19.run(buf401, buf413, 1536, stream=stream0)
        buf414 = reinterpret_tensor(buf409, (24, 256, 64), (16384, 64, 1), 0); del buf409  # reuse
        ...
        extern_kernels.bmm(reinterpret_tensor(buf412, (24, 256, 1), (256, 1, 0), 0), reinterpret_tensor(buf413, (24, 1, 64), (64, 0, 1), 0), out=buf414)
        buf415 = reinterpret_tensor(buf408, (6, 256, 4, 64), (65536, 256, 64, 1), 0); del buf408  # reuse
        # Topologically Sorted Source Nodes: [matmul_23, transpose_98, out_64], Original ATen: [aten.view, aten.transpose, aten.clone]
        stream0 = get_raw_stream(0)
        triton_poi_fused_clone_transpose_view_20.run(buf414, buf415, 393216, stream=stream0)
        buf416 = reinterpret_tensor(buf414, (1536, 256), (256, 1), 0); del buf414  # reuse
        ...
        extern_kernels.mm(reinterpret_tensor(buf415, (1536, 256), (256, 1), 0), reinterpret_tensor(arg46_1, (256, 256), (1, 256), 0), out=buf416)
        del arg46_1
        buf417 = reinterpret_tensor(buf416, (6, 256, 16, 16), (65536, 1, 4096, 256), 0); del buf416  # reuse
        ...
        stream0 = get_raw_stream(0)
        triton_poi_fused_add_addmm_convolution_native_group_norm_silu_split_with_sizes_transpose_view_27.run(buf417, buf406, arg43_1, buf381, arg35_1, arg47_1, 393216, stream=stream0)
        del arg47_1
        buf418 = buf393; del buf393  # reuse
        # Topologically Sorted Source Nodes: [h_26, input_60, transpose_91, out_61, x_63, x_64, x_norm_19, split_18, x_flat_19, out_62, view_146, shift_37, out_63, x_65, x_66, add_69, h_27, input_62, transpose_99, out_65, x_67, x_68], Original ATen: [aten.convolution, aten.addmm, aten.view, aten.transpose, aten.add, aten.native_group_norm, aten.split_with_sizes, aten.silu]
        stream0 = get_raw_stream(0)
        triton_poi_fused_add_addmm_convolution_transpose_view_22.run(arg48_1, buf418, 65536, 9, stream=stream0)
        del arg48_1
        # Topologically Sorted Source Nodes: [h_26, input_60, transpose_91, out_61, x_63, x_64, x_norm_19, split_18, x_flat_19, out_62, view_146, shift_37, out_63, x_65, x_66, add_69, h_27, input_62, transpose_99, out_65, x_67, x_68], Original ATen: [aten.convolution, aten.addmm, aten.view, aten.transpose, aten.add, aten.native_group_norm, aten.split_with_sizes, aten.silu]
        ...
        assert_size_stride(buf419, (6, 256, 16, 16), (65536, 1, 4096, 256), 'torch.ops.aten.convolution.default')
        del buf418
        ...
        stream0 = get_raw_stream(0)
        triton_red_fused_add_addmm_convolution_native_group_norm_transpose_view_23.run(buf419, arg49_1, buf420, buf421, 192, 2048, stream=stream0)
        buf423 = reinterpret_tensor(buf412, (6, 1024), (1024, 1), 0); del buf412  # reuse
        # Topologically Sorted Source Nodes: [linear_60], Original ATen: [aten.t, aten.mm]
        extern_kernels.mm(buf358, reinterpret_tensor(arg55_1, (256, 1024), (1, 256), 0), out=buf423)
        del arg55_1
        buf424 = reinterpret_tensor(buf417, (6, 32, 8, 256), (65536, 2048, 256, 1), 0); del buf417  # reuse
        # Topologically Sorted Source Nodes: [h_26, input_60, transpose_91, out_61, x_63, x_64, x_norm_19, split_18, x_flat_19, out_62, view_146, shift_37, out_63, x_65, x_66, add_69, h_27, input_62, transpose_99, out_65, x_67, x_68, x_norm_20], Original ATen: [aten.convolution, aten.addmm, aten.view, aten.transpose, aten.add, aten.native_group_norm, aten.split_with_sizes, aten.silu]
        stream0 = get_raw_stream(0)
        triton_poi_fused_add_addmm_convolution_native_group_norm_transpose_view_24.run(buf419, arg49_1, buf420, buf421, buf424, 1536, 256, stream=stream0)
        del arg49_1
        ...
        extern_kernels.bmm(reinterpret_tensor(buf400, (6, 12, 256), (6400, 1, 12), 3072), reinterpret_tensor(buf424, (6, 256, 256), (65536, 256, 1), 0), out=buf425)
        buf426 = reinterpret_tensor(buf419, (6, 256, 256), (65536, 256, 1), 0); del buf419  # reuse
        # Topologically Sorted Source Nodes: [split_19, u_39, mixed_19], Original ATen: [aten.split_with_sizes, aten.view, aten.bmm]
        extern_kernels.bmm(reinterpret_tensor(buf400, (6, 256, 12), (6400, 12, 1), 0), buf425, out=buf426)
        buf427 = reinterpret_tensor(buf415, (6, 256, 16, 16), (65536, 1, 4096, 256), 0); del buf415  # reuse
        ...
        stream0 = get_raw_stream(0)
        triton_poi_fused_add_addmm_convolution_native_group_norm_silu_split_with_sizes_transpose_view_25.run(buf424, buf426, buf400, buf427, 1536, 256, stream=stream0)
        del buf424
        del buf426
        # Topologically Sorted Source Nodes: [h_26, input_60, transpose_91, out_61, x_63, x_64, x_norm_19, split_18, x_flat_19, out_62, view_146, shift_37, out_63, x_65, x_66, add_69, h_27, input_62, transpose_99, out_65, x_67, x_68, x_norm_20, split_19, x_flat_20, out_66, view_156, shift_39, out_67, x_69, x_70], Original ATen: [aten.convolution, aten.addmm, aten.view, aten.transpose, aten.add, aten.native_group_norm, aten.split_with_sizes, aten.silu]
        buf428 = extern_kernels.convolution(buf427, arg50_1, stride=(1, 1), padding=(0, 0), dilation=(1, 1), transposed=False, output_padding=(0, 0), groups=1, bias=None)
        assert_size_stride(buf428, (6, 256, 16, 16), (65536, 1, 4096, 256), 'torch.ops.aten.convolution.default')
        del arg50_1
        del buf427
        ...
        stream0 = get_raw_stream(0)
        triton_poi_fused_add_addmm_convolution_native_group_norm_silu_split_with_sizes_transpose_view_28.run(buf430, arg51_1, buf406, arg43_1, buf381, arg35_1, 393216, stream=stream0)
        del arg35_1
        del arg43_1
        del arg51_1
        del buf381
        del buf406
        buf431 = empty_strided_cuda((512, 256, 3, 3), (2304, 1, 768, 256), torch.float32)
        # Topologically Sorted Source Nodes: [h_28, h_29], Original ATen: [aten.silu, aten.convolution]
        stream0 = get_raw_stream(0)
        triton_poi_fused_convolution_silu_29.run(arg52_1, buf431, 131072, 9, stream=stream0)
        del arg52_1
        # Topologically Sorted Source Nodes: [h_28, h_29], Original ATen: [aten.silu, aten.convolution]
        buf432 = extern_kernels.convolution(buf430, buf431, stride=(2, 2), padding=(1, 1), dilation=(1, 1), transposed=False, output_padding=(0, 0), groups=1, bias=None)
        assert_size_stride(buf432, (6, 512, 8, 8), (32768, 1, 4096, 512), 'torch.ops.aten.convolution.default')
        del buf431
        buf433 = empty_strided_cuda((6, 64, 512), (32768, 512, 1), torch.float32)
        ...
        stream0 = get_raw_stream(0)
        triton_poi_fused_clone_convolution_silu_transpose_view_30.run(buf432, arg53_1, buf433, 196608, stream=stream0)
        buf434 = empty_strided_cuda((384, 512), (512, 1), torch.float32)
        ...
        extern_kernels.mm(reinterpret_tensor(buf433, (384, 512), (512, 1), 0), reinterpret_tensor(arg54_1, (512, 512), (1, 512), 0), out=buf434)
        del arg54_1
        buf435 = reinterpret_tensor(buf433, (6, 8, 64, 64), (32768, 4096, 64, 1), 0); del buf433  # reuse
        ...
        stream0 = get_raw_stream(0)
        triton_poi_fused__unsafe_view_clone_transpose_view_31.run(buf434, buf435, 196608, stream=stream0)
        buf436 = reinterpret_tensor(buf401, (6, 8, 64, 1), (512, 64, 1, 1), 0); del buf401  # reuse
        ...
        stream0 = get_raw_stream(0)
        triton_poi_fused_clone_split_transpose_unsqueeze_view_32.run(buf423, buf436, 3072, stream=stream0)
        buf437 = reinterpret_tensor(buf355, (48, 64, 1), (64, 1, 1), 0); del buf355  # reuse
        ...
        extern_kernels.bmm(reinterpret_tensor(buf435, (48, 64, 64), (4096, 64, 1), 0), reinterpret_tensor(buf436, (48, 64, 1), (64, 1, 0), 0), out=buf437)
        buf438 = reinterpret_tensor(buf437, (6, 8, 64, 1), (512, 64, 1, 1), 0); del buf437  # reuse
        # Topologically Sorted Source Nodes: [matmul_24, attn_25], Original ATen: [aten.view, aten.mul, aten.amax, aten.sub, aten._softmax]
        stream0 = get_raw_stream(0)
        triton_poi_fused__softmax_amax_mul_sub_view_33.run(buf438, 3072, stream=stream0)
        buf439 = reinterpret_tensor(buf436, (6, 8, 1, 64), (512, 64, 64, 1), 0); del buf436  # reuse
        ...
        stream0 = get_raw_stream(0)
        triton_poi_fused_clone_split_transpose_unsqueeze_view_34.run(buf423, buf439, 3072, stream=stream0)
        buf440 = reinterpret_tensor(buf435, (48, 64, 64), (4096, 64, 1), 0); del buf435  # reuse
        ...
        extern_kernels.bmm(reinterpret_tensor(buf438, (48, 64, 1), (64, 1, 0), 0), reinterpret_tensor(buf439, (48, 1, 64), (64, 0, 1), 0), out=buf440)
        buf441 = reinterpret_tensor(buf434, (6, 64, 8, 64), (32768, 512, 64, 1), 0); del buf434  # reuse
        # Topologically Sorted Source Nodes: [matmul_25, transpose_106, out_68], Original ATen: [aten.view, aten.transpose, aten.clone]
        stream0 = get_raw_stream(0)
        triton_poi_fused_clone_transpose_view_35.run(buf440, buf441, 196608, stream=stream0)
        buf442 = reinterpret_tensor(buf440, (384, 512), (512, 1), 0); del buf440  # reuse
        ...
        extern_kernels.mm(reinterpret_tensor(buf441, (384, 512), (512, 1), 0), reinterpret_tensor(arg56_1, (512, 512), (1, 512), 0), out=buf442)
        del arg56_1
        buf443 = reinterpret_tensor(buf442, (6, 512, 8, 8), (32768, 1, 4096, 512), 0); del buf442  # reuse
        ...
        stream0 = get_raw_stream(0)
        triton_poi_fused_add_addmm_convolution_silu_transpose_view_36.run(buf443, buf432, arg53_1, arg57_1, 196608, stream=stream0)
        del arg57_1
        buf444 = empty_strided_cuda((512, 512, 3, 3), (4608, 1, 1536, 512), torch.float32)
        ...
        stream0 = get_raw_stream(0)
        triton_poi_fused_add_addmm_convolution_silu_transpose_view_37.run(arg58_1, buf444, 262144, 9, stream=stream0)
        del arg58_1
        # Topologically Sorted Source Nodes: [h_28, h_29, input_64, transpose_107, out_69, x_71, x_72], Original ATen: [aten.silu, aten.convolution, aten.addmm, aten.view, aten.transpose, aten.add]
        ...
        assert_size_stride(buf445, (6, 512, 8, 8), (32768, 1, 4096, 512), 'torch.ops.aten.convolution.default')
        ...
        stream0 = get_raw_stream(0)
        triton_per_fused_add_addmm_convolution_native_group_norm_silu_transpose_view_38.run(buf445, arg59_1, buf446, buf447, 192, 1024, stream=stream0)
        buf449 = reinterpret_tensor(buf413, (6, 256), (256, 1), 0); del buf413  # reuse
        # Topologically Sorted Source Nodes: [input_57], Original ATen: [aten.t, aten.addmm]
        extern_kernels.mm(buf358, reinterpret_tensor(arg19_1, (256, 256), (1, 256), 0), out=buf449)
        del arg19_1
        buf450 = buf449; del buf449  # reuse
        # Topologically Sorted Source Nodes: [input_57, input_58], Original ATen: [aten.addmm, aten.silu]
        stream0 = get_raw_stream(0)
        triton_poi_fused_addmm_silu_10.run(buf450, arg20_1, 1536, stream=stream0)
        del arg20_1
        buf451 = buf110; del buf110  # reuse
        # Topologically Sorted Source Nodes: [input_57, input_58, input_59], Original ATen: [aten.addmm, aten.silu, aten.t]
        extern_kernels.addmm(arg22_1, buf450, reinterpret_tensor(arg21_1, (256, 12800), (1, 256), 0), alpha=1, beta=1, out=buf451)
        del arg21_1
        del arg22_1
        buf452 = buf423; del buf423  # reuse
        # Topologically Sorted Source Nodes: [linear_63], Original ATen: [aten.t, aten.mm]
        extern_kernels.mm(buf358, reinterpret_tensor(arg63_1, (256, 1024), (1, 256), 0), out=buf452)
        del arg63_1
        buf453 = reinterpret_tensor(buf443, (6, 32, 16, 64), (32768, 1024, 64, 1), 0); del buf443  # reuse
        # Topologically Sorted Source Nodes: [h_28, h_29, input_64, transpose_107, out_69, x_71, x_72, x_norm_21], Original ATen: [aten.silu, aten.convolution, aten.addmm, aten.view, aten.transpose, aten.add, aten.native_group_norm]
        stream0 = get_raw_stream(0)
        triton_poi_fused_add_addmm_convolution_native_group_norm_silu_transpose_view_39.run(buf445, arg59_1, buf446, buf447, buf453, 3072, 64, stream=stream0)
        del arg59_1
        buf454 = reinterpret_tensor(buf342, (6, 12, 64), (768, 64, 1), 0); del buf342  # reuse
        ...
        extern_kernels.bmm(reinterpret_tensor(buf451, (6, 12, 512), (12800, 1, 12), 6144), reinterpret_tensor(buf453, (6, 512, 64), (32768, 64, 1), 0), out=buf454)
        buf455 = reinterpret_tensor(buf445, (6, 512, 64), (32768, 64, 1), 0); del buf445  # reuse
        # Topologically Sorted Source Nodes: [split_20, u_41, mixed_20], Original ATen: [aten.split_with_sizes, aten.view, aten.bmm]
        extern_kernels.bmm(reinterpret_tensor(buf451, (6, 512, 12), (12800, 12, 1), 0), buf454, out=buf455)
        buf456 = reinterpret_tensor(buf441, (6, 512, 8, 8), (32768, 1, 4096, 512), 0); del buf441  # reuse
        ...
        stream0 = get_raw_stream(0)
        triton_poi_fused_add_addmm_convolution_native_group_norm_silu_split_with_sizes_transpose_view_40.run(buf453, buf455, buf451, buf456, 3072, 64, stream=stream0)
        del buf453
        ...
        buf457 = extern_kernels.convolution(buf456, arg60_1, stride=(1, 1), padding=(0, 0), dilation=(1, 1), transposed=False, output_padding=(0, 0), groups=1, bias=None)
        assert_size_stride(buf457, (6, 512, 8, 8), (32768, 1, 4096, 512), 'torch.ops.aten.convolution.default')
        del arg60_1
        buf458 = reinterpret_tensor(buf456, (6, 64, 512), (32768, 512, 1), 0); del buf456  # reuse
        ...
        stream0 = get_raw_stream(0)
        triton_poi_fused_add_addmm_clone_convolution_native_group_norm_silu_split_with_sizes_transpose_view_41.run(buf457, arg61_1, buf432, arg53_1, buf458, 196608, stream=stream0)
        buf459 = reinterpret_tensor(buf455, (384, 512), (512, 1), 0); del buf455  # reuse
        # Topologically Sorted Source Nodes: [h_28, h_29, input_64, transpose_107, out_69, x_71, x_72, x_norm_21, split_20, x_flat_21, out_70, view_166, shift_41, out_71, x_73, x_74, add_77, h_30, view_167, q_37, q_38], Original ATen: [aten.silu, aten.convolution, aten.addmm, aten.view, aten.transpose, aten.add, aten.native_group_norm, aten.split_with_sizes, aten.clone, aten._unsafe_view, aten.t, aten.mm]
        extern_kernels.mm(reinterpret_tensor(buf458, (384, 512), (512, 1), 0), reinterpret_tensor(arg62_1, (512, 512), (1, 512), 0), out=buf459)
        del arg62_1
        buf460 = reinterpret_tensor(buf458, (6, 8, 64, 64), (32768, 4096, 64, 1), 0); del buf458  # reuse
        ...
        stream0 = get_raw_stream(0)
        triton_poi_fused__unsafe_view_clone_transpose_view_31.run(buf459, buf460, 196608, stream=stream0)
        buf461 = reinterpret_tensor(buf439, (6, 8, 64, 1), (512, 64, 1, 1), 0); del buf439  # reuse
        ...
        stream0 = get_raw_stream(0)
        triton_poi_fused_clone_split_transpose_unsqueeze_view_32.run(buf452, buf461, 3072, stream=stream0)
        buf462 = reinterpret_tensor(buf438, (48, 64, 1), (64, 1, 1), 0); del buf438  # reuse
        ...
        extern_kernels.bmm(reinterpret_tensor(buf460, (48, 64, 64), (4096, 64, 1), 0), reinterpret_tensor(buf461, (48, 64, 1), (64, 1, 0), 0), out=buf462)
        buf463 = reinterpret_tensor(buf462, (6, 8, 64, 1), (512, 64, 1, 1), 0); del buf462  # reuse
        # Topologically Sorted Source Nodes: [matmul_26, attn_27], Original ATen: [aten.view, aten.mul, aten.amax, aten.sub, aten._softmax]
        stream0 = get_raw_stream(0)
        triton_poi_fused__softmax_amax_mul_sub_view_33.run(buf463, 3072, stream=stream0)
        buf464 = reinterpret_tensor(buf461, (6, 8, 1, 64), (512, 64, 64, 1), 0); del buf461  # reuse
        ...
        stream0 = get_raw_stream(0)
        triton_poi_fused_clone_split_transpose_unsqueeze_view_34.run(buf452, buf464, 3072, stream=stream0)
        buf465 = reinterpret_tensor(buf460, (48, 64, 64), (4096, 64, 1), 0); del buf460  # reuse
        ...
        extern_kernels.bmm(reinterpret_tensor(buf463, (48, 64, 1), (64, 1, 0), 0), reinterpret_tensor(buf464, (48, 1, 64), (64, 0, 1), 0), out=buf465)
        del buf463
        buf466 = reinterpret_tensor(buf459, (6, 64, 8, 64), (32768, 512, 64, 1), 0); del buf459  # reuse
        # Topologically Sorted Source Nodes: [matmul_27, transpose_114, out_72], Original ATen: [aten.view, aten.transpose, aten.clone]
        stream0 = get_raw_stream(0)
        triton_poi_fused_clone_transpose_view_35.run(buf465, buf466, 196608, stream=stream0)
        buf467 = reinterpret_tensor(buf465, (384, 512), (512, 1), 0); del buf465  # reuse
        ...
        extern_kernels.mm(reinterpret_tensor(buf466, (384, 512), (512, 1), 0), reinterpret_tensor(arg64_1, (512, 512), (1, 512), 0), out=buf467)
        del arg64_1
        buf468 = reinterpret_tensor(buf467, (6, 512, 8, 8), (32768, 1, 4096, 512), 0); del buf467  # reuse
        ...
        stream0 = get_raw_stream(0)
        triton_poi_fused_add_addmm_convolution_native_group_norm_silu_split_with_sizes_transpose_view_42.run(buf468, buf457, arg61_1, buf432, arg53_1, arg65_1, 196608, stream=stream0)
        del arg65_1
        ...
        stream0 = get_raw_stream(0)
        triton_poi_fused_add_addmm_convolution_silu_transpose_view_37.run(arg66_1, buf469, 262144, 9, stream=stream0)
        del arg66_1
        # Topologically Sorted Source Nodes: [h_28, h_29, input_64, transpose_107, out_69, x_71, x_72, x_norm_21, split_20, x_flat_21, out_70, view_166, shift_41, out_71, x_73, x_74, add_77, h_30, input_66, transpose_115, out_73, x_75, x_76], Original ATen: [aten.silu, aten.convolution, aten.addmm, aten.view, aten.transpose, aten.add, aten.native_group_norm, aten.split_with_sizes]
        buf470 = extern_kernels.convolution(buf468, buf469, stride=(1, 1), padding=(1, 1), dilation=(1, 1), transposed=False, output_padding=(0, 0), groups=1, bias=None)
        assert_size_stride(buf470, (6, 512, 8, 8), (32768, 1, 4096, 512), 'torch.ops.aten.convolution.default')
        del buf469
        ...
        stream0 = get_raw_stream(0)
        triton_per_fused_add_addmm_convolution_native_group_norm_silu_transpose_view_38.run(buf470, arg67_1, buf471, buf472, 192, 1024, stream=stream0)
        buf474 = reinterpret_tensor(buf468, (6, 32, 16, 64), (32768, 1024, 64, 1), 0); del buf468  # reuse
        # Topologically Sorted Source Nodes: [h_28, h_29, input_64, transpose_107, out_69, x_71, x_72, x_norm_21, split_20, x_flat_21, out_70, view_166, shift_41, out_71, x_73, x_74, add_77, h_30, input_66, transpose_115, out_73, x_75, x_76, x_norm_22], Original ATen: [aten.silu, aten.convolution, aten.addmm, aten.view, aten.transpose, aten.add, aten.native_group_norm, aten.split_with_sizes]
        stream0 = get_raw_stream(0)
        triton_poi_fused_add_addmm_convolution_native_group_norm_silu_transpose_view_39.run(buf470, arg67_1, buf471, buf472, buf474, 3072, 64, stream=stream0)
        del arg67_1
        ...
        extern_kernels.bmm(reinterpret_tensor(buf451, (6, 12, 512), (12800, 1, 12), 6144), reinterpret_tensor(buf474, (6, 512, 64), (32768, 64, 1), 0), out=buf475)
        buf476 = reinterpret_tensor(buf470, (6, 512, 64), (32768, 64, 1), 0); del buf470  # reuse
        # Topologically Sorted Source Nodes: [split_21, u_43, mixed_21], Original ATen: [aten.split_with_sizes, aten.view, aten.bmm]
        extern_kernels.bmm(reinterpret_tensor(buf451, (6, 512, 12), (12800, 12, 1), 0), buf475, out=buf476)
        del buf475
        buf477 = reinterpret_tensor(buf466, (6, 512, 8, 8), (32768, 1, 4096, 512), 0); del buf466  # reuse
        ...
        stream0 = get_raw_stream(0)
        triton_poi_fused_add_addmm_convolution_native_group_norm_silu_split_with_sizes_transpose_view_40.run(buf474, buf476, buf451, buf477, 3072, 64, stream=stream0)
        del buf451
        del buf474
        del buf476
        ...
        buf478 = extern_kernels.convolution(buf477, arg68_1, stride=(1, 1), padding=(0, 0), dilation=(1, 1), transposed=False, output_padding=(0, 0), groups=1, bias=None)
        assert_size_stride(buf478, (6, 512, 8, 8), (32768, 1, 4096, 512), 'torch.ops.aten.convolution.default')
        del arg68_1
        buf479 = buf478; del buf478  # reuse
        buf483 = reinterpret_tensor(buf477, (6, 64, 512), (32768, 512, 1), 0); del buf477  # reuse
        ...
        stream0 = get_raw_stream(0)
        triton_per_fused_add_addmm_convolution_native_group_norm_native_layer_norm_silu_split_with_sizes_transpose_view_43.run(buf479, arg69_1, buf457, arg61_1, buf432, arg53_1, arg70_1, arg71_1, buf483, 384, 512, stream=stream0)
        del arg53_1
        del arg61_1
        del arg69_1
        del arg70_1
        del arg71_1
        buf484 = empty_strided_cuda((384, 1536), (1536, 1), torch.float32)
        ...
        extern_kernels.mm(reinterpret_tensor(buf483, (384, 512), (512, 1), 0), reinterpret_tensor(arg72_1, (512, 1536), (1, 512), 0), out=buf484)
        del arg72_1
        buf485 = reinterpret_tensor(buf483, (6, 8, 64, 64), (32768, 4096, 64, 1), 0); del buf483  # reuse
        ...
        stream0 = get_raw_stream(0)
        triton_poi_fused_addmm_clone_permute_select_view_44.run(buf484, arg73_1, buf485, 196608, stream=stream0)
        buf486 = reinterpret_tensor(buf457, (6, 8, 64, 64), (32768, 4096, 64, 1), 0); del buf457  # reuse
        ...
        stream0 = get_raw_stream(0)
        triton_poi_fused_addmm_clone_permute_select_transpose_view_45.run(buf484, arg73_1, buf486, 3072, 64, stream=stream0)
        buf487 = reinterpret_tensor(buf432, (48, 64, 64), (4096, 64, 1), 0); del buf432  # reuse
        ...
        extern_kernels.bmm(reinterpret_tensor(buf485, (48, 64, 64), (4096, 64, 1), 0), reinterpret_tensor(buf486, (48, 64, 64), (4096, 64, 1), 0), out=buf487)
        buf490 = reinterpret_tensor(buf487, (6, 8, 64, 64), (32768, 4096, 64, 1), 0); del buf487  # reuse
        # Topologically Sorted Source Nodes: [matmul_28, attn_29], Original ATen: [aten.view, aten.mul, aten.amax, aten.sub, aten._softmax]
        stream0 = get_raw_stream(0)
        triton_per_fused__softmax_amax_mul_sub_view_46.run(buf490, 3072, 64, stream=stream0)
        ...
        stream0 = get_raw_stream(0)
        triton_poi_fused_addmm_clone_permute_select_view_47.run(buf484, arg73_1, buf491, 196608, stream=stream0)
        del arg73_1
        buf492 = reinterpret_tensor(buf485, (48, 64, 64), (4096, 64, 1), 0); del buf485  # reuse
        ...
        extern_kernels.bmm(reinterpret_tensor(buf490, (48, 64, 64), (4096, 64, 1), 0), reinterpret_tensor(buf491, (48, 64, 64), (4096, 64, 1), 0), out=buf492)
        del buf490
        buf493 = reinterpret_tensor(buf491, (6, 64, 8, 64), (32768, 512, 64, 1), 0); del buf491  # reuse
        # Topologically Sorted Source Nodes: [out_76, transpose_119, out_77], Original ATen: [aten.view, aten.transpose, aten.clone]
        stream0 = get_raw_stream(0)
        triton_poi_fused_clone_transpose_view_35.run(buf492, buf493, 196608, stream=stream0)
        buf494 = reinterpret_tensor(buf492, (384, 512), (512, 1), 0); del buf492  # reuse
        ...
        extern_kernels.mm(reinterpret_tensor(buf493, (384, 512), (512, 1), 0), reinterpret_tensor(arg74_1, (512, 512), (1, 512), 0), out=buf494)
        del arg74_1
        del buf493
        buf499 = reinterpret_tensor(buf479, (6, 64, 512), (32768, 512, 1), 0); del buf479  # reuse
        ...
        stream0 = get_raw_stream(0)
        triton_per_fused_add_addmm_native_layer_norm_silu_transpose_view_48.run(buf499, buf494, arg75_1, arg76_1, arg77_1, 384, 512, stream=stream0)
        del arg75_1
        del arg76_1
        del arg77_1
        del buf494
        buf498 = reinterpret_tensor(buf464, (6, 512), (512, 1), 0); del buf464  # reuse
        # Topologically Sorted Source Nodes: [linear_70], Original ATen: [aten.t, aten.mm]
        extern_kernels.mm(buf358, reinterpret_tensor(arg85_1, (256, 512), (1, 256), 0), out=buf498)
        del arg85_1
        buf500 = empty_strided_cuda((512, 256, 4, 4), (4096, 1, 1024, 256), torch.float32)
        ...
        stream0 = get_raw_stream(0)
        triton_poi_fused_add_addmm_convolution_native_layer_norm_silu_transpose_view_49.run(arg78_1, buf500, 131072, 16, stream=stream0)
        del arg78_1
        # Topologically Sorted Source Nodes: [h_31, view_177, x_flat_23, out_78, out_79, out_80, transpose_120, out_81, h_32], Original ATen: [aten.silu, aten.view, aten.transpose, aten.addmm, aten.add, aten.native_layer_norm, aten.convolution]
        buf501 = extern_kernels.convolution(reinterpret_tensor(buf499, (6, 512, 8, 8), (32768, 1, 4096, 512), 0), buf500, stride=(2, 2), padding=(1, 1), dilation=(1, 1), transposed=True, output_padding=(0, 0), groups=1, bias=None)
        assert_size_stride(buf501, (6, 256, 16, 16), (65536, 1, 4096, 256), 'torch.ops.aten.convolution.default')
        del buf499
        del buf500
        buf502 = buf450; del buf450  # reuse
        # Topologically Sorted Source Nodes: [input_68], Original ATen: [aten.t, aten.addmm]
        extern_kernels.mm(buf358, reinterpret_tensor(arg80_1, (256, 256), (1, 256), 0), out=buf502)
        del arg80_1
        buf503 = buf502; del buf502  # reuse
        # Topologically Sorted Source Nodes: [input_68, input_69], Original ATen: [aten.addmm, aten.silu]
        stream0 = get_raw_stream(0)
        triton_poi_fused_addmm_silu_10.run(buf503, arg81_1, 1536, stream=stream0)
        del arg81_1
        buf504 = buf354; del buf354  # reuse
        # Topologically Sorted Source Nodes: [input_68, input_69, input_70], Original ATen: [aten.addmm, aten.silu]
        stream0 = get_raw_stream(0)
        triton_poi_fused_addmm_silu_50.run(buf503, buf504, 2048, stream=stream0)
        ...
        stream0 = get_raw_stream(0)
        triton_poi_fused_add_addmm_convolution_mul_native_layer_norm_sigmoid_silu_transpose_unsqueeze_view_51.run(buf501, arg79_1, buf430, buf505, arg83_1, buf506, 1536, 256, stream=stream0)
        del arg79_1
        del arg83_1
        del buf505
        buf507 = reinterpret_tensor(buf501, (1536, 256), (1, 1536), 0); del buf501  # reuse
        # Topologically Sorted Source Nodes: [view_179, q_41, q_42], Original ATen: [aten.view, aten.transpose, aten.t, aten.mm]
        stream0 = get_raw_stream(0)
        triton_poi_fused_mm_t_transpose_view_52.run(buf506, buf507, 393216, stream=stream0)
        buf508 = reinterpret_tensor(buf430, (1536, 256), (256, 1), 0); del buf430  # reuse
        # Topologically Sorted Source Nodes: [view_179, q_41, q_42], Original ATen: [aten.view, aten.transpose, aten.t, aten.mm]
        ...
        buf510 = reinterpret_tensor(buf503, (6, 4, 64, 1), (256, 64, 1, 1), 0); del buf503  # reuse
        ...
        stream0 = get_raw_stream(0)
        triton_poi_fused_clone_split_transpose_unsqueeze_view_17.run(buf498, buf510, 1536, stream=stream0)
        buf511 = reinterpret_tensor(buf452, (24, 256, 1), (256, 1, 1), 0); del buf452  # reuse
        ...
        stream0 = get_raw_stream(0)
        triton_poi_fused_clone_split_transpose_unsqueeze_view_19.run(buf498, buf513, 1536, stream=stream0)
        ...
        stream0 = get_raw_stream(0)
        triton_poi_fused_add_addmm_transpose_view_53.run(buf517, buf506, arg87_1, 1536, 256, stream=stream0)
        del arg87_1
        buf518 = reinterpret_tensor(buf484, (256, 256, 3, 3), (2304, 1, 768, 256), 0); del buf484  # reuse
        ...
        buf520 = buf472; del buf472  # reuse
        buf521 = buf471; del buf471  # reuse
        ...
        buf523 = buf498; del buf498  # reuse
        # Topologically Sorted Source Nodes: [linear_73], Original ATen: [aten.t, aten.mm]
        extern_kernels.mm(buf358, reinterpret_tensor(arg93_1, (256, 512), (1, 256), 0), out=buf523)
        del arg93_1
        ...
        del arg89_1
        buf525 = buf425; del buf425  # reuse
        ...
        extern_kernels.bmm(reinterpret_tensor(buf400, (6, 12, 256), (6400, 1, 12), 3072), reinterpret_tensor(buf524, (6, 256, 256), (65536, 256, 1), 0), out=buf525)
        ...
        extern_kernels.bmm(reinterpret_tensor(buf400, (6, 256, 12), (6400, 12, 1), 0), buf525, out=buf526)
        ...
        stream0 = get_raw_stream(0)
        triton_poi_fused_add_addmm_convolution_native_group_norm_silu_split_with_sizes_transpose_view_25.run(buf524, buf526, buf400, buf527, 1536, 256, stream=stream0)
        del buf524
        ...
        stream0 = get_raw_stream(0)
        triton_poi_fused_add_addmm_clone_convolution_native_group_norm_silu_split_with_sizes_transpose_view_54.run(buf528, arg91_1, buf506, buf529, 1536, 256, stream=stream0)
        ...
        stream0 = get_raw_stream(0)
        triton_poi_fused_add_addmm_clone_convolution_native_group_norm_silu_split_with_sizes_transpose_view_55.run(buf539, buf528, arg91_1, buf506, arg95_1, 1536, 256, stream=stream0)
        del arg95_1
        ...
        extern_kernels.mm(buf358, reinterpret_tensor(arg101_1, (256, 512), (1, 256), 0), out=buf545)
        del arg101_1
        ...
        extern_kernels.bmm(reinterpret_tensor(buf400, (6, 12, 256), (6400, 1, 12), 3072), reinterpret_tensor(buf546, (6, 256, 256), (65536, 256, 1), 0), out=buf547)
        ...
        extern_kernels.bmm(reinterpret_tensor(buf400, (6, 256, 12), (6400, 12, 1), 0), buf547, out=buf548)
        ...
        stream0 = get_raw_stream(0)
        triton_poi_fused_add_addmm_convolution_native_group_norm_silu_split_with_sizes_transpose_view_25.run(buf546, buf548, buf400, buf549, 1536, 256, stream=stream0)
        del buf546
        del buf548
        ...
        stream0 = get_raw_stream(0)
        triton_poi_fused_add_addmm_clone_convolution_native_group_norm_silu_split_with_sizes_transpose_view_56.run(buf551, arg99_1, buf528, arg91_1, buf506, buf552, 393216, stream=stream0)
        del arg91_1
        del arg99_1
        del buf506
        ...
        stream0 = get_raw_stream(0)
        triton_poi_fused_add_addmm_silu_transpose_view_57.run(buf562, buf551, arg103_1, 393216, stream=stream0)
        del arg103_1
        ...
        extern_kernels.mm(buf358, reinterpret_tensor(arg109_1, (256, 512), (1, 256), 0), out=buf568)
        del arg109_1
        ...
        extern_kernels.bmm(reinterpret_tensor(buf400, (6, 12, 256), (6400, 1, 12), 3072), reinterpret_tensor(buf569, (6, 256, 256), (65536, 256, 1), 0), out=buf570)
        ...
        extern_kernels.bmm(reinterpret_tensor(buf400, (6, 256, 12), (6400, 12, 1), 0), buf570, out=buf571)
        ...
        stream0 = get_raw_stream(0)
        triton_poi_fused_add_addmm_convolution_native_group_norm_silu_split_with_sizes_transpose_view_25.run(buf569, buf571, buf400, buf572, 1536, 256, stream=stream0)
        del buf569
        ...
        stream0 = get_raw_stream(0)
        triton_poi_fused_add_addmm_clone_convolution_native_group_norm_silu_split_with_sizes_transpose_view_58.run(buf573, arg107_1, buf551, buf574, 393216, stream=stream0)
        ...
        stream0 = get_raw_stream(0)
        triton_poi_fused_add_addmm_convolution_native_group_norm_silu_split_with_sizes_transpose_view_59.run(buf584, buf573, arg107_1, buf551, arg111_1, 393216, stream=stream0)
        del arg111_1
        ...
        extern_kernels.mm(buf358, reinterpret_tensor(arg117_1, (256, 512), (1, 256), 0), out=buf590)
        del arg117_1
        ...
        extern_kernels.bmm(reinterpret_tensor(buf400, (6, 12, 256), (6400, 1, 12), 3072), reinterpret_tensor(buf591, (6, 256, 256), (65536, 256, 1), 0), out=buf592)
        ...
        extern_kernels.bmm(reinterpret_tensor(buf400, (6, 256, 12), (6400, 12, 1), 0), buf592, out=buf593)
        ...
        stream0 = get_raw_stream(0)
        triton_poi_fused_add_addmm_convolution_native_group_norm_silu_split_with_sizes_transpose_view_25.run(buf591, buf593, buf400, buf594, 1536, 256, stream=stream0)
        del buf591
        del buf593
        ...
        stream0 = get_raw_stream(0)
        triton_poi_fused_add_addmm_clone_convolution_native_group_norm_silu_split_with_sizes_transpose_view_60.run(buf596, arg115_1, buf573, arg107_1, buf551, buf597, 393216, stream=stream0)
        del arg107_1
        del arg115_1
        del buf551
        ...
        stream0 = get_raw_stream(0)
        triton_poi_fused_add_addmm_silu_transpose_view_57.run(buf607, buf596, arg119_1, 393216, stream=stream0)
        del arg119_1
        ...
        extern_kernels.bmm(reinterpret_tensor(buf400, (6, 12, 256), (6400, 1, 12), 3072), reinterpret_tensor(buf613, (6, 256, 256), (65536, 256, 1), 0), out=buf614)
        ...
        extern_kernels.bmm(reinterpret_tensor(buf400, (6, 256, 12), (6400, 12, 1), 0), buf614, out=buf615)
        del buf614
        ...
        stream0 = get_raw_stream(0)
        triton_poi_fused_add_addmm_convolution_native_group_norm_silu_split_with_sizes_transpose_view_25.run(buf613, buf615, buf400, buf616, 1536, 256, stream=stream0)
        del buf400
        del buf613
        del buf615
        ...
        stream0 = get_raw_stream(0)
        triton_poi_fused_add_addmm_convolution_native_group_norm_silu_split_with_sizes_transpose_view_61.run(buf618, arg123_1, buf596, 393216, stream=stream0)
        del arg123_1
        del buf596
        ...
        stream0 = get_raw_stream(0)
        triton_poi_fused_add_addmm_convolution_native_group_norm_silu_split_with_sizes_transpose_view_62.run(arg124_1, buf619, 32768, 16, stream=stream0)
        del arg124_1
        # Topologically Sorted Source Nodes: [h_37, input_80, transpose_159, out_99, x_95, x_96, x_norm_28, split_26, x_flat_28, out_100, view_228, shift_53, out_101, x_97, x_98, add_103, h_38, h_39], Original ATen: [aten.silu, aten.addmm, aten.view, aten.transpose, aten.add, aten.convolution, aten.native_group_norm, aten.split_with_sizes]
        ...
        extern_kernels.mm(buf358, reinterpret_tensor(arg126_1, (256, 256), (1, 256), 0), out=buf621)
        del arg126_1
        del buf358
        ...
        stream0 = get_raw_stream(0)
        triton_poi_fused_add_addmm_convolution_mul_native_group_norm_sigmoid_silu_split_with_sizes_transpose_unsqueeze_view_63.run(buf624, arg125_1, buf379, buf623, arg129_1, 786432, stream=stream0)
        del arg125_1
        del arg129_1
        del buf623
        ...
        buf630 = reinterpret_tensor(buf379, (6, 32, 4, 1024), (131072, 4096, 1024, 1), 0); del buf379  # reuse
        # Topologically Sorted Source Nodes: [x_99, x_norm_29], Original ATen: [aten.convolution, aten.native_group_norm]
        stream0 = get_raw_stream(0)
        ...
        extern_kernels.bmm(reinterpret_tensor(buf361, (6, 12, 128), (3200, 1, 12), 1536), reinterpret_tensor(buf630, (6, 128, 1024), (131072, 1024, 1), 0), out=buf631)
        ...
        extern_kernels.bmm(reinterpret_tensor(buf361, (6, 128, 12), (3200, 12, 1), 0), buf631, out=buf632)
        ...
        stream0 = get_raw_stream(0)
        triton_poi_fused_add_convolution_native_group_norm_silu_split_with_sizes_view_12.run(buf630, buf632, buf361, buf633, 768, 1024, stream=stream0)
        del buf630
        del buf632
        ...
        extern_kernels.bmm(reinterpret_tensor(buf361, (6, 12, 128), (3200, 1, 12), 1536), reinterpret_tensor(buf641, (6, 128, 1024), (131072, 1024, 1), 0), out=buf642)
        ...
        extern_kernels.bmm(reinterpret_tensor(buf361, (6, 128, 12), (3200, 12, 1), 0), buf642, out=buf643)
        ...
        stream0 = get_raw_stream(0)
        triton_poi_fused_add_convolution_native_group_norm_silu_split_with_sizes_view_12.run(buf641, buf643, buf361, buf644, 768, 1024, stream=stream0)
        del buf641
        del buf643
        ...
        extern_kernels.bmm(reinterpret_tensor(buf361, (6, 12, 128), (3200, 1, 12), 1536), reinterpret_tensor(buf652, (6, 128, 1024), (131072, 1024, 1), 0), out=buf653)
        ...
        extern_kernels.bmm(reinterpret_tensor(buf361, (6, 128, 12), (3200, 12, 1), 0), buf653, out=buf654)
        ...
        stream0 = get_raw_stream(0)
        triton_poi_fused_add_convolution_native_group_norm_silu_split_with_sizes_view_12.run(buf652, buf654, buf361, buf655, 768, 1024, stream=stream0)
        del buf652
        del buf654
        ...
        extern_kernels.bmm(reinterpret_tensor(buf361, (6, 12, 128), (3200, 1, 12), 1536), reinterpret_tensor(buf663, (6, 128, 1024), (131072, 1024, 1), 0), out=buf664)
        ...
        extern_kernels.bmm(reinterpret_tensor(buf361, (6, 128, 12), (3200, 12, 1), 0), buf664, out=buf665)
        ...
        stream0 = get_raw_stream(0)
        triton_poi_fused_add_convolution_native_group_norm_silu_split_with_sizes_view_12.run(buf663, buf665, buf361, buf666, 768, 1024, stream=stream0)
        del buf663
        del buf665
        ...
        extern_kernels.bmm(reinterpret_tensor(buf361, (6, 12, 128), (3200, 1, 12), 1536), reinterpret_tensor(buf674, (6, 128, 1024), (131072, 1024, 1), 0), out=buf675)
        ...
        extern_kernels.bmm(reinterpret_tensor(buf361, (6, 128, 12), (3200, 12, 1), 0), buf675, out=buf676)
        del buf675
        ...
        stream0 = get_raw_stream(0)
        triton_poi_fused_add_convolution_native_group_norm_silu_split_with_sizes_view_12.run(buf674, buf676, buf361, buf677, 768, 1024, stream=stream0)
        del buf361
        del buf674
        del buf676
        ...
        stream0 = get_raw_stream(0)
        triton_red_fused_add_convolution_native_group_norm_silu_split_with_sizes_view_64.run(buf678, arg149_1, buf668, buf679, buf680, 192, 4096, stream=stream0)
        buf682 = empty_strided_cuda((6, ), (1, ), torch.float32)
        # Topologically Sorted Source Nodes: [lt, zeros_like, full_like, sigma], Original ATen: [aten.lt, aten.zeros_like, aten.full_like, aten.where]
        stream0 = get_raw_stream(0)
        triton_poi_fused_full_like_lt_where_zeros_like_66.run(arg0_1, buf682, 6, stream=stream0)
        del arg0_1
        ...
        # Topologically Sorted Source Nodes: [x_54, x_norm_16, split_15, x_flat_16, out_54, view_126, shift_31, out_55, x_55, x_56, add_59, h_22, input_42, x_111, x_norm_33, split_31, x_flat_33, out_110, view_253, shift_63, out_111, x_112, x_113, add_119, h_45, input_86, input_43, input_87], Original ATen: [aten.convolution, aten.native_group_norm, aten.split_with_sizes, aten.view, aten.add, aten.silu]
        stream0 = get_raw_stream(0)
        triton_poi_fused_add_convolution_native_group_norm_silu_split_with_sizes_view_67.run(buf684, buf691, arg149_1, buf327, buf338, buf339, arg150_1, arg151_1, buf668, buf679, buf680, 786432, stream=stream0)
        del arg149_1
        del arg150_1
        del arg151_1
        del buf327
        ...
        # Topologically Sorted Source Nodes: [input_43, input_44, input_87, input_88], Original ATen: [aten.silu, aten.convolution]
        stream0 = get_raw_stream(0)
        triton_poi_fused_convolution_silu_68.run(arg152_1, buf685, buf692, 512, 9, stream=stream0)
        del arg152_1
        ...
        del buf691
        del buf692
        buf688 = empty_strided_cuda((6, 1, 1, 1), (1, 6, 6, 6), torch.float32)
        buf695 = empty_strided_cuda((6, 1, 1, 1), (1, 6, 6, 6), torch.float32)
        # Topologically Sorted Source Nodes: [input_43, input_44, std_target, input_87, input_88, sub_1, v_pred, std_pred], Original ATen: [aten.silu, aten.convolution, aten.std, aten.sub, aten.add]
        stream0 = get_raw_stream(0)
        triton_red_fused_add_convolution_silu_std_sub_69.run(buf686, arg153_1, buf693, buf688, buf695, s57, 6, 4096, stream=stream0)
        buf698 = empty_strided_cuda((6, 4, 32, 32), (4096, 1024, 32, 1), torch.float32)
        # Topologically Sorted Source Nodes: [input_43, input_44, std_target, input_87, input_88, sub_1, v_pred, std_pred, add_121, rescale_factor, v_pred_rescaled, mul_31, mul_32, v_guided, mul_33, x_next], Original ATen: [aten.silu, aten.convolution, aten.std, aten.sub, aten.add, aten.div, aten.mul]
        stream0 = get_raw_stream(0)
        triton_poi_fused_add_convolution_div_mul_silu_std_sub_70.run(buf693, arg153_1, buf686, buf688, buf695, arg25_1, buf698, s57, 6144, 4, stream=stream0)
        del arg153_1
        del arg25_1
        del buf686
        del buf688
        ...
        # Topologically Sorted Source Nodes: [gt, add_noise], Original ATen: [aten.gt, aten.any]
        stream0 = get_raw_stream(0)
        triton_poi_fused_any_gt_71.run(buf682, buf699, 1, stream=stream0)
