...
#   getitem => unsqueeze
#   getitem_1 => unsqueeze_1
#   input_1 => constant_pad_nd_default
#   mul => mul
#   sin => sin
#   truediv => div
# Graph fragment:
...
#   %sin : Tensor "f32[6, 128][128, 1]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.sin.default](args = (%mul_1,), kwargs = {})
#   %cat : Tensor "f32[6, 256][256, 1]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.cat.default](args = ([%cos, %sin], -1), kwargs = {})
#   %constant_pad_nd_default : Tensor "f32[8, 256][256, 1]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.constant_pad_nd.default](args = (%cat, [0, 0, 0, 2]), kwargs = {})
...
# Source node to ATen node mapping:
#   input_1 => add_tensor_19, slice_tensor
#   input_2 => mul_2, sigmoid
# Graph fragment:
#   %mm_default_19 : Tensor "f32[8, 1024][1024, 1]cuda:0" = PlaceHolder[target=mm_default_19]
#   %arg2_1 : Tensor "f32[1024][1]cuda:0" = PlaceHolder[target=arg2_1]
#   %add_tensor_19 : Tensor "f32[8, 1024][1024, 1]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.add.Tensor](args = (%mm_default_19, %arg2_1), kwargs = {})
#   %slice_tensor : Tensor "f32[6, 1024][1024, 1]cuda:0"[num_users=2] = call_function[target=torch.ops.aten.slice.Tensor](args = (%add_tensor_19, 0, 0, -2), kwargs = {})
#   %sigmoid : Tensor "f32[6, 1024][1024, 1]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.sigmoid.default](args = (%slice_tensor,), kwargs = {})
#   %mul_2 : Tensor "f32[6, 1024][1024, 1]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%slice_tensor, %sigmoid), kwargs = {})
#   return %mul_2
...
#   %mm_default_7 : Tensor "f32[6, 256][256, 1]cuda:0" = PlaceHolder[target=mm_default_7]
...
#   %view_119 : Tensor "f32[6, 512, 8, 8][32768, 1, 4096, 512]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.reshape.default](args = (%permute_62, [6, 512, 8, 8]), kwargs = {})
#   %convolution_15 : Tensor "f32[6, 256, 16, 16][65536, 1, 4096, 256]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.convolution.default](args = (%view_119, %arg78_1, %arg79_1, [2, 2], [1, 1], [1, 1], True, [0, 0], 1), kwargs = {})
#   %add_tensor_7 : Tensor "f32[6, 256][256, 1]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.add.Tensor](args = (%mm_default_7, %arg83_1), kwargs = {})
#   %sigmoid_18 : Tensor "f32[6, 256][256, 1]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.sigmoid.default](args = (%add_tensor_7,), kwargs = {})
...
# kernel path: ./.compile_cache/y7/cy7oveenkbclneqxireww7ppkau5dtynheyv7ct4ztpwk43ukrzs.py
...
# kernel path: ./.compile_cache/mq/cmq6xb53h3t6djardbebu323cd4zacczkr6lxawbz34urzusymwn.py
# Topologically Sorted Source Nodes: [input_43, input_44], Original ATen: [aten.silu, aten.convolution]
# Source node to ATen node mapping:
#   input_43 => mul_75, sigmoid_41
#   input_44 => convolution_37
...
def partition_0(args):
    ...
    with torch.cuda._DeviceGuard(0):
        ...
        del arg65_1
        buf129 = empty_strided_cuda((512, 512, 3, 3), (4608, 1, 1536, 512), torch.float32)
        ...
        buf132 = empty_strided_cuda((6, 32, 1, 1), (32, 1, 192, 192), torch.float32)
        ...
        del arg67_1
        buf135 = empty_strided_cuda((6, 12, 64), (768, 64, 1), torch.float32)
        ...
        buf137 = empty_strided_cuda((6, 512, 8, 8), (32768, 1, 4096, 512), torch.float32)
        ...
        del arg70_1
        del arg71_1
        buf144 = empty_strided_cuda((384, 1536), (1536, 1), torch.float32)
        ...
        del arg77_1
        del buf154
        buf158 = empty_strided_cuda((6, 512), (512, 1), torch.float32)
        ...
        del buf159
        del buf160
        buf162 = empty_strided_cuda((6, 256), (256, 1), torch.float32)
        ...
        # Topologically Sorted Source Nodes: [x_54, x_norm_16, split_15, x_flat_16, out_54, view_126, shift_31, out_55, x_55, x_56, add_59, h_22, input_42, input_43], Original ATen: [aten.convolution, aten.native_group_norm, aten.split_with_sizes, aten.view, aten.add, aten.silu]
        stream0 = get_raw_stream(0)
        triton_poi_fused_add_convolution_native_group_norm_silu_split_with_sizes_view_64.run(buf342, arg149_1, buf327, buf338, buf339, arg150_1, arg151_1, 786432, stream=stream0)
        del arg149_1
        del arg150_1
        del arg151_1
        del buf327
        del buf338
        del buf339
        buf343 = reinterpret_tensor(buf135, (4, 128, 3, 3), (1152, 1, 384, 128), 0); del buf135  # reuse
        # Topologically Sorted Source Nodes: [input_43, input_44], Original ATen: [aten.silu, aten.convolution]
        stream0 = get_raw_stream(0)
        ...
        # Topologically Sorted Source Nodes: [input_43, input_44], Original ATen: [aten.silu, aten.convolution]
        stream0 = get_raw_stream(0)
        triton_poi_fused_convolution_silu_66.run(buf344, arg153_1, buf345, 24, 1024, stream=stream0)
        del arg153_1
        del buf344
    return (buf345, )
