...
# kernel path: /mnt/g/GitHub/VAE_ca_proj/Thermal/.compile_cache/w4/cw47xbepnyapyttiprnnnjevkqaah3fnmgjaurmrnds47kekzqig.py
# Topologically Sorted Source Nodes: [h], Original ATen: [aten._to_copy]
# Source node to ATen node mapping:
#   h => convert_element_type_64
# Graph fragment:
#   %arg25_1 : Tensor "f16[1, 4, 32, 32][4096, 1024, 32, 1]cuda:0" = PlaceHolder[target=arg25_1]
...
def benchmark_compiled_module(times=10, repeat=10):
    ...
    arg25_1 = rand_strided((1, 4, 32, 32), (4096, 1024, 32, 1), device='cuda:0', dtype=torch.float16)
