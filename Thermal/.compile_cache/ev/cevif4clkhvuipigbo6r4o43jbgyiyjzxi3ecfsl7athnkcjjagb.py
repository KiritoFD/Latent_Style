...
# kernel path: /mnt/g/GitHub/VAE_ca_proj/Thermal/.compile_cache/vk/cvkdaiqyfle5rzoxn3qynpllubhj4czv52uigmvcm6vneu4a472p.py
# Topologically Sorted Source Nodes: [unsqueeze, s_emb, cat_1, input_4], Original ATen: [aten.unsqueeze, aten.expand, aten.cat, aten._to_copy]
# Source node to ATen node mapping:
#   cat_1 => cat_1
...
#   %unsqueeze_2 : Tensor "f32[1, 256][256, 1]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.unsqueeze.default](args = (%primals_6, 0), kwargs = {})
#   %expand : Tensor "f32[128, 256][0, 1]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.expand.default](args = (%unsqueeze_2, [128, -1]), kwargs = {})
#   %cat_1 : Tensor "f32[128, 512][512, 1]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.cat.default](args = ([%addmm_1, %expand], -1), kwargs = {})
...
triton_poi_fused__to_copy_cat_expand_unsqueeze_5 = async_compile.triton('triton_poi_fused__to_copy_cat_expand_unsqueeze_5', '''
import triton
import triton.language as tl
...
@triton_heuristics.pointwise(
    ...
    inductor_meta={'grid_type': 'Grid1D', 'autotune_hints': set(), 'kernel_name': 'triton_poi_fused__to_copy_cat_expand_unsqueeze_5', 'mutated_arg_names': [], 'optimize_mem': False, 'no_x_dim': False, 'num_load': 2, 'num_reduction': 0, 'backend_hash': 'D54CF9E23D08230976451A78161C34C47AAE433535668E89333E7039B8F7F720', 'are_deterministic_algorithms_enabled': False, 'assert_indirect_indexing': True, 'autotune_local_cache': True, 'autotune_pointwise': True, 'autotune_remote_cache': None, 'force_disable_caches': False, 'dynamic_scale_rblock': True, 'max_autotune': False, 'max_autotune_pointwise': False, 'min_split_scan_rblock': 256, 'spill_threshold': 16, 'store_cubin': False, 'tiling_scores': {'x': 395264}},
    min_elem_per_thread=0
)
@triton.jit
def triton_poi_fused__to_copy_cat_expand_unsqueeze_5(in_ptr0, in_ptr1, out_ptr0, xnumel, XBLOCK : tl.constexpr):
    xnumel = 65536
    xoffset = tl.program_id(0) * XBLOCK
    xindex = xoffset + tl.arange(0, XBLOCK)[:]
    xmask = tl.full([XBLOCK], True, tl.int1)
    ...
    tmp11 = tmp0 < tmp10
    tmp12 = tl.load(in_ptr1 + ((-256) + x0), tmp9, eviction_policy='evict_last', other=0.0)
...
# Graph fragment:
#   %primals_8 : Tensor "f32[512][1]cuda:0" = PlaceHolder[target=primals_8]
#   %convert_element_type_13 : Tensor "bf16[512][1]cuda:0"[num_users=1] = call_function[target=torch.ops.prims.convert_element_type.default](args = (%primals_8, torch.bfloat16), kwargs = {})
...
# Graph fragment:
#   %primals_9 : Tensor "f32[256, 512][512, 1]cuda:0" = PlaceHolder[target=primals_9]
#   %convert_element_type_22 : Tensor "bf16[256, 512][512, 1]cuda:0"[num_users=1] = call_function[target=torch.ops.prims.convert_element_type.default](args = (%primals_9, torch.bfloat16), kwargs = {})
...
# Graph fragment:
#   %primals_11 : Tensor "f32[256, 256][256, 1]cuda:0" = PlaceHolder[target=primals_11]
#   %convert_element_type_27 : Tensor "bf16[256, 256][256, 1]cuda:0"[num_users=1] = call_function[target=torch.ops.prims.convert_element_type.default](args = (%primals_11, torch.bfloat16), kwargs = {})
...
# Graph fragment:
#   %primals_13 : Tensor "f32[3200, 256][256, 1]cuda:0" = PlaceHolder[target=primals_13]
#   %convert_element_type_34 : Tensor "bf16[3200, 256][256, 1]cuda:0"[num_users=1] = call_function[target=torch.ops.prims.convert_element_type.default](args = (%primals_13, torch.bfloat16), kwargs = {})
...
# Graph fragment:
#   %primals_14 : Tensor "f32[3200][1]cuda:0" = PlaceHolder[target=primals_14]
#   %convert_element_type_33 : Tensor "bf16[3200][1]cuda:0"[num_users=1] = call_function[target=torch.ops.prims.convert_element_type.default](args = (%primals_14, torch.bfloat16), kwargs = {})
...
# Graph fragment:
#   %primals_17 : Tensor "f32[6400, 256][256, 1]cuda:0" = PlaceHolder[target=primals_17]
#   %convert_element_type_46 : Tensor "bf16[6400, 256][256, 1]cuda:0"[num_users=1] = call_function[target=torch.ops.prims.convert_element_type.default](args = (%primals_17, torch.bfloat16), kwargs = {})
...
# Graph fragment:
#   %primals_18 : Tensor "f32[6400][1]cuda:0" = PlaceHolder[target=primals_18]
#   %convert_element_type_45 : Tensor "bf16[6400][1]cuda:0"[num_users=1] = call_function[target=torch.ops.prims.convert_element_type.default](args = (%primals_18, torch.bfloat16), kwargs = {})
...
# Graph fragment:
#   %primals_21 : Tensor "f32[12800, 256][256, 1]cuda:0" = PlaceHolder[target=primals_21]
#   %convert_element_type_58 : Tensor "bf16[12800, 256][256, 1]cuda:0"[num_users=1] = call_function[target=torch.ops.prims.convert_element_type.default](args = (%primals_21, torch.bfloat16), kwargs = {})
...
# Graph fragment:
#   %primals_22 : Tensor "f32[12800][1]cuda:0" = PlaceHolder[target=primals_22]
#   %convert_element_type_57 : Tensor "bf16[12800][1]cuda:0"[num_users=1] = call_function[target=torch.ops.prims.convert_element_type.default](args = (%primals_22, torch.bfloat16), kwargs = {})
...
# Graph fragment:
#   %primals_23 : Tensor "f32[128, 4, 3, 3][36, 1, 12, 4]cuda:0" = PlaceHolder[target=primals_23]
#   %convert_element_type_63 : Tensor "bf16[128, 4, 3, 3][36, 1, 12, 4]cuda:0"[num_users=2] = call_function[target=torch.ops.prims.convert_element_type.default](args = (%primals_23, torch.bfloat16), kwargs = {})
...
# Graph fragment:
#   %primals_25 : Tensor "f32[128, 4, 32, 32][4096, 1, 128, 4]cuda:0" = PlaceHolder[target=primals_25]
#   %convert_element_type_64 : Tensor "bf16[128, 4, 32, 32][4096, 1, 128, 4]cuda:0"[num_users=2] = call_function[target=torch.ops.prims.convert_element_type.default](args = (%primals_25, torch.bfloat16), kwargs = {})
...
#   %convert_element_type_62 : Tensor "bf16[128][1]cuda:0"[num_users=1] = call_function[target=torch.ops.prims.convert_element_type.default](args = (%primals_24, torch.bfloat16), kwargs = {})
...
# Graph fragment:
#   %primals_26 : Tensor "f32[128, 128, 3, 3][1152, 1, 384, 128]cuda:0" = PlaceHolder[target=primals_26]
#   %convert_element_type_66 : Tensor "bf16[128, 128, 3, 3][1152, 1, 384, 128]cuda:0"[num_users=2] = call_function[target=torch.ops.prims.convert_element_type.default](args = (%primals_26, torch.bfloat16), kwargs = {})
...
#   %convert_element_type_73 : Tensor "bf16[128][1]cuda:0"[num_users=1] = call_function[target=torch.ops.prims.convert_element_type.default](args = (%primals_29, torch.bfloat16), kwargs = {})
...
# Graph fragment:
#   %primals_28 : Tensor "f32[128, 128, 1, 1][128, 1, 128, 128]cuda:0" = PlaceHolder[target=primals_28]
#   %convert_element_type_74 : Tensor "bf16[128, 128, 1, 1][128, 1, 128, 128]cuda:0"[num_users=2] = call_function[target=torch.ops.prims.convert_element_type.default](args = (%primals_28, torch.bfloat16), kwargs = {})
...
#   %convert_element_type_86 : Tensor "bf16[128][1]cuda:0"[num_users=1] = call_function[target=torch.ops.prims.convert_element_type.default](args = (%primals_33, torch.bfloat16), kwargs = {})
...
# Graph fragment:
#   %primals_34 : Tensor "f32[256, 128, 3, 3][1152, 1, 384, 128]cuda:0" = PlaceHolder[target=primals_34]
#   %convert_element_type_92 : Tensor "bf16[256, 128, 3, 3][1152, 1, 384, 128]cuda:0"[num_users=2] = call_function[target=torch.ops.prims.convert_element_type.default](args = (%primals_34, torch.bfloat16), kwargs = {})
...
#   %convert_element_type_91 : Tensor "bf16[256][1]cuda:0"[num_users=1] = call_function[target=torch.ops.prims.convert_element_type.default](args = (%primals_35, torch.bfloat16), kwargs = {})
...
#   %clone_2 : Tensor "bf16[128, 4, 256, 64][65536, 16384, 64, 1]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.clone.default](args = (%expand_1,), kwargs = {memory_format: torch.contiguous_format})
#   return %clone_2
...
#   %unsqueeze_3 : Tensor "bf16[128, 1, 512][512, 512, 1]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.unsqueeze.default](args = (%mm_1, 1), kwargs = {})
#   %split : [num_users=2] = call_function[target=torch.ops.aten.split.Tensor](args = (%unsqueeze_3, 256, -1), kwargs = {})
...
#   %clone_3 : Tensor "bf16[128, 4, 64, 1][256, 64, 1, 1]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.clone.default](args = (%expand_2,), kwargs = {memory_format: torch.contiguous_format})
#   return %clone_3
...
#   %clone_4 : Tensor "bf16[128, 4, 1, 64][256, 64, 64, 1]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.clone.default](args = (%expand_4,), kwargs = {memory_format: torch.contiguous_format})
#   return %clone_4
...
# Graph fragment:
#   %primals_40 : Tensor "f32[256, 256, 3, 3][2304, 1, 768, 256]cuda:0" = PlaceHolder[target=primals_40]
#   %convert_element_type_111 : Tensor "bf16[256, 256, 3, 3][2304, 1, 768, 256]cuda:0"[num_users=2] = call_function[target=torch.ops.prims.convert_element_type.default](args = (%primals_40, torch.bfloat16), kwargs = {})
...
#   %convert_element_type_118 : Tensor "bf16[256][1]cuda:0"[num_users=1] = call_function[target=torch.ops.prims.convert_element_type.default](args = (%primals_43, torch.bfloat16), kwargs = {})
...
#   %convert_element_type_148 : Tensor "bf16[256][1]cuda:0"[num_users=1] = call_function[target=torch.ops.prims.convert_element_type.default](args = (%primals_51, torch.bfloat16), kwargs = {})
...
# Graph fragment:
#   %primals_52 : Tensor "f32[512, 256, 3, 3][2304, 1, 768, 256]cuda:0" = PlaceHolder[target=primals_52]
#   %convert_element_type_154 : Tensor "bf16[512, 256, 3, 3][2304, 1, 768, 256]cuda:0"[num_users=2] = call_function[target=torch.ops.prims.convert_element_type.default](args = (%primals_52, torch.bfloat16), kwargs = {})
...
#   %convert_element_type_153 : Tensor "bf16[512][1]cuda:0"[num_users=1] = call_function[target=torch.ops.prims.convert_element_type.default](args = (%primals_53, torch.bfloat16), kwargs = {})
...
#   %clone_12 : Tensor "bf16[128, 8, 64, 64][32768, 4096, 64, 1]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.clone.default](args = (%expand_9,), kwargs = {memory_format: torch.contiguous_format})
#   return %clone_12
...
#   %unsqueeze_5 : Tensor "bf16[128, 1, 1024][1024, 1024, 1]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.unsqueeze.default](args = (%mm_5, 1), kwargs = {})
#   %split_2 : [num_users=2] = call_function[target=torch.ops.aten.split.Tensor](args = (%unsqueeze_5, 512, -1), kwargs = {})
...
#   %clone_13 : Tensor "bf16[128, 8, 64, 1][512, 64, 1, 1]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.clone.default](args = (%expand_10,), kwargs = {memory_format: torch.contiguous_format})
#   return %clone_13
...
#   %clone_14 : Tensor "bf16[128, 8, 1, 64][512, 64, 64, 1]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.clone.default](args = (%expand_12,), kwargs = {memory_format: torch.contiguous_format})
#   return %clone_14
...
# Graph fragment:
#   %primals_58 : Tensor "f32[512, 512, 3, 3][4608, 1, 1536, 512]cuda:0" = PlaceHolder[target=primals_58]
#   %convert_element_type_173 : Tensor "bf16[512, 512, 3, 3][4608, 1, 1536, 512]cuda:0"[num_users=2] = call_function[target=torch.ops.prims.convert_element_type.default](args = (%primals_58, torch.bfloat16), kwargs = {})
...
#   %convert_element_type_180 : Tensor "bf16[512][1]cuda:0"[num_users=1] = call_function[target=torch.ops.prims.convert_element_type.default](args = (%primals_61, torch.bfloat16), kwargs = {})
...
#   %convert_element_type_210 : Tensor "bf16[512][1]cuda:0"[num_users=1] = call_function[target=torch.ops.prims.convert_element_type.default](args = (%primals_69, torch.bfloat16), kwargs = {})
...
#   %mul_30 : Tensor "f32[128, 64, 512][32768, 512, 1]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%mul_29, %primals_70), kwargs = {})
#   %add_29 : Tensor "f32[128, 64, 512][32768, 512, 1]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.add.Tensor](args = (%mul_30, %primals_71), kwargs = {})
...
# Graph fragment:
#   %primals_72 : Tensor "f32[1536, 512][512, 1]cuda:0" = PlaceHolder[target=primals_72]
#   %convert_element_type_217 : Tensor "bf16[1536, 512][512, 1]cuda:0"[num_users=1] = call_function[target=torch.ops.prims.convert_element_type.default](args = (%primals_72, torch.bfloat16), kwargs = {})
...
#   %primals_73 : Tensor "f32[1536][1]cuda:0" = PlaceHolder[target=primals_73]
#   %convert_element_type_216 : Tensor "bf16[1536][1]cuda:0"[num_users=1] = call_function[target=torch.ops.prims.convert_element_type.default](args = (%primals_73, torch.bfloat16), kwargs = {})
...
#   %clone_22 : Tensor "bf16[128, 8, 64, 64][32768, 4096, 64, 1]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.clone.default](args = (%expand_17,), kwargs = {memory_format: torch.contiguous_format})
#   return %clone_22
...
#   %clone_23 : Tensor "bf16[128, 8, 64, 64][32768, 4096, 64, 1]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.clone.default](args = (%expand_18,), kwargs = {memory_format: torch.contiguous_format})
#   return %clone_23
...
#   return %amax_default_5,%sum_5,%expand_19
...
#   %clone_24 : Tensor "bf16[128, 8, 64, 64][32768, 4096, 64, 1]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.clone.default](args = (%expand_20,), kwargs = {memory_format: torch.contiguous_format})
#   return %clone_24
...
#   %primals_75 : Tensor "f32[512][1]cuda:0" = PlaceHolder[target=primals_75]
...
#   %view_106 : Tensor "bf16[128, 512, 64][32768, 1, 512]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.reshape.default](args = (%convert_element_type_214, [128, 512, 64]), kwargs = {})
#   %permute_56 : Tensor "bf16[128, 64, 512][32768, 512, 1]cuda:0"[num_users=2] = call_function[target=torch.ops.aten.permute.default](args = (%view_106, [0, 2, 1]), kwargs = {})
#   %convert_element_type_228 : Tensor "bf16[512][1]cuda:0"[num_users=1] = call_function[target=torch.ops.prims.convert_element_type.default](args = (%primals_75, torch.bfloat16), kwargs = {})
...
#   %mul_33 : Tensor "f32[128, 64, 512][32768, 512, 1]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%mul_32, %primals_76), kwargs = {})
#   %add_32 : Tensor "f32[128, 64, 512][32768, 512, 1]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.add.Tensor](args = (%mul_33, %primals_77), kwargs = {})
...
# Graph fragment:
#   %primals_78 : Tensor "f32[512, 256, 4, 4][4096, 1, 1024, 256]cuda:0" = PlaceHolder[target=primals_78]
#   %convert_element_type_235 : Tensor "bf16[512, 256, 4, 4][4096, 1, 1024, 256]cuda:0"[num_users=2] = call_function[target=torch.ops.prims.convert_element_type.default](args = (%primals_78, torch.bfloat16), kwargs = {})
...
# Topologically Sorted Source Nodes: [h_9, input_27, unsqueeze_5, gate, h_16_gated, h_10], Original ATen: [aten._to_copy, aten.convolution, aten.sigmoid, aten.unsqueeze, aten.mul, aten.add]
# Source node to ATen node mapping:
#   gate => unsqueeze_8
#   h_10 => add_33
#   h_16_gated => mul_35
...
#   %convert_element_type_234 : Tensor "bf16[256][1]cuda:0"[num_users=1] = call_function[target=torch.ops.prims.convert_element_type.default](args = (%primals_79, torch.bfloat16), kwargs = {})
...
#   %mul_35 : Tensor "bf16[128, 256, 16, 16][65536, 1, 4096, 256]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%convert_element_type_152, %unsqueeze_8), kwargs = {})
...
# Graph fragment:
#   %primals_128 : Tensor "f32[128, 256][256, 1]cuda:0" = PlaceHolder[target=primals_128]
#   %convert_element_type_409 : Tensor "bf16[128, 256][256, 1]cuda:0"[num_users=1] = call_function[target=torch.ops.prims.convert_element_type.default](args = (%primals_128, torch.bfloat16), kwargs = {})
...
# Topologically Sorted Source Nodes: [h_16, input_41, unsqueeze_12, gate_1, h_32_gated, h_17], Original ATen: [aten._to_copy, aten.convolution, aten.sigmoid, aten.unsqueeze, aten.mul, aten.add]
# Source node to ATen node mapping:
#   gate_1 => unsqueeze_15
...
#   %convert_element_type_399 : Tensor "bf16[128][1]cuda:0"[num_users=1] = call_function[target=torch.ops.prims.convert_element_type.default](args = (%primals_125, torch.bfloat16), kwargs = {})
...
#   %mul_57 : Tensor "bf16[128, 128, 32, 32][131072, 1, 4096, 128]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%convert_element_type_90, %unsqueeze_15), kwargs = {})
...
#   %convert_element_type_447 : Tensor "bf16[128][1]cuda:0"[num_users=1] = call_function[target=torch.ops.prims.convert_element_type.default](args = (%primals_141, torch.bfloat16), kwargs = {})
...
#   %convert_element_type_473 : Tensor "bf16[128][1]cuda:0"[num_users=1] = call_function[target=torch.ops.prims.convert_element_type.default](args = (%primals_149, torch.bfloat16), kwargs = {})
...
#   %unsqueeze_16 : Tensor "f32[1, 128][128, 1]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.unsqueeze.default](args = (%primals_150, 0), kwargs = {})
...
# Graph fragment:
#   %primals_153 : Tensor "f32[4][1]cuda:0" = PlaceHolder[target=primals_153]
#   %convert_element_type_479 : Tensor "bf16[4][1]cuda:0"[num_users=1] = call_function[target=torch.ops.prims.convert_element_type.default](args = (%primals_153, torch.bfloat16), kwargs = {})
...
#   %convert_element_type_434 : Tensor "bf16[128][1]cuda:0"[num_users=1] = call_function[target=torch.ops.prims.convert_element_type.default](args = (%primals_137, torch.bfloat16), kwargs = {})
...
#   %convert_element_type_394 : Tensor "bf16[256][1]cuda:0"[num_users=1] = call_function[target=torch.ops.prims.convert_element_type.default](args = (%primals_123, torch.bfloat16), kwargs = {})
...
class Runner:
    ...
    def call(self, args):
        ...
        assert_size_stride(primals_9, (256, 512), (512, 1))
        assert_size_stride(primals_10, (256, ), (1, ))
        assert_size_stride(primals_11, (256, 256), (256, 1))
        assert_size_stride(primals_12, (256, ), (1, ))
        assert_size_stride(primals_13, (3200, 256), (256, 1))
        assert_size_stride(primals_14, (3200, ), (1, ))
        assert_size_stride(primals_15, (256, 256), (256, 1))
        assert_size_stride(primals_16, (256, ), (1, ))
        assert_size_stride(primals_17, (6400, 256), (256, 1))
        assert_size_stride(primals_18, (6400, ), (1, ))
        assert_size_stride(primals_19, (256, 256), (256, 1))
        assert_size_stride(primals_20, (256, ), (1, ))
        assert_size_stride(primals_21, (12800, 256), (256, 1))
        assert_size_stride(primals_22, (12800, ), (1, ))
        assert_size_stride(primals_23, (128, 4, 3, 3), (36, 1, 12, 4))
        assert_size_stride(primals_24, (128, ), (1, ))
        assert_size_stride(primals_25, (128, 4, 32, 32), (4096, 1, 128, 4))
        assert_size_stride(primals_26, (128, 128, 3, 3), (1152, 1, 384, 128))
        assert_size_stride(primals_27, (128, ), (1, ))
        assert_size_stride(primals_28, (128, 128, 1, 1), (128, 1, 128, 128))
        assert_size_stride(primals_29, (128, ), (1, ))
        assert_size_stride(primals_30, (128, 128, 3, 3), (1152, 1, 384, 128))
        assert_size_stride(primals_31, (128, ), (1, ))
        assert_size_stride(primals_32, (128, 128, 1, 1), (128, 1, 128, 128))
        assert_size_stride(primals_33, (128, ), (1, ))
        assert_size_stride(primals_34, (256, 128, 3, 3), (1152, 1, 384, 128))
        assert_size_stride(primals_35, (256, ), (1, ))
        assert_size_stride(primals_36, (256, 256), (256, 1))
        assert_size_stride(primals_37, (512, 256), (256, 1))
        assert_size_stride(primals_38, (256, 256), (256, 1))
        assert_size_stride(primals_39, (256, ), (1, ))
        assert_size_stride(primals_40, (256, 256, 3, 3), (2304, 1, 768, 256))
        assert_size_stride(primals_41, (256, ), (1, ))
        assert_size_stride(primals_42, (256, 256, 1, 1), (256, 1, 256, 256))
        assert_size_stride(primals_43, (256, ), (1, ))
        assert_size_stride(primals_44, (256, 256), (256, 1))
        assert_size_stride(primals_45, (512, 256), (256, 1))
        assert_size_stride(primals_46, (256, 256), (256, 1))
        assert_size_stride(primals_47, (256, ), (1, ))
        assert_size_stride(primals_48, (256, 256, 3, 3), (2304, 1, 768, 256))
        assert_size_stride(primals_49, (256, ), (1, ))
        assert_size_stride(primals_50, (256, 256, 1, 1), (256, 1, 256, 256))
        assert_size_stride(primals_51, (256, ), (1, ))
        assert_size_stride(primals_52, (512, 256, 3, 3), (2304, 1, 768, 256))
        assert_size_stride(primals_53, (512, ), (1, ))
        assert_size_stride(primals_54, (512, 512), (512, 1))
        assert_size_stride(primals_55, (1024, 256), (256, 1))
        ...
        assert_size_stride(primals_60, (512, 512, 1, 1), (512, 1, 512, 512))
        assert_size_stride(primals_61, (512, ), (1, ))
        assert_size_stride(primals_62, (512, 512), (512, 1))
        assert_size_stride(primals_63, (1024, 256), (256, 1))
        assert_size_stride(primals_64, (512, 512), (512, 1))
        assert_size_stride(primals_65, (512, ), (1, ))
        assert_size_stride(primals_66, (512, 512, 3, 3), (4608, 1, 1536, 512))
        assert_size_stride(primals_67, (512, ), (1, ))
        assert_size_stride(primals_68, (512, 512, 1, 1), (512, 1, 512, 512))
        assert_size_stride(primals_69, (512, ), (1, ))
        assert_size_stride(primals_70, (512, ), (1, ))
        assert_size_stride(primals_71, (512, ), (1, ))
        assert_size_stride(primals_72, (1536, 512), (512, 1))
        assert_size_stride(primals_73, (1536, ), (1, ))
        assert_size_stride(primals_74, (512, 512), (512, 1))
        assert_size_stride(primals_75, (512, ), (1, ))
        assert_size_stride(primals_76, (512, ), (1, ))
        assert_size_stride(primals_77, (512, ), (1, ))
        assert_size_stride(primals_78, (512, 256, 4, 4), (4096, 1, 1024, 256))
        assert_size_stride(primals_79, (256, ), (1, ))
        assert_size_stride(primals_80, (256, 256), (256, 1))
        assert_size_stride(primals_81, (256, ), (1, ))
        assert_size_stride(primals_82, (256, 256), (256, 1))
        assert_size_stride(primals_83, (256, ), (1, ))
        assert_size_stride(primals_84, (256, 256), (256, 1))
        assert_size_stride(primals_85, (512, 256), (256, 1))
        assert_size_stride(primals_86, (256, 256), (256, 1))
        ...
        assert_size_stride(primals_90, (256, 256, 1, 1), (256, 1, 256, 256))
        assert_size_stride(primals_91, (256, ), (1, ))
        assert_size_stride(primals_92, (256, 256), (256, 1))
        assert_size_stride(primals_93, (512, 256), (256, 1))
        assert_size_stride(primals_94, (256, 256), (256, 1))
        assert_size_stride(primals_95, (256, ), (1, ))
        assert_size_stride(primals_96, (256, 256, 3, 3), (2304, 1, 768, 256))
        assert_size_stride(primals_97, (256, ), (1, ))
        assert_size_stride(primals_98, (256, 256, 1, 1), (256, 1, 256, 256))
        assert_size_stride(primals_99, (256, ), (1, ))
        assert_size_stride(primals_100, (256, 256), (256, 1))
        assert_size_stride(primals_101, (512, 256), (256, 1))
        assert_size_stride(primals_102, (256, 256), (256, 1))
        assert_size_stride(primals_103, (256, ), (1, ))
        assert_size_stride(primals_104, (256, 256, 3, 3), (2304, 1, 768, 256))
        assert_size_stride(primals_105, (256, ), (1, ))
        assert_size_stride(primals_106, (256, 256, 1, 1), (256, 1, 256, 256))
        assert_size_stride(primals_107, (256, ), (1, ))
        assert_size_stride(primals_108, (256, 256), (256, 1))
        assert_size_stride(primals_109, (512, 256), (256, 1))
        assert_size_stride(primals_110, (256, 256), (256, 1))
        assert_size_stride(primals_111, (256, ), (1, ))
        assert_size_stride(primals_112, (256, 256, 3, 3), (2304, 1, 768, 256))
        assert_size_stride(primals_113, (256, ), (1, ))
        assert_size_stride(primals_114, (256, 256, 1, 1), (256, 1, 256, 256))
        assert_size_stride(primals_115, (256, ), (1, ))
        assert_size_stride(primals_116, (256, 256), (256, 1))
        assert_size_stride(primals_117, (512, 256), (256, 1))
        assert_size_stride(primals_118, (256, 256), (256, 1))
        assert_size_stride(primals_119, (256, ), (1, ))
        assert_size_stride(primals_120, (256, 256, 3, 3), (2304, 1, 768, 256))
        assert_size_stride(primals_121, (256, ), (1, ))
        assert_size_stride(primals_122, (256, 256, 1, 1), (256, 1, 256, 256))
        assert_size_stride(primals_123, (256, ), (1, ))
        assert_size_stride(primals_124, (256, 128, 4, 4), (2048, 1, 512, 128))
        assert_size_stride(primals_125, (128, ), (1, ))
        assert_size_stride(primals_126, (256, 256), (256, 1))
        assert_size_stride(primals_127, (256, ), (1, ))
        assert_size_stride(primals_128, (128, 256), (256, 1))
        assert_size_stride(primals_129, (128, ), (1, ))
        assert_size_stride(primals_130, (128, 128, 3, 3), (1152, 1, 384, 128))
        assert_size_stride(primals_131, (128, ), (1, ))
        assert_size_stride(primals_132, (128, 128, 1, 1), (128, 1, 128, 128))
        assert_size_stride(primals_133, (128, ), (1, ))
        assert_size_stride(primals_134, (128, 128, 3, 3), (1152, 1, 384, 128))
        assert_size_stride(primals_135, (128, ), (1, ))
        assert_size_stride(primals_136, (128, 128, 1, 1), (128, 1, 128, 128))
        assert_size_stride(primals_137, (128, ), (1, ))
        assert_size_stride(primals_138, (128, 128, 3, 3), (1152, 1, 384, 128))
        assert_size_stride(primals_139, (128, ), (1, ))
        assert_size_stride(primals_140, (128, 128, 1, 1), (128, 1, 128, 128))
        assert_size_stride(primals_141, (128, ), (1, ))
        assert_size_stride(primals_142, (128, 128, 3, 3), (1152, 1, 384, 128))
        assert_size_stride(primals_143, (128, ), (1, ))
        assert_size_stride(primals_144, (128, 128, 1, 1), (128, 1, 128, 128))
        assert_size_stride(primals_145, (128, ), (1, ))
        assert_size_stride(primals_146, (128, 128, 3, 3), (1152, 1, 384, 128))
        assert_size_stride(primals_147, (128, ), (1, ))
        assert_size_stride(primals_148, (128, 128, 1, 1), (128, 1, 128, 128))
        assert_size_stride(primals_149, (128, ), (1, ))
        assert_size_stride(primals_150, (128, ), (1, ))
        assert_size_stride(primals_151, (128, ), (1, ))
        assert_size_stride(primals_152, (4, 128, 3, 3), (1152, 1, 384, 128))
        ...
        with torch.cuda._DeviceGuard(0):
            ...
            # Topologically Sorted Source Nodes: [unsqueeze, s_emb, cat_1, input_4], Original ATen: [aten.unsqueeze, aten.expand, aten.cat, aten._to_copy]
            stream0 = get_raw_stream(0)
            triton_poi_fused__to_copy_cat_expand_unsqueeze_5.run(buf7, primals_6, buf8, 65536, stream=stream0)
            del primals_6
            buf9 = empty_strided_cuda((512, 512), (512, 1), torch.bfloat16)
            # Topologically Sorted Source Nodes: [input_4], Original ATen: [aten._to_copy]
            stream0 = get_raw_stream(0)
            triton_poi_fused__to_copy_1.run(primals_7, buf9, 262144, stream=stream0)
            del primals_7
            buf10 = empty_strided_cuda((512, ), (1, ), torch.bfloat16)
            # Topologically Sorted Source Nodes: [input_4], Original ATen: [aten._to_copy]
            stream0 = get_raw_stream(0)
            triton_poi_fused__to_copy_6.run(primals_8, buf10, 512, stream=stream0)
            del primals_8
            ...
            # Topologically Sorted Source Nodes: [input_6], Original ATen: [aten._to_copy]
            stream0 = get_raw_stream(0)
            triton_poi_fused__to_copy_8.run(primals_9, buf13, 131072, stream=stream0)
            del primals_9
            buf14 = buf6; del buf6  # reuse
            # Topologically Sorted Source Nodes: [input_6], Original ATen: [aten._to_copy]
            stream0 = get_raw_stream(0)
            triton_poi_fused__to_copy_4.run(primals_10, buf14, 256, stream=stream0)
            del primals_10
            ...
            # Topologically Sorted Source Nodes: [input_7], Original ATen: [aten._to_copy]
            stream0 = get_raw_stream(0)
            triton_poi_fused__to_copy_9.run(primals_11, buf16, 65536, stream=stream0)
            del primals_11
            buf17 = buf14; del buf14  # reuse
            # Topologically Sorted Source Nodes: [input_7], Original ATen: [aten._to_copy]
            stream0 = get_raw_stream(0)
            triton_poi_fused__to_copy_4.run(primals_12, buf17, 256, stream=stream0)
            del primals_12
            ...
            # Topologically Sorted Source Nodes: [input_9], Original ATen: [aten._to_copy]
            stream0 = get_raw_stream(0)
            triton_poi_fused__to_copy_11.run(primals_13, buf20, 819200, stream=stream0)
            del primals_13
            buf21 = empty_strided_cuda((3200, ), (1, ), torch.bfloat16)
            # Topologically Sorted Source Nodes: [input_9], Original ATen: [aten._to_copy]
            stream0 = get_raw_stream(0)
            triton_poi_fused__to_copy_12.run(primals_14, buf21, 3200, stream=stream0)
            del primals_14
            ...
            stream0 = get_raw_stream(0)
            triton_poi_fused__to_copy_9.run(primals_15, buf23, 65536, stream=stream0)
            del primals_15
            buf24 = buf17; del buf17  # reuse
            # Topologically Sorted Source Nodes: [input_10], Original ATen: [aten._to_copy]
            stream0 = get_raw_stream(0)
            triton_poi_fused__to_copy_4.run(primals_16, buf24, 256, stream=stream0)
            del primals_16
            ...
            # Topologically Sorted Source Nodes: [input_12], Original ATen: [aten._to_copy]
            stream0 = get_raw_stream(0)
            triton_poi_fused__to_copy_13.run(primals_17, buf27, 1638400, stream=stream0)
            del primals_17
            buf28 = empty_strided_cuda((6400, ), (1, ), torch.bfloat16)
            # Topologically Sorted Source Nodes: [input_12], Original ATen: [aten._to_copy]
            stream0 = get_raw_stream(0)
            triton_poi_fused__to_copy_14.run(primals_18, buf28, 6400, stream=stream0)
            del primals_18
            ...
            stream0 = get_raw_stream(0)
            triton_poi_fused__to_copy_9.run(primals_19, buf30, 65536, stream=stream0)
            del primals_19
            buf31 = buf24; del buf24  # reuse
            # Topologically Sorted Source Nodes: [input_13], Original ATen: [aten._to_copy]
            stream0 = get_raw_stream(0)
            triton_poi_fused__to_copy_4.run(primals_20, buf31, 256, stream=stream0)
            del primals_20
            ...
            # Topologically Sorted Source Nodes: [input_15], Original ATen: [aten._to_copy]
            stream0 = get_raw_stream(0)
            triton_poi_fused__to_copy_15.run(primals_21, buf34, 3276800, stream=stream0)
            del primals_21
            buf35 = empty_strided_cuda((12800, ), (1, ), torch.bfloat16)
            # Topologically Sorted Source Nodes: [input_15], Original ATen: [aten._to_copy]
            stream0 = get_raw_stream(0)
            triton_poi_fused__to_copy_16.run(primals_22, buf35, 12800, stream=stream0)
            del primals_22
            ...
            # Topologically Sorted Source Nodes: [h], Original ATen: [aten._to_copy]
            stream0 = get_raw_stream(0)
            triton_poi_fused__to_copy_17.run(primals_23, buf37, 4608, stream=stream0)
            del primals_23
            buf38 = empty_strided_cuda((128, 4, 32, 32), (4096, 1, 128, 4), torch.bfloat16)
            # Topologically Sorted Source Nodes: [h], Original ATen: [aten._to_copy]
            stream0 = get_raw_stream(0)
            triton_poi_fused__to_copy_18.run(primals_25, buf38, 524288, stream=stream0)
            del primals_25
            buf39 = empty_strided_cuda((128, ), (1, ), torch.bfloat16)
            # Topologically Sorted Source Nodes: [h], Original ATen: [aten._to_copy, aten.convolution]
            stream0 = get_raw_stream(0)
            triton_poi_fused__to_copy_convolution_19.run(primals_24, buf39, 128, stream=stream0)
            del primals_24
            # Topologically Sorted Source Nodes: [h], Original ATen: [aten._to_copy, aten.convolution]
            ...
            # Topologically Sorted Source Nodes: [x], Original ATen: [aten._to_copy]
            stream0 = get_raw_stream(0)
            triton_poi_fused__to_copy_21.run(primals_26, buf42, 147456, stream=stream0)
            del primals_26
            buf43 = buf39; del buf39  # reuse
            # Topologically Sorted Source Nodes: [x], Original ATen: [aten._to_copy, aten.convolution]
            stream0 = get_raw_stream(0)
            triton_poi_fused__to_copy_convolution_19.run(primals_27, buf43, 128, stream=stream0)
            del primals_27
            # Topologically Sorted Source Nodes: [x], Original ATen: [aten._to_copy, aten.convolution]
            ...
            # Topologically Sorted Source Nodes: [x_2], Original ATen: [aten._to_copy]
            stream0 = get_raw_stream(0)
            triton_poi_fused__to_copy_25.run(primals_28, buf54, 16384, stream=stream0)
            del primals_28
            buf56 = buf43; del buf43  # reuse
            # Topologically Sorted Source Nodes: [x_2], Original ATen: [aten._to_copy, aten.convolution]
            stream0 = get_raw_stream(0)
            triton_poi_fused__to_copy_convolution_19.run(primals_29, buf56, 128, stream=stream0)
            del primals_29
            # Topologically Sorted Source Nodes: [x_2], Original ATen: [aten._to_copy, aten.convolution]
            ...
            stream0 = get_raw_stream(0)
            triton_poi_fused__to_copy_21.run(primals_30, buf61, 147456, stream=stream0)
            del primals_30
            buf62 = buf56; del buf56  # reuse
            # Topologically Sorted Source Nodes: [x_3], Original ATen: [aten._to_copy, aten.convolution]
            stream0 = get_raw_stream(0)
            triton_poi_fused__to_copy_convolution_19.run(primals_31, buf62, 128, stream=stream0)
            del primals_31
            # Topologically Sorted Source Nodes: [x_3], Original ATen: [aten._to_copy, aten.convolution]
            ...
            stream0 = get_raw_stream(0)
            triton_poi_fused__to_copy_25.run(primals_32, buf73, 16384, stream=stream0)
            del primals_32
            buf75 = buf62; del buf62  # reuse
            # Topologically Sorted Source Nodes: [x_5], Original ATen: [aten._to_copy, aten.convolution]
            stream0 = get_raw_stream(0)
            triton_poi_fused__to_copy_convolution_19.run(primals_33, buf75, 128, stream=stream0)
            del primals_33
            # Topologically Sorted Source Nodes: [x_5], Original ATen: [aten._to_copy, aten.convolution]
            ...
            # Topologically Sorted Source Nodes: [h_3], Original ATen: [aten._to_copy]
            stream0 = get_raw_stream(0)
            triton_poi_fused__to_copy_28.run(primals_34, buf79, 294912, stream=stream0)
            del primals_34
            buf80 = buf31; del buf31  # reuse
            # Topologically Sorted Source Nodes: [h_3], Original ATen: [aten._to_copy, aten.convolution]
            stream0 = get_raw_stream(0)
            triton_poi_fused__to_copy_4.run(primals_35, buf80, 256, stream=stream0)
            del primals_35
            # Topologically Sorted Source Nodes: [h_3], Original ATen: [aten._to_copy, aten.convolution]
            ...
            stream0 = get_raw_stream(0)
            triton_poi_fused__to_copy_9.run(primals_36, buf83, 65536, stream=stream0)
            del primals_36
            ...
            stream0 = get_raw_stream(0)
            triton_poi_fused__to_copy_8.run(primals_37, buf85, 131072, stream=stream0)
            del primals_37
            ...
            stream0 = get_raw_stream(0)
            triton_poi_fused__to_copy_9.run(primals_38, buf94, 65536, stream=stream0)
            del primals_38
            buf95 = buf80; del buf80  # reuse
            # Topologically Sorted Source Nodes: [input_16], Original ATen: [aten._to_copy]
            stream0 = get_raw_stream(0)
            triton_poi_fused__to_copy_4.run(primals_39, buf95, 256, stream=stream0)
            del primals_39
            ...
            # Topologically Sorted Source Nodes: [x_7], Original ATen: [aten._to_copy]
            stream0 = get_raw_stream(0)
            triton_poi_fused__to_copy_36.run(primals_40, buf101, 589824, stream=stream0)
            del primals_40
            buf102 = buf95; del buf95  # reuse
            # Topologically Sorted Source Nodes: [x_7], Original ATen: [aten._to_copy, aten.convolution]
            stream0 = get_raw_stream(0)
            triton_poi_fused__to_copy_4.run(primals_41, buf102, 256, stream=stream0)
            del primals_41
            # Topologically Sorted Source Nodes: [x_7], Original ATen: [aten._to_copy, aten.convolution]
            ...
            stream0 = get_raw_stream(0)
            triton_poi_fused__to_copy_9.run(primals_42, buf113, 65536, stream=stream0)
            del primals_42
            buf115 = buf102; del buf102  # reuse
            # Topologically Sorted Source Nodes: [x_9], Original ATen: [aten._to_copy, aten.convolution]
            stream0 = get_raw_stream(0)
            triton_poi_fused__to_copy_4.run(primals_43, buf115, 256, stream=stream0)
            del primals_43
            # Topologically Sorted Source Nodes: [x_9], Original ATen: [aten._to_copy, aten.convolution]
            ...
            stream0 = get_raw_stream(0)
            triton_poi_fused__to_copy_9.run(primals_44, buf119, 65536, stream=stream0)
            del primals_44
            ...
            stream0 = get_raw_stream(0)
            triton_poi_fused__to_copy_8.run(primals_45, buf122, 131072, stream=stream0)
            del primals_45
            ...
            stream0 = get_raw_stream(0)
            triton_poi_fused__to_copy_9.run(primals_46, buf131, 65536, stream=stream0)
            del primals_46
            buf132 = buf115; del buf115  # reuse
            # Topologically Sorted Source Nodes: [input_18], Original ATen: [aten._to_copy]
            stream0 = get_raw_stream(0)
            triton_poi_fused__to_copy_4.run(primals_47, buf132, 256, stream=stream0)
            del primals_47
            ...
            stream0 = get_raw_stream(0)
            triton_poi_fused__to_copy_36.run(primals_48, buf138, 589824, stream=stream0)
            del primals_48
            buf139 = buf132; del buf132  # reuse
            # Topologically Sorted Source Nodes: [x_11], Original ATen: [aten._to_copy, aten.convolution]
            stream0 = get_raw_stream(0)
            triton_poi_fused__to_copy_4.run(primals_49, buf139, 256, stream=stream0)
            del primals_49
            # Topologically Sorted Source Nodes: [x_11], Original ATen: [aten._to_copy, aten.convolution]
            ...
            stream0 = get_raw_stream(0)
            triton_poi_fused__to_copy_9.run(primals_50, buf150, 65536, stream=stream0)
            del primals_50
            buf152 = buf139; del buf139  # reuse
            # Topologically Sorted Source Nodes: [x_13], Original ATen: [aten._to_copy, aten.convolution]
            stream0 = get_raw_stream(0)
            triton_poi_fused__to_copy_4.run(primals_51, buf152, 256, stream=stream0)
            del primals_51
            # Topologically Sorted Source Nodes: [x_13], Original ATen: [aten._to_copy, aten.convolution]
            ...
            # Topologically Sorted Source Nodes: [h_6], Original ATen: [aten._to_copy]
            stream0 = get_raw_stream(0)
            triton_poi_fused__to_copy_42.run(primals_52, buf156, 1179648, stream=stream0)
            del primals_52
            buf157 = buf10; del buf10  # reuse
            # Topologically Sorted Source Nodes: [h_6], Original ATen: [aten._to_copy, aten.convolution]
            stream0 = get_raw_stream(0)
            triton_poi_fused__to_copy_6.run(primals_53, buf157, 512, stream=stream0)
            del primals_53
            # Topologically Sorted Source Nodes: [h_6], Original ATen: [aten._to_copy, aten.convolution]
            ...
            stream0 = get_raw_stream(0)
            triton_poi_fused__to_copy_1.run(primals_54, buf160, 262144, stream=stream0)
            del primals_54
            ...
            stream0 = get_raw_stream(0)
            triton_poi_fused__to_copy_1.run(primals_55, buf162, 262144, stream=stream0)
            del primals_55
            ...
            stream0 = get_raw_stream(0)
            triton_poi_fused__to_copy_1.run(primals_56, buf171, 262144, stream=stream0)
            del primals_56
            buf172 = buf157; del buf157  # reuse
            # Topologically Sorted Source Nodes: [input_20], Original ATen: [aten._to_copy]
            stream0 = get_raw_stream(0)
            triton_poi_fused__to_copy_6.run(primals_57, buf172, 512, stream=stream0)
            del primals_57
            ...
            # Topologically Sorted Source Nodes: [x_15], Original ATen: [aten._to_copy]
            stream0 = get_raw_stream(0)
            triton_poi_fused__to_copy_50.run(primals_58, buf178, 2359296, stream=stream0)
            del primals_58
            buf179 = buf172; del buf172  # reuse
            # Topologically Sorted Source Nodes: [x_15], Original ATen: [aten._to_copy, aten.convolution]
            stream0 = get_raw_stream(0)
            triton_poi_fused__to_copy_6.run(primals_59, buf179, 512, stream=stream0)
            del primals_59
            # Topologically Sorted Source Nodes: [x_15], Original ATen: [aten._to_copy, aten.convolution]
            ...
            stream0 = get_raw_stream(0)
            triton_poi_fused__to_copy_1.run(primals_60, buf190, 262144, stream=stream0)
            del primals_60
            buf192 = buf179; del buf179  # reuse
            # Topologically Sorted Source Nodes: [x_17], Original ATen: [aten._to_copy, aten.convolution]
            stream0 = get_raw_stream(0)
            triton_poi_fused__to_copy_6.run(primals_61, buf192, 512, stream=stream0)
            del primals_61
            # Topologically Sorted Source Nodes: [x_17], Original ATen: [aten._to_copy, aten.convolution]
            ...
            stream0 = get_raw_stream(0)
            triton_poi_fused__to_copy_1.run(primals_62, buf196, 262144, stream=stream0)
            del primals_62
            ...
            stream0 = get_raw_stream(0)
            triton_poi_fused__to_copy_1.run(primals_63, buf199, 262144, stream=stream0)
            del primals_63
            ...
            stream0 = get_raw_stream(0)
            triton_poi_fused__to_copy_1.run(primals_64, buf208, 262144, stream=stream0)
            del primals_64
            buf209 = buf192; del buf192  # reuse
            # Topologically Sorted Source Nodes: [input_22], Original ATen: [aten._to_copy]
            stream0 = get_raw_stream(0)
            triton_poi_fused__to_copy_6.run(primals_65, buf209, 512, stream=stream0)
            del primals_65
            ...
            stream0 = get_raw_stream(0)
            triton_poi_fused__to_copy_50.run(primals_66, buf215, 2359296, stream=stream0)
            del primals_66
            buf216 = buf209; del buf209  # reuse
            # Topologically Sorted Source Nodes: [x_19], Original ATen: [aten._to_copy, aten.convolution]
            stream0 = get_raw_stream(0)
            triton_poi_fused__to_copy_6.run(primals_67, buf216, 512, stream=stream0)
            del primals_67
            # Topologically Sorted Source Nodes: [x_19], Original ATen: [aten._to_copy, aten.convolution]
            ...
            stream0 = get_raw_stream(0)
            triton_poi_fused__to_copy_1.run(primals_68, buf227, 262144, stream=stream0)
            del primals_68
            buf229 = buf216; del buf216  # reuse
            # Topologically Sorted Source Nodes: [x_21], Original ATen: [aten._to_copy, aten.convolution]
            stream0 = get_raw_stream(0)
            triton_poi_fused__to_copy_6.run(primals_69, buf229, 512, stream=stream0)
            del primals_69
            # Topologically Sorted Source Nodes: [x_21], Original ATen: [aten._to_copy, aten.convolution]
            ...
            # Topologically Sorted Source Nodes: [x_21, add_21, h_8, view_50, x_flat_6, x_norm_6, qkv], Original ATen: [aten._to_copy, aten.convolution, aten.add, aten.silu, aten.view, aten.transpose, aten.native_layer_norm]
            stream0 = get_raw_stream(0)
            triton_per_fused__to_copy_add_convolution_native_layer_norm_silu_transpose_view_55.run(buf232, buf236, buf229, buf197, primals_70, primals_71, buf233, buf237, 8192, 512, stream=stream0)
            del buf229
            del primals_71
            buf238 = empty_strided_cuda((512, 1536), (1, 512), torch.bfloat16)
            # Topologically Sorted Source Nodes: [qkv], Original ATen: [aten._to_copy, aten.t]
            stream0 = get_raw_stream(0)
            triton_poi_fused__to_copy_t_56.run(primals_72, buf238, 786432, stream=stream0)
            del primals_72
            ...
            # Topologically Sorted Source Nodes: [qkv, qkv_1, qkv_2, q_12, matmul_8], Original ATen: [aten._to_copy, aten.addmm, aten.view, aten.permute, aten.select, aten.clone]
            stream0 = get_raw_stream(0)
            triton_poi_fused__to_copy_addmm_clone_permute_select_view_57.run(buf239, primals_73, buf240, 4194304, stream=stream0)
            buf241 = empty_strided_cuda((128, 8, 64, 64), (32768, 4096, 64, 1), torch.bfloat16)
            # Topologically Sorted Source Nodes: [qkv, qkv_1, qkv_2, k_8, transpose_35, matmul_8], Original ATen: [aten._to_copy, aten.addmm, aten.view, aten.permute, aten.select, aten.transpose, aten.clone]
            stream0 = get_raw_stream(0)
            triton_poi_fused__to_copy_addmm_clone_permute_select_transpose_view_58.run(buf239, primals_73, buf241, 65536, 64, stream=stream0)
            ...
            # Topologically Sorted Source Nodes: [qkv, qkv_1, qkv_2, v_20, out_20], Original ATen: [aten._to_copy, aten.addmm, aten.view, aten.permute, aten.select, aten.clone]
            stream0 = get_raw_stream(0)
            triton_poi_fused__to_copy_addmm_clone_permute_select_view_60.run(buf239, primals_73, buf246, 4194304, stream=stream0)
            del buf239
            del primals_73
            ...
            stream0 = get_raw_stream(0)
            triton_poi_fused__to_copy_1.run(primals_74, buf249, 262144, stream=stream0)
            del primals_74
            ...
            # Topologically Sorted Source Nodes: [h_8, view_50, x_flat_6, out_22, out_23, out_24, transpose_37, out_25, h_9], Original ATen: [aten.silu, aten.view, aten.transpose, aten._to_copy, aten.addmm, aten.add, aten.native_layer_norm]
            stream0 = get_raw_stream(0)
            triton_per_fused__to_copy_add_addmm_native_layer_norm_silu_transpose_view_61.run(buf251, buf255, buf232, primals_75, primals_76, primals_77, buf252, buf257, 8192, 512, stream=stream0)
            del primals_75
            del primals_77
            buf256 = empty_strided_cuda((512, 256, 4, 4), (4096, 1, 1024, 256), torch.bfloat16)
            # Topologically Sorted Source Nodes: [h_9], Original ATen: [aten._to_copy]
            stream0 = get_raw_stream(0)
            triton_poi_fused__to_copy_62.run(primals_78, buf256, 2097152, stream=stream0)
            del primals_78
            ...
            stream0 = get_raw_stream(0)
            triton_poi_fused__to_copy_4.run(primals_79, buf258, 256, stream=stream0)
            del primals_79
            # Topologically Sorted Source Nodes: [h_9], Original ATen: [aten._to_copy, aten.convolution]
            ...
            stream0 = get_raw_stream(0)
            triton_poi_fused__to_copy_9.run(primals_80, buf260, 65536, stream=stream0)
            del primals_80
            buf261 = empty_strided_cuda((256, ), (1, ), torch.bfloat16)
            # Topologically Sorted Source Nodes: [input_24], Original ATen: [aten._to_copy]
            stream0 = get_raw_stream(0)
            triton_poi_fused__to_copy_4.run(primals_81, buf261, 256, stream=stream0)
            del primals_81
            ...
            stream0 = get_raw_stream(0)
            triton_poi_fused__to_copy_9.run(primals_82, buf264, 65536, stream=stream0)
            del primals_82
            buf265 = buf261; del buf261  # reuse
            # Topologically Sorted Source Nodes: [input_26], Original ATen: [aten._to_copy]
            stream0 = get_raw_stream(0)
            triton_poi_fused__to_copy_4.run(primals_83, buf265, 256, stream=stream0)
            del primals_83
            ...
            stream0 = get_raw_stream(0)
            triton_poi_fused__to_copy_9.run(primals_84, buf267, 65536, stream=stream0)
            del primals_84
            ...
            # Topologically Sorted Source Nodes: [h_9, input_27, unsqueeze_5, gate, h_16_gated, h_10, view_52, q_13, q_14], Original ATen: [aten._to_copy, aten.convolution, aten.sigmoid, aten.unsqueeze, aten.mul, aten.add, aten.view, aten.transpose, aten.mm]
            ...
            stream0 = get_raw_stream(0)
            triton_poi_fused__to_copy_8.run(primals_85, buf270, 131072, stream=stream0)
            del primals_85
            ...
            stream0 = get_raw_stream(0)
            triton_poi_fused__to_copy_9.run(primals_86, buf279, 65536, stream=stream0)
            del primals_86
            buf280 = buf258; del buf258  # reuse
            # Topologically Sorted Source Nodes: [input_28], Original ATen: [aten._to_copy]
            stream0 = get_raw_stream(0)
            triton_poi_fused__to_copy_4.run(primals_87, buf280, 256, stream=stream0)
            del primals_87
            ...
            stream0 = get_raw_stream(0)
            triton_poi_fused__to_copy_36.run(primals_88, buf286, 589824, stream=stream0)
            del primals_88
            buf287 = buf280; del buf280  # reuse
            # Topologically Sorted Source Nodes: [x_23], Original ATen: [aten._to_copy, aten.convolution]
            stream0 = get_raw_stream(0)
            triton_poi_fused__to_copy_4.run(primals_89, buf287, 256, stream=stream0)
            del primals_89
            # Topologically Sorted Source Nodes: [x_23], Original ATen: [aten._to_copy, aten.convolution]
            ...
            stream0 = get_raw_stream(0)
            triton_poi_fused__to_copy_9.run(primals_90, buf298, 65536, stream=stream0)
            del primals_90
            buf300 = buf287; del buf287  # reuse
            # Topologically Sorted Source Nodes: [x_25], Original ATen: [aten._to_copy, aten.convolution]
            stream0 = get_raw_stream(0)
            triton_poi_fused__to_copy_4.run(primals_91, buf300, 256, stream=stream0)
            del primals_91
            # Topologically Sorted Source Nodes: [x_25], Original ATen: [aten._to_copy, aten.convolution]
            ...
            stream0 = get_raw_stream(0)
            triton_poi_fused__to_copy_9.run(primals_92, buf303, 65536, stream=stream0)
            del primals_92
            ...
            stream0 = get_raw_stream(0)
            triton_poi_fused__to_copy_8.run(primals_93, buf306, 131072, stream=stream0)
            del primals_93
            ...
            stream0 = get_raw_stream(0)
            triton_poi_fused__to_copy_9.run(primals_94, buf315, 65536, stream=stream0)
            del primals_94
            buf316 = buf265; del buf265  # reuse
            # Topologically Sorted Source Nodes: [input_30], Original ATen: [aten._to_copy]
            stream0 = get_raw_stream(0)
            triton_poi_fused__to_copy_4.run(primals_95, buf316, 256, stream=stream0)
            del primals_95
            ...
            stream0 = get_raw_stream(0)
            triton_poi_fused__to_copy_36.run(primals_96, buf322, 589824, stream=stream0)
            del primals_96
            buf323 = buf316; del buf316  # reuse
            # Topologically Sorted Source Nodes: [x_27], Original ATen: [aten._to_copy, aten.convolution]
            stream0 = get_raw_stream(0)
            triton_poi_fused__to_copy_4.run(primals_97, buf323, 256, stream=stream0)
            del primals_97
            # Topologically Sorted Source Nodes: [x_27], Original ATen: [aten._to_copy, aten.convolution]
            ...
            stream0 = get_raw_stream(0)
            triton_poi_fused__to_copy_9.run(primals_98, buf334, 65536, stream=stream0)
            del primals_98
            buf336 = buf323; del buf323  # reuse
            # Topologically Sorted Source Nodes: [x_29], Original ATen: [aten._to_copy, aten.convolution]
            stream0 = get_raw_stream(0)
            triton_poi_fused__to_copy_4.run(primals_99, buf336, 256, stream=stream0)
            del primals_99
            # Topologically Sorted Source Nodes: [x_29], Original ATen: [aten._to_copy, aten.convolution]
            ...
            stream0 = get_raw_stream(0)
            triton_poi_fused__to_copy_9.run(primals_100, buf339, 65536, stream=stream0)
            del primals_100
            ...
            stream0 = get_raw_stream(0)
            triton_poi_fused__to_copy_8.run(primals_101, buf342, 131072, stream=stream0)
            del primals_101
            ...
            stream0 = get_raw_stream(0)
            triton_poi_fused__to_copy_9.run(primals_102, buf351, 65536, stream=stream0)
            del primals_102
            buf352 = empty_strided_cuda((256, ), (1, ), torch.bfloat16)
            # Topologically Sorted Source Nodes: [input_32], Original ATen: [aten._to_copy]
            stream0 = get_raw_stream(0)
            triton_poi_fused__to_copy_4.run(primals_103, buf352, 256, stream=stream0)
            del primals_103
            ...
            stream0 = get_raw_stream(0)
            triton_poi_fused__to_copy_36.run(primals_104, buf358, 589824, stream=stream0)
            del primals_104
            buf359 = buf352; del buf352  # reuse
            # Topologically Sorted Source Nodes: [x_31], Original ATen: [aten._to_copy, aten.convolution]
            stream0 = get_raw_stream(0)
            triton_poi_fused__to_copy_4.run(primals_105, buf359, 256, stream=stream0)
            del primals_105
            # Topologically Sorted Source Nodes: [x_31], Original ATen: [aten._to_copy, aten.convolution]
            ...
            stream0 = get_raw_stream(0)
            triton_poi_fused__to_copy_9.run(primals_106, buf370, 65536, stream=stream0)
            del primals_106
            buf372 = buf359; del buf359  # reuse
            # Topologically Sorted Source Nodes: [x_33], Original ATen: [aten._to_copy, aten.convolution]
            stream0 = get_raw_stream(0)
            triton_poi_fused__to_copy_4.run(primals_107, buf372, 256, stream=stream0)
            del primals_107
            # Topologically Sorted Source Nodes: [x_33], Original ATen: [aten._to_copy, aten.convolution]
            ...
            stream0 = get_raw_stream(0)
            triton_poi_fused__to_copy_9.run(primals_108, buf375, 65536, stream=stream0)
            del primals_108
            ...
            stream0 = get_raw_stream(0)
            triton_poi_fused__to_copy_8.run(primals_109, buf378, 131072, stream=stream0)
            del primals_109
            ...
            stream0 = get_raw_stream(0)
            triton_poi_fused__to_copy_9.run(primals_110, buf387, 65536, stream=stream0)
            del primals_110
            buf388 = empty_strided_cuda((256, ), (1, ), torch.bfloat16)
            # Topologically Sorted Source Nodes: [input_34], Original ATen: [aten._to_copy]
            stream0 = get_raw_stream(0)
            triton_poi_fused__to_copy_4.run(primals_111, buf388, 256, stream=stream0)
            del primals_111
            ...
            stream0 = get_raw_stream(0)
            triton_poi_fused__to_copy_36.run(primals_112, buf394, 589824, stream=stream0)
            del primals_112
            buf395 = buf388; del buf388  # reuse
            # Topologically Sorted Source Nodes: [x_35], Original ATen: [aten._to_copy, aten.convolution]
            stream0 = get_raw_stream(0)
            triton_poi_fused__to_copy_4.run(primals_113, buf395, 256, stream=stream0)
            del primals_113
            # Topologically Sorted Source Nodes: [x_35], Original ATen: [aten._to_copy, aten.convolution]
            ...
            stream0 = get_raw_stream(0)
            triton_poi_fused__to_copy_9.run(primals_114, buf406, 65536, stream=stream0)
            del primals_114
            buf408 = buf395; del buf395  # reuse
            # Topologically Sorted Source Nodes: [x_37], Original ATen: [aten._to_copy, aten.convolution]
            stream0 = get_raw_stream(0)
            triton_poi_fused__to_copy_4.run(primals_115, buf408, 256, stream=stream0)
            del primals_115
            # Topologically Sorted Source Nodes: [x_37], Original ATen: [aten._to_copy, aten.convolution]
            ...
            stream0 = get_raw_stream(0)
            triton_poi_fused__to_copy_9.run(primals_116, buf411, 65536, stream=stream0)
            del primals_116
            ...
            stream0 = get_raw_stream(0)
            triton_poi_fused__to_copy_8.run(primals_117, buf414, 131072, stream=stream0)
            del primals_117
            ...
            stream0 = get_raw_stream(0)
            triton_poi_fused__to_copy_9.run(primals_118, buf423, 65536, stream=stream0)
            del primals_118
            buf424 = empty_strided_cuda((256, ), (1, ), torch.bfloat16)
            # Topologically Sorted Source Nodes: [input_36], Original ATen: [aten._to_copy]
            stream0 = get_raw_stream(0)
            triton_poi_fused__to_copy_4.run(primals_119, buf424, 256, stream=stream0)
            del primals_119
            ...
            stream0 = get_raw_stream(0)
            triton_poi_fused__to_copy_36.run(primals_120, buf430, 589824, stream=stream0)
            del primals_120
            buf431 = buf424; del buf424  # reuse
            # Topologically Sorted Source Nodes: [x_39], Original ATen: [aten._to_copy, aten.convolution]
            stream0 = get_raw_stream(0)
            triton_poi_fused__to_copy_4.run(primals_121, buf431, 256, stream=stream0)
            del primals_121
            # Topologically Sorted Source Nodes: [x_39], Original ATen: [aten._to_copy, aten.convolution]
            ...
            stream0 = get_raw_stream(0)
            triton_poi_fused__to_copy_9.run(primals_122, buf442, 65536, stream=stream0)
            del primals_122
            buf444 = buf431; del buf431  # reuse
            # Topologically Sorted Source Nodes: [x_41], Original ATen: [aten._to_copy, aten.convolution]
            stream0 = get_raw_stream(0)
            triton_poi_fused__to_copy_4.run(primals_123, buf444, 256, stream=stream0)
            del primals_123
            # Topologically Sorted Source Nodes: [x_41], Original ATen: [aten._to_copy, aten.convolution]
            ...
            stream0 = get_raw_stream(0)
            triton_poi_fused__to_copy_18.run(primals_124, buf448, 524288, stream=stream0)
            del primals_124
            ...
            stream0 = get_raw_stream(0)
            triton_poi_fused__to_copy_convolution_19.run(primals_125, buf449, 128, stream=stream0)
            del primals_125
            # Topologically Sorted Source Nodes: [h_16], Original ATen: [aten._to_copy, aten.convolution]
            ...
            stream0 = get_raw_stream(0)
            triton_poi_fused__to_copy_9.run(primals_126, buf451, 65536, stream=stream0)
            del primals_126
            buf452 = empty_strided_cuda((256, ), (1, ), torch.bfloat16)
            # Topologically Sorted Source Nodes: [input_38], Original ATen: [aten._to_copy]
            stream0 = get_raw_stream(0)
            triton_poi_fused__to_copy_4.run(primals_127, buf452, 256, stream=stream0)
            del primals_127
            ...
            # Topologically Sorted Source Nodes: [input_40], Original ATen: [aten._to_copy]
            stream0 = get_raw_stream(0)
            triton_poi_fused__to_copy_64.run(primals_128, buf455, 32768, stream=stream0)
            del primals_128
            buf456 = empty_strided_cuda((128, ), (1, ), torch.bfloat16)
            # Topologically Sorted Source Nodes: [input_40], Original ATen: [aten._to_copy]
            stream0 = get_raw_stream(0)
            triton_poi_fused__to_copy_convolution_19.run(primals_129, buf456, 128, stream=stream0)
            del primals_129
            ...
            stream0 = get_raw_stream(0)
            triton_poi_fused__to_copy_21.run(primals_130, buf459, 147456, stream=stream0)
            del primals_130
            buf460 = buf449; del buf449  # reuse
            # Topologically Sorted Source Nodes: [x_42], Original ATen: [aten._to_copy, aten.convolution]
            stream0 = get_raw_stream(0)
            triton_poi_fused__to_copy_convolution_19.run(primals_131, buf460, 128, stream=stream0)
            del primals_131
            # Topologically Sorted Source Nodes: [x_42], Original ATen: [aten._to_copy, aten.convolution]
            ...
            stream0 = get_raw_stream(0)
            triton_poi_fused__to_copy_25.run(primals_132, buf471, 16384, stream=stream0)
            del primals_132
            buf473 = buf460; del buf460  # reuse
            # Topologically Sorted Source Nodes: [x_44], Original ATen: [aten._to_copy, aten.convolution]
            stream0 = get_raw_stream(0)
            triton_poi_fused__to_copy_convolution_19.run(primals_133, buf473, 128, stream=stream0)
            del primals_133
            # Topologically Sorted Source Nodes: [x_44], Original ATen: [aten._to_copy, aten.convolution]
            ...
            stream0 = get_raw_stream(0)
            triton_poi_fused__to_copy_21.run(primals_134, buf477, 147456, stream=stream0)
            del primals_134
            buf478 = buf456; del buf456  # reuse
            # Topologically Sorted Source Nodes: [x_45], Original ATen: [aten._to_copy, aten.convolution]
            stream0 = get_raw_stream(0)
            triton_poi_fused__to_copy_convolution_19.run(primals_135, buf478, 128, stream=stream0)
            del primals_135
            # Topologically Sorted Source Nodes: [x_45], Original ATen: [aten._to_copy, aten.convolution]
            ...
            stream0 = get_raw_stream(0)
            triton_poi_fused__to_copy_25.run(primals_136, buf489, 16384, stream=stream0)
            del primals_136
            buf491 = buf478; del buf478  # reuse
            # Topologically Sorted Source Nodes: [x_47], Original ATen: [aten._to_copy, aten.convolution]
            stream0 = get_raw_stream(0)
            triton_poi_fused__to_copy_convolution_19.run(primals_137, buf491, 128, stream=stream0)
            del primals_137
            # Topologically Sorted Source Nodes: [x_47], Original ATen: [aten._to_copy, aten.convolution]
            ...
            stream0 = get_raw_stream(0)
            triton_poi_fused__to_copy_21.run(primals_138, buf495, 147456, stream=stream0)
            del primals_138
            ...
            stream0 = get_raw_stream(0)
            triton_poi_fused__to_copy_convolution_19.run(primals_139, buf496, 128, stream=stream0)
            del primals_139
            # Topologically Sorted Source Nodes: [x_48], Original ATen: [aten._to_copy, aten.convolution]
            ...
            stream0 = get_raw_stream(0)
            triton_poi_fused__to_copy_25.run(primals_140, buf507, 16384, stream=stream0)
            del primals_140
            buf509 = buf496; del buf496  # reuse
            # Topologically Sorted Source Nodes: [x_50], Original ATen: [aten._to_copy, aten.convolution]
            stream0 = get_raw_stream(0)
            triton_poi_fused__to_copy_convolution_19.run(primals_141, buf509, 128, stream=stream0)
            del primals_141
            # Topologically Sorted Source Nodes: [x_50], Original ATen: [aten._to_copy, aten.convolution]
            ...
            stream0 = get_raw_stream(0)
            triton_poi_fused__to_copy_21.run(primals_142, buf513, 147456, stream=stream0)
            del primals_142
            buf514 = buf509; del buf509  # reuse
            # Topologically Sorted Source Nodes: [x_51], Original ATen: [aten._to_copy, aten.convolution]
            stream0 = get_raw_stream(0)
            triton_poi_fused__to_copy_convolution_19.run(primals_143, buf514, 128, stream=stream0)
            del primals_143
            # Topologically Sorted Source Nodes: [x_51], Original ATen: [aten._to_copy, aten.convolution]
            ...
            stream0 = get_raw_stream(0)
            triton_poi_fused__to_copy_25.run(primals_144, buf525, 16384, stream=stream0)
            del primals_144
            buf527 = buf514; del buf514  # reuse
            # Topologically Sorted Source Nodes: [x_53], Original ATen: [aten._to_copy, aten.convolution]
            stream0 = get_raw_stream(0)
            triton_poi_fused__to_copy_convolution_19.run(primals_145, buf527, 128, stream=stream0)
            del primals_145
            # Topologically Sorted Source Nodes: [x_53], Original ATen: [aten._to_copy, aten.convolution]
            ...
            stream0 = get_raw_stream(0)
            triton_poi_fused__to_copy_21.run(primals_146, buf531, 147456, stream=stream0)
            del primals_146
            buf532 = buf527; del buf527  # reuse
            # Topologically Sorted Source Nodes: [x_54], Original ATen: [aten._to_copy, aten.convolution]
            stream0 = get_raw_stream(0)
            triton_poi_fused__to_copy_convolution_19.run(primals_147, buf532, 128, stream=stream0)
            del primals_147
            # Topologically Sorted Source Nodes: [x_54], Original ATen: [aten._to_copy, aten.convolution]
            ...
            stream0 = get_raw_stream(0)
            triton_poi_fused__to_copy_25.run(primals_148, buf543, 16384, stream=stream0)
            del primals_148
            buf545 = buf532; del buf532  # reuse
            # Topologically Sorted Source Nodes: [x_56], Original ATen: [aten._to_copy, aten.convolution]
            stream0 = get_raw_stream(0)
            triton_poi_fused__to_copy_convolution_19.run(primals_149, buf545, 128, stream=stream0)
            del primals_149
            # Topologically Sorted Source Nodes: [x_56], Original ATen: [aten._to_copy, aten.convolution]
            ...
            # Topologically Sorted Source Nodes: [h_22, input_42, input_43, input_44], Original ATen: [aten.silu, aten.clone, aten.native_group_norm, aten._to_copy]
            stream0 = get_raw_stream(0)
            triton_poi_fused__to_copy_clone_native_group_norm_silu_69.run(buf548, buf549, buf552, primals_150, primals_151, buf555, 131072, 128, stream=stream0)
            ...
            stream0 = get_raw_stream(0)
            triton_poi_fused__to_copy_17.run(primals_152, buf554, 4608, stream=stream0)
            del primals_152
            buf556 = empty_strided_cuda((4, ), (1, ), torch.bfloat16)
            # Topologically Sorted Source Nodes: [input_44], Original ATen: [aten._to_copy, aten.convolution]
            stream0 = get_raw_stream(0)
            triton_poi_fused__to_copy_convolution_70.run(primals_153, buf556, 4, stream=stream0)
            del primals_153
...
def benchmark_compiled_module(times=10, repeat=10):
    ...
    primals_9 = rand_strided((256, 512), (512, 1), device='cuda:0', dtype=torch.float32)
    ...
    primals_13 = rand_strided((3200, 256), (256, 1), device='cuda:0', dtype=torch.float32)
    primals_14 = rand_strided((3200, ), (1, ), device='cuda:0', dtype=torch.float32)
    primals_15 = rand_strided((256, 256), (256, 1), device='cuda:0', dtype=torch.float32)
    primals_16 = rand_strided((256, ), (1, ), device='cuda:0', dtype=torch.float32)
    primals_17 = rand_strided((6400, 256), (256, 1), device='cuda:0', dtype=torch.float32)
    primals_18 = rand_strided((6400, ), (1, ), device='cuda:0', dtype=torch.float32)
    primals_19 = rand_strided((256, 256), (256, 1), device='cuda:0', dtype=torch.float32)
    primals_20 = rand_strided((256, ), (1, ), device='cuda:0', dtype=torch.float32)
    primals_21 = rand_strided((12800, 256), (256, 1), device='cuda:0', dtype=torch.float32)
    primals_22 = rand_strided((12800, ), (1, ), device='cuda:0', dtype=torch.float32)
    primals_23 = rand_strided((128, 4, 3, 3), (36, 1, 12, 4), device='cuda:0', dtype=torch.float32)
    primals_24 = rand_strided((128, ), (1, ), device='cuda:0', dtype=torch.float32)
    primals_25 = rand_strided((128, 4, 32, 32), (4096, 1, 128, 4), device='cuda:0', dtype=torch.float32)
    primals_26 = rand_strided((128, 128, 3, 3), (1152, 1, 384, 128), device='cuda:0', dtype=torch.float32)
    primals_27 = rand_strided((128, ), (1, ), device='cuda:0', dtype=torch.float32)
    primals_28 = rand_strided((128, 128, 1, 1), (128, 1, 128, 128), device='cuda:0', dtype=torch.float32)
    primals_29 = rand_strided((128, ), (1, ), device='cuda:0', dtype=torch.float32)
    primals_30 = rand_strided((128, 128, 3, 3), (1152, 1, 384, 128), device='cuda:0', dtype=torch.float32)
    primals_31 = rand_strided((128, ), (1, ), device='cuda:0', dtype=torch.float32)
    primals_32 = rand_strided((128, 128, 1, 1), (128, 1, 128, 128), device='cuda:0', dtype=torch.float32)
    ...
    primals_36 = rand_strided((256, 256), (256, 1), device='cuda:0', dtype=torch.float32)
    primals_37 = rand_strided((512, 256), (256, 1), device='cuda:0', dtype=torch.float32)
    primals_38 = rand_strided((256, 256), (256, 1), device='cuda:0', dtype=torch.float32)
    ...
    primals_42 = rand_strided((256, 256, 1, 1), (256, 1, 256, 256), device='cuda:0', dtype=torch.float32)
    ...
    primals_45 = rand_strided((512, 256), (256, 1), device='cuda:0', dtype=torch.float32)
    ...
    primals_48 = rand_strided((256, 256, 3, 3), (2304, 1, 768, 256), device='cuda:0', dtype=torch.float32)
    primals_49 = rand_strided((256, ), (1, ), device='cuda:0', dtype=torch.float32)
    primals_50 = rand_strided((256, 256, 1, 1), (256, 1, 256, 256), device='cuda:0', dtype=torch.float32)
    primals_51 = rand_strided((256, ), (1, ), device='cuda:0', dtype=torch.float32)
    primals_52 = rand_strided((512, 256, 3, 3), (2304, 1, 768, 256), device='cuda:0', dtype=torch.float32)
    ...
    primals_55 = rand_strided((1024, 256), (256, 1), device='cuda:0', dtype=torch.float32)
    ...
    primals_60 = rand_strided((512, 512, 1, 1), (512, 1, 512, 512), device='cuda:0', dtype=torch.float32)
    ...
    primals_63 = rand_strided((1024, 256), (256, 1), device='cuda:0', dtype=torch.float32)
    primals_64 = rand_strided((512, 512), (512, 1), device='cuda:0', dtype=torch.float32)
    primals_65 = rand_strided((512, ), (1, ), device='cuda:0', dtype=torch.float32)
    primals_66 = rand_strided((512, 512, 3, 3), (4608, 1, 1536, 512), device='cuda:0', dtype=torch.float32)
    primals_67 = rand_strided((512, ), (1, ), device='cuda:0', dtype=torch.float32)
    primals_68 = rand_strided((512, 512, 1, 1), (512, 1, 512, 512), device='cuda:0', dtype=torch.float32)
    ...
    primals_72 = rand_strided((1536, 512), (512, 1), device='cuda:0', dtype=torch.float32)
    primals_73 = rand_strided((1536, ), (1, ), device='cuda:0', dtype=torch.float32)
    primals_74 = rand_strided((512, 512), (512, 1), device='cuda:0', dtype=torch.float32)
    ...
    primals_78 = rand_strided((512, 256, 4, 4), (4096, 1, 1024, 256), device='cuda:0', dtype=torch.float32)
    primals_79 = rand_strided((256, ), (1, ), device='cuda:0', dtype=torch.float32)
    primals_80 = rand_strided((256, 256), (256, 1), device='cuda:0', dtype=torch.float32)
    primals_81 = rand_strided((256, ), (1, ), device='cuda:0', dtype=torch.float32)
    primals_82 = rand_strided((256, 256), (256, 1), device='cuda:0', dtype=torch.float32)
    primals_83 = rand_strided((256, ), (1, ), device='cuda:0', dtype=torch.float32)
    primals_84 = rand_strided((256, 256), (256, 1), device='cuda:0', dtype=torch.float32)
    primals_85 = rand_strided((512, 256), (256, 1), device='cuda:0', dtype=torch.float32)
    primals_86 = rand_strided((256, 256), (256, 1), device='cuda:0', dtype=torch.float32)
    ...
    primals_90 = rand_strided((256, 256, 1, 1), (256, 1, 256, 256), device='cuda:0', dtype=torch.float32)
    ...
    primals_93 = rand_strided((512, 256), (256, 1), device='cuda:0', dtype=torch.float32)
    ...
    primals_96 = rand_strided((256, 256, 3, 3), (2304, 1, 768, 256), device='cuda:0', dtype=torch.float32)
    primals_97 = rand_strided((256, ), (1, ), device='cuda:0', dtype=torch.float32)
    primals_98 = rand_strided((256, 256, 1, 1), (256, 1, 256, 256), device='cuda:0', dtype=torch.float32)
    primals_99 = rand_strided((256, ), (1, ), device='cuda:0', dtype=torch.float32)
    primals_100 = rand_strided((256, 256), (256, 1), device='cuda:0', dtype=torch.float32)
    primals_101 = rand_strided((512, 256), (256, 1), device='cuda:0', dtype=torch.float32)
    primals_102 = rand_strided((256, 256), (256, 1), device='cuda:0', dtype=torch.float32)
    primals_103 = rand_strided((256, ), (1, ), device='cuda:0', dtype=torch.float32)
    primals_104 = rand_strided((256, 256, 3, 3), (2304, 1, 768, 256), device='cuda:0', dtype=torch.float32)
    primals_105 = rand_strided((256, ), (1, ), device='cuda:0', dtype=torch.float32)
    primals_106 = rand_strided((256, 256, 1, 1), (256, 1, 256, 256), device='cuda:0', dtype=torch.float32)
    ...
    primals_109 = rand_strided((512, 256), (256, 1), device='cuda:0', dtype=torch.float32)
    ...
    primals_112 = rand_strided((256, 256, 3, 3), (2304, 1, 768, 256), device='cuda:0', dtype=torch.float32)
    primals_113 = rand_strided((256, ), (1, ), device='cuda:0', dtype=torch.float32)
    primals_114 = rand_strided((256, 256, 1, 1), (256, 1, 256, 256), device='cuda:0', dtype=torch.float32)
    primals_115 = rand_strided((256, ), (1, ), device='cuda:0', dtype=torch.float32)
    primals_116 = rand_strided((256, 256), (256, 1), device='cuda:0', dtype=torch.float32)
    primals_117 = rand_strided((512, 256), (256, 1), device='cuda:0', dtype=torch.float32)
    primals_118 = rand_strided((256, 256), (256, 1), device='cuda:0', dtype=torch.float32)
    primals_119 = rand_strided((256, ), (1, ), device='cuda:0', dtype=torch.float32)
    primals_120 = rand_strided((256, 256, 3, 3), (2304, 1, 768, 256), device='cuda:0', dtype=torch.float32)
    primals_121 = rand_strided((256, ), (1, ), device='cuda:0', dtype=torch.float32)
    primals_122 = rand_strided((256, 256, 1, 1), (256, 1, 256, 256), device='cuda:0', dtype=torch.float32)
    primals_123 = rand_strided((256, ), (1, ), device='cuda:0', dtype=torch.float32)
    primals_124 = rand_strided((256, 128, 4, 4), (2048, 1, 512, 128), device='cuda:0', dtype=torch.float32)
    ...
    primals_128 = rand_strided((128, 256), (256, 1), device='cuda:0', dtype=torch.float32)
    primals_129 = rand_strided((128, ), (1, ), device='cuda:0', dtype=torch.float32)
    primals_130 = rand_strided((128, 128, 3, 3), (1152, 1, 384, 128), device='cuda:0', dtype=torch.float32)
    primals_131 = rand_strided((128, ), (1, ), device='cuda:0', dtype=torch.float32)
    primals_132 = rand_strided((128, 128, 1, 1), (128, 1, 128, 128), device='cuda:0', dtype=torch.float32)
    primals_133 = rand_strided((128, ), (1, ), device='cuda:0', dtype=torch.float32)
    primals_134 = rand_strided((128, 128, 3, 3), (1152, 1, 384, 128), device='cuda:0', dtype=torch.float32)
    primals_135 = rand_strided((128, ), (1, ), device='cuda:0', dtype=torch.float32)
    primals_136 = rand_strided((128, 128, 1, 1), (128, 1, 128, 128), device='cuda:0', dtype=torch.float32)
    primals_137 = rand_strided((128, ), (1, ), device='cuda:0', dtype=torch.float32)
    primals_138 = rand_strided((128, 128, 3, 3), (1152, 1, 384, 128), device='cuda:0', dtype=torch.float32)
    primals_139 = rand_strided((128, ), (1, ), device='cuda:0', dtype=torch.float32)
    primals_140 = rand_strided((128, 128, 1, 1), (128, 1, 128, 128), device='cuda:0', dtype=torch.float32)
    primals_141 = rand_strided((128, ), (1, ), device='cuda:0', dtype=torch.float32)
    primals_142 = rand_strided((128, 128, 3, 3), (1152, 1, 384, 128), device='cuda:0', dtype=torch.float32)
    primals_143 = rand_strided((128, ), (1, ), device='cuda:0', dtype=torch.float32)
    primals_144 = rand_strided((128, 128, 1, 1), (128, 1, 128, 128), device='cuda:0', dtype=torch.float32)
    primals_145 = rand_strided((128, ), (1, ), device='cuda:0', dtype=torch.float32)
    primals_146 = rand_strided((128, 128, 3, 3), (1152, 1, 384, 128), device='cuda:0', dtype=torch.float32)
    primals_147 = rand_strided((128, ), (1, ), device='cuda:0', dtype=torch.float32)
    primals_148 = rand_strided((128, 128, 1, 1), (128, 1, 128, 128), device='cuda:0', dtype=torch.float32)
    ...
    primals_152 = rand_strided((4, 128, 3, 3), (1152, 1, 384, 128), device='cuda:0', dtype=torch.float32)
