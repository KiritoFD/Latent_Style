...
# kernel path: /mnt/g/GitHub/VAE_ca_proj/Thermal/.compile_cache/c5/cc5a6ki5sm3u37tja52otivirdfafx3ldfusziiej2ylesfwzvam.py
# Topologically Sorted Source Nodes: [], Original ATen: [aten.embedding_dense_backward]
# Source node to ATen node mapping:
# Graph fragment:
#   %full_default_43 : Tensor "f32[4, 256][256, 1]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.full.default](args = ([4, 256], 0), kwargs = {dtype: torch.float32, layout: torch.strided, device: cuda:0, pin_memory: False})
#   return %index_put
...
@triton_heuristics.pointwise(
    size_hints={'x': 1024}, 
    filename=__file__,
    triton_meta={'signature': {'out_ptr0': '*fp32', 'xnumel': 'i32', 'XBLOCK': 'constexpr'}, 'device': DeviceProperties(type='cuda', index=0, multi_processor_count=36, cc=89, major=8, regs_per_multiprocessor=65536, max_threads_per_multi_processor=1536, warp_size=32), 'constants': {}, 'configs': [{(0,): [['tt.divisibility', 16]], (1,): [['tt.divisibility', 16]]}]},
    inductor_meta={'grid_type': 'Grid1D', 'autotune_hints': set(), 'kernel_name': 'triton_poi_fused_embedding_dense_backward_0', 'mutated_arg_names': [], 'optimize_mem': True, 'no_x_dim': False, 'num_load': 0, 'num_reduction': 0, 'backend_hash': 'D54CF9E23D08230976451A78161C34C47AAE433535668E89333E7039B8F7F720', 'are_deterministic_algorithms_enabled': False, 'assert_indirect_indexing': True, 'autotune_local_cache': True, 'autotune_pointwise': True, 'autotune_remote_cache': None, 'force_disable_caches': False, 'dynamic_scale_rblock': True, 'max_autotune': False, 'max_autotune_pointwise': False, 'min_split_scan_rblock': 256, 'spill_threshold': 16, 'store_cubin': False, 'tiling_scores': {'x': 8192}},
...
# kernel path: /mnt/g/GitHub/VAE_ca_proj/Thermal/.compile_cache/dt/cdttbt3zrcrv3rbezn7pjcp62t6o6vxas67ohkg7vlerrk44ijfo.py
...
#   return %buf0
triton_red_fused_convolution_backward_1 = async_compile.triton('triton_red_fused_convolution_backward_1', '''
import triton
import triton.language as tl
...
@triton_heuristics.reduction(
    ...
    inductor_meta={'grid_type': 'Grid1D', 'autotune_hints': set(), 'kernel_name': 'triton_red_fused_convolution_backward_1', 'mutated_arg_names': [], 'optimize_mem': True, 'no_x_dim': False, 'num_load': 1, 'num_reduction': 1, 'backend_hash': 'D54CF9E23D08230976451A78161C34C47AAE433535668E89333E7039B8F7F720', 'are_deterministic_algorithms_enabled': False, 'assert_indirect_indexing': True, 'autotune_local_cache': True, 'autotune_pointwise': True, 'autotune_remote_cache': None, 'force_disable_caches': False, 'dynamic_scale_rblock': True, 'max_autotune': False, 'max_autotune_pointwise': False, 'min_split_scan_rblock': 256, 'spill_threshold': 16, 'store_cubin': False, 'tiling_scores': {'x': 1081344, 'r0_': 0}}
)
@triton.jit
def triton_red_fused_convolution_backward_1(in_ptr0, out_ptr0, xnumel, r0_numel, XBLOCK : tl.constexpr, R0_BLOCK : tl.constexpr):
    xnumel = 4096
    r0_numel = 128
    rnumel = r0_numel
...
# kernel path: /mnt/g/GitHub/VAE_ca_proj/Thermal/.compile_cache/eu/ceuxwjdp5s6ruy7fzumm3mrkho5dshw7fchqg7uds2iv7b7up6uy.py
...
triton_red_fused__to_copy_convolution_backward_2 = async_compile.triton('triton_red_fused__to_copy_convolution_backward_2', '''
import triton
import triton.language as tl
...
@triton_heuristics.reduction(
    ...
    inductor_meta={'grid_type': 'Grid1D', 'autotune_hints': set(), 'kernel_name': 'triton_red_fused__to_copy_convolution_backward_2', 'mutated_arg_names': [], 'optimize_mem': True, 'no_x_dim': False, 'num_load': 1, 'num_reduction': 1, 'backend_hash': 'D54CF9E23D08230976451A78161C34C47AAE433535668E89333E7039B8F7F720', 'are_deterministic_algorithms_enabled': False, 'assert_indirect_indexing': True, 'autotune_local_cache': True, 'autotune_pointwise': True, 'autotune_remote_cache': None, 'force_disable_caches': False, 'dynamic_scale_rblock': True, 'max_autotune': False, 'max_autotune_pointwise': False, 'min_split_scan_rblock': 256, 'spill_threshold': 16, 'store_cubin': False, 'tiling_scores': {'x': 8208, 'r0_': 0}}
)
@triton.jit
def triton_red_fused__to_copy_convolution_backward_2(in_ptr0, out_ptr1, xnumel, r0_numel, XBLOCK : tl.constexpr, R0_BLOCK : tl.constexpr):
    xnumel = 4
    r0_numel = 1024
    rnumel = r0_numel
    RBLOCK: tl.constexpr = R0_BLOCK
...
# kernel path: /mnt/g/GitHub/VAE_ca_proj/Thermal/.compile_cache/jk/cjkh6qzipmpb6thmyqxefwcmxlindnjd2phjbmuqb7iibjhyuufs.py
...
# kernel path: /mnt/g/GitHub/VAE_ca_proj/Thermal/.compile_cache/qu/cqukm2wyl5gxjelseysrhqgkzvl7lx4shbecu4luxxf4jcvhqwow.py
...
#   %unsqueeze_15 : Tensor "f32[1, 128][128, 1]cuda:0"[num_users=3] = call_function[target=torch.ops.aten.unsqueeze.default](args = (%primals_151, 0), kwargs = {})
...
#   return %add_81
triton_poi_fused_clone_native_group_norm_silu_4 = async_compile.triton('triton_poi_fused_clone_native_group_norm_silu_4', '''
import triton
import triton.language as tl
...
@triton_heuristics.pointwise(
    ...
    inductor_meta={'grid_type': 'Grid1D', 'autotune_hints': set(), 'kernel_name': 'triton_poi_fused_clone_native_group_norm_silu_4', 'mutated_arg_names': [], 'optimize_mem': True, 'no_x_dim': False, 'num_load': 5, 'num_reduction': 0, 'backend_hash': 'D54CF9E23D08230976451A78161C34C47AAE433535668E89333E7039B8F7F720', 'are_deterministic_algorithms_enabled': False, 'assert_indirect_indexing': True, 'autotune_local_cache': True, 'autotune_pointwise': True, 'autotune_remote_cache': None, 'force_disable_caches': False, 'dynamic_scale_rblock': True, 'max_autotune': False, 'max_autotune_pointwise': False, 'min_split_scan_rblock': 256, 'spill_threshold': 16, 'store_cubin': False, 'tiling_scores': {'x': 167773184}},
    min_elem_per_thread=0
)
@triton.jit
def triton_poi_fused_clone_native_group_norm_silu_4(in_ptr0, in_ptr1, in_ptr2, in_ptr3, in_ptr4, out_ptr0, xnumel, XBLOCK : tl.constexpr):
    xnumel = 16777216
    xoffset = tl.program_id(0) * XBLOCK
    xindex = xoffset + tl.arange(0, XBLOCK)[:]
...
# kernel path: /mnt/g/GitHub/VAE_ca_proj/Thermal/.compile_cache/6h/c6hd7n4rhqaz6z57yhpnfcva3loqunkpew4x4vnuq2qxid2s6bcf.py
...
triton_red_fused__to_copy_add_clone_fill_mul_native_group_norm_backward_silu_sub_5 = async_compile.triton('triton_red_fused__to_copy_add_clone_fill_mul_native_group_norm_backward_silu_sub_5', '''
import triton
import triton.language as tl
...
@triton_heuristics.reduction(
    ...
    inductor_meta={'grid_type': 'Grid1D', 'autotune_hints': set(), 'kernel_name': 'triton_red_fused__to_copy_add_clone_fill_mul_native_group_norm_backward_silu_sub_5', 'mutated_arg_names': [], 'optimize_mem': True, 'no_x_dim': False, 'num_load': 3, 'num_reduction': 2, 'backend_hash': 'D54CF9E23D08230976451A78161C34C47AAE433535668E89333E7039B8F7F720', 'are_deterministic_algorithms_enabled': False, 'assert_indirect_indexing': True, 'autotune_local_cache': True, 'autotune_pointwise': True, 'autotune_remote_cache': None, 'force_disable_caches': False, 'dynamic_scale_rblock': True, 'max_autotune': False, 'max_autotune_pointwise': False, 'min_split_scan_rblock': 256, 'spill_threshold': 16, 'store_cubin': False, 'tiling_scores': {'x': 134479872, 'r0_': 0}}
)
@triton.jit
def triton_red_fused__to_copy_add_clone_fill_mul_native_group_norm_backward_silu_sub_5(in_ptr0, in_ptr1, in_ptr2, out_ptr0, out_ptr1, xnumel, r0_numel, XBLOCK : tl.constexpr, R0_BLOCK : tl.constexpr):
    xnumel = 16384
    r0_numel = 1024
    rnumel = r0_numel
    RBLOCK: tl.constexpr = R0_BLOCK
...
# kernel path: /mnt/g/GitHub/VAE_ca_proj/Thermal/.compile_cache/io/ciopufgjp4r4bjmux7u7i7loj7eccn7fk2c4q47sixdhzmxbsb57.py
...
#   %unsqueeze_23 : Tensor "f32[128, 32, 1][32, 1, 1]cuda:0"[num_users=2] = call_function[target=torch.ops.aten.unsqueeze.default](args = (%squeeze_33, -1), kwargs = {})
...
#   %unsqueeze_29 : Tensor "f32[128, 32, 1][32, 1, 1]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.unsqueeze.default](args = (%squeeze_32, -1), kwargs = {})
#   %mul_93 : Tensor "f32[128, 32, 4][128, 4, 1]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%view_281, %unsqueeze_29), kwargs = {})
...
#   %mul_94 : Tensor "f32[128, 32, 4][128, 4, 1]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%sub_32, %unsqueeze_23), kwargs = {})
...
triton_red_fused_native_group_norm_native_group_norm_backward_6 = async_compile.triton('triton_red_fused_native_group_norm_native_group_norm_backward_6', '''
import triton
import triton.language as tl
...
@triton_heuristics.reduction(
    ...
    inductor_meta={'grid_type': 'Grid1D', 'autotune_hints': set(), 'kernel_name': 'triton_red_fused_native_group_norm_native_group_norm_backward_6', 'mutated_arg_names': [], 'optimize_mem': True, 'no_x_dim': False, 'num_load': 4, 'num_reduction': 2, 'backend_hash': 'D54CF9E23D08230976451A78161C34C47AAE433535668E89333E7039B8F7F720', 'are_deterministic_algorithms_enabled': False, 'assert_indirect_indexing': True, 'autotune_local_cache': True, 'autotune_pointwise': True, 'autotune_remote_cache': None, 'force_disable_caches': False, 'dynamic_scale_rblock': True, 'max_autotune': False, 'max_autotune_pointwise': False, 'min_split_scan_rblock': 256, 'spill_threshold': 16, 'store_cubin': False, 'tiling_scores': {'x': 133120, 'r0_': 0}}
)
@triton.jit
def triton_red_fused_native_group_norm_native_group_norm_backward_6(in_ptr0, in_ptr1, in_ptr2, in_ptr3, out_ptr0, out_ptr1, xnumel, r0_numel, XBLOCK : tl.constexpr, R0_BLOCK : tl.constexpr):
    xnumel = 128
    r0_numel = 128
    rnumel = r0_numel
    RBLOCK: tl.constexpr = R0_BLOCK
...
# kernel path: /mnt/g/GitHub/VAE_ca_proj/Thermal/.compile_cache/wt/cwt47eyal6qbgbqodk642rl47krzsiowgpout7mkeacbtfw4fajx.py
# Topologically Sorted Source Nodes: [input_42], Original ATen: [aten.native_group_norm, aten.native_group_norm_backward]
# Source node to ATen node mapping:
#   input_42 => squeeze_32, unsqueeze_15
# Graph fragment:
#   %sum_13 : Tensor "f32[128, 128][128, 1]cuda:0" = PlaceHolder[target=sum_13]
#   %primals_151 : Tensor "f32[128][1]cuda:0" = PlaceHolder[target=primals_151]
...
#   %sum_12 : Tensor "f32[128, 128][128, 1]cuda:0" = PlaceHolder[target=sum_12]
#   %unsqueeze_15 : Tensor "f32[1, 128][128, 1]cuda:0"[num_users=3] = call_function[target=torch.ops.aten.unsqueeze.default](args = (%primals_151, 0), kwargs = {})
#   %mul_80 : Tensor "f32[128, 128][128, 1]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%sum_12, %unsqueeze_15), kwargs = {})
...
#   %mul_81 : Tensor "f32[128, 128][128, 1]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%sum_13, %unsqueeze_15), kwargs = {})
...
triton_poi_fused_native_group_norm_native_group_norm_backward_7 = async_compile.triton('triton_poi_fused_native_group_norm_native_group_norm_backward_7', '''
import triton
import triton.language as tl
...
@triton_heuristics.pointwise(
    ...
    inductor_meta={'grid_type': 'Grid1D', 'autotune_hints': set(), 'kernel_name': 'triton_poi_fused_native_group_norm_native_group_norm_backward_7', 'mutated_arg_names': [], 'optimize_mem': True, 'no_x_dim': False, 'num_load': 13, 'num_reduction': 0, 'backend_hash': 'D54CF9E23D08230976451A78161C34C47AAE433535668E89333E7039B8F7F720', 'are_deterministic_algorithms_enabled': False, 'assert_indirect_indexing': True, 'autotune_local_cache': True, 'autotune_pointwise': True, 'autotune_remote_cache': None, 'force_disable_caches': False, 'dynamic_scale_rblock': True, 'max_autotune': False, 'max_autotune_pointwise': False, 'min_split_scan_rblock': 256, 'spill_threshold': 16, 'store_cubin': False, 'tiling_scores': {'x': 81920}},
    min_elem_per_thread=0
)
@triton.jit
def triton_poi_fused_native_group_norm_native_group_norm_backward_7(in_ptr0, in_ptr1, in_ptr2, in_ptr3, out_ptr0, out_ptr1, xnumel, XBLOCK : tl.constexpr):
    xnumel = 4096
    xoffset = tl.program_id(0) * XBLOCK
    xindex = xoffset + tl.arange(0, XBLOCK)[:]
    xmask = tl.full([XBLOCK], True, tl.int1)
...
# kernel path: /mnt/g/GitHub/VAE_ca_proj/Thermal/.compile_cache/vu/cvulyakjaajfuo5dkxqqbh737a7hn26li24ce4fvgna2qz2i4rti.py
...
#   %squeeze_33 : Tensor "f32[128, 32][32, 1]cuda:0"[num_users=5] = call_function[target=torch.ops.aten.squeeze.dims](args = (%rsqrt_18, [2, 3]), kwargs = {})
#   %unsqueeze_23 : Tensor "f32[128, 32, 1][32, 1, 1]cuda:0"[num_users=2] = call_function[target=torch.ops.aten.unsqueeze.default](args = (%squeeze_33, -1), kwargs = {})
#   %view_276 : Tensor "f32[1, 32, 4][128, 4, 1]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.reshape.default](args = (%primals_151, [1, 32, 4]), kwargs = {})
#   %mul_82 : Tensor "f32[128, 32, 4][128, 4, 1]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%unsqueeze_23, %view_276), kwargs = {})
#   %squeeze_32 : Tensor "f32[128, 32][32, 1]cuda:0"[num_users=3] = call_function[target=torch.ops.aten.squeeze.dims](args = (%getitem_121, [2, 3]), kwargs = {})
...
#   %unsqueeze_24 : Tensor "f32[128, 32, 4, 1][128, 4, 1, 1]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.unsqueeze.default](args = (%mul_82, -1), kwargs = {})
#   %unsqueeze_25 : Tensor "f32[128, 32, 1][32, 1, 1]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.unsqueeze.default](args = (%mul_87, -1), kwargs = {})
#   %unsqueeze_26 : Tensor "f32[128, 32, 1, 1][32, 1, 1, 1]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.unsqueeze.default](args = (%unsqueeze_25, -1), kwargs = {})
#   %unsqueeze_27 : Tensor "f32[128, 32, 1][32, 1, 1]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.unsqueeze.default](args = (%sub_31, -1), kwargs = {})
#   %unsqueeze_28 : Tensor "f32[128, 32, 1, 1][32, 1, 1, 1]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.unsqueeze.default](args = (%unsqueeze_27, -1), kwargs = {})
...
#   %mul_91 : Tensor "f32[128, 32, 4, 1024][131072, 4096, 1024, 1]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%view_277, %unsqueeze_24), kwargs = {})
#   %mul_92 : Tensor "f32[128, 32, 4, 1024][131072, 4096, 1024, 1]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%view_270, %unsqueeze_26), kwargs = {})
...
#   %add_84 : Tensor "f32[128, 32, 4, 1024][131072, 4096, 1024, 1]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.add.Tensor](args = (%add_83, %unsqueeze_28), kwargs = {})
...
triton_poi_fused__to_copy_add_clone_fill_mul_native_group_norm_native_group_norm_backward_sigmoid_silu_sub_8 = async_compile.triton('triton_poi_fused__to_copy_add_clone_fill_mul_native_group_norm_native_group_norm_backward_sigmoid_silu_sub_8', '''
import triton
import triton.language as tl
...
# kernel path: /mnt/g/GitHub/VAE_ca_proj/Thermal/.compile_cache/o2/co2ynzp6wsxmmtsyysbty2ugu7bd5fsv54nevzcvnabdyy3nhd2j.py
# Topologically Sorted Source Nodes: [], Original ATen: [aten.convolution_backward, aten._to_copy]
# Source node to ATen node mapping:
# Graph fragment:
...
triton_red_fused__to_copy_convolution_backward_9 = async_compile.triton('triton_red_fused__to_copy_convolution_backward_9', '''
import triton
import triton.language as tl
...
@triton_heuristics.reduction(
    ...
    inductor_meta={'grid_type': 'Grid1D', 'autotune_hints': set(), 'kernel_name': 'triton_red_fused__to_copy_convolution_backward_9', 'mutated_arg_names': [], 'optimize_mem': True, 'no_x_dim': False, 'num_load': 1, 'num_reduction': 1, 'backend_hash': 'D54CF9E23D08230976451A78161C34C47AAE433535668E89333E7039B8F7F720', 'are_deterministic_algorithms_enabled': False, 'assert_indirect_indexing': True, 'autotune_local_cache': True, 'autotune_pointwise': True, 'autotune_remote_cache': None, 'force_disable_caches': False, 'dynamic_scale_rblock': True, 'max_autotune': False, 'max_autotune_pointwise': False, 'min_split_scan_rblock': 256, 'spill_threshold': 16, 'store_cubin': False, 'tiling_scores': {'x': 1024, 'r0_': 0}}
)
@triton.jit
def triton_red_fused__to_copy_convolution_backward_9(in_ptr0, out_ptr1, xnumel, r0_numel, XBLOCK : tl.constexpr, R0_BLOCK : tl.constexpr):
    xnumel = 128
    r0_numel = 131072
    rnumel = r0_numel
    RBLOCK: tl.constexpr = R0_BLOCK
...
# kernel path: /mnt/g/GitHub/VAE_ca_proj/Thermal/.compile_cache/7g/c7gzioxjbhe2ui4tfpzuurryiphlnooe3trzvybddihgptd7unay.py
# Topologically Sorted Source Nodes: [], Original ATen: [aten._to_copy]
# Source node to ATen node mapping:
# Graph fragment:
...
@triton_heuristics.pointwise(
    ...
    filename=__file__,
    triton_meta={'signature': {'in_ptr0': '*bf16', 'out_ptr0': '*fp32', 'xnumel': 'i32', 'XBLOCK': 'constexpr'}, 'device': DeviceProperties(type='cuda', index=0, multi_processor_count=36, cc=89, major=8, regs_per_multiprocessor=65536, max_threads_per_multi_processor=1536, warp_size=32), 'constants': {}, 'configs': [{(0,): [['tt.divisibility', 16]], (1,): [['tt.divisibility', 16]], (2,): [['tt.divisibility', 16]]}]},
    inductor_meta={'grid_type': 'Grid1D', 'autotune_hints': set(), 'kernel_name': 'triton_poi_fused__to_copy_10', 'mutated_arg_names': [], 'optimize_mem': True, 'no_x_dim': False, 'num_load': 1, 'num_reduction': 0, 'backend_hash': 'D54CF9E23D08230976451A78161C34C47AAE433535668E89333E7039B8F7F720', 'are_deterministic_algorithms_enabled': False, 'assert_indirect_indexing': True, 'autotune_local_cache': True, 'autotune_pointwise': True, 'autotune_remote_cache': None, 'force_disable_caches': False, 'dynamic_scale_rblock': True, 'max_autotune': False, 'max_autotune_pointwise': False, 'min_split_scan_rblock': 256, 'spill_threshold': 16, 'store_cubin': False, 'tiling_scores': {'x': 163840}},
    min_elem_per_thread=0
)
@triton.jit
...
# kernel path: /mnt/g/GitHub/VAE_ca_proj/Thermal/.compile_cache/e2/ce2o54o6cqsvtiozjjwpy6q7icmut6yfo7hp4y3uhiwk3uwcx325.py
...
triton_red_fused__to_copy_mul_sum_view_11 = async_compile.triton('triton_red_fused__to_copy_mul_sum_view_11', '''
import triton
import triton.language as tl
...
@triton_heuristics.reduction(
    ...
    inductor_meta={'grid_type': 'Grid1D', 'autotune_hints': set(), 'kernel_name': 'triton_red_fused__to_copy_mul_sum_view_11', 'mutated_arg_names': [], 'optimize_mem': True, 'no_x_dim': False, 'num_load': 2, 'num_reduction': 1, 'backend_hash': 'D54CF9E23D08230976451A78161C34C47AAE433535668E89333E7039B8F7F720', 'are_deterministic_algorithms_enabled': False, 'assert_indirect_indexing': True, 'autotune_local_cache': True, 'autotune_pointwise': True, 'autotune_remote_cache': None, 'force_disable_caches': False, 'dynamic_scale_rblock': True, 'max_autotune': False, 'max_autotune_pointwise': False, 'min_split_scan_rblock': 256, 'spill_threshold': 16, 'store_cubin': False, 'tiling_scores': {'x': 33685504, 'r0_': 134217728}}
)
@triton.jit
def triton_red_fused__to_copy_mul_sum_view_11(in_ptr0, in_ptr1, out_ptr0, out_ptr1, xnumel, r0_numel, XBLOCK : tl.constexpr, R0_BLOCK : tl.constexpr):
    xnumel = 16384
    r0_numel = 1024
    rnumel = r0_numel
    RBLOCK: tl.constexpr = R0_BLOCK
...
# kernel path: /mnt/g/GitHub/VAE_ca_proj/Thermal/.compile_cache/i2/ci2hjlgnzy5hqnsvzfqtwp2kkkswxr4yhw2v5paar7jgplu7mryc.py
...
triton_red_fused__to_copy_add_clone_mul_native_group_norm_backward_view_12 = async_compile.triton('triton_red_fused__to_copy_add_clone_mul_native_group_norm_backward_view_12', '''
import triton
import triton.language as tl
...
@triton_heuristics.reduction(
    ...
    inductor_meta={'grid_type': 'Grid1D', 'autotune_hints': set(), 'kernel_name': 'triton_red_fused__to_copy_add_clone_mul_native_group_norm_backward_view_12', 'mutated_arg_names': [], 'optimize_mem': True, 'no_x_dim': False, 'num_load': 4, 'num_reduction': 2, 'backend_hash': 'D54CF9E23D08230976451A78161C34C47AAE433535668E89333E7039B8F7F720', 'are_deterministic_algorithms_enabled': False, 'assert_indirect_indexing': True, 'autotune_local_cache': True, 'autotune_pointwise': True, 'autotune_remote_cache': None, 'force_disable_caches': False, 'dynamic_scale_rblock': True, 'max_autotune': False, 'max_autotune_pointwise': False, 'min_split_scan_rblock': 256, 'spill_threshold': 16, 'store_cubin': False, 'tiling_scores': {'x': 67371008, 'r0_': 100663296}}
)
@triton.jit
def triton_red_fused__to_copy_add_clone_mul_native_group_norm_backward_view_12(in_ptr0, in_ptr1, in_ptr2, in_ptr3, out_ptr0, out_ptr1, xnumel, r0_numel, XBLOCK : tl.constexpr, R0_BLOCK : tl.constexpr):
    xnumel = 16384
    r0_numel = 1024
    rnumel = r0_numel
    RBLOCK: tl.constexpr = R0_BLOCK
...
# kernel path: /mnt/g/GitHub/VAE_ca_proj/Thermal/.compile_cache/xn/cxngn5rrdpdv5gorg47f6n6amkwjcz3kkcfe45bfvxu66iivj5et.py
...
triton_poi_fused_native_group_norm_backward_13 = async_compile.triton('triton_poi_fused_native_group_norm_backward_13', '''
import triton
import triton.language as tl
...
@triton_heuristics.pointwise(
    ...
    inductor_meta={'grid_type': 'Grid1D', 'autotune_hints': set(), 'kernel_name': 'triton_poi_fused_native_group_norm_backward_13', 'mutated_arg_names': ['in_out_ptr0'], 'optimize_mem': True, 'no_x_dim': False, 'num_load': 10, 'num_reduction': 0, 'backend_hash': 'D54CF9E23D08230976451A78161C34C47AAE433535668E89333E7039B8F7F720', 'are_deterministic_algorithms_enabled': False, 'assert_indirect_indexing': True, 'autotune_local_cache': True, 'autotune_pointwise': True, 'autotune_remote_cache': None, 'force_disable_caches': False, 'dynamic_scale_rblock': True, 'max_autotune': False, 'max_autotune_pointwise': False, 'min_split_scan_rblock': 256, 'spill_threshold': 16, 'store_cubin': False, 'tiling_scores': {'x': 98304}},
    min_elem_per_thread=0
)
@triton.jit
def triton_poi_fused_native_group_norm_backward_13(in_out_ptr0, in_ptr0, in_ptr1, in_ptr2, out_ptr0, xnumel, XBLOCK : tl.constexpr):
    xnumel = 4096
    xoffset = tl.program_id(0) * XBLOCK
    xindex = xoffset + tl.arange(0, XBLOCK)[:]
    xmask = tl.full([XBLOCK], True, tl.int1)
...
# kernel path: /mnt/g/GitHub/VAE_ca_proj/Thermal/.compile_cache/b4/cb4wtl5gjb5gi7rlxa3xdia77wbslq5h5sfhidvscwaifseoktkp.py
...
#   %view_291 : Tensor "f32[128, 32, 4][128, 4, 1]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.reshape.default](args = (%sum_21, [128, 32, 4]), kwargs = {})
#   %sum_23 : Tensor "f32[128, 32][32, 1]cuda:0"[num_users=2] = call_function[target=torch.ops.aten.sum.dim_IntList](args = (%view_291, [2]), kwargs = {})
#   %unsqueeze_31 : Tensor "f32[128, 32, 1][32, 1, 1]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.unsqueeze.default](args = (%squeeze_31, -1), kwargs = {})
...
#   %mul_102 : Tensor "f32[128, 32, 4][128, 4, 1]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%unsqueeze_31, %full_default_2), kwargs = {})
#   %mul_104 : Tensor "f32[128, 32][32, 1]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%sub_35, %squeeze_31), kwargs = {})
#   %mul_105 : Tensor "f32[128, 32][32, 1]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%mul_104, %squeeze_31), kwargs = {})
#   %mul_106 : Tensor "f32[128, 32][32, 1]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%mul_105, %squeeze_31), kwargs = {})
#   %mul_107 : Tensor "f32[128, 32][32, 1]cuda:0"[num_users=2] = call_function[target=torch.ops.aten.mul.Tensor](args = (%mul_106, 0.000244140625), kwargs = {})
...
#   %mul_110 : Tensor "f32[128, 32][32, 1]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%mul_109, 0.000244140625), kwargs = {})
#   %sub_36 : Tensor "f32[128, 32][32, 1]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.sub.Tensor](args = (%mul_108, %mul_110), kwargs = {})
#   %unsqueeze_32 : Tensor "f32[128, 32, 4, 1][128, 4, 1, 1]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.unsqueeze.default](args = (%mul_102, -1), kwargs = {})
#   %unsqueeze_33 : Tensor "f32[128, 32, 1][32, 1, 1]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.unsqueeze.default](args = (%mul_107, -1), kwargs = {})
#   %unsqueeze_34 : Tensor "f32[128, 32, 1, 1][32, 1, 1, 1]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.unsqueeze.default](args = (%unsqueeze_33, -1), kwargs = {})
#   %unsqueeze_35 : Tensor "f32[128, 32, 1][32, 1, 1]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.unsqueeze.default](args = (%sub_36, -1), kwargs = {})
#   %unsqueeze_36 : Tensor "f32[128, 32, 1, 1][32, 1, 1, 1]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.unsqueeze.default](args = (%unsqueeze_35, -1), kwargs = {})
...
#   %mul_111 : Tensor "f32[128, 32, 4, 1024][131072, 4096, 1024, 1]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%view_292, %unsqueeze_32), kwargs = {})
...
#   %mul_112 : Tensor "f32[128, 32, 4, 1024][131072, 4096, 1024, 1]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%view_263, %unsqueeze_34), kwargs = {})
...
#   %add_89 : Tensor "f32[128, 32, 4, 1024][131072, 4096, 1024, 1]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.add.Tensor](args = (%add_88, %unsqueeze_36), kwargs = {})
...
triton_poi_fused__to_copy_add_clone_mul_native_group_norm_native_group_norm_backward_view_14 = async_compile.triton('triton_poi_fused__to_copy_add_clone_mul_native_group_norm_native_group_norm_backward_view_14', '''
import triton
import triton.language as tl
...
@triton_heuristics.pointwise(
    ...
    inductor_meta={'grid_type': 'Grid2D', 'autotune_hints': set(), 'kernel_name': 'triton_poi_fused__to_copy_add_clone_mul_native_group_norm_native_group_norm_backward_view_14', 'mutated_arg_names': ['in_out_ptr0'], 'optimize_mem': True, 'no_x_dim': False, 'num_load': 7, 'num_reduction': 0, 'backend_hash': 'D54CF9E23D08230976451A78161C34C47AAE433535668E89333E7039B8F7F720', 'are_deterministic_algorithms_enabled': False, 'assert_indirect_indexing': True, 'autotune_local_cache': True, 'autotune_pointwise': True, 'autotune_remote_cache': None, 'force_disable_caches': False, 'dynamic_scale_rblock': True, 'max_autotune': False, 'max_autotune_pointwise': False, 'min_split_scan_rblock': 256, 'spill_threshold': 16, 'store_cubin': False, 'tiling_scores': {'y': 67108864, 'x': 167772160}},
    min_elem_per_thread=0
)
@triton.jit
def triton_poi_fused__to_copy_add_clone_mul_native_group_norm_native_group_norm_backward_view_14(in_out_ptr0, in_ptr0, in_ptr1, in_ptr2, in_ptr3, in_ptr4, in_ptr5, ynumel, xnumel, YBLOCK : tl.constexpr, XBLOCK : tl.constexpr):
    ynumel = 16384
    xnumel = 1024
...
# kernel path: /mnt/g/GitHub/VAE_ca_proj/Thermal/.compile_cache/ua/cuadapjuv7rc3yt4huvmwzl5w5ppb2huyvsj4zwyatli7wsjvfdl.py
...
@triton_heuristics.pointwise(
    ...
    inductor_meta={'grid_type': 'Grid2D', 'autotune_hints': set(), 'kernel_name': 'triton_poi_fused_add_mul_15', 'mutated_arg_names': ['in_out_ptr0'], 'optimize_mem': True, 'no_x_dim': False, 'num_load': 3, 'num_reduction': 0, 'backend_hash': 'D54CF9E23D08230976451A78161C34C47AAE433535668E89333E7039B8F7F720', 'are_deterministic_algorithms_enabled': False, 'assert_indirect_indexing': True, 'autotune_local_cache': True, 'autotune_pointwise': True, 'autotune_remote_cache': None, 'force_disable_caches': False, 'dynamic_scale_rblock': True, 'max_autotune': False, 'max_autotune_pointwise': False, 'min_split_scan_rblock': 256, 'spill_threshold': 16, 'store_cubin': False, 'tiling_scores': {'y': 67108864, 'x': 100663296}},
    min_elem_per_thread=0
)
@triton.jit
def triton_poi_fused_add_mul_15(in_out_ptr0, in_ptr0, in_ptr1, ynumel, xnumel, YBLOCK : tl.constexpr, XBLOCK : tl.constexpr):
    ynumel = 16384
    xnumel = 1024
    yoffset = tl.program_id(1) * YBLOCK
    yindex = yoffset + tl.arange(0, YBLOCK)[:, None]
...
# kernel path: /mnt/g/GitHub/VAE_ca_proj/Thermal/.compile_cache/xa/cxauzsp5p3ie7cwnr4hk4gu77qzvanlyirqb3zxf2m2gv56ide5j.py
# Topologically Sorted Source Nodes: [], Original ATen: [aten._to_copy]
# Source node to ATen node mapping:
# Graph fragment:
...
# kernel path: /mnt/g/GitHub/VAE_ca_proj/Thermal/.compile_cache/p4/cp4lqhi3hp44o53m67adxk7kxq3ai7gk5bbdghpra4blssnslh6z.py
...
triton_red_fused__to_copy_add_mul_sigmoid_sigmoid_backward_squeeze_sum_17 = async_compile.triton('triton_red_fused__to_copy_add_mul_sigmoid_sigmoid_backward_squeeze_sum_17', '''
import triton
import triton.language as tl
...
# kernel path: /mnt/g/GitHub/VAE_ca_proj/Thermal/.compile_cache/je/cjeljmowkhb2m746y4vrsyh62najmodawem7clk3giflnagy6jbx.py
...
@triton.jit
def triton_poi_fused_mul_18(in_out_ptr0, in_ptr0, xnumel, XBLOCK : tl.constexpr):
    xnumel = 8388608
    xoffset = tl.program_id(0) * XBLOCK
    xindex = xoffset + tl.arange(0, XBLOCK)[:]
    xmask = tl.full([XBLOCK], True, tl.int1)
...
# kernel path: /mnt/g/GitHub/VAE_ca_proj/Thermal/.compile_cache/pn/cpnn6xisptz2th52y6zl7hw6dsfgwsllkdmhegwmw5j5rocrrkjp.py
...
#   return %mul_191
triton_poi_fused_add_fill_mul_sigmoid_sub_19 = async_compile.triton('triton_poi_fused_add_fill_mul_sigmoid_sub_19', '''
import triton
import triton.language as tl
...
@triton_heuristics.pointwise(
    ...
    filename=__file__,
    triton_meta={'signature': {'in_out_ptr0': '*bf16', 'in_ptr0': '*bf16', 'xnumel': 'i32', 'XBLOCK': 'constexpr'}, 'device': DeviceProperties(type='cuda', index=0, multi_processor_count=36, cc=89, major=8, regs_per_multiprocessor=65536, max_threads_per_multi_processor=1536, warp_size=32), 'constants': {}, 'configs': [{(0,): [['tt.divisibility', 16]], (1,): [['tt.divisibility', 16]], (2,): [['tt.divisibility', 16]]}]},
    inductor_meta={'grid_type': 'Grid1D', 'autotune_hints': set(), 'kernel_name': 'triton_poi_fused_add_fill_mul_sigmoid_sub_19', 'mutated_arg_names': ['in_out_ptr0'], 'optimize_mem': True, 'no_x_dim': False, 'num_load': 2, 'num_reduction': 0, 'backend_hash': 'D54CF9E23D08230976451A78161C34C47AAE433535668E89333E7039B8F7F720', 'are_deterministic_algorithms_enabled': False, 'assert_indirect_indexing': True, 'autotune_local_cache': True, 'autotune_pointwise': True, 'autotune_remote_cache': None, 'force_disable_caches': False, 'dynamic_scale_rblock': True, 'max_autotune': False, 'max_autotune_pointwise': False, 'min_split_scan_rblock': 256, 'spill_threshold': 16, 'store_cubin': False, 'tiling_scores': {'x': 262144}},
    min_elem_per_thread=0
)
@triton.jit
def triton_poi_fused_add_fill_mul_sigmoid_sub_19(in_out_ptr0, in_ptr0, xnumel, XBLOCK : tl.constexpr):
    xnumel = 32768
    xoffset = tl.program_id(0) * XBLOCK
    xindex = xoffset + tl.arange(0, XBLOCK)[:]
    xmask = tl.full([XBLOCK], True, tl.int1)
...
# kernel path: /mnt/g/GitHub/VAE_ca_proj/Thermal/.compile_cache/im/cimz5vlenrdcexcw7l5mmq453yhec76gfyk7i7uz42jzevsajyem.py
...
# kernel path: /mnt/g/GitHub/VAE_ca_proj/Thermal/.compile_cache/lm/clmpkm7hl6vvnbx4kaztvsq4vspgtecmx3gbtdvohcadijdnmshs.py
# Topologically Sorted Source Nodes: [], Original ATen: [aten.sum]
# Source node to ATen node mapping:
# Graph fragment:
...
#   return %sum_55
triton_red_fused_sum_21 = async_compile.triton('triton_red_fused_sum_21', '''
import triton
import triton.language as tl
...
@triton_heuristics.reduction(
    ...
    filename=__file__,
    triton_meta={'signature': {'in_ptr0': '*bf16', 'out_ptr0': '*fp32', 'xnumel': 'i32', 'r0_numel': 'i32', 'XBLOCK': 'constexpr', 'R0_BLOCK': 'constexpr'}, 'device': DeviceProperties(type='cuda', index=0, multi_processor_count=36, cc=89, major=8, regs_per_multiprocessor=65536, max_threads_per_multi_processor=1536, warp_size=32), 'constants': {}, 'configs': [{(0,): [['tt.divisibility', 16]], (1,): [['tt.divisibility', 16]], (2,): [['tt.divisibility', 16]], (3,): [['tt.divisibility', 16]]}]},
    inductor_meta={'grid_type': 'Grid1D', 'autotune_hints': set(), 'kernel_name': 'triton_red_fused_sum_21', 'mutated_arg_names': [], 'optimize_mem': True, 'no_x_dim': False, 'num_load': 1, 'num_reduction': 1, 'backend_hash': 'D54CF9E23D08230976451A78161C34C47AAE433535668E89333E7039B8F7F720', 'are_deterministic_algorithms_enabled': False, 'assert_indirect_indexing': True, 'autotune_local_cache': True, 'autotune_pointwise': True, 'autotune_remote_cache': None, 'force_disable_caches': False, 'dynamic_scale_rblock': True, 'max_autotune': False, 'max_autotune_pointwise': False, 'min_split_scan_rblock': 256, 'spill_threshold': 16, 'store_cubin': False, 'tiling_scores': {'x': 67584, 'r0_': 0}}
)
@triton.jit
def triton_red_fused_sum_21(in_ptr0, out_ptr0, xnumel, r0_numel, XBLOCK : tl.constexpr, R0_BLOCK : tl.constexpr):
    xnumel = 256
    r0_numel = 128
    rnumel = r0_numel
    RBLOCK: tl.constexpr = R0_BLOCK
...
# kernel path: /mnt/g/GitHub/VAE_ca_proj/Thermal/.compile_cache/5a/c5ankqw3lghpscxllvqkc53hlc6ybraaw364deyvpfqrmc4zxr52.py
# Topologically Sorted Source Nodes: [], Original ATen: [aten._to_copy]
# Source node to ATen node mapping:
# Graph fragment:
...
# kernel path: /mnt/g/GitHub/VAE_ca_proj/Thermal/.compile_cache/pv/cpvdehmbflwavg7vf3r3hye7tjikqlinrrzwqovv6ttznrdutjrn.py
# Topologically Sorted Source Nodes: [], Original ATen: [aten._to_copy]
# Source node to ATen node mapping:
# Graph fragment:
...
# kernel path: /mnt/g/GitHub/VAE_ca_proj/Thermal/.compile_cache/hb/chbwpvcb6gztkhbcohwa5pn2c3joesmzz2msjbnfhc7srvrc2tto.py
# Topologically Sorted Source Nodes: [], Original ATen: [aten.convolution_backward]
# Source node to ATen node mapping:
# Graph fragment:
...
#   return %buf156
triton_red_fused_convolution_backward_24 = async_compile.triton('triton_red_fused_convolution_backward_24', '''
import triton
import triton.language as tl
...
@triton_heuristics.reduction(
    ...
    filename=__file__,
    triton_meta={'signature': {'in_ptr0': '*bf16', 'out_ptr0': '*fp32', 'xnumel': 'i32', 'r0_numel': 'i32', 'XBLOCK': 'constexpr', 'R0_BLOCK': 'constexpr'}, 'device': DeviceProperties(type='cuda', index=0, multi_processor_count=36, cc=89, major=8, regs_per_multiprocessor=65536, max_threads_per_multi_processor=1536, warp_size=32), 'constants': {}, 'configs': [{(0,): [['tt.divisibility', 16]], (1,): [['tt.divisibility', 16]], (2,): [['tt.divisibility', 16]], (3,): [['tt.divisibility', 16]]}]},
    inductor_meta={'grid_type': 'Grid1D', 'autotune_hints': set(), 'kernel_name': 'triton_red_fused_convolution_backward_24', 'mutated_arg_names': [], 'optimize_mem': True, 'no_x_dim': False, 'num_load': 1, 'num_reduction': 1, 'backend_hash': 'D54CF9E23D08230976451A78161C34C47AAE433535668E89333E7039B8F7F720', 'are_deterministic_algorithms_enabled': False, 'assert_indirect_indexing': True, 'autotune_local_cache': True, 'autotune_pointwise': True, 'autotune_remote_cache': None, 'force_disable_caches': False, 'dynamic_scale_rblock': True, 'max_autotune': False, 'max_autotune_pointwise': False, 'min_split_scan_rblock': 256, 'spill_threshold': 16, 'store_cubin': False, 'tiling_scores': {'x': 17039360, 'r0_': 0}}
)
@triton.jit
def triton_red_fused_convolution_backward_24(in_ptr0, out_ptr0, xnumel, r0_numel, XBLOCK : tl.constexpr, R0_BLOCK : tl.constexpr):
    xnumel = 32768
    r0_numel = 256
    rnumel = r0_numel
    RBLOCK: tl.constexpr = R0_BLOCK
...
# kernel path: /mnt/g/GitHub/VAE_ca_proj/Thermal/.compile_cache/ic/cicpfaqtibdavqsrtrhfdhvc5wpeghptohzbf3lxyjk4mme5wzyk.py
# Topologically Sorted Source Nodes: [], Original ATen: [aten.convolution_backward, aten._to_copy]
# Source node to ATen node mapping:
# Graph fragment:
...
triton_red_fused__to_copy_convolution_backward_25 = async_compile.triton('triton_red_fused__to_copy_convolution_backward_25', '''
import triton
import triton.language as tl
...
@triton_heuristics.reduction(
    ...
    filename=__file__,
    triton_meta={'signature': {'in_ptr0': '*fp32', 'out_ptr1': '*fp32', 'xnumel': 'i32', 'r0_numel': 'i32', 'XBLOCK': 'constexpr', 'R0_BLOCK': 'constexpr'}, 'device': DeviceProperties(type='cuda', index=0, multi_processor_count=36, cc=89, major=8, regs_per_multiprocessor=65536, max_threads_per_multi_processor=1536, warp_size=32), 'constants': {}, 'configs': [{(0,): [['tt.divisibility', 16]], (1,): [['tt.divisibility', 16]], (2,): [['tt.divisibility', 16]], (3,): [['tt.divisibility', 16]]}]},
    inductor_meta={'grid_type': 'Grid1D', 'autotune_hints': set(), 'kernel_name': 'triton_red_fused__to_copy_convolution_backward_25', 'mutated_arg_names': [], 'optimize_mem': True, 'no_x_dim': False, 'num_load': 1, 'num_reduction': 1, 'backend_hash': 'D54CF9E23D08230976451A78161C34C47AAE433535668E89333E7039B8F7F720', 'are_deterministic_algorithms_enabled': False, 'assert_indirect_indexing': True, 'autotune_local_cache': True, 'autotune_pointwise': True, 'autotune_remote_cache': None, 'force_disable_caches': False, 'dynamic_scale_rblock': True, 'max_autotune': False, 'max_autotune_pointwise': False, 'min_split_scan_rblock': 256, 'spill_threshold': 16, 'store_cubin': False, 'tiling_scores': {'x': 133120, 'r0_': 0}}
)
@triton.jit
def triton_red_fused__to_copy_convolution_backward_25(in_ptr0, out_ptr1, xnumel, r0_numel, XBLOCK : tl.constexpr, R0_BLOCK : tl.constexpr):
    xnumel = 256
    r0_numel = 128
    rnumel = r0_numel
    RBLOCK: tl.constexpr = R0_BLOCK
...
# kernel path: /mnt/g/GitHub/VAE_ca_proj/Thermal/.compile_cache/zu/czusldco427ci4goeblsp4zhdsk7vjy3345em4d3y3tnxesb4wvb.py
# Topologically Sorted Source Nodes: [], Original ATen: [aten._to_copy]
# Source node to ATen node mapping:
# Graph fragment:
...
# kernel path: /mnt/g/GitHub/VAE_ca_proj/Thermal/.compile_cache/6f/c6f44vsgnbnrztekobivqhjqtnhqgagcclschtlkugi5ptyynnkk.py
# Topologically Sorted Source Nodes: [], Original ATen: [aten._to_copy, aten.mul, aten.sum, aten.view]
# Source node to ATen node mapping:
# Graph fragment:
...
triton_red_fused__to_copy_mul_sum_view_27 = async_compile.triton('triton_red_fused__to_copy_mul_sum_view_27', '''
import triton
import triton.language as tl
...
@triton_heuristics.reduction(
    ...
    filename=__file__,
    triton_meta={'signature': {'in_ptr0': '*bf16', 'in_ptr1': '*fp32', 'out_ptr0': '*fp32', 'out_ptr1': '*bf16', 'xnumel': 'i32', 'r0_numel': 'i32', 'XBLOCK': 'constexpr', 'R0_BLOCK': 'constexpr'}, 'device': DeviceProperties(type='cuda', index=0, multi_processor_count=36, cc=89, major=8, regs_per_multiprocessor=65536, max_threads_per_multi_processor=1536, warp_size=32), 'constants': {}, 'configs': [{(0,): [['tt.divisibility', 16]], (1,): [['tt.divisibility', 16]], (2,): [['tt.divisibility', 16]], (3,): [['tt.divisibility', 16]], (4,): [['tt.divisibility', 16]], (5,): [['tt.divisibility', 16]]}]},
    inductor_meta={'grid_type': 'Grid1D', 'autotune_hints': set(), 'kernel_name': 'triton_red_fused__to_copy_mul_sum_view_27', 'mutated_arg_names': [], 'optimize_mem': True, 'no_x_dim': False, 'num_load': 2, 'num_reduction': 1, 'backend_hash': 'D54CF9E23D08230976451A78161C34C47AAE433535668E89333E7039B8F7F720', 'are_deterministic_algorithms_enabled': False, 'assert_indirect_indexing': True, 'autotune_local_cache': True, 'autotune_pointwise': True, 'autotune_remote_cache': None, 'force_disable_caches': False, 'dynamic_scale_rblock': True, 'max_autotune': False, 'max_autotune_pointwise': False, 'min_split_scan_rblock': 256, 'spill_threshold': 16, 'store_cubin': False, 'tiling_scores': {'x': 17039360, 'r0_': 67108864}}
)
@triton.jit
def triton_red_fused__to_copy_mul_sum_view_27(in_ptr0, in_ptr1, out_ptr0, out_ptr1, xnumel, r0_numel, XBLOCK : tl.constexpr, R0_BLOCK : tl.constexpr):
    xnumel = 32768
    r0_numel = 256
    rnumel = r0_numel
    RBLOCK: tl.constexpr = R0_BLOCK
...
# kernel path: /mnt/g/GitHub/VAE_ca_proj/Thermal/.compile_cache/je/cjes27zusewikiigmnxbbrim5p5qnglqus3ysfvyhxcljsh73ftl.py
...
triton_red_fused__to_copy_add_clone_mul_native_group_norm_backward_view_28 = async_compile.triton('triton_red_fused__to_copy_add_clone_mul_native_group_norm_backward_view_28', '''
import triton
import triton.language as tl
...
@triton_heuristics.reduction(
    ...
    filename=__file__,
    triton_meta={'signature': {'in_ptr0': '*bf16', 'in_ptr1': '*fp32', 'in_ptr2': '*bf16', 'in_ptr3': '*bf16', 'out_ptr0': '*fp32', 'out_ptr1': '*fp32', 'xnumel': 'i32', 'r0_numel': 'i32', 'XBLOCK': 'constexpr', 'R0_BLOCK': 'constexpr'}, 'device': DeviceProperties(type='cuda', index=0, multi_processor_count=36, cc=89, major=8, regs_per_multiprocessor=65536, max_threads_per_multi_processor=1536, warp_size=32), 'constants': {}, 'configs': [{(0,): [['tt.divisibility', 16]], (1,): [['tt.divisibility', 16]], (2,): [['tt.divisibility', 16]], (3,): [['tt.divisibility', 16]], (4,): [['tt.divisibility', 16]], (5,): [['tt.divisibility', 16]], (6,): [['tt.divisibility', 16]], (7,): [['tt.divisibility', 16]]}]},
    inductor_meta={'grid_type': 'Grid1D', 'autotune_hints': set(), 'kernel_name': 'triton_red_fused__to_copy_add_clone_mul_native_group_norm_backward_view_28', 'mutated_arg_names': [], 'optimize_mem': True, 'no_x_dim': False, 'num_load': 4, 'num_reduction': 2, 'backend_hash': 'D54CF9E23D08230976451A78161C34C47AAE433535668E89333E7039B8F7F720', 'are_deterministic_algorithms_enabled': False, 'assert_indirect_indexing': True, 'autotune_local_cache': True, 'autotune_pointwise': True, 'autotune_remote_cache': None, 'force_disable_caches': False, 'dynamic_scale_rblock': True, 'max_autotune': False, 'max_autotune_pointwise': False, 'min_split_scan_rblock': 256, 'spill_threshold': 16, 'store_cubin': False, 'tiling_scores': {'x': 34078720, 'r0_': 50331648}}
)
@triton.jit
def triton_red_fused__to_copy_add_clone_mul_native_group_norm_backward_view_28(in_ptr0, in_ptr1, in_ptr2, in_ptr3, out_ptr0, out_ptr1, xnumel, r0_numel, XBLOCK : tl.constexpr, R0_BLOCK : tl.constexpr):
    xnumel = 32768
    r0_numel = 256
    rnumel = r0_numel
    RBLOCK: tl.constexpr = R0_BLOCK
...
# kernel path: /mnt/g/GitHub/VAE_ca_proj/Thermal/.compile_cache/j3/cj35wbyit3eq6wliiwthdkiexirl5ojkwyxnjqdkn4aizqelj45k.py
# Topologically Sorted Source Nodes: [], Original ATen: [aten.native_group_norm_backward]
# Source node to ATen node mapping:
# Graph fragment:
...
#   return %sum_61
triton_per_fused_native_group_norm_backward_29 = async_compile.triton('triton_per_fused_native_group_norm_backward_29', '''
import triton
import triton.language as tl
...
@triton_heuristics.persistent_reduction(
    ...
    inductor_meta={'grid_type': 'Grid1D', 'autotune_hints': set(), 'kernel_name': 'triton_per_fused_native_group_norm_backward_29', 'mutated_arg_names': [], 'optimize_mem': True, 'no_x_dim': None, 'num_load': 1, 'num_reduction': 1, 'backend_hash': 'D54CF9E23D08230976451A78161C34C47AAE433535668E89333E7039B8F7F720', 'are_deterministic_algorithms_enabled': False, 'assert_indirect_indexing': True, 'autotune_local_cache': True, 'autotune_pointwise': True, 'autotune_remote_cache': None, 'force_disable_caches': False, 'dynamic_scale_rblock': True, 'max_autotune': False, 'max_autotune_pointwise': False, 'min_split_scan_rblock': 256, 'spill_threshold': 16, 'store_cubin': False, 'tiling_scores': {'x': 32768, 'r0_': 131072}}
)
@triton.jit
def triton_per_fused_native_group_norm_backward_29(in_ptr0, out_ptr0, xnumel, r0_numel, XBLOCK : tl.constexpr):
    xnumel = 4096
    r0_numel = 8
...
# kernel path: /mnt/g/GitHub/VAE_ca_proj/Thermal/.compile_cache/u7/cu7ovlsbvbp6sghebhnaszg4yraurc7kesh26excby3jfcnjb7oh.py
...
#   %convert_element_type_388 : Tensor "f32[128, 256, 16, 16][65536, 1, 4096, 256]cuda:0"[num_users=1] = call_function[target=torch.ops.prims.convert_element_type.default](args = (%convolution_24, torch.float32), kwargs = {})
#   %clone_50 : Tensor "f32[128, 256, 16, 16][65536, 256, 16, 1]cuda:0"[num_users=2] = call_function[target=torch.ops.aten.clone.default](args = (%convert_element_type_388,), kwargs = {memory_format: torch.contiguous_format})
#   %unsqueeze_61 : Tensor "f32[128, 32, 1][32, 1, 1]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.unsqueeze.default](args = (%squeeze_21, -1), kwargs = {})
...
#   %mul_199 : Tensor "f32[128, 32, 8][256, 8, 1]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%unsqueeze_61, %full_default_13), kwargs = {})
...
#   %unsqueeze_62 : Tensor "f32[128, 32, 8, 1][256, 8, 1, 1]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.unsqueeze.default](args = (%mul_199, -1), kwargs = {})
#   %unsqueeze_63 : Tensor "f32[128, 32, 1][32, 1, 1]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.unsqueeze.default](args = (%mul_204, -1), kwargs = {})
#   %unsqueeze_64 : Tensor "f32[128, 32, 1, 1][32, 1, 1, 1]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.unsqueeze.default](args = (%unsqueeze_63, -1), kwargs = {})
#   %unsqueeze_65 : Tensor "f32[128, 32, 1][32, 1, 1]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.unsqueeze.default](args = (%sub_58, -1), kwargs = {})
#   %unsqueeze_66 : Tensor "f32[128, 32, 1, 1][32, 1, 1, 1]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.unsqueeze.default](args = (%unsqueeze_65, -1), kwargs = {})
...
#   %mul_208 : Tensor "f32[128, 32, 8, 256][65536, 2048, 256, 1]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%view_354, %unsqueeze_62), kwargs = {})
...
#   %mul_209 : Tensor "f32[128, 32, 8, 256][65536, 2048, 256, 1]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%view_228, %unsqueeze_64), kwargs = {})
...
#   %add_124 : Tensor "f32[128, 32, 8, 256][65536, 2048, 256, 1]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.add.Tensor](args = (%add_123, %unsqueeze_66), kwargs = {})
...
triton_poi_fused__to_copy_add_clone_mul_native_group_norm_native_group_norm_backward_view_30 = async_compile.triton('triton_poi_fused__to_copy_add_clone_mul_native_group_norm_native_group_norm_backward_view_30', '''
import triton
import triton.language as tl
...
# kernel path: /mnt/g/GitHub/VAE_ca_proj/Thermal/.compile_cache/wk/cwksvc2iikitvhbwrwmpi2nvlf2hysnajuje6mpuootzeluiy6rc.py
# Topologically Sorted Source Nodes: [], Original ATen: [aten.convolution_backward, aten._to_copy]
# Source node to ATen node mapping:
# Graph fragment:
...
triton_red_fused__to_copy_convolution_backward_31 = async_compile.triton('triton_red_fused__to_copy_convolution_backward_31', '''
import triton
import triton.language as tl
...
@triton_heuristics.reduction(
    ...
    filename=__file__,
    triton_meta={'signature': {'in_ptr0': '*bf16', 'out_ptr1': '*fp32', 'xnumel': 'i32', 'r0_numel': 'i32', 'XBLOCK': 'constexpr', 'R0_BLOCK': 'constexpr'}, 'device': DeviceProperties(type='cuda', index=0, multi_processor_count=36, cc=89, major=8, regs_per_multiprocessor=65536, max_threads_per_multi_processor=1536, warp_size=32), 'constants': {}, 'configs': [{(0,): [['tt.divisibility', 16]], (1,): [['tt.divisibility', 16]], (2,): [['tt.divisibility', 16]], (3,): [['tt.divisibility', 16]]}]},
    inductor_meta={'grid_type': 'Grid1D', 'autotune_hints': set(), 'kernel_name': 'triton_red_fused__to_copy_convolution_backward_31', 'mutated_arg_names': [], 'optimize_mem': True, 'no_x_dim': False, 'num_load': 1, 'num_reduction': 1, 'backend_hash': 'D54CF9E23D08230976451A78161C34C47AAE433535668E89333E7039B8F7F720', 'are_deterministic_algorithms_enabled': False, 'assert_indirect_indexing': True, 'autotune_local_cache': True, 'autotune_pointwise': True, 'autotune_remote_cache': None, 'force_disable_caches': False, 'dynamic_scale_rblock': True, 'max_autotune': False, 'max_autotune_pointwise': False, 'min_split_scan_rblock': 256, 'spill_threshold': 16, 'store_cubin': False, 'tiling_scores': {'x': 2048, 'r0_': 0}}
)
@triton.jit
def triton_red_fused__to_copy_convolution_backward_31(in_ptr0, out_ptr1, xnumel, r0_numel, XBLOCK : tl.constexpr, R0_BLOCK : tl.constexpr):
    xnumel = 256
    r0_numel = 32768
    rnumel = r0_numel
    RBLOCK: tl.constexpr = R0_BLOCK
...
# kernel path: /mnt/g/GitHub/VAE_ca_proj/Thermal/.compile_cache/ft/cftlfuo3bzsiqgj35sveq477ipfd5zcmyo7zt7iddswyolqj7eib.py
# Topologically Sorted Source Nodes: [], Original ATen: [aten._to_copy]
# Source node to ATen node mapping:
# Graph fragment:
...
# kernel path: /mnt/g/GitHub/VAE_ca_proj/Thermal/.compile_cache/gd/cgd6yhhjhqkshrackny2whextq23y6t46w4ocdw4yyjysq6lhcly.py
...
#   return %mul_211
triton_poi_fused_native_dropout_backward_transpose_view_33 = async_compile.triton('triton_poi_fused_native_dropout_backward_transpose_view_33', '''
import triton
import triton.language as tl
...
@triton_heuristics.pointwise(
    ...
    inductor_meta={'grid_type': 'Grid1D', 'autotune_hints': set(), 'kernel_name': 'triton_poi_fused_native_dropout_backward_transpose_view_33', 'mutated_arg_names': [], 'optimize_mem': True, 'no_x_dim': False, 'num_load': 2, 'num_reduction': 0, 'backend_hash': 'D54CF9E23D08230976451A78161C34C47AAE433535668E89333E7039B8F7F720', 'are_deterministic_algorithms_enabled': False, 'assert_indirect_indexing': True, 'autotune_local_cache': True, 'autotune_pointwise': True, 'autotune_remote_cache': None, 'force_disable_caches': False, 'dynamic_scale_rblock': True, 'max_autotune': False, 'max_autotune_pointwise': False, 'min_split_scan_rblock': 256, 'spill_threshold': 16, 'store_cubin': False, 'tiling_scores': {'x': 58720256}},
    min_elem_per_thread=0
)
@triton.jit
def triton_poi_fused_native_dropout_backward_transpose_view_33(in_ptr0, in_ptr1, out_ptr0, xnumel, XBLOCK : tl.constexpr):
    xnumel = 8388608
    xoffset = tl.program_id(0) * XBLOCK
    xindex = xoffset + tl.arange(0, XBLOCK)[:]
    xmask = tl.full([XBLOCK], True, tl.int1)
...
# kernel path: /mnt/g/GitHub/VAE_ca_proj/Thermal/.compile_cache/r3/cr3d4tunkutkv2sxan6cay7r3v3q4c6d6zhbkziwipes7v4ldnae.py
...
# kernel path: /mnt/g/GitHub/VAE_ca_proj/Thermal/.compile_cache/o2/co2s7wsugajfddcx74jlrajzfnfcealanohygmreqe56v3vfng2e.py
# Topologically Sorted Source Nodes: [], Original ATen: [aten.view, aten.transpose, aten.native_dropout_backward, aten.sum]
# Source node to ATen node mapping:
# Graph fragment:
...
#   %sum_64 : Tensor "f32[1, 256][256, 1]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.sum.dim_IntList](args = (%view_358, [0], True), kwargs = {dtype: torch.float32})
#   return %sum_64
triton_red_fused_native_dropout_backward_sum_transpose_view_35 = async_compile.triton('triton_red_fused_native_dropout_backward_sum_transpose_view_35', '''
import triton
import triton.language as tl
...
@triton_heuristics.reduction(
    ...
    inductor_meta={'grid_type': 'Grid1D', 'autotune_hints': set(), 'kernel_name': 'triton_red_fused_native_dropout_backward_sum_transpose_view_35', 'mutated_arg_names': [], 'optimize_mem': True, 'no_x_dim': False, 'num_load': 1, 'num_reduction': 1, 'backend_hash': 'D54CF9E23D08230976451A78161C34C47AAE433535668E89333E7039B8F7F720', 'are_deterministic_algorithms_enabled': False, 'assert_indirect_indexing': True, 'autotune_local_cache': True, 'autotune_pointwise': True, 'autotune_remote_cache': None, 'force_disable_caches': False, 'dynamic_scale_rblock': True, 'max_autotune': False, 'max_autotune_pointwise': False, 'min_split_scan_rblock': 256, 'spill_threshold': 16, 'store_cubin': False, 'tiling_scores': {'x': 133120, 'r0_': 0}}
)
@triton.jit
def triton_red_fused_native_dropout_backward_sum_transpose_view_35(in_ptr0, out_ptr0, xnumel, r0_numel, XBLOCK : tl.constexpr, R0_BLOCK : tl.constexpr):
    xnumel = 256
    r0_numel = 128
    rnumel = r0_numel
    RBLOCK: tl.constexpr = R0_BLOCK
...
# kernel path: /mnt/g/GitHub/VAE_ca_proj/Thermal/.compile_cache/65/c65czqssybhtm7dzokenkor333cfhtz2nn4yjbij2ae2z2csd3h7.py
...
#   return %clone_77
triton_poi_fused_clone_transpose_view_36 = async_compile.triton('triton_poi_fused_clone_transpose_view_36', '''
import triton
import triton.language as tl
...
@triton_heuristics.pointwise(
    ...
    inductor_meta={'grid_type': 'Grid1D', 'autotune_hints': set(), 'kernel_name': 'triton_poi_fused_clone_transpose_view_36', 'mutated_arg_names': [], 'optimize_mem': True, 'no_x_dim': False, 'num_load': 1, 'num_reduction': 0, 'backend_hash': 'D54CF9E23D08230976451A78161C34C47AAE433535668E89333E7039B8F7F720', 'are_deterministic_algorithms_enabled': False, 'assert_indirect_indexing': True, 'autotune_local_cache': True, 'autotune_pointwise': True, 'autotune_remote_cache': None, 'force_disable_caches': False, 'dynamic_scale_rblock': True, 'max_autotune': False, 'max_autotune_pointwise': False, 'min_split_scan_rblock': 256, 'spill_threshold': 16, 'store_cubin': False, 'tiling_scores': {'x': 50331648}},
    min_elem_per_thread=0
)
@triton.jit
def triton_poi_fused_clone_transpose_view_36(in_ptr0, out_ptr0, xnumel, XBLOCK : tl.constexpr):
    xnumel = 8388608
    xoffset = tl.program_id(0) * XBLOCK
    xindex = xoffset + tl.arange(0, XBLOCK)[:]
    xmask = tl.full([XBLOCK], True, tl.int1)
...
# kernel path: /mnt/g/GitHub/VAE_ca_proj/Thermal/.compile_cache/hv/chvfo3qxodzto7m43wc3gsy76y5bgtozgjtifs2pxzdjlurt4wse.py
...
#   return %mul_213
triton_poi_fused__softmax__softmax_backward_data__to_copy_amax_mul_sub_view_37 = async_compile.triton('triton_poi_fused__softmax__softmax_backward_data__to_copy_amax_mul_sub_view_37', '''
import triton
import triton.language as tl
...
@triton_heuristics.pointwise(
    ...
    filename=__file__,
    triton_meta={'signature': {'in_out_ptr0': '*bf16', 'in_ptr0': '*bf16', 'xnumel': 'i32', 'XBLOCK': 'constexpr'}, 'device': DeviceProperties(type='cuda', index=0, multi_processor_count=36, cc=89, major=8, regs_per_multiprocessor=65536, max_threads_per_multi_processor=1536, warp_size=32), 'constants': {}, 'configs': [{(0,): [['tt.divisibility', 16]], (1,): [['tt.divisibility', 16]], (2,): [['tt.divisibility', 16]]}]},
    inductor_meta={'grid_type': 'Grid1D', 'autotune_hints': set(), 'kernel_name': 'triton_poi_fused__softmax__softmax_backward_data__to_copy_amax_mul_sub_view_37', 'mutated_arg_names': ['in_out_ptr0'], 'optimize_mem': True, 'no_x_dim': False, 'num_load': 2, 'num_reduction': 0, 'backend_hash': 'D54CF9E23D08230976451A78161C34C47AAE433535668E89333E7039B8F7F720', 'are_deterministic_algorithms_enabled': False, 'assert_indirect_indexing': True, 'autotune_local_cache': True, 'autotune_pointwise': True, 'autotune_remote_cache': None, 'force_disable_caches': False, 'dynamic_scale_rblock': True, 'max_autotune': False, 'max_autotune_pointwise': False, 'min_split_scan_rblock': 256, 'spill_threshold': 16, 'store_cubin': False, 'tiling_scores': {'x': 1048576}},
    min_elem_per_thread=0
)
@triton.jit
def triton_poi_fused__softmax__softmax_backward_data__to_copy_amax_mul_sub_view_37(in_out_ptr0, in_ptr0, xnumel, XBLOCK : tl.constexpr):
    xnumel = 131072
    xoffset = tl.program_id(0) * XBLOCK
    xindex = xoffset + tl.arange(0, XBLOCK)[:]
    xmask = tl.full([XBLOCK], True, tl.int1)
...
# kernel path: /mnt/g/GitHub/VAE_ca_proj/Thermal/.compile_cache/gl/cglblsn7jnixo6lvwkokweifprow5pma5ijf6u6i6apgtidhwsyf.py
...
#   return %cat_8
triton_poi_fused_cat_transpose_view_38 = async_compile.triton('triton_poi_fused_cat_transpose_view_38', '''
import triton
import triton.language as tl
...
@triton_heuristics.pointwise(
    ...
    inductor_meta={'grid_type': 'Grid1D', 'autotune_hints': set(), 'kernel_name': 'triton_poi_fused_cat_transpose_view_38', 'mutated_arg_names': [], 'optimize_mem': True, 'no_x_dim': False, 'num_load': 2, 'num_reduction': 0, 'backend_hash': 'D54CF9E23D08230976451A78161C34C47AAE433535668E89333E7039B8F7F720', 'are_deterministic_algorithms_enabled': False, 'assert_indirect_indexing': True, 'autotune_local_cache': True, 'autotune_pointwise': True, 'autotune_remote_cache': None, 'force_disable_caches': False, 'dynamic_scale_rblock': True, 'max_autotune': False, 'max_autotune_pointwise': False, 'min_split_scan_rblock': 256, 'spill_threshold': 16, 'store_cubin': False, 'tiling_scores': {'x': 524288}},
    min_elem_per_thread=0
)
@triton.jit
def triton_poi_fused_cat_transpose_view_38(in_ptr0, in_ptr1, out_ptr0, xnumel, XBLOCK : tl.constexpr):
    xnumel = 65536
    xoffset = tl.program_id(0) * XBLOCK
    xindex = xoffset + tl.arange(0, XBLOCK)[:]
    xmask = tl.full([XBLOCK], True, tl.int1)
...
# kernel path: /mnt/g/GitHub/VAE_ca_proj/Thermal/.compile_cache/xm/cxmyzko2wwvnexzlmuo2lgmjgd7da6rlakfjdrgkaibfnpwkjtyf.py
# Topologically Sorted Source Nodes: [], Original ATen: [aten._to_copy]
# Source node to ATen node mapping:
# Graph fragment:
...
@triton_heuristics.pointwise(
    ...
    filename=__file__,
    triton_meta={'signature': {'in_ptr0': '*bf16', 'out_ptr0': '*fp32', 'xnumel': 'i32', 'XBLOCK': 'constexpr'}, 'device': DeviceProperties(type='cuda', index=0, multi_processor_count=36, cc=89, major=8, regs_per_multiprocessor=65536, max_threads_per_multi_processor=1536, warp_size=32), 'constants': {}, 'configs': [{(0,): [['tt.divisibility', 16]], (1,): [['tt.divisibility', 16]], (2,): [['tt.divisibility', 16]]}]},
    inductor_meta={'grid_type': 'Grid1D', 'autotune_hints': set(), 'kernel_name': 'triton_poi_fused__to_copy_39', 'mutated_arg_names': [], 'optimize_mem': True, 'no_x_dim': False, 'num_load': 1, 'num_reduction': 0, 'backend_hash': 'D54CF9E23D08230976451A78161C34C47AAE433535668E89333E7039B8F7F720', 'are_deterministic_algorithms_enabled': False, 'assert_indirect_indexing': True, 'autotune_local_cache': True, 'autotune_pointwise': True, 'autotune_remote_cache': None, 'force_disable_caches': False, 'dynamic_scale_rblock': True, 'max_autotune': False, 'max_autotune_pointwise': False, 'min_split_scan_rblock': 256, 'spill_threshold': 16, 'store_cubin': False, 'tiling_scores': {'x': 1310720}},
    min_elem_per_thread=0
)
@triton.jit
...
# kernel path: /mnt/g/GitHub/VAE_ca_proj/Thermal/.compile_cache/kv/ckvcwacjwijcrtjauf2bh32ijunzxhbd76btlm5pjhvr66njt2vq.py
...
#   return %view_371
triton_poi_fused__unsafe_view_clone_transpose_view_40 = async_compile.triton('triton_poi_fused__unsafe_view_clone_transpose_view_40', '''
import triton
import triton.language as tl
...
@triton_heuristics.pointwise(
    ...
    filename=__file__,
    triton_meta={'signature': {'in_ptr0': '*bf16', 'out_ptr0': '*bf16', 'xnumel': 'i32', 'XBLOCK': 'constexpr'}, 'device': DeviceProperties(type='cuda', index=0, multi_processor_count=36, cc=89, major=8, regs_per_multiprocessor=65536, max_threads_per_multi_processor=1536, warp_size=32), 'constants': {}, 'configs': [{(0,): [['tt.divisibility', 16]], (1,): [['tt.divisibility', 16]], (2,): [['tt.divisibility', 16]]}]},
    inductor_meta={'grid_type': 'Grid1D', 'autotune_hints': set(), 'kernel_name': 'triton_poi_fused__unsafe_view_clone_transpose_view_40', 'mutated_arg_names': [], 'optimize_mem': True, 'no_x_dim': False, 'num_load': 1, 'num_reduction': 0, 'backend_hash': 'D54CF9E23D08230976451A78161C34C47AAE433535668E89333E7039B8F7F720', 'are_deterministic_algorithms_enabled': False, 'assert_indirect_indexing': True, 'autotune_local_cache': True, 'autotune_pointwise': True, 'autotune_remote_cache': None, 'force_disable_caches': False, 'dynamic_scale_rblock': True, 'max_autotune': False, 'max_autotune_pointwise': False, 'min_split_scan_rblock': 256, 'spill_threshold': 16, 'store_cubin': False, 'tiling_scores': {'x': 50331648}},
    min_elem_per_thread=0
)
@triton.jit
def triton_poi_fused__unsafe_view_clone_transpose_view_40(in_ptr0, out_ptr0, xnumel, XBLOCK : tl.constexpr):
    xnumel = 8388608
    xoffset = tl.program_id(0) * XBLOCK
    xindex = xoffset + tl.arange(0, XBLOCK)[:]
    xmask = tl.full([XBLOCK], True, tl.int1)
...
# kernel path: /mnt/g/GitHub/VAE_ca_proj/Thermal/.compile_cache/ma/cmafrlnxsbmk7u7whthpt4urfxx5fp7n52oousegmleckguzpzgi.py
...
#   return %mul_216
triton_poi_fused_add_mul_transpose_view_41 = async_compile.triton('triton_poi_fused_add_mul_transpose_view_41', '''
import triton
import triton.language as tl
...
@triton_heuristics.pointwise(
    ...
    inductor_meta={'grid_type': 'Grid1D', 'autotune_hints': set(), 'kernel_name': 'triton_poi_fused_add_mul_transpose_view_41', 'mutated_arg_names': ['in_out_ptr0'], 'optimize_mem': True, 'no_x_dim': False, 'num_load': 4, 'num_reduction': 0, 'backend_hash': 'D54CF9E23D08230976451A78161C34C47AAE433535668E89333E7039B8F7F720', 'are_deterministic_algorithms_enabled': False, 'assert_indirect_indexing': True, 'autotune_local_cache': True, 'autotune_pointwise': True, 'autotune_remote_cache': None, 'force_disable_caches': False, 'dynamic_scale_rblock': True, 'max_autotune': False, 'max_autotune_pointwise': False, 'min_split_scan_rblock': 256, 'spill_threshold': 16, 'store_cubin': False, 'tiling_scores': {'x': 100663296}},
    min_elem_per_thread=0
)
@triton.jit
def triton_poi_fused_add_mul_transpose_view_41(in_out_ptr0, in_ptr0, in_ptr1, in_ptr2, xnumel, XBLOCK : tl.constexpr):
    xnumel = 8388608
    xoffset = tl.program_id(0) * XBLOCK
    xindex = xoffset + tl.arange(0, XBLOCK)[:]
    xmask = tl.full([XBLOCK], True, tl.int1)
...
# kernel path: /mnt/g/GitHub/VAE_ca_proj/Thermal/.compile_cache/hb/chbn7ro7jgcslipxrac7wf5aevfyoh7g4zzpajxguchwhgwrc2lx.py
...
#   return %add_163
triton_poi_fused_add_transpose_view_42 = async_compile.triton('triton_poi_fused_add_transpose_view_42', '''
import triton
import triton.language as tl
...
@triton_heuristics.pointwise(
    ...
    inductor_meta={'grid_type': 'Grid1D', 'autotune_hints': set(), 'kernel_name': 'triton_poi_fused_add_transpose_view_42', 'mutated_arg_names': ['in_out_ptr0'], 'optimize_mem': True, 'no_x_dim': False, 'num_load': 3, 'num_reduction': 0, 'backend_hash': 'D54CF9E23D08230976451A78161C34C47AAE433535668E89333E7039B8F7F720', 'are_deterministic_algorithms_enabled': False, 'assert_indirect_indexing': True, 'autotune_local_cache': True, 'autotune_pointwise': True, 'autotune_remote_cache': None, 'force_disable_caches': False, 'dynamic_scale_rblock': True, 'max_autotune': False, 'max_autotune_pointwise': False, 'min_split_scan_rblock': 256, 'spill_threshold': 16, 'store_cubin': False, 'tiling_scores': {'x': 83886080}},
    min_elem_per_thread=0
)
@triton.jit
def triton_poi_fused_add_transpose_view_42(in_out_ptr0, in_ptr0, in_ptr1, xnumel, XBLOCK : tl.constexpr):
    xnumel = 8388608
    xoffset = tl.program_id(0) * XBLOCK
    xindex = xoffset + tl.arange(0, XBLOCK)[:]
    xmask = tl.full([XBLOCK], True, tl.int1)
...
# kernel path: /mnt/g/GitHub/VAE_ca_proj/Thermal/.compile_cache/p4/cp44lguttz3dqgtulij4uf7z2zee5tges45ysr5jpomtgrgpwj7t.py
...
triton_red_fused__to_copy_convolution_backward_mul_sigmoid_sigmoid_backward_squeeze_sum_43 = async_compile.triton('triton_red_fused__to_copy_convolution_backward_mul_sigmoid_sigmoid_backward_squeeze_sum_43', '''
import triton
import triton.language as tl
...
@triton_heuristics.reduction(
    ...
    inductor_meta={'grid_type': 'Grid1D', 'autotune_hints': set(), 'kernel_name': 'triton_red_fused__to_copy_convolution_backward_mul_sigmoid_sigmoid_backward_squeeze_sum_43', 'mutated_arg_names': [], 'optimize_mem': True, 'no_x_dim': False, 'num_load': 3, 'num_reduction': 2, 'backend_hash': 'D54CF9E23D08230976451A78161C34C47AAE433535668E89333E7039B8F7F720', 'are_deterministic_algorithms_enabled': False, 'assert_indirect_indexing': True, 'autotune_local_cache': True, 'autotune_pointwise': True, 'autotune_remote_cache': None, 'force_disable_caches': False, 'dynamic_scale_rblock': True, 'max_autotune': False, 'max_autotune_pointwise': False, 'min_split_scan_rblock': 256, 'spill_threshold': 16, 'store_cubin': False, 'tiling_scores': {'x': 34013184, 'r0_': 0}}
)
@triton.jit
def triton_red_fused__to_copy_convolution_backward_mul_sigmoid_sigmoid_backward_squeeze_sum_43(in_ptr0, in_ptr1, in_ptr2, out_ptr1, out_ptr2, xnumel, r0_numel, XBLOCK : tl.constexpr, R0_BLOCK : tl.constexpr):
    xnumel = 32768
    r0_numel = 256
    rnumel = r0_numel
    RBLOCK: tl.constexpr = R0_BLOCK
...
# kernel path: /mnt/g/GitHub/VAE_ca_proj/Thermal/.compile_cache/jj/cjjdvytzztmi2kfqfw25aprmo7xfaqkkugv6lp6glrkklu6ukl7s.py
...
triton_red_fused__to_copy_native_layer_norm_native_layer_norm_backward_transpose_view_44 = async_compile.triton('triton_red_fused__to_copy_native_layer_norm_native_layer_norm_backward_transpose_view_44', '''
import triton
import triton.language as tl
...
@triton_heuristics.reduction(
    ...
    inductor_meta={'grid_type': 'Grid1D', 'autotune_hints': set(), 'kernel_name': 'triton_red_fused__to_copy_native_layer_norm_native_layer_norm_backward_transpose_view_44', 'mutated_arg_names': [], 'optimize_mem': True, 'no_x_dim': False, 'num_load': 4, 'num_reduction': 2, 'backend_hash': 'D54CF9E23D08230976451A78161C34C47AAE433535668E89333E7039B8F7F720', 'are_deterministic_algorithms_enabled': False, 'assert_indirect_indexing': True, 'autotune_local_cache': True, 'autotune_pointwise': True, 'autotune_remote_cache': None, 'force_disable_caches': False, 'dynamic_scale_rblock': True, 'max_autotune': False, 'max_autotune_pointwise': False, 'min_split_scan_rblock': 256, 'spill_threshold': 16, 'store_cubin': False, 'tiling_scores': {'x': 17301504, 'r0_': 65536}}
)
@triton.jit
def triton_red_fused__to_copy_native_layer_norm_native_layer_norm_backward_transpose_view_44(in_ptr0, in_ptr1, in_ptr2, in_ptr3, out_ptr0, out_ptr1, xnumel, r0_numel, XBLOCK : tl.constexpr, R0_BLOCK : tl.constexpr):
    xnumel = 32768
    r0_numel = 128
    rnumel = r0_numel
    RBLOCK: tl.constexpr = R0_BLOCK
...
# kernel path: /mnt/g/GitHub/VAE_ca_proj/Thermal/.compile_cache/2p/c2pvsrohmy64xwwja36fcyze47mmot3qnv74q2h3e2ptvhc4sie6.py
...
#   %view_492 : Tensor "f32[128, 512, 64][32768, 1, 512]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.reshape.default](args = (%convert_element_type_834, [128, 512, 64]), kwargs = {})
#   %permute_341 : Tensor "f32[128, 64, 512][32768, 512, 1]cuda:0"[num_users=3] = call_function[target=torch.ops.aten.permute.default](args = (%view_492, [0, 2, 1]), kwargs = {})
#   %mul_310 : Tensor "f32[128, 64, 512][32768, 512, 1]cuda:0"[num_users=3] = call_function[target=torch.ops.aten.mul.Tensor](args = (%permute_341, %primals_77), kwargs = {})
...
# kernel path: /mnt/g/GitHub/VAE_ca_proj/Thermal/.compile_cache/h4/ch4svt3tp3o6sxz3ek3qahpawcrninvunazxm6rzguwacei32eon.py
# Topologically Sorted Source Nodes: [out_24], Original ATen: [aten._to_copy, aten.view, aten.transpose, aten.native_layer_norm, aten.native_layer_norm_backward]
# Source node to ATen node mapping:
#   out_24 => convert_element_type_233, mul_32, sub_12
# Graph fragment:
...
#   %sum_108 : Tensor "f32[512][1]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.sum.dim_IntList](args = (%mul_315, [0, 1]), kwargs = {})
#   return %sum_108
triton_per_fused__to_copy_native_layer_norm_native_layer_norm_backward_transpose_view_46 = async_compile.triton('triton_per_fused__to_copy_native_layer_norm_native_layer_norm_backward_transpose_view_46', '''
import triton
import triton.language as tl
...
@triton_heuristics.persistent_reduction(
    ...
    filename=__file__,
    triton_meta={'signature': {'in_ptr0': '*fp32', 'out_ptr0': '*fp32', 'xnumel': 'i32', 'r0_numel': 'i32', 'XBLOCK': 'constexpr'}, 'device': DeviceProperties(type='cuda', index=0, multi_processor_count=36, cc=89, major=8, regs_per_multiprocessor=65536, max_threads_per_multi_processor=1536, warp_size=32), 'constants': {}, 'configs': [{(0,): [['tt.divisibility', 16]], (1,): [['tt.divisibility', 16]], (2,): [['tt.divisibility', 16]], (3,): [['tt.divisibility', 16]]}]},
    inductor_meta={'grid_type': 'Grid1D', 'autotune_hints': set(), 'kernel_name': 'triton_per_fused__to_copy_native_layer_norm_native_layer_norm_backward_transpose_view_46', 'mutated_arg_names': [], 'optimize_mem': True, 'no_x_dim': None, 'num_load': 1, 'num_reduction': 1, 'backend_hash': 'D54CF9E23D08230976451A78161C34C47AAE433535668E89333E7039B8F7F720', 'are_deterministic_algorithms_enabled': False, 'assert_indirect_indexing': True, 'autotune_local_cache': True, 'autotune_pointwise': True, 'autotune_remote_cache': None, 'force_disable_caches': False, 'dynamic_scale_rblock': True, 'max_autotune': False, 'max_autotune_pointwise': False, 'min_split_scan_rblock': 256, 'spill_threshold': 16, 'store_cubin': False, 'tiling_scores': {'x': 135168, 'r0_': 0}}
)
@triton.jit
def triton_per_fused__to_copy_native_layer_norm_native_layer_norm_backward_transpose_view_46(in_ptr0, out_ptr0, xnumel, r0_numel, XBLOCK : tl.constexpr):
    xnumel = 512
    r0_numel = 64
...
# kernel path: /mnt/g/GitHub/VAE_ca_proj/Thermal/.compile_cache/dp/cdpwqtrd5g5mzht6azbkjeb67ujxn76xktyye2nug5tjaan6otlx.py
...
#   return %buf415
triton_red_fused_sum_view_47 = async_compile.triton('triton_red_fused_sum_view_47', '''
import triton
import triton.language as tl
...
@triton_heuristics.reduction(
    ...
    filename=__file__,
    triton_meta={'signature': {'in_ptr0': '*bf16', 'out_ptr0': '*fp32', 'xnumel': 'i32', 'r0_numel': 'i32', 'XBLOCK': 'constexpr', 'R0_BLOCK': 'constexpr'}, 'device': DeviceProperties(type='cuda', index=0, multi_processor_count=36, cc=89, major=8, regs_per_multiprocessor=65536, max_threads_per_multi_processor=1536, warp_size=32), 'constants': {}, 'configs': [{(0,): [['tt.divisibility', 16]], (1,): [['tt.divisibility', 16]], (2,): [['tt.divisibility', 16]], (3,): [['tt.divisibility', 16]]}]},
    inductor_meta={'grid_type': 'Grid1D', 'autotune_hints': set(), 'kernel_name': 'triton_red_fused_sum_view_47', 'mutated_arg_names': [], 'optimize_mem': True, 'no_x_dim': False, 'num_load': 1, 'num_reduction': 1, 'backend_hash': 'D54CF9E23D08230976451A78161C34C47AAE433535668E89333E7039B8F7F720', 'are_deterministic_algorithms_enabled': False, 'assert_indirect_indexing': True, 'autotune_local_cache': True, 'autotune_pointwise': True, 'autotune_remote_cache': None, 'force_disable_caches': False, 'dynamic_scale_rblock': True, 'max_autotune': False, 'max_autotune_pointwise': False, 'min_split_scan_rblock': 256, 'spill_threshold': 16, 'store_cubin': False, 'tiling_scores': {'x': 8650752, 'r0_': 0}}
)
@triton.jit
def triton_red_fused_sum_view_47(in_ptr0, out_ptr0, xnumel, r0_numel, XBLOCK : tl.constexpr, R0_BLOCK : tl.constexpr):
    xnumel = 32768
    r0_numel = 128
    rnumel = r0_numel
    RBLOCK: tl.constexpr = R0_BLOCK
...
# kernel path: /mnt/g/GitHub/VAE_ca_proj/Thermal/.compile_cache/qe/cqe75duelpuhkat4u5aueg52qvo6xikg23wc5o4welzoj7vwp6y5.py
# Topologically Sorted Source Nodes: [], Original ATen: [aten._to_copy]
# Source node to ATen node mapping:
# Graph fragment:
...
# kernel path: /mnt/g/GitHub/VAE_ca_proj/Thermal/.compile_cache/aw/cawomm7apvzforf2fzzhzyx7r5oyimqmi67c7k3qxlmo6xh6iwgs.py
# Topologically Sorted Source Nodes: [], Original ATen: [aten._to_copy]
# Source node to ATen node mapping:
# Graph fragment:
...
# kernel path: /mnt/g/GitHub/VAE_ca_proj/Thermal/.compile_cache/rq/crqm336rnxalccqohgjdtdesnlbkhjpnn2yzpdfit6k37gvsipla.py
# Topologically Sorted Source Nodes: [], Original ATen: [aten.view, aten.transpose, aten.clone]
# Source node to ATen node mapping:
# Graph fragment:
...
#   return %clone_103
triton_poi_fused_clone_transpose_view_50 = async_compile.triton('triton_poi_fused_clone_transpose_view_50', '''
import triton
import triton.language as tl
...
@triton_heuristics.pointwise(
    ...
    filename=__file__,
    triton_meta={'signature': {'in_ptr0': '*bf16', 'out_ptr0': '*bf16', 'xnumel': 'i32', 'XBLOCK': 'constexpr'}, 'device': DeviceProperties(type='cuda', index=0, multi_processor_count=36, cc=89, major=8, regs_per_multiprocessor=65536, max_threads_per_multi_processor=1536, warp_size=32), 'constants': {}, 'configs': [{(0,): [['tt.divisibility', 16]], (1,): [['tt.divisibility', 16]], (2,): [['tt.divisibility', 16]]}]},
    inductor_meta={'grid_type': 'Grid1D', 'autotune_hints': set(), 'kernel_name': 'triton_poi_fused_clone_transpose_view_50', 'mutated_arg_names': [], 'optimize_mem': True, 'no_x_dim': False, 'num_load': 1, 'num_reduction': 0, 'backend_hash': 'D54CF9E23D08230976451A78161C34C47AAE433535668E89333E7039B8F7F720', 'are_deterministic_algorithms_enabled': False, 'assert_indirect_indexing': True, 'autotune_local_cache': True, 'autotune_pointwise': True, 'autotune_remote_cache': None, 'force_disable_caches': False, 'dynamic_scale_rblock': True, 'max_autotune': False, 'max_autotune_pointwise': False, 'min_split_scan_rblock': 256, 'spill_threshold': 16, 'store_cubin': False, 'tiling_scores': {'x': 25165824}},
    min_elem_per_thread=0
)
@triton.jit
def triton_poi_fused_clone_transpose_view_50(in_ptr0, out_ptr0, xnumel, XBLOCK : tl.constexpr):
    xnumel = 4194304
    xoffset = tl.program_id(0) * XBLOCK
    xindex = xoffset + tl.arange(0, XBLOCK)[:]
    xmask = tl.full([XBLOCK], True, tl.int1)
...
# kernel path: /mnt/g/GitHub/VAE_ca_proj/Thermal/.compile_cache/zo/czodaytlhqkhw2f34ecieoqrlcahnw7klr7i6xdf2vvr5syg45zy.py
...
triton_per_fused__softmax__softmax_backward_data__to_copy_mul_sub_view_51 = async_compile.triton('triton_per_fused__softmax__softmax_backward_data__to_copy_mul_sub_view_51', '''
import triton
import triton.language as tl
...
@triton_heuristics.persistent_reduction(
    ...
    inductor_meta={'grid_type': 'Grid1D', 'autotune_hints': set(), 'kernel_name': 'triton_per_fused__softmax__softmax_backward_data__to_copy_mul_sub_view_51', 'mutated_arg_names': ['in_out_ptr0'], 'optimize_mem': True, 'no_x_dim': None, 'num_load': 4, 'num_reduction': 1, 'backend_hash': 'D54CF9E23D08230976451A78161C34C47AAE433535668E89333E7039B8F7F720', 'are_deterministic_algorithms_enabled': False, 'assert_indirect_indexing': True, 'autotune_local_cache': True, 'autotune_pointwise': True, 'autotune_remote_cache': None, 'force_disable_caches': False, 'dynamic_scale_rblock': True, 'max_autotune': False, 'max_autotune_pointwise': False, 'min_split_scan_rblock': 256, 'spill_threshold': 16, 'store_cubin': False, 'tiling_scores': {'x': 524288, 'r0_': 33554432}}
)
@triton.jit
def triton_per_fused__softmax__softmax_backward_data__to_copy_mul_sub_view_51(in_out_ptr0, in_ptr0, in_ptr1, in_ptr2, xnumel, r0_numel, XBLOCK : tl.constexpr):
    xnumel = 65536
    r0_numel = 64
    R0_BLOCK: tl.constexpr = 64
    rnumel = r0_numel
...
# kernel path: /mnt/g/GitHub/VAE_ca_proj/Thermal/.compile_cache/ja/cjat3jkdhf45eyvgmuqauxd6vgdq7utdahlovynpdibg7hhdjsz6.py
...
#   return %clone_104
triton_poi_fused_add_clone_permute_select_backward_transpose_view_52 = async_compile.triton('triton_poi_fused_add_clone_permute_select_backward_transpose_view_52', '''
import triton
import triton.language as tl
...
# kernel path: /mnt/g/GitHub/VAE_ca_proj/Thermal/.compile_cache/nn/cnn57fyr6gztulftmiffdb334pffiep4mfeyjci4m2q5fshyvapi.py
...
#   return %buf428
triton_red_fused__unsafe_view_add_clone_permute_select_backward_sum_transpose_view_53 = async_compile.triton('triton_red_fused__unsafe_view_add_clone_permute_select_backward_sum_transpose_view_53', '''
import triton
import triton.language as tl
...
@triton_heuristics.reduction(
    ...
    filename=__file__,
    triton_meta={'signature': {'in_ptr0': '*bf16', 'out_ptr0': '*fp32', 'xnumel': 'i32', 'r0_numel': 'i32', 'XBLOCK': 'constexpr', 'R0_BLOCK': 'constexpr'}, 'device': DeviceProperties(type='cuda', index=0, multi_processor_count=36, cc=89, major=8, regs_per_multiprocessor=65536, max_threads_per_multi_processor=1536, warp_size=32), 'constants': {}, 'configs': [{(0,): [['tt.divisibility', 16]], (1,): [['tt.divisibility', 16]], (2,): [['tt.divisibility', 16]]}]},
    inductor_meta={'grid_type': 'Grid1D', 'autotune_hints': set(), 'kernel_name': 'triton_red_fused__unsafe_view_add_clone_permute_select_backward_sum_transpose_view_53', 'mutated_arg_names': [], 'optimize_mem': True, 'no_x_dim': False, 'num_load': 1, 'num_reduction': 1, 'backend_hash': 'D54CF9E23D08230976451A78161C34C47AAE433535668E89333E7039B8F7F720', 'are_deterministic_algorithms_enabled': False, 'assert_indirect_indexing': True, 'autotune_local_cache': True, 'autotune_pointwise': True, 'autotune_remote_cache': None, 'force_disable_caches': False, 'dynamic_scale_rblock': True, 'max_autotune': False, 'max_autotune_pointwise': False, 'min_split_scan_rblock': 256, 'spill_threshold': 16, 'store_cubin': False, 'tiling_scores': {'x': 25509888, 'r0_': 0}}
)
@triton.jit
def triton_red_fused__unsafe_view_add_clone_permute_select_backward_sum_transpose_view_53(in_ptr0, out_ptr0, xnumel, r0_numel, XBLOCK : tl.constexpr, R0_BLOCK : tl.constexpr):
    xnumel = 36864
    r0_numel = 342
    rnumel = r0_numel
    RBLOCK: tl.constexpr = R0_BLOCK
...
# kernel path: /mnt/g/GitHub/VAE_ca_proj/Thermal/.compile_cache/iw/ciwt4wifffyncjtuz5zvlrw2aswkkssarlgdotc54vdvmyoe3y3e.py
# Topologically Sorted Source Nodes: [], Original ATen: [aten.view, aten.transpose, aten.select_backward, aten.add, aten.permute, aten.clone, aten._unsafe_view, aten.sum]
# Source node to ATen node mapping:
# Graph fragment:
...
#   %sum_112 : Tensor "f32[1, 1536][1536, 1]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.sum.dim_IntList](args = (%view_504, [0], True), kwargs = {dtype: torch.float32})
#   return %sum_112
triton_per_fused__unsafe_view_add_clone_permute_select_backward_sum_transpose_view_54 = async_compile.triton('triton_per_fused__unsafe_view_add_clone_permute_select_backward_sum_transpose_view_54', '''
import triton
import triton.language as tl
...
@triton_heuristics.persistent_reduction(
    ...
    filename=__file__,
    triton_meta={'signature': {'in_ptr0': '*fp32', 'out_ptr0': '*fp32', 'xnumel': 'i32', 'r0_numel': 'i32', 'XBLOCK': 'constexpr'}, 'device': DeviceProperties(type='cuda', index=0, multi_processor_count=36, cc=89, major=8, regs_per_multiprocessor=65536, max_threads_per_multi_processor=1536, warp_size=32), 'constants': {}, 'configs': [{(0,): [['tt.divisibility', 16]], (1,): [['tt.divisibility', 16]], (2,): [['tt.divisibility', 16]]}]},
    inductor_meta={'grid_type': 'Grid1D', 'autotune_hints': set(), 'kernel_name': 'triton_per_fused__unsafe_view_add_clone_permute_select_backward_sum_transpose_view_54', 'mutated_arg_names': [], 'optimize_mem': True, 'no_x_dim': None, 'num_load': 1, 'num_reduction': 1, 'backend_hash': 'D54CF9E23D08230976451A78161C34C47AAE433535668E89333E7039B8F7F720', 'are_deterministic_algorithms_enabled': False, 'assert_indirect_indexing': True, 'autotune_local_cache': True, 'autotune_pointwise': True, 'autotune_remote_cache': None, 'force_disable_caches': False, 'dynamic_scale_rblock': True, 'max_autotune': False, 'max_autotune_pointwise': False, 'min_split_scan_rblock': 256, 'spill_threshold': 16, 'store_cubin': False, 'tiling_scores': {'x': 159744, 'r0_': 0}}
)
@triton.jit
def triton_per_fused__unsafe_view_add_clone_permute_select_backward_sum_transpose_view_54(in_ptr0, out_ptr0, xnumel, r0_numel, XBLOCK : tl.constexpr):
    xnumel = 1536
    r0_numel = 24
...
# kernel path: /mnt/g/GitHub/VAE_ca_proj/Thermal/.compile_cache/6y/c6yrum72teaw6lqckh2szxwjtquc63eqr2lnmdumdv54hjvtipkl.py
...
#   %mul_319 : Tensor "f32[128, 64, 512][32768, 512, 1]cuda:0"[num_users=3] = call_function[target=torch.ops.aten.mul.Tensor](args = (%convert_element_type_860, %primals_71), kwargs = {})
...
triton_per_fused__to_copy_add_fill_mul_native_layer_norm_native_layer_norm_backward_sigmoid_silu_sub_transpose_view_55 = async_compile.triton('triton_per_fused__to_copy_add_fill_mul_native_layer_norm_native_layer_norm_backward_sigmoid_silu_sub_transpose_view_55', '''
import triton
import triton.language as tl
...
@triton_heuristics.persistent_reduction(
    ...
    inductor_meta={'grid_type': 'Grid1D', 'autotune_hints': set(), 'kernel_name': 'triton_per_fused__to_copy_add_fill_mul_native_layer_norm_native_layer_norm_backward_sigmoid_silu_sub_transpose_view_55', 'mutated_arg_names': ['in_out_ptr0'], 'optimize_mem': True, 'no_x_dim': None, 'num_load': 6, 'num_reduction': 2, 'backend_hash': 'D54CF9E23D08230976451A78161C34C47AAE433535668E89333E7039B8F7F720', 'are_deterministic_algorithms_enabled': False, 'assert_indirect_indexing': True, 'autotune_local_cache': True, 'autotune_pointwise': True, 'autotune_remote_cache': None, 'force_disable_caches': False, 'dynamic_scale_rblock': True, 'max_autotune': False, 'max_autotune_pointwise': False, 'min_split_scan_rblock': 256, 'spill_threshold': 16, 'store_cubin': False, 'tiling_scores': {'x': 65536, 'r0_': 41945088}}
)
@triton.jit
def triton_per_fused__to_copy_add_fill_mul_native_layer_norm_native_layer_norm_backward_sigmoid_silu_sub_transpose_view_55(in_out_ptr0, in_ptr0, in_ptr1, in_ptr2, in_ptr3, in_ptr4, xnumel, r0_numel, XBLOCK : tl.constexpr):
    xnumel = 8192
    r0_numel = 512
    R0_BLOCK: tl.constexpr = 512
    rnumel = r0_numel
...
# kernel path: /mnt/g/GitHub/VAE_ca_proj/Thermal/.compile_cache/2v/c2vhd2doo3i4ani6j2rq3tjyl4yu3z6kp22sjjjmb7fyrrvemxxk.py
...
triton_red_fused__to_copy_native_layer_norm_native_layer_norm_backward_silu_transpose_view_56 = async_compile.triton('triton_red_fused__to_copy_native_layer_norm_native_layer_norm_backward_silu_transpose_view_56', '''
import triton
import triton.language as tl
...
@triton_heuristics.reduction(
    ...
    filename=__file__,
    triton_meta={'signature': {'in_ptr0': '*bf16', 'in_ptr1': '*bf16', 'in_ptr2': '*fp32', 'in_ptr3': '*fp32', 'out_ptr0': '*fp32', 'out_ptr1': '*fp32', 'xnumel': 'i32', 'r0_numel': 'i32', 'XBLOCK': 'constexpr', 'R0_BLOCK': 'constexpr'}, 'device': DeviceProperties(type='cuda', index=0, multi_processor_count=36, cc=89, major=8, regs_per_multiprocessor=65536, max_threads_per_multi_processor=1536, warp_size=32), 'constants': {}, 'configs': [{(0,): [['tt.divisibility', 16]], (1,): [['tt.divisibility', 16]], (2,): [['tt.divisibility', 16]], (3,): [['tt.divisibility', 16]], (4,): [['tt.divisibility', 16]], (5,): [['tt.divisibility', 16]], (6,): [['tt.divisibility', 16]], (7,): [['tt.divisibility', 16]]}]},
    inductor_meta={'grid_type': 'Grid1D', 'autotune_hints': set(), 'kernel_name': 'triton_red_fused__to_copy_native_layer_norm_native_layer_norm_backward_silu_transpose_view_56', 'mutated_arg_names': [], 'optimize_mem': True, 'no_x_dim': False, 'num_load': 4, 'num_reduction': 2, 'backend_hash': 'D54CF9E23D08230976451A78161C34C47AAE433535668E89333E7039B8F7F720', 'are_deterministic_algorithms_enabled': False, 'assert_indirect_indexing': True, 'autotune_local_cache': True, 'autotune_pointwise': True, 'autotune_remote_cache': None, 'force_disable_caches': False, 'dynamic_scale_rblock': True, 'max_autotune': False, 'max_autotune_pointwise': False, 'min_split_scan_rblock': 256, 'spill_threshold': 16, 'store_cubin': False, 'tiling_scores': {'x': 17301504, 'r0_': 65536}}
)
@triton.jit
def triton_red_fused__to_copy_native_layer_norm_native_layer_norm_backward_silu_transpose_view_56(in_ptr0, in_ptr1, in_ptr2, in_ptr3, out_ptr0, out_ptr1, xnumel, r0_numel, XBLOCK : tl.constexpr, R0_BLOCK : tl.constexpr):
    xnumel = 32768
    r0_numel = 128
    rnumel = r0_numel
    RBLOCK: tl.constexpr = R0_BLOCK
...
# kernel path: /mnt/g/GitHub/VAE_ca_proj/Thermal/.compile_cache/pb/cpbrkf2zjnisrl3cffdglg64niqdljypuf2t2mi2huqa5vonhg4o.py
# Topologically Sorted Source Nodes: [], Original ATen: [aten.convolution_backward]
# Source node to ATen node mapping:
# Graph fragment:
...
#   return %buf438
triton_red_fused_convolution_backward_57 = async_compile.triton('triton_red_fused_convolution_backward_57', '''
import triton
import triton.language as tl
...
@triton_heuristics.reduction(
    ...
    filename=__file__,
    triton_meta={'signature': {'in_ptr0': '*bf16', 'out_ptr0': '*fp32', 'xnumel': 'i32', 'r0_numel': 'i32', 'XBLOCK': 'constexpr', 'R0_BLOCK': 'constexpr'}, 'device': DeviceProperties(type='cuda', index=0, multi_processor_count=36, cc=89, major=8, regs_per_multiprocessor=65536, max_threads_per_multi_processor=1536, warp_size=32), 'constants': {}, 'configs': [{(0,): [['tt.divisibility', 16]], (1,): [['tt.divisibility', 16]], (2,): [['tt.divisibility', 16]], (3,): [['tt.divisibility', 16]]}]},
    inductor_meta={'grid_type': 'Grid1D', 'autotune_hints': set(), 'kernel_name': 'triton_red_fused_convolution_backward_57', 'mutated_arg_names': [], 'optimize_mem': True, 'no_x_dim': False, 'num_load': 1, 'num_reduction': 1, 'backend_hash': 'D54CF9E23D08230976451A78161C34C47AAE433535668E89333E7039B8F7F720', 'are_deterministic_algorithms_enabled': False, 'assert_indirect_indexing': True, 'autotune_local_cache': True, 'autotune_pointwise': True, 'autotune_remote_cache': None, 'force_disable_caches': False, 'dynamic_scale_rblock': True, 'max_autotune': False, 'max_autotune_pointwise': False, 'min_split_scan_rblock': 256, 'spill_threshold': 16, 'store_cubin': False, 'tiling_scores': {'x': 8650752, 'r0_': 0}}
)
@triton.jit
def triton_red_fused_convolution_backward_57(in_ptr0, out_ptr0, xnumel, r0_numel, XBLOCK : tl.constexpr, R0_BLOCK : tl.constexpr):
    xnumel = 32768
    r0_numel = 128
    rnumel = r0_numel
    RBLOCK: tl.constexpr = R0_BLOCK
...
# kernel path: /mnt/g/GitHub/VAE_ca_proj/Thermal/.compile_cache/nu/cnuj2xcc7d6gf4gzbebaegas2a7hccrewohl762d7whctfj2fr3b.py
# Topologically Sorted Source Nodes: [], Original ATen: [aten.convolution_backward, aten._to_copy]
# Source node to ATen node mapping:
# Graph fragment:
...
triton_per_fused__to_copy_convolution_backward_58 = async_compile.triton('triton_per_fused__to_copy_convolution_backward_58', '''
import triton
import triton.language as tl
...
@triton_heuristics.persistent_reduction(
    ...
    inductor_meta={'grid_type': 'Grid1D', 'autotune_hints': set(), 'kernel_name': 'triton_per_fused__to_copy_convolution_backward_58', 'mutated_arg_names': [], 'optimize_mem': True, 'no_x_dim': None, 'num_load': 1, 'num_reduction': 1, 'backend_hash': 'D54CF9E23D08230976451A78161C34C47AAE433535668E89333E7039B8F7F720', 'are_deterministic_algorithms_enabled': False, 'assert_indirect_indexing': True, 'autotune_local_cache': True, 'autotune_pointwise': True, 'autotune_remote_cache': None, 'force_disable_caches': False, 'dynamic_scale_rblock': True, 'max_autotune': False, 'max_autotune_pointwise': False, 'min_split_scan_rblock': 256, 'spill_threshold': 16, 'store_cubin': False, 'tiling_scores': {'x': 135168, 'r0_': 0}}
)
@triton.jit
def triton_per_fused__to_copy_convolution_backward_58(in_ptr0, out_ptr1, xnumel, r0_numel, XBLOCK : tl.constexpr):
    xnumel = 512
    r0_numel = 64
    R0_BLOCK: tl.constexpr = 64
    rnumel = r0_numel
...
# kernel path: /mnt/g/GitHub/VAE_ca_proj/Thermal/.compile_cache/4e/c4eh52xaizufwm7deh7oe4yqa3as4q67q73cua5bbseq4f6zsam2.py
# Topologically Sorted Source Nodes: [], Original ATen: [aten._to_copy]
# Source node to ATen node mapping:
# Graph fragment:
...
@triton_heuristics.pointwise(
    ...
    filename=__file__,
    triton_meta={'signature': {'in_ptr0': '*bf16', 'out_ptr0': '*fp32', 'xnumel': 'i32', 'XBLOCK': 'constexpr'}, 'device': DeviceProperties(type='cuda', index=0, multi_processor_count=36, cc=89, major=8, regs_per_multiprocessor=65536, max_threads_per_multi_processor=1536, warp_size=32), 'constants': {}, 'configs': [{(0,): [['tt.divisibility', 16]], (1,): [['tt.divisibility', 16]], (2,): [['tt.divisibility', 16]]}]},
    inductor_meta={'grid_type': 'Grid1D', 'autotune_hints': set(), 'kernel_name': 'triton_poi_fused__to_copy_59', 'mutated_arg_names': [], 'optimize_mem': True, 'no_x_dim': False, 'num_load': 1, 'num_reduction': 0, 'backend_hash': 'D54CF9E23D08230976451A78161C34C47AAE433535668E89333E7039B8F7F720', 'are_deterministic_algorithms_enabled': False, 'assert_indirect_indexing': True, 'autotune_local_cache': True, 'autotune_pointwise': True, 'autotune_remote_cache': None, 'force_disable_caches': False, 'dynamic_scale_rblock': True, 'max_autotune': False, 'max_autotune_pointwise': False, 'min_split_scan_rblock': 256, 'spill_threshold': 16, 'store_cubin': False, 'tiling_scores': {'x': 7864320}},
    min_elem_per_thread=0
)
@triton.jit
...
# kernel path: /mnt/g/GitHub/VAE_ca_proj/Thermal/.compile_cache/qs/cqs2p6hhzmnellnpdozporj3fbcxuxvb2pwmzxjzcjiendmahodi.py
# Topologically Sorted Source Nodes: [], Original ATen: [aten._to_copy, aten.mul, aten.sum, aten.view]
# Source node to ATen node mapping:
# Graph fragment:
...
triton_per_fused__to_copy_mul_sum_view_60 = async_compile.triton('triton_per_fused__to_copy_mul_sum_view_60', '''
import triton
import triton.language as tl
...
@triton_heuristics.persistent_reduction(
    ...
    inductor_meta={'grid_type': 'Grid1D', 'autotune_hints': set(), 'kernel_name': 'triton_per_fused__to_copy_mul_sum_view_60', 'mutated_arg_names': [], 'optimize_mem': True, 'no_x_dim': None, 'num_load': 2, 'num_reduction': 1, 'backend_hash': 'D54CF9E23D08230976451A78161C34C47AAE433535668E89333E7039B8F7F720', 'are_deterministic_algorithms_enabled': False, 'assert_indirect_indexing': True, 'autotune_local_cache': True, 'autotune_pointwise': True, 'autotune_remote_cache': None, 'force_disable_caches': False, 'dynamic_scale_rblock': True, 'max_autotune': False, 'max_autotune_pointwise': False, 'min_split_scan_rblock': 256, 'spill_threshold': 16, 'store_cubin': False, 'tiling_scores': {'x': 8912896, 'r0_': 33554432}}
)
@triton.jit
def triton_per_fused__to_copy_mul_sum_view_60(in_ptr0, in_ptr1, out_ptr0, out_ptr1, xnumel, r0_numel, XBLOCK : tl.constexpr):
    xnumel = 65536
    r0_numel = 64
    R0_BLOCK: tl.constexpr = 64
    rnumel = r0_numel
...
# kernel path: /mnt/g/GitHub/VAE_ca_proj/Thermal/.compile_cache/zs/czsmikzvo7tt2j7sgwj5nro3g43ps5625cmmunfd7vgumm2daeta.py
...
triton_per_fused__to_copy_add_clone_mul_native_group_norm_backward_view_61 = async_compile.triton('triton_per_fused__to_copy_add_clone_mul_native_group_norm_backward_view_61', '''
import triton
import triton.language as tl
...
# kernel path: /mnt/g/GitHub/VAE_ca_proj/Thermal/.compile_cache/xh/cxhiojbetlmevugqrv5vii3dixysnwrg2ax4av2qwlye5x26qkuk.py
# Topologically Sorted Source Nodes: [], Original ATen: [aten.native_group_norm_backward]
# Source node to ATen node mapping:
# Graph fragment:
...
#   return %sum_121
triton_per_fused_native_group_norm_backward_62 = async_compile.triton('triton_per_fused_native_group_norm_backward_62', '''
import triton
import triton.language as tl
...
@triton_heuristics.persistent_reduction(
    ...
    filename=__file__,
    triton_meta={'signature': {'in_ptr0': '*fp32', 'out_ptr0': '*fp32', 'xnumel': 'i32', 'r0_numel': 'i32', 'XBLOCK': 'constexpr'}, 'device': DeviceProperties(type='cuda', index=0, multi_processor_count=36, cc=89, major=8, regs_per_multiprocessor=65536, max_threads_per_multi_processor=1536, warp_size=32), 'constants': {}, 'configs': [{(0,): [['tt.divisibility', 16]], (1,): [['tt.divisibility', 16]], (2,): [['tt.divisibility', 16]], (3,): [['tt.divisibility', 16]]}]},
    inductor_meta={'grid_type': 'Grid1D', 'autotune_hints': set(), 'kernel_name': 'triton_per_fused_native_group_norm_backward_62', 'mutated_arg_names': [], 'optimize_mem': True, 'no_x_dim': None, 'num_load': 1, 'num_reduction': 1, 'backend_hash': 'D54CF9E23D08230976451A78161C34C47AAE433535668E89333E7039B8F7F720', 'are_deterministic_algorithms_enabled': False, 'assert_indirect_indexing': True, 'autotune_local_cache': True, 'autotune_pointwise': True, 'autotune_remote_cache': None, 'force_disable_caches': False, 'dynamic_scale_rblock': True, 'max_autotune': False, 'max_autotune_pointwise': False, 'min_split_scan_rblock': 256, 'spill_threshold': 16, 'store_cubin': False, 'tiling_scores': {'x': 32768, 'r0_': 262144}}
)
@triton.jit
def triton_per_fused_native_group_norm_backward_62(in_ptr0, out_ptr0, xnumel, r0_numel, XBLOCK : tl.constexpr):
    xnumel = 4096
    r0_numel = 16
...
# kernel path: /mnt/g/GitHub/VAE_ca_proj/Thermal/.compile_cache/22/c22kr63wffovamq52dteq6b6ndfqcijekvethltbszjyqmvu7wcj.py
...
#   %convert_element_type_204 : Tensor "f32[128, 512, 8, 8][32768, 1, 4096, 512]cuda:0"[num_users=1] = call_function[target=torch.ops.prims.convert_element_type.default](args = (%convolution_13, torch.float32), kwargs = {})
#   %clone_21 : Tensor "f32[128, 512, 8, 8][32768, 64, 8, 1]cuda:0"[num_users=2] = call_function[target=torch.ops.aten.clone.default](args = (%convert_element_type_204,), kwargs = {memory_format: torch.contiguous_format})
#   %unsqueeze_91 : Tensor "f32[128, 32, 1][32, 1, 1]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.unsqueeze.default](args = (%squeeze_11, -1), kwargs = {})
...
#   %mul_332 : Tensor "f32[128, 32, 16][512, 16, 1]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%unsqueeze_91, %full_default_27), kwargs = {})
...
#   %unsqueeze_92 : Tensor "f32[128, 32, 16, 1][512, 16, 1, 1]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.unsqueeze.default](args = (%mul_332, -1), kwargs = {})
#   %unsqueeze_93 : Tensor "f32[128, 32, 1][32, 1, 1]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.unsqueeze.default](args = (%mul_337, -1), kwargs = {})
#   %unsqueeze_94 : Tensor "f32[128, 32, 1, 1][32, 1, 1, 1]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.unsqueeze.default](args = (%unsqueeze_93, -1), kwargs = {})
#   %unsqueeze_95 : Tensor "f32[128, 32, 1][32, 1, 1]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.unsqueeze.default](args = (%sub_86, -1), kwargs = {})
#   %unsqueeze_96 : Tensor "f32[128, 32, 1, 1][32, 1, 1, 1]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.unsqueeze.default](args = (%unsqueeze_95, -1), kwargs = {})
...
#   %mul_341 : Tensor "f32[128, 32, 16, 64][32768, 1024, 64, 1]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%view_517, %unsqueeze_92), kwargs = {})
...
#   %mul_342 : Tensor "f32[128, 32, 16, 64][32768, 1024, 64, 1]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%view_99, %unsqueeze_94), kwargs = {})
...
#   %add_173 : Tensor "f32[128, 32, 16, 64][32768, 1024, 64, 1]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.add.Tensor](args = (%add_172, %unsqueeze_96), kwargs = {})
...
triton_poi_fused__to_copy_add_clone_mul_native_group_norm_native_group_norm_backward_view_63 = async_compile.triton('triton_poi_fused__to_copy_add_clone_mul_native_group_norm_native_group_norm_backward_view_63', '''
import triton
import triton.language as tl
...
@triton_heuristics.pointwise(
    ...
    filename=__file__,
    triton_meta={'signature': {'in_ptr0': '*bf16', 'in_ptr1': '*fp32', 'in_ptr2': '*bf16', 'in_ptr3': '*fp32', 'in_ptr4': '*bf16', 'in_ptr5': '*fp32', 'in_ptr6': '*fp32', 'in_ptr7': '*fp32', 'out_ptr1': '*bf16', 'xnumel': 'i32', 'XBLOCK': 'constexpr'}, 'device': DeviceProperties(type='cuda', index=0, multi_processor_count=36, cc=89, major=8, regs_per_multiprocessor=65536, max_threads_per_multi_processor=1536, warp_size=32), 'constants': {}, 'configs': [{(0,): [['tt.divisibility', 16]], (1,): [['tt.divisibility', 16]], (2,): [['tt.divisibility', 16]], (3,): [['tt.divisibility', 16]], (4,): [['tt.divisibility', 16]], (5,): [['tt.divisibility', 16]], (6,): [['tt.divisibility', 16]], (7,): [['tt.divisibility', 16]], (8,): [['tt.divisibility', 16]], (9,): [['tt.divisibility', 16]]}]},
    inductor_meta={'grid_type': 'Grid1D', 'autotune_hints': set(), 'kernel_name': 'triton_poi_fused__to_copy_add_clone_mul_native_group_norm_native_group_norm_backward_view_63', 'mutated_arg_names': [], 'optimize_mem': True, 'no_x_dim': False, 'num_load': 8, 'num_reduction': 0, 'backend_hash': 'D54CF9E23D08230976451A78161C34C47AAE433535668E89333E7039B8F7F720', 'are_deterministic_algorithms_enabled': False, 'assert_indirect_indexing': True, 'autotune_local_cache': True, 'autotune_pointwise': True, 'autotune_remote_cache': None, 'force_disable_caches': False, 'dynamic_scale_rblock': True, 'max_autotune': False, 'max_autotune_pointwise': False, 'min_split_scan_rblock': 256, 'spill_threshold': 16, 'store_cubin': False, 'tiling_scores': {'x': 41943040}},
    min_elem_per_thread=0
)
@triton.jit
def triton_poi_fused__to_copy_add_clone_mul_native_group_norm_native_group_norm_backward_view_63(in_ptr0, in_ptr1, in_ptr2, in_ptr3, in_ptr4, in_ptr5, in_ptr6, in_ptr7, out_ptr1, xnumel, XBLOCK : tl.constexpr):
    xnumel = 4194304
    xoffset = tl.program_id(0) * XBLOCK
    xindex = xoffset + tl.arange(0, XBLOCK)[:]
    xmask = tl.full([XBLOCK], True, tl.int1)
...
# kernel path: /mnt/g/GitHub/VAE_ca_proj/Thermal/.compile_cache/p3/cp3ttulhta7jioh2rzkuvco3a3lq6uuok2qdsfwjsy4gkeindt6u.py
# Topologically Sorted Source Nodes: [], Original ATen: [aten.convolution_backward, aten._to_copy]
# Source node to ATen node mapping:
# Graph fragment:
...
triton_red_fused__to_copy_convolution_backward_64 = async_compile.triton('triton_red_fused__to_copy_convolution_backward_64', '''
import triton
import triton.language as tl
...
@triton_heuristics.reduction(
    ...
    filename=__file__,
    triton_meta={'signature': {'in_ptr0': '*bf16', 'out_ptr1': '*fp32', 'xnumel': 'i32', 'r0_numel': 'i32', 'XBLOCK': 'constexpr', 'R0_BLOCK': 'constexpr'}, 'device': DeviceProperties(type='cuda', index=0, multi_processor_count=36, cc=89, major=8, regs_per_multiprocessor=65536, max_threads_per_multi_processor=1536, warp_size=32), 'constants': {}, 'configs': [{(0,): [['tt.divisibility', 16]], (1,): [['tt.divisibility', 16]], (2,): [['tt.divisibility', 16]], (3,): [['tt.divisibility', 16]]}]},
    inductor_meta={'grid_type': 'Grid1D', 'autotune_hints': set(), 'kernel_name': 'triton_red_fused__to_copy_convolution_backward_64', 'mutated_arg_names': [], 'optimize_mem': True, 'no_x_dim': False, 'num_load': 1, 'num_reduction': 1, 'backend_hash': 'D54CF9E23D08230976451A78161C34C47AAE433535668E89333E7039B8F7F720', 'are_deterministic_algorithms_enabled': False, 'assert_indirect_indexing': True, 'autotune_local_cache': True, 'autotune_pointwise': True, 'autotune_remote_cache': None, 'force_disable_caches': False, 'dynamic_scale_rblock': True, 'max_autotune': False, 'max_autotune_pointwise': False, 'min_split_scan_rblock': 256, 'spill_threshold': 16, 'store_cubin': False, 'tiling_scores': {'x': 4096, 'r0_': 0}}
)
@triton.jit
def triton_red_fused__to_copy_convolution_backward_64(in_ptr0, out_ptr1, xnumel, r0_numel, XBLOCK : tl.constexpr, R0_BLOCK : tl.constexpr):
    xnumel = 512
    r0_numel = 8192
    rnumel = r0_numel
    RBLOCK: tl.constexpr = R0_BLOCK
...
# kernel path: /mnt/g/GitHub/VAE_ca_proj/Thermal/.compile_cache/mf/cmfbfgyzbhnitv3w5q6opxl537rbnccgrlhe5bn4kb7w23t2dzwh.py
# Topologically Sorted Source Nodes: [], Original ATen: [aten.view, aten.transpose, aten.native_dropout_backward]
# Source node to ATen node mapping:
# Graph fragment:
...
#   return %mul_344
triton_poi_fused_native_dropout_backward_transpose_view_65 = async_compile.triton('triton_poi_fused_native_dropout_backward_transpose_view_65', '''
import triton
import triton.language as tl
...
@triton_heuristics.pointwise(
    ...
    filename=__file__,
    triton_meta={'signature': {'in_ptr0': '*bf16', 'in_ptr1': '*i1', 'out_ptr0': '*bf16', 'xnumel': 'i32', 'XBLOCK': 'constexpr'}, 'device': DeviceProperties(type='cuda', index=0, multi_processor_count=36, cc=89, major=8, regs_per_multiprocessor=65536, max_threads_per_multi_processor=1536, warp_size=32), 'constants': {}, 'configs': [{(0,): [['tt.divisibility', 16]], (1,): [['tt.divisibility', 16]], (2,): [['tt.divisibility', 16]], (3,): [['tt.divisibility', 16]]}]},
    inductor_meta={'grid_type': 'Grid1D', 'autotune_hints': set(), 'kernel_name': 'triton_poi_fused_native_dropout_backward_transpose_view_65', 'mutated_arg_names': [], 'optimize_mem': True, 'no_x_dim': False, 'num_load': 2, 'num_reduction': 0, 'backend_hash': 'D54CF9E23D08230976451A78161C34C47AAE433535668E89333E7039B8F7F720', 'are_deterministic_algorithms_enabled': False, 'assert_indirect_indexing': True, 'autotune_local_cache': True, 'autotune_pointwise': True, 'autotune_remote_cache': None, 'force_disable_caches': False, 'dynamic_scale_rblock': True, 'max_autotune': False, 'max_autotune_pointwise': False, 'min_split_scan_rblock': 256, 'spill_threshold': 16, 'store_cubin': False, 'tiling_scores': {'x': 29360128}},
    min_elem_per_thread=0
)
@triton.jit
def triton_poi_fused_native_dropout_backward_transpose_view_65(in_ptr0, in_ptr1, out_ptr0, xnumel, XBLOCK : tl.constexpr):
    xnumel = 4194304
    xoffset = tl.program_id(0) * XBLOCK
    xindex = xoffset + tl.arange(0, XBLOCK)[:]
    xmask = tl.full([XBLOCK], True, tl.int1)
...
# kernel path: /mnt/g/GitHub/VAE_ca_proj/Thermal/.compile_cache/lj/cljy2hyjsifzpbncgyk3ztbs2bwtjphnpfvgctsb4vb7sl42ubzi.py
...
#   return %mul_346
triton_poi_fused__softmax__softmax_backward_data__to_copy_amax_mul_sub_view_66 = async_compile.triton('triton_poi_fused__softmax__softmax_backward_data__to_copy_amax_mul_sub_view_66', '''
import triton
import triton.language as tl
...
@triton_heuristics.pointwise(
    ...
    filename=__file__,
    triton_meta={'signature': {'in_out_ptr0': '*bf16', 'in_ptr0': '*bf16', 'xnumel': 'i32', 'XBLOCK': 'constexpr'}, 'device': DeviceProperties(type='cuda', index=0, multi_processor_count=36, cc=89, major=8, regs_per_multiprocessor=65536, max_threads_per_multi_processor=1536, warp_size=32), 'constants': {}, 'configs': [{(0,): [['tt.divisibility', 16]], (1,): [['tt.divisibility', 16]], (2,): [['tt.divisibility', 16]]}]},
    inductor_meta={'grid_type': 'Grid1D', 'autotune_hints': set(), 'kernel_name': 'triton_poi_fused__softmax__softmax_backward_data__to_copy_amax_mul_sub_view_66', 'mutated_arg_names': ['in_out_ptr0'], 'optimize_mem': True, 'no_x_dim': False, 'num_load': 2, 'num_reduction': 0, 'backend_hash': 'D54CF9E23D08230976451A78161C34C47AAE433535668E89333E7039B8F7F720', 'are_deterministic_algorithms_enabled': False, 'assert_indirect_indexing': True, 'autotune_local_cache': True, 'autotune_pointwise': True, 'autotune_remote_cache': None, 'force_disable_caches': False, 'dynamic_scale_rblock': True, 'max_autotune': False, 'max_autotune_pointwise': False, 'min_split_scan_rblock': 256, 'spill_threshold': 16, 'store_cubin': False, 'tiling_scores': {'x': 524288}},
    min_elem_per_thread=0
)
@triton.jit
def triton_poi_fused__softmax__softmax_backward_data__to_copy_amax_mul_sub_view_66(in_out_ptr0, in_ptr0, xnumel, XBLOCK : tl.constexpr):
    xnumel = 65536
    xoffset = tl.program_id(0) * XBLOCK
    xindex = xoffset + tl.arange(0, XBLOCK)[:]
    xmask = tl.full([XBLOCK], True, tl.int1)
...
# kernel path: /mnt/g/GitHub/VAE_ca_proj/Thermal/.compile_cache/6p/c6ptzez5l4lbo5m5ly733liyivefm7ofwpj5ic7mo754q3cvdup4.py
# Topologically Sorted Source Nodes: [], Original ATen: [aten.view, aten.transpose, aten.cat]
# Source node to ATen node mapping:
# Graph fragment:
...
#   return %cat_18
triton_poi_fused_cat_transpose_view_67 = async_compile.triton('triton_poi_fused_cat_transpose_view_67', '''
import triton
import triton.language as tl
...
@triton_heuristics.pointwise(
    ...
    filename=__file__,
    triton_meta={'signature': {'in_ptr0': '*bf16', 'in_ptr1': '*bf16', 'out_ptr0': '*bf16', 'xnumel': 'i32', 'XBLOCK': 'constexpr'}, 'device': DeviceProperties(type='cuda', index=0, multi_processor_count=36, cc=89, major=8, regs_per_multiprocessor=65536, max_threads_per_multi_processor=1536, warp_size=32), 'constants': {}, 'configs': [{(0,): [['tt.divisibility', 16]], (1,): [['tt.divisibility', 16]], (2,): [['tt.divisibility', 16]], (3,): [['tt.divisibility', 16]]}]},
    inductor_meta={'grid_type': 'Grid1D', 'autotune_hints': set(), 'kernel_name': 'triton_poi_fused_cat_transpose_view_67', 'mutated_arg_names': [], 'optimize_mem': True, 'no_x_dim': False, 'num_load': 2, 'num_reduction': 0, 'backend_hash': 'D54CF9E23D08230976451A78161C34C47AAE433535668E89333E7039B8F7F720', 'are_deterministic_algorithms_enabled': False, 'assert_indirect_indexing': True, 'autotune_local_cache': True, 'autotune_pointwise': True, 'autotune_remote_cache': None, 'force_disable_caches': False, 'dynamic_scale_rblock': True, 'max_autotune': False, 'max_autotune_pointwise': False, 'min_split_scan_rblock': 256, 'spill_threshold': 16, 'store_cubin': False, 'tiling_scores': {'x': 1048576}},
    min_elem_per_thread=0
)
@triton.jit
def triton_poi_fused_cat_transpose_view_67(in_ptr0, in_ptr1, out_ptr0, xnumel, XBLOCK : tl.constexpr):
    xnumel = 131072
    xoffset = tl.program_id(0) * XBLOCK
    xindex = xoffset + tl.arange(0, XBLOCK)[:]
    xmask = tl.full([XBLOCK], True, tl.int1)
...
# kernel path: /mnt/g/GitHub/VAE_ca_proj/Thermal/.compile_cache/qg/cqgiypwelz36lp3ketisxq5murglfjrq4vtcllhfm5c3s7j5yipy.py
# Topologically Sorted Source Nodes: [], Original ATen: [aten._to_copy]
# Source node to ATen node mapping:
# Graph fragment:
...
@triton_heuristics.pointwise(
    ...
    filename=__file__,
    triton_meta={'signature': {'in_ptr0': '*bf16', 'out_ptr0': '*fp32', 'xnumel': 'i32', 'XBLOCK': 'constexpr'}, 'device': DeviceProperties(type='cuda', index=0, multi_processor_count=36, cc=89, major=8, regs_per_multiprocessor=65536, max_threads_per_multi_processor=1536, warp_size=32), 'constants': {}, 'configs': [{(0,): [['tt.divisibility', 16]], (1,): [['tt.divisibility', 16]], (2,): [['tt.divisibility', 16]]}]},
    inductor_meta={'grid_type': 'Grid1D', 'autotune_hints': set(), 'kernel_name': 'triton_poi_fused__to_copy_68', 'mutated_arg_names': [], 'optimize_mem': True, 'no_x_dim': False, 'num_load': 1, 'num_reduction': 0, 'backend_hash': 'D54CF9E23D08230976451A78161C34C47AAE433535668E89333E7039B8F7F720', 'are_deterministic_algorithms_enabled': False, 'assert_indirect_indexing': True, 'autotune_local_cache': True, 'autotune_pointwise': True, 'autotune_remote_cache': None, 'force_disable_caches': False, 'dynamic_scale_rblock': True, 'max_autotune': False, 'max_autotune_pointwise': False, 'min_split_scan_rblock': 256, 'spill_threshold': 16, 'store_cubin': False, 'tiling_scores': {'x': 23592960}},
    min_elem_per_thread=0
)
@triton.jit
...
# kernel path: /mnt/g/GitHub/VAE_ca_proj/Thermal/.compile_cache/wd/cwdq4ruji3zkdbo6xsbjo4byel55leg7qqxu6qtho6iotimsgel5.py
# Topologically Sorted Source Nodes: [], Original ATen: [aten.view, aten.transpose, aten.clone, aten._unsafe_view]
# Source node to ATen node mapping:
# Graph fragment:
...
#   return %view_534
triton_poi_fused__unsafe_view_clone_transpose_view_69 = async_compile.triton('triton_poi_fused__unsafe_view_clone_transpose_view_69', '''
import triton
import triton.language as tl
...
@triton_heuristics.pointwise(
    ...
    filename=__file__,
    triton_meta={'signature': {'in_ptr0': '*bf16', 'out_ptr0': '*bf16', 'xnumel': 'i32', 'XBLOCK': 'constexpr'}, 'device': DeviceProperties(type='cuda', index=0, multi_processor_count=36, cc=89, major=8, regs_per_multiprocessor=65536, max_threads_per_multi_processor=1536, warp_size=32), 'constants': {}, 'configs': [{(0,): [['tt.divisibility', 16]], (1,): [['tt.divisibility', 16]], (2,): [['tt.divisibility', 16]]}]},
    inductor_meta={'grid_type': 'Grid1D', 'autotune_hints': set(), 'kernel_name': 'triton_poi_fused__unsafe_view_clone_transpose_view_69', 'mutated_arg_names': [], 'optimize_mem': True, 'no_x_dim': False, 'num_load': 1, 'num_reduction': 0, 'backend_hash': 'D54CF9E23D08230976451A78161C34C47AAE433535668E89333E7039B8F7F720', 'are_deterministic_algorithms_enabled': False, 'assert_indirect_indexing': True, 'autotune_local_cache': True, 'autotune_pointwise': True, 'autotune_remote_cache': None, 'force_disable_caches': False, 'dynamic_scale_rblock': True, 'max_autotune': False, 'max_autotune_pointwise': False, 'min_split_scan_rblock': 256, 'spill_threshold': 16, 'store_cubin': False, 'tiling_scores': {'x': 25165824}},
    min_elem_per_thread=0
)
@triton.jit
def triton_poi_fused__unsafe_view_clone_transpose_view_69(in_ptr0, out_ptr0, xnumel, XBLOCK : tl.constexpr):
    xnumel = 4194304
    xoffset = tl.program_id(0) * XBLOCK
    xindex = xoffset + tl.arange(0, XBLOCK)[:]
    xmask = tl.full([XBLOCK], True, tl.int1)
...
# kernel path: /mnt/g/GitHub/VAE_ca_proj/Thermal/.compile_cache/2y/c2ytoqn4u4xwyhb22h6wxu7mgtco5yisazplufoeav3mbvyiiqhw.py
...
#   return %mul_349
triton_poi_fused_add_fill_mul_sigmoid_sub_transpose_view_70 = async_compile.triton('triton_poi_fused_add_fill_mul_sigmoid_sub_transpose_view_70', '''
import triton
import triton.language as tl
...
@triton_heuristics.pointwise(
    ...
    inductor_meta={'grid_type': 'Grid1D', 'autotune_hints': set(), 'kernel_name': 'triton_poi_fused_add_fill_mul_sigmoid_sub_transpose_view_70', 'mutated_arg_names': ['in_out_ptr0'], 'optimize_mem': True, 'no_x_dim': False, 'num_load': 5, 'num_reduction': 0, 'backend_hash': 'D54CF9E23D08230976451A78161C34C47AAE433535668E89333E7039B8F7F720', 'are_deterministic_algorithms_enabled': False, 'assert_indirect_indexing': True, 'autotune_local_cache': True, 'autotune_pointwise': True, 'autotune_remote_cache': None, 'force_disable_caches': False, 'dynamic_scale_rblock': True, 'max_autotune': False, 'max_autotune_pointwise': False, 'min_split_scan_rblock': 256, 'spill_threshold': 16, 'store_cubin': False, 'tiling_scores': {'x': 58720256}},
    min_elem_per_thread=0
)
@triton.jit
def triton_poi_fused_add_fill_mul_sigmoid_sub_transpose_view_70(in_out_ptr0, in_ptr0, in_ptr1, in_ptr2, in_ptr3, xnumel, XBLOCK : tl.constexpr):
    xnumel = 4194304
    xoffset = tl.program_id(0) * XBLOCK
    xindex = xoffset + tl.arange(0, XBLOCK)[:]
    xmask = tl.full([XBLOCK], True, tl.int1)
...
# kernel path: /mnt/g/GitHub/VAE_ca_proj/Thermal/.compile_cache/t2/ct2s5k6jpqxltibjmlmqh5ju263ckgdpkfab2rycoujyx5j4egrn.py
...
#   return %add_180
triton_poi_fused__to_copy__unsafe_view_add_cat_clone_transpose_view_71 = async_compile.triton('triton_poi_fused__to_copy__unsafe_view_add_cat_clone_transpose_view_71', '''
import triton
import triton.language as tl
...
# kernel path: /mnt/g/GitHub/VAE_ca_proj/Thermal/.compile_cache/6w/c6wjrozhm74eqbcbybv3yjlvafpd424dcrfxx3tzqtqymmw24b4p.py
# Topologically Sorted Source Nodes: [], Original ATen: [aten.sum]
# Source node to ATen node mapping:
# Graph fragment:
...
#   return %sum_170
triton_red_fused_sum_72 = async_compile.triton('triton_red_fused_sum_72', '''
import triton
import triton.language as tl
...
@triton_heuristics.reduction(
    ...
    filename=__file__,
    triton_meta={'signature': {'in_ptr0': '*bf16', 'out_ptr0': '*fp32', 'xnumel': 'i32', 'r0_numel': 'i32', 'XBLOCK': 'constexpr', 'R0_BLOCK': 'constexpr'}, 'device': DeviceProperties(type='cuda', index=0, multi_processor_count=36, cc=89, major=8, regs_per_multiprocessor=65536, max_threads_per_multi_processor=1536, warp_size=32), 'constants': {}, 'configs': [{(0,): [['tt.divisibility', 16]], (1,): [['tt.divisibility', 16]], (2,): [['tt.divisibility', 16]], (3,): [['tt.divisibility', 16]]}]},
    inductor_meta={'grid_type': 'Grid1D', 'autotune_hints': set(), 'kernel_name': 'triton_red_fused_sum_72', 'mutated_arg_names': [], 'optimize_mem': True, 'no_x_dim': False, 'num_load': 1, 'num_reduction': 1, 'backend_hash': 'D54CF9E23D08230976451A78161C34C47AAE433535668E89333E7039B8F7F720', 'are_deterministic_algorithms_enabled': False, 'assert_indirect_indexing': True, 'autotune_local_cache': True, 'autotune_pointwise': True, 'autotune_remote_cache': None, 'force_disable_caches': False, 'dynamic_scale_rblock': True, 'max_autotune': False, 'max_autotune_pointwise': False, 'min_split_scan_rblock': 256, 'spill_threshold': 16, 'store_cubin': False, 'tiling_scores': {'x': 3379200, 'r0_': 0}}
)
@triton.jit
def triton_red_fused_sum_72(in_ptr0, out_ptr0, xnumel, r0_numel, XBLOCK : tl.constexpr, R0_BLOCK : tl.constexpr):
    xnumel = 12800
    r0_numel = 128
    rnumel = r0_numel
    RBLOCK: tl.constexpr = R0_BLOCK
...
# kernel path: /mnt/g/GitHub/VAE_ca_proj/Thermal/.compile_cache/zo/czo7taao4sapfjgkujxnlxxoqxojv5mk6daytm2dfgapnwkdi3km.py
# Topologically Sorted Source Nodes: [], Original ATen: [aten._to_copy]
# Source node to ATen node mapping:
# Graph fragment:
...
@triton_heuristics.pointwise(
    ...
    filename=__file__,
    triton_meta={'signature': {'in_ptr0': '*bf16', 'out_ptr0': '*fp32', 'xnumel': 'i32', 'XBLOCK': 'constexpr'}, 'device': DeviceProperties(type='cuda', index=0, multi_processor_count=36, cc=89, major=8, regs_per_multiprocessor=65536, max_threads_per_multi_processor=1536, warp_size=32), 'constants': {}, 'configs': [{(0,): [['tt.divisibility', 16]], (1,): [['tt.divisibility', 16]], (2,): [['tt.divisibility', 16]]}]},
    inductor_meta={'grid_type': 'Grid1D', 'autotune_hints': set(), 'kernel_name': 'triton_poi_fused__to_copy_73', 'mutated_arg_names': [], 'optimize_mem': True, 'no_x_dim': False, 'num_load': 1, 'num_reduction': 0, 'backend_hash': 'D54CF9E23D08230976451A78161C34C47AAE433535668E89333E7039B8F7F720', 'are_deterministic_algorithms_enabled': False, 'assert_indirect_indexing': True, 'autotune_local_cache': True, 'autotune_pointwise': True, 'autotune_remote_cache': None, 'force_disable_caches': False, 'dynamic_scale_rblock': True, 'max_autotune': False, 'max_autotune_pointwise': False, 'min_split_scan_rblock': 256, 'spill_threshold': 16, 'store_cubin': False, 'tiling_scores': {'x': 32768000}},
    min_elem_per_thread=0
)
@triton.jit
...
# kernel path: /mnt/g/GitHub/VAE_ca_proj/Thermal/.compile_cache/2j/c2jxb22d2zda7tpsktp6d6sbp34a2dzh35ijouvhlc53fycvzwzs.py
# Topologically Sorted Source Nodes: [], Original ATen: [aten.add, aten.view, aten.transpose]
# Source node to ATen node mapping:
# Graph fragment:
...
#   return %add_185
triton_poi_fused_add_transpose_view_74 = async_compile.triton('triton_poi_fused_add_transpose_view_74', '''
import triton
import triton.language as tl
...
@triton_heuristics.pointwise(
    ...
    filename=__file__,
    triton_meta={'signature': {'in_out_ptr0': '*bf16', 'in_ptr0': '*bf16', 'in_ptr1': '*bf16', 'xnumel': 'i32', 'XBLOCK': 'constexpr'}, 'device': DeviceProperties(type='cuda', index=0, multi_processor_count=36, cc=89, major=8, regs_per_multiprocessor=65536, max_threads_per_multi_processor=1536, warp_size=32), 'constants': {}, 'configs': [{(0,): [['tt.divisibility', 16]], (1,): [['tt.divisibility', 16]], (2,): [['tt.divisibility', 16]], (3,): [['tt.divisibility', 16]]}]},
    inductor_meta={'grid_type': 'Grid1D', 'autotune_hints': set(), 'kernel_name': 'triton_poi_fused_add_transpose_view_74', 'mutated_arg_names': ['in_out_ptr0'], 'optimize_mem': True, 'no_x_dim': False, 'num_load': 3, 'num_reduction': 0, 'backend_hash': 'D54CF9E23D08230976451A78161C34C47AAE433535668E89333E7039B8F7F720', 'are_deterministic_algorithms_enabled': False, 'assert_indirect_indexing': True, 'autotune_local_cache': True, 'autotune_pointwise': True, 'autotune_remote_cache': None, 'force_disable_caches': False, 'dynamic_scale_rblock': True, 'max_autotune': False, 'max_autotune_pointwise': False, 'min_split_scan_rblock': 256, 'spill_threshold': 16, 'store_cubin': False, 'tiling_scores': {'x': 41943040}},
    min_elem_per_thread=0
)
@triton.jit
def triton_poi_fused_add_transpose_view_74(in_out_ptr0, in_ptr0, in_ptr1, xnumel, XBLOCK : tl.constexpr):
    xnumel = 4194304
    xoffset = tl.program_id(0) * XBLOCK
    xindex = xoffset + tl.arange(0, XBLOCK)[:]
    xmask = tl.full([XBLOCK], True, tl.int1)
...
# kernel path: /mnt/g/GitHub/VAE_ca_proj/Thermal/.compile_cache/p2/cp2tibpogijyd3grurusgctjujoo32yqagpvf3w3d5p7kveqvyuy.py
# Topologically Sorted Source Nodes: [input_27, unsqueeze_4, gate], Original ATen: [aten.sigmoid, aten.unsqueeze, aten.mul, aten.add]
# Source node to ATen node mapping:
#   gate => unsqueeze_7
#   input_27 => sigmoid_18
...
#   %mul_303 : Tensor "bf16[128, 256, 16, 16][65536, 1, 4096, 256]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%add_163, %unsqueeze_7), kwargs = {})
...
#   return %mul_371
triton_poi_fused_add_mul_sigmoid_unsqueeze_75 = async_compile.triton('triton_poi_fused_add_mul_sigmoid_unsqueeze_75', '''
import triton
import triton.language as tl
...
@triton_heuristics.pointwise(
    ...
    filename=__file__,
    triton_meta={'signature': {'in_out_ptr0': '*bf16', 'in_ptr0': '*bf16', 'in_ptr1': '*bf16', 'in_ptr2': '*bf16', 'xnumel': 'i32', 'XBLOCK': 'constexpr'}, 'device': DeviceProperties(type='cuda', index=0, multi_processor_count=36, cc=89, major=8, regs_per_multiprocessor=65536, max_threads_per_multi_processor=1536, warp_size=32), 'constants': {}, 'configs': [{(0,): [['tt.divisibility', 16]], (1,): [['tt.divisibility', 16]], (2,): [['tt.divisibility', 16]], (3,): [['tt.divisibility', 16]], (4,): [['tt.divisibility', 16]]}]},
    inductor_meta={'grid_type': 'Grid1D', 'autotune_hints': set(), 'kernel_name': 'triton_poi_fused_add_mul_sigmoid_unsqueeze_75', 'mutated_arg_names': ['in_out_ptr0'], 'optimize_mem': True, 'no_x_dim': False, 'num_load': 4, 'num_reduction': 0, 'backend_hash': 'D54CF9E23D08230976451A78161C34C47AAE433535668E89333E7039B8F7F720', 'are_deterministic_algorithms_enabled': False, 'assert_indirect_indexing': True, 'autotune_local_cache': True, 'autotune_pointwise': True, 'autotune_remote_cache': None, 'force_disable_caches': False, 'dynamic_scale_rblock': True, 'max_autotune': False, 'max_autotune_pointwise': False, 'min_split_scan_rblock': 256, 'spill_threshold': 16, 'store_cubin': False, 'tiling_scores': {'x': 83951616}},
    min_elem_per_thread=0
)
@triton.jit
def triton_poi_fused_add_mul_sigmoid_unsqueeze_75(in_out_ptr0, in_ptr0, in_ptr1, in_ptr2, xnumel, XBLOCK : tl.constexpr):
    xnumel = 8388608
    xoffset = tl.program_id(0) * XBLOCK
    xindex = xoffset + tl.arange(0, XBLOCK)[:]
    xmask = tl.full([XBLOCK], True, tl.int1)
...
# kernel path: /mnt/g/GitHub/VAE_ca_proj/Thermal/.compile_cache/5h/c5hmfgfxivawjsgkisvbhh4m4gx6f63b6ngvhdej35cl3lp7ejsb.py
# Topologically Sorted Source Nodes: [], Original ATen: [aten._to_copy]
# Source node to ATen node mapping:
# Graph fragment:
...
@triton_heuristics.pointwise(
    ...
    filename=__file__,
    triton_meta={'signature': {'in_ptr0': '*bf16', 'out_ptr0': '*fp32', 'xnumel': 'i32', 'XBLOCK': 'constexpr'}, 'device': DeviceProperties(type='cuda', index=0, multi_processor_count=36, cc=89, major=8, regs_per_multiprocessor=65536, max_threads_per_multi_processor=1536, warp_size=32), 'constants': {}, 'configs': [{(0,): [['tt.divisibility', 16]], (1,): [['tt.divisibility', 16]], (2,): [['tt.divisibility', 16]]}]},
    inductor_meta={'grid_type': 'Grid1D', 'autotune_hints': set(), 'kernel_name': 'triton_poi_fused__to_copy_76', 'mutated_arg_names': [], 'optimize_mem': True, 'no_x_dim': False, 'num_load': 1, 'num_reduction': 0, 'backend_hash': 'D54CF9E23D08230976451A78161C34C47AAE433535668E89333E7039B8F7F720', 'are_deterministic_algorithms_enabled': False, 'assert_indirect_indexing': True, 'autotune_local_cache': True, 'autotune_pointwise': True, 'autotune_remote_cache': None, 'force_disable_caches': False, 'dynamic_scale_rblock': True, 'max_autotune': False, 'max_autotune_pointwise': False, 'min_split_scan_rblock': 256, 'spill_threshold': 16, 'store_cubin': False, 'tiling_scores': {'x': 11796480}},
    min_elem_per_thread=0
)
@triton.jit
...
# kernel path: /mnt/g/GitHub/VAE_ca_proj/Thermal/.compile_cache/yt/cytzx3ffsgdharsspoaorukxayvpememj32f7srtnb6vcmpxmbzo.py
...
#   return %mul_393
triton_poi_fused_add_fill_mul_sigmoid_sub_transpose_view_77 = async_compile.triton('triton_poi_fused_add_fill_mul_sigmoid_sub_transpose_view_77', '''
import triton
import triton.language as tl
...
@triton_heuristics.pointwise(
    ...
    filename=__file__,
    triton_meta={'signature': {'in_out_ptr0': '*bf16', 'in_ptr0': '*bf16', 'in_ptr1': '*bf16', 'in_ptr2': '*bf16', 'in_ptr3': '*bf16', 'xnumel': 'i32', 'XBLOCK': 'constexpr'}, 'device': DeviceProperties(type='cuda', index=0, multi_processor_count=36, cc=89, major=8, regs_per_multiprocessor=65536, max_threads_per_multi_processor=1536, warp_size=32), 'constants': {}, 'configs': [{(0,): [['tt.divisibility', 16]], (1,): [['tt.divisibility', 16]], (2,): [['tt.divisibility', 16]], (3,): [['tt.divisibility', 16]], (4,): [['tt.divisibility', 16]], (5,): [['tt.divisibility', 16]]}]},
    inductor_meta={'grid_type': 'Grid1D', 'autotune_hints': set(), 'kernel_name': 'triton_poi_fused_add_fill_mul_sigmoid_sub_transpose_view_77', 'mutated_arg_names': ['in_out_ptr0'], 'optimize_mem': True, 'no_x_dim': False, 'num_load': 5, 'num_reduction': 0, 'backend_hash': 'D54CF9E23D08230976451A78161C34C47AAE433535668E89333E7039B8F7F720', 'are_deterministic_algorithms_enabled': False, 'assert_indirect_indexing': True, 'autotune_local_cache': True, 'autotune_pointwise': True, 'autotune_remote_cache': None, 'force_disable_caches': False, 'dynamic_scale_rblock': True, 'max_autotune': False, 'max_autotune_pointwise': False, 'min_split_scan_rblock': 256, 'spill_threshold': 16, 'store_cubin': False, 'tiling_scores': {'x': 117440512}},
    min_elem_per_thread=0
)
@triton.jit
def triton_poi_fused_add_fill_mul_sigmoid_sub_transpose_view_77(in_out_ptr0, in_ptr0, in_ptr1, in_ptr2, in_ptr3, xnumel, XBLOCK : tl.constexpr):
    xnumel = 8388608
    xoffset = tl.program_id(0) * XBLOCK
    xindex = xoffset + tl.arange(0, XBLOCK)[:]
    xmask = tl.full([XBLOCK], True, tl.int1)
...
# kernel path: /mnt/g/GitHub/VAE_ca_proj/Thermal/.compile_cache/3u/c3uvhf7zj7kywyfyb7v3j2nnpxmei6yi5ckkmyeryggka4d5eicd.py
# Topologically Sorted Source Nodes: [], Original ATen: [aten._to_copy, aten.transpose, aten.view, aten.clone, aten._unsafe_view, aten.cat, aten.add]
# Source node to ATen node mapping:
# Graph fragment:
...
triton_poi_fused__to_copy__unsafe_view_add_cat_clone_transpose_view_78 = async_compile.triton('triton_poi_fused__to_copy__unsafe_view_add_cat_clone_transpose_view_78', '''
import triton
import triton.language as tl
...
@triton_heuristics.pointwise(
    ...
    inductor_meta={'grid_type': 'Grid1D', 'autotune_hints': set(), 'kernel_name': 'triton_poi_fused__to_copy__unsafe_view_add_cat_clone_transpose_view_78', 'mutated_arg_names': ['in_out_ptr0'], 'optimize_mem': True, 'no_x_dim': False, 'num_load': 21, 'num_reduction': 0, 'backend_hash': 'D54CF9E23D08230976451A78161C34C47AAE433535668E89333E7039B8F7F720', 'are_deterministic_algorithms_enabled': False, 'assert_indirect_indexing': True, 'autotune_local_cache': True, 'autotune_pointwise': True, 'autotune_remote_cache': None, 'force_disable_caches': False, 'dynamic_scale_rblock': True, 'max_autotune': False, 'max_autotune_pointwise': False, 'min_split_scan_rblock': 256, 'spill_threshold': 16, 'store_cubin': False, 'tiling_scores': {'x': 37683200}},
    min_elem_per_thread=0
)
@triton.jit
def triton_poi_fused__to_copy__unsafe_view_add_cat_clone_transpose_view_78(in_out_ptr0, in_ptr0, in_ptr1, in_ptr2, in_ptr3, in_ptr4, in_ptr5, in_ptr6, in_ptr7, in_ptr8, in_ptr9, in_ptr10, in_ptr11, in_ptr12, in_ptr13, in_ptr14, in_ptr15, in_ptr16, in_ptr17, in_ptr18, in_ptr19, in_ptr20, xnumel, XBLOCK : tl.constexpr):
    xnumel = 819200
    xoffset = tl.program_id(0) * XBLOCK
    xindex = xoffset + tl.arange(0, XBLOCK)[:]
    xmask = tl.full([XBLOCK], True, tl.int1)
...
# kernel path: /mnt/g/GitHub/VAE_ca_proj/Thermal/.compile_cache/ft/cftgw6pfii3qgieto76f5fjekzsc3t6uvz3mmwvfsz4xfz2owef6.py
# Topologically Sorted Source Nodes: [], Original ATen: [aten.sum]
# Source node to ATen node mapping:
# Graph fragment:
...
#   return %sum_172
triton_red_fused_sum_79 = async_compile.triton('triton_red_fused_sum_79', '''
import triton
import triton.language as tl
...
@triton_heuristics.reduction(
    ...
    filename=__file__,
    triton_meta={'signature': {'in_ptr0': '*bf16', 'out_ptr0': '*fp32', 'xnumel': 'i32', 'r0_numel': 'i32', 'XBLOCK': 'constexpr', 'R0_BLOCK': 'constexpr'}, 'device': DeviceProperties(type='cuda', index=0, multi_processor_count=36, cc=89, major=8, regs_per_multiprocessor=65536, max_threads_per_multi_processor=1536, warp_size=32), 'constants': {}, 'configs': [{(0,): [['tt.divisibility', 16]], (1,): [['tt.divisibility', 16]], (2,): [['tt.divisibility', 16]], (3,): [['tt.divisibility', 16]]}]},
    inductor_meta={'grid_type': 'Grid1D', 'autotune_hints': set(), 'kernel_name': 'triton_red_fused_sum_79', 'mutated_arg_names': [], 'optimize_mem': True, 'no_x_dim': False, 'num_load': 1, 'num_reduction': 1, 'backend_hash': 'D54CF9E23D08230976451A78161C34C47AAE433535668E89333E7039B8F7F720', 'are_deterministic_algorithms_enabled': False, 'assert_indirect_indexing': True, 'autotune_local_cache': True, 'autotune_pointwise': True, 'autotune_remote_cache': None, 'force_disable_caches': False, 'dynamic_scale_rblock': True, 'max_autotune': False, 'max_autotune_pointwise': False, 'min_split_scan_rblock': 256, 'spill_threshold': 16, 'store_cubin': False, 'tiling_scores': {'x': 1689600, 'r0_': 0}}
)
@triton.jit
def triton_red_fused_sum_79(in_ptr0, out_ptr0, xnumel, r0_numel, XBLOCK : tl.constexpr, R0_BLOCK : tl.constexpr):
    xnumel = 6400
    r0_numel = 128
    rnumel = r0_numel
    RBLOCK: tl.constexpr = R0_BLOCK
...
# kernel path: /mnt/g/GitHub/VAE_ca_proj/Thermal/.compile_cache/3t/c3tihamgjc3ae2eolfc2oskthjtwhv3juw4u2wwafx3cgjoznn3o.py
# Topologically Sorted Source Nodes: [], Original ATen: [aten._to_copy]
# Source node to ATen node mapping:
# Graph fragment:
...
@triton_heuristics.pointwise(
    ...
    filename=__file__,
    triton_meta={'signature': {'in_ptr0': '*bf16', 'out_ptr0': '*fp32', 'xnumel': 'i32', 'XBLOCK': 'constexpr'}, 'device': DeviceProperties(type='cuda', index=0, multi_processor_count=36, cc=89, major=8, regs_per_multiprocessor=65536, max_threads_per_multi_processor=1536, warp_size=32), 'constants': {}, 'configs': [{(0,): [['tt.divisibility', 16]], (1,): [['tt.divisibility', 16]], (2,): [['tt.divisibility', 16]]}]},
    inductor_meta={'grid_type': 'Grid1D', 'autotune_hints': set(), 'kernel_name': 'triton_poi_fused__to_copy_80', 'mutated_arg_names': [], 'optimize_mem': True, 'no_x_dim': False, 'num_load': 1, 'num_reduction': 0, 'backend_hash': 'D54CF9E23D08230976451A78161C34C47AAE433535668E89333E7039B8F7F720', 'are_deterministic_algorithms_enabled': False, 'assert_indirect_indexing': True, 'autotune_local_cache': True, 'autotune_pointwise': True, 'autotune_remote_cache': None, 'force_disable_caches': False, 'dynamic_scale_rblock': True, 'max_autotune': False, 'max_autotune_pointwise': False, 'min_split_scan_rblock': 256, 'spill_threshold': 16, 'store_cubin': False, 'tiling_scores': {'x': 16384000}},
    min_elem_per_thread=0
)
@triton.jit
...
# kernel path: /mnt/g/GitHub/VAE_ca_proj/Thermal/.compile_cache/26/c26ocp5vb4iun6czvkb27aspcmj7hviec3psgu5xwdvolsshxrgo.py
# Topologically Sorted Source Nodes: [input_41, unsqueeze_11, gate_1], Original ATen: [aten.sigmoid, aten.unsqueeze, aten.mul, aten.add]
# Source node to ATen node mapping:
#   gate_1 => unsqueeze_14
#   input_41 => sigmoid_30
...
#   %mul_186 : Tensor "bf16[128, 128, 32, 32][131072, 1024, 32, 1]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%add_118, %unsqueeze_14), kwargs = {})
...
#   return %mul_415
triton_poi_fused_add_mul_sigmoid_unsqueeze_81 = async_compile.triton('triton_poi_fused_add_mul_sigmoid_unsqueeze_81', '''
import triton
import triton.language as tl
...
@triton_heuristics.pointwise(
    ...
    inductor_meta={'grid_type': 'Grid2D', 'autotune_hints': set(), 'kernel_name': 'triton_poi_fused_add_mul_sigmoid_unsqueeze_81', 'mutated_arg_names': ['in_out_ptr0'], 'optimize_mem': True, 'no_x_dim': False, 'num_load': 4, 'num_reduction': 0, 'backend_hash': 'D54CF9E23D08230976451A78161C34C47AAE433535668E89333E7039B8F7F720', 'are_deterministic_algorithms_enabled': False, 'assert_indirect_indexing': True, 'autotune_local_cache': True, 'autotune_pointwise': True, 'autotune_remote_cache': None, 'force_disable_caches': False, 'dynamic_scale_rblock': True, 'max_autotune': False, 'max_autotune_pointwise': False, 'min_split_scan_rblock': 256, 'spill_threshold': 16, 'store_cubin': False, 'tiling_scores': {'y': 67141632, 'x': 100663296}},
    min_elem_per_thread=0
)
@triton.jit
def triton_poi_fused_add_mul_sigmoid_unsqueeze_81(in_out_ptr0, in_ptr0, in_ptr1, in_ptr2, ynumel, xnumel, YBLOCK : tl.constexpr, XBLOCK : tl.constexpr):
    ynumel = 16384
    xnumel = 1024
    yoffset = tl.program_id(1) * YBLOCK
    yindex = yoffset + tl.arange(0, YBLOCK)[:, None]
...
# kernel path: /mnt/g/GitHub/VAE_ca_proj/Thermal/.compile_cache/hv/chv4rqyknwynyy5p4dgqel5bxngeufuilziri5qj2gbpmbyqgb5n.py
# Topologically Sorted Source Nodes: [], Original ATen: [aten._to_copy]
# Source node to ATen node mapping:
# Graph fragment:
...
# kernel path: /mnt/g/GitHub/VAE_ca_proj/Thermal/.compile_cache/dp/cdpjmneddbm4zh2k6ixofhcfuq5qvddmmqgvcdmylpwtunxjkqw4.py
...
#   return %mul_433
triton_poi_fused_add_fill_mul_sigmoid_sub_83 = async_compile.triton('triton_poi_fused_add_fill_mul_sigmoid_sub_83', '''
import triton
import triton.language as tl
...
@triton_heuristics.pointwise(
    ...
    filename=__file__,
    triton_meta={'signature': {'in_out_ptr0': '*bf16', 'in_ptr0': '*bf16', 'in_ptr1': '*bf16', 'in_ptr2': '*bf16', 'ynumel': 'i32', 'xnumel': 'i32', 'YBLOCK': 'constexpr', 'XBLOCK': 'constexpr'}, 'device': DeviceProperties(type='cuda', index=0, multi_processor_count=36, cc=89, major=8, regs_per_multiprocessor=65536, max_threads_per_multi_processor=1536, warp_size=32), 'constants': {}, 'configs': [{(0,): [['tt.divisibility', 16]], (1,): [['tt.divisibility', 16]], (2,): [['tt.divisibility', 16]], (3,): [['tt.divisibility', 16]], (4,): [['tt.divisibility', 16]], (5,): [['tt.divisibility', 16]]}]},
    inductor_meta={'grid_type': 'Grid2DWithYZOverflow', 'autotune_hints': set(), 'kernel_name': 'triton_poi_fused_add_fill_mul_sigmoid_sub_83', 'mutated_arg_names': ['in_out_ptr0'], 'optimize_mem': True, 'no_x_dim': False, 'num_load': 4, 'num_reduction': 0, 'backend_hash': 'D54CF9E23D08230976451A78161C34C47AAE433535668E89333E7039B8F7F720', 'are_deterministic_algorithms_enabled': False, 'assert_indirect_indexing': True, 'autotune_local_cache': True, 'autotune_pointwise': True, 'autotune_remote_cache': None, 'force_disable_caches': False, 'dynamic_scale_rblock': True, 'max_autotune': False, 'max_autotune_pointwise': False, 'min_split_scan_rblock': 256, 'spill_threshold': 16, 'store_cubin': False, 'tiling_scores': {'y': 100663296, 'x': 100663296}},
    min_elem_per_thread=0
)
@triton.jit
def triton_poi_fused_add_fill_mul_sigmoid_sub_83(in_out_ptr0, in_ptr0, in_ptr1, in_ptr2, ynumel, xnumel, YBLOCK : tl.constexpr, XBLOCK : tl.constexpr):
    ynumel = 131072
    xnumel = 128
    yoffset = (tl.program_id(1) + tl.program_id(2) * tl.num_programs(1)) * YBLOCK
    yindex = yoffset + tl.arange(0, YBLOCK)[:, None]
...
# kernel path: /mnt/g/GitHub/VAE_ca_proj/Thermal/.compile_cache/w5/cw5uxpwfk45sg6jniitfcr3cjovvphhuy6bpjywv4sf4y5ra6d4k.py
# Topologically Sorted Source Nodes: [], Original ATen: [aten._to_copy, aten.transpose, aten.view, aten.clone, aten._unsafe_view, aten.cat, aten.add]
# Source node to ATen node mapping:
# Graph fragment:
...
triton_poi_fused__to_copy__unsafe_view_add_cat_clone_transpose_view_84 = async_compile.triton('triton_poi_fused__to_copy__unsafe_view_add_cat_clone_transpose_view_84', '''
import triton
import triton.language as tl
...
# kernel path: /mnt/g/GitHub/VAE_ca_proj/Thermal/.compile_cache/6f/c6f2udeqrw6aerywvfkgyo6uortie4qame3hswkodrzpm25nfuce.py
# Topologically Sorted Source Nodes: [], Original ATen: [aten.sigmoid, aten.fill, aten.sub, aten.mul, aten.add]
# Source node to ATen node mapping:
# Graph fragment:
...
#   return %mul_460
triton_poi_fused_add_fill_mul_sigmoid_sub_85 = async_compile.triton('triton_poi_fused_add_fill_mul_sigmoid_sub_85', '''
import triton
import triton.language as tl
...
@triton_heuristics.pointwise(
    ...
    filename=__file__,
    triton_meta={'signature': {'in_out_ptr0': '*bf16', 'in_ptr0': '*bf16', 'xnumel': 'i32', 'XBLOCK': 'constexpr'}, 'device': DeviceProperties(type='cuda', index=0, multi_processor_count=36, cc=89, major=8, regs_per_multiprocessor=65536, max_threads_per_multi_processor=1536, warp_size=32), 'constants': {}, 'configs': [{(0,): [['tt.divisibility', 16]], (1,): [['tt.divisibility', 16]], (2,): [['tt.divisibility', 16]]}]},
    inductor_meta={'grid_type': 'Grid1D', 'autotune_hints': set(), 'kernel_name': 'triton_poi_fused_add_fill_mul_sigmoid_sub_85', 'mutated_arg_names': ['in_out_ptr0'], 'optimize_mem': True, 'no_x_dim': False, 'num_load': 2, 'num_reduction': 0, 'backend_hash': 'D54CF9E23D08230976451A78161C34C47AAE433535668E89333E7039B8F7F720', 'are_deterministic_algorithms_enabled': False, 'assert_indirect_indexing': True, 'autotune_local_cache': True, 'autotune_pointwise': True, 'autotune_remote_cache': None, 'force_disable_caches': False, 'dynamic_scale_rblock': True, 'max_autotune': False, 'max_autotune_pointwise': False, 'min_split_scan_rblock': 256, 'spill_threshold': 16, 'store_cubin': False, 'tiling_scores': {'x': 524288}},
    min_elem_per_thread=0
)
@triton.jit
def triton_poi_fused_add_fill_mul_sigmoid_sub_85(in_out_ptr0, in_ptr0, xnumel, XBLOCK : tl.constexpr):
    xnumel = 65536
    xoffset = tl.program_id(0) * XBLOCK
    xindex = xoffset + tl.arange(0, XBLOCK)[:]
    xmask = tl.full([XBLOCK], True, tl.int1)
...
# kernel path: /mnt/g/GitHub/VAE_ca_proj/Thermal/.compile_cache/5u/c5ugnlrsbhafmxw3u7ufnlc4647pjjhfrp7syl67zrcpd5g6b5te.py
# Topologically Sorted Source Nodes: [], Original ATen: [aten._to_copy, aten.slice, aten.embedding_dense_backward]
# Source node to ATen node mapping:
# Graph fragment:
...
#   %index_put : Tensor "f32[4, 256][256, 1]cuda:0" = PlaceHolder[target=index_put]
#   %convert_element_type_1138 : Tensor "f32[128, 512][512, 1]cuda:0"[num_users=2] = call_function[target=torch.ops.prims.convert_element_type.default](args = (%mm_98, torch.float32), kwargs = {})
#   %slice_2 : Tensor "f32[128, 256][512, 1]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.slice.Tensor](args = (%convert_element_type_1138, 1, 256, 512), kwargs = {})
#   %eq : Tensor "b8[128][1]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.eq.Scalar](args = (%primals_7, -1), kwargs = {})
#   %unsqueeze_127 : Tensor "b8[128, 1][1, 1]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.unsqueeze.default](args = (%eq, -1), kwargs = {})
#   %full_default_42 : Tensor "f32[][]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.full.default](args = ([], 0.0), kwargs = {dtype: torch.float32, layout: torch.strided, device: cuda:0, pin_memory: False})
#   %where : Tensor "f32[128, 256][256, 1]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.where.self](args = (%unsqueeze_127, %full_default_42, %slice_2), kwargs = {})
#   %full_default_43 : Tensor "f32[4, 256][256, 1]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.full.default](args = ([4, 256], 0), kwargs = {dtype: torch.float32, layout: torch.strided, device: cuda:0, pin_memory: False})
#   %index_put : Tensor "f32[4, 256][256, 1]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.index_put_.default](args = (%full_default_43, [%primals_7], %where, True), kwargs = {})
#   return %buf734
triton_poi_fused__to_copy_embedding_dense_backward_slice_86 = async_compile.triton('triton_poi_fused__to_copy_embedding_dense_backward_slice_86', '''
import triton
import triton.language as tl
...
@triton_heuristics.pointwise(
    ...
    inductor_meta={'grid_type': 'Grid1D', 'autotune_hints': set(), 'kernel_name': 'triton_poi_fused__to_copy_embedding_dense_backward_slice_86', 'mutated_arg_names': ['out_ptr0'], 'optimize_mem': True, 'no_x_dim': False, 'num_load': 2, 'num_reduction': 0, 'backend_hash': 'D54CF9E23D08230976451A78161C34C47AAE433535668E89333E7039B8F7F720', 'are_deterministic_algorithms_enabled': False, 'assert_indirect_indexing': True, 'autotune_local_cache': True, 'autotune_pointwise': True, 'autotune_remote_cache': None, 'force_disable_caches': False, 'dynamic_scale_rblock': True, 'max_autotune': False, 'max_autotune_pointwise': False, 'min_split_scan_rblock': 256, 'spill_threshold': 16, 'store_cubin': False},
    min_elem_per_thread=0
)
@triton.jit
def triton_poi_fused__to_copy_embedding_dense_backward_slice_86(in_ptr0, in_ptr1, out_ptr0, xnumel, XBLOCK : tl.constexpr):
    xnumel = 32768
    xoffset = tl.program_id(0) * XBLOCK
    xindex = xoffset + tl.arange(0, XBLOCK)[:]
    xmask = tl.full([XBLOCK], True, tl.int1)
    ...
    tmp8 = tl.load(in_ptr1 + (256 + x0 + 512*x1), None).to(tl.float32)
    ...
    tl.atomic_add(out_ptr0 + (x0 + 256*tmp4), tmp11, None, sem='relaxed')
''', device_str='cuda')


# kernel path: /mnt/g/GitHub/VAE_ca_proj/Thermal/.compile_cache/xm/cxm5wi2jc2hfgpggm772tqi3nsgyuskyocdt4ncsybfo5qzid7do.py
...
triton_poi_fused__to_copy_slice_87 = async_compile.triton('triton_poi_fused__to_copy_slice_87', '''
import triton
import triton.language as tl
...
@triton_heuristics.pointwise(
    ...
    filename=__file__,
    triton_meta={'signature': {'in_ptr0': '*bf16', 'out_ptr0': '*bf16', 'xnumel': 'i32', 'XBLOCK': 'constexpr'}, 'device': DeviceProperties(type='cuda', index=0, multi_processor_count=36, cc=89, major=8, regs_per_multiprocessor=65536, max_threads_per_multi_processor=1536, warp_size=32), 'constants': {}, 'configs': [{(0,): [['tt.divisibility', 16]], (1,): [['tt.divisibility', 16]], (2,): [['tt.divisibility', 16]]}]},
    inductor_meta={'grid_type': 'Grid1D', 'autotune_hints': set(), 'kernel_name': 'triton_poi_fused__to_copy_slice_87', 'mutated_arg_names': [], 'optimize_mem': True, 'no_x_dim': False, 'num_load': 1, 'num_reduction': 0, 'backend_hash': 'D54CF9E23D08230976451A78161C34C47AAE433535668E89333E7039B8F7F720', 'are_deterministic_algorithms_enabled': False, 'assert_indirect_indexing': True, 'autotune_local_cache': True, 'autotune_pointwise': True, 'autotune_remote_cache': None, 'force_disable_caches': False, 'dynamic_scale_rblock': True, 'max_autotune': False, 'max_autotune_pointwise': False, 'min_split_scan_rblock': 256, 'spill_threshold': 16, 'store_cubin': False, 'tiling_scores': {'x': 196608}},
    min_elem_per_thread=0
)
@triton.jit
def triton_poi_fused__to_copy_slice_87(in_ptr0, out_ptr0, xnumel, XBLOCK : tl.constexpr):
    xnumel = 32768
    xoffset = tl.program_id(0) * XBLOCK
    xindex = xoffset + tl.arange(0, XBLOCK)[:]
    xmask = tl.full([XBLOCK], True, tl.int1)
...
# kernel path: /mnt/g/GitHub/VAE_ca_proj/Thermal/.compile_cache/oy/coybcqjmmpq7ryevejeju3nxhk73gdstwyb43i65y6ixzsppf4fv.py
# Topologically Sorted Source Nodes: [], Original ATen: [aten.sigmoid, aten.fill, aten.sub, aten.mul, aten.add]
# Source node to ATen node mapping:
# Graph fragment:
...
#   %full_default_44 : Tensor "bf16[128, 1024][1024, 1]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.full.default](args = ([128, 1024], 1), kwargs = {dtype: torch.bfloat16, layout: torch.strided, device: cuda:0, pin_memory: False})
#   %sub_111 : Tensor "bf16[128, 1024][1024, 1]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.sub.Tensor](args = (%full_default_44, %sigmoid_81), kwargs = {})
...
#   return %mul_463
triton_poi_fused_add_fill_mul_sigmoid_sub_88 = async_compile.triton('triton_poi_fused_add_fill_mul_sigmoid_sub_88', '''
import triton
import triton.language as tl
...
@triton_heuristics.pointwise(
    ...
    filename=__file__,
    triton_meta={'signature': {'in_out_ptr0': '*bf16', 'in_ptr0': '*bf16', 'xnumel': 'i32', 'XBLOCK': 'constexpr'}, 'device': DeviceProperties(type='cuda', index=0, multi_processor_count=36, cc=89, major=8, regs_per_multiprocessor=65536, max_threads_per_multi_processor=1536, warp_size=32), 'constants': {}, 'configs': [{(0,): [['tt.divisibility', 16]], (1,): [['tt.divisibility', 16]], (2,): [['tt.divisibility', 16]]}]},
    inductor_meta={'grid_type': 'Grid1D', 'autotune_hints': set(), 'kernel_name': 'triton_poi_fused_add_fill_mul_sigmoid_sub_88', 'mutated_arg_names': ['in_out_ptr0'], 'optimize_mem': True, 'no_x_dim': False, 'num_load': 2, 'num_reduction': 0, 'backend_hash': 'D54CF9E23D08230976451A78161C34C47AAE433535668E89333E7039B8F7F720', 'are_deterministic_algorithms_enabled': False, 'assert_indirect_indexing': True, 'autotune_local_cache': True, 'autotune_pointwise': True, 'autotune_remote_cache': None, 'force_disable_caches': False, 'dynamic_scale_rblock': True, 'max_autotune': False, 'max_autotune_pointwise': False, 'min_split_scan_rblock': 256, 'spill_threshold': 16, 'store_cubin': False, 'tiling_scores': {'x': 1048576}},
    min_elem_per_thread=0
)
@triton.jit
def triton_poi_fused_add_fill_mul_sigmoid_sub_88(in_out_ptr0, in_ptr0, xnumel, XBLOCK : tl.constexpr):
    xnumel = 131072
    xoffset = tl.program_id(0) * XBLOCK
    xindex = xoffset + tl.arange(0, XBLOCK)[:]
    xmask = tl.full([XBLOCK], True, tl.int1)
...
# kernel path: /mnt/g/GitHub/VAE_ca_proj/Thermal/.compile_cache/22/c22nqbofrb6zv3vr5ukbjbmo4v56pfzeu7jfnp4pppr5cvsfczld.py
# Topologically Sorted Source Nodes: [], Original ATen: [aten.sum]
# Source node to ATen node mapping:
# Graph fragment:
...
# kernel path: /mnt/g/GitHub/VAE_ca_proj/Thermal/.compile_cache/bg/cbgimw7ky3xazb7fa2ymcmygbtnqznhh4y65fvuohlnbnrf54vj5.py
# Topologically Sorted Source Nodes: [], Original ATen: [aten.sum]
# Source node to ATen node mapping:
# Graph fragment:
...
#   return %sum_179
triton_red_fused_sum_90 = async_compile.triton('triton_red_fused_sum_90', '''
import triton
import triton.language as tl
...
@triton_heuristics.reduction(
    ...
    filename=__file__,
    triton_meta={'signature': {'in_ptr0': '*bf16', 'out_ptr0': '*fp32', 'xnumel': 'i32', 'r0_numel': 'i32', 'XBLOCK': 'constexpr', 'R0_BLOCK': 'constexpr'}, 'device': DeviceProperties(type='cuda', index=0, multi_processor_count=36, cc=89, major=8, regs_per_multiprocessor=65536, max_threads_per_multi_processor=1536, warp_size=32), 'constants': {}, 'configs': [{(0,): [['tt.divisibility', 16]], (1,): [['tt.divisibility', 16]], (2,): [['tt.divisibility', 16]], (3,): [['tt.divisibility', 16]]}]},
    inductor_meta={'grid_type': 'Grid1D', 'autotune_hints': set(), 'kernel_name': 'triton_red_fused_sum_90', 'mutated_arg_names': [], 'optimize_mem': True, 'no_x_dim': False, 'num_load': 1, 'num_reduction': 1, 'backend_hash': 'D54CF9E23D08230976451A78161C34C47AAE433535668E89333E7039B8F7F720', 'are_deterministic_algorithms_enabled': False, 'assert_indirect_indexing': True, 'autotune_local_cache': True, 'autotune_pointwise': True, 'autotune_remote_cache': None, 'force_disable_caches': False, 'dynamic_scale_rblock': True, 'max_autotune': False, 'max_autotune_pointwise': False, 'min_split_scan_rblock': 256, 'spill_threshold': 16, 'store_cubin': False, 'tiling_scores': {'x': 270336, 'r0_': 0}}
)
@triton.jit
def triton_red_fused_sum_90(in_ptr0, out_ptr0, xnumel, r0_numel, XBLOCK : tl.constexpr, R0_BLOCK : tl.constexpr):
    xnumel = 1024
    r0_numel = 128
    rnumel = r0_numel
    RBLOCK: tl.constexpr = R0_BLOCK
...
# kernel path: /mnt/g/GitHub/VAE_ca_proj/Thermal/.compile_cache/2q/c2q35feswkwsdvvsfoh3fjxyuoek6r5awruhu45ebjlhefjibg45.py
# Topologically Sorted Source Nodes: [], Original ATen: [aten.sum]
# Source node to ATen node mapping:
# Graph fragment:
...
#   return %sum_174
triton_red_fused_sum_91 = async_compile.triton('triton_red_fused_sum_91', '''
import triton
import triton.language as tl
...
@triton_heuristics.reduction(
    ...
    filename=__file__,
    triton_meta={'signature': {'in_ptr0': '*bf16', 'out_ptr0': '*fp32', 'xnumel': 'i32', 'r0_numel': 'i32', 'XBLOCK': 'constexpr', 'R0_BLOCK': 'constexpr'}, 'device': DeviceProperties(type='cuda', index=0, multi_processor_count=36, cc=89, major=8, regs_per_multiprocessor=65536, max_threads_per_multi_processor=1536, warp_size=32), 'constants': {}, 'configs': [{(0,): [['tt.divisibility', 16]], (1,): [['tt.divisibility', 16]], (2,): [['tt.divisibility', 16]], (3,): [['tt.divisibility', 16]]}]},
    inductor_meta={'grid_type': 'Grid1D', 'autotune_hints': set(), 'kernel_name': 'triton_red_fused_sum_91', 'mutated_arg_names': [], 'optimize_mem': True, 'no_x_dim': False, 'num_load': 1, 'num_reduction': 1, 'backend_hash': 'D54CF9E23D08230976451A78161C34C47AAE433535668E89333E7039B8F7F720', 'are_deterministic_algorithms_enabled': False, 'assert_indirect_indexing': True, 'autotune_local_cache': True, 'autotune_pointwise': True, 'autotune_remote_cache': None, 'force_disable_caches': False, 'dynamic_scale_rblock': True, 'max_autotune': False, 'max_autotune_pointwise': False, 'min_split_scan_rblock': 256, 'spill_threshold': 16, 'store_cubin': False, 'tiling_scores': {'x': 844800, 'r0_': 0}}
)
@triton.jit
def triton_red_fused_sum_91(in_ptr0, out_ptr0, xnumel, r0_numel, XBLOCK : tl.constexpr, R0_BLOCK : tl.constexpr):
    xnumel = 3200
    r0_numel = 128
    rnumel = r0_numel
    RBLOCK: tl.constexpr = R0_BLOCK
...
# kernel path: /mnt/g/GitHub/VAE_ca_proj/Thermal/.compile_cache/7x/c7xrs33tcjah34lvp7hchvvgkysorn424xel3fibytpacwrbc7vl.py
# Topologically Sorted Source Nodes: [], Original ATen: [aten._to_copy]
# Source node to ATen node mapping:
# Graph fragment:
...
@triton_heuristics.pointwise(
    ...
    filename=__file__,
    triton_meta={'signature': {'in_ptr0': '*bf16', 'out_ptr0': '*fp32', 'xnumel': 'i32', 'XBLOCK': 'constexpr'}, 'device': DeviceProperties(type='cuda', index=0, multi_processor_count=36, cc=89, major=8, regs_per_multiprocessor=65536, max_threads_per_multi_processor=1536, warp_size=32), 'constants': {}, 'configs': [{(0,): [['tt.divisibility', 16]], (1,): [['tt.divisibility', 16]], (2,): [['tt.divisibility', 16]]}]},
    inductor_meta={'grid_type': 'Grid1D', 'autotune_hints': set(), 'kernel_name': 'triton_poi_fused__to_copy_92', 'mutated_arg_names': [], 'optimize_mem': True, 'no_x_dim': False, 'num_load': 1, 'num_reduction': 0, 'backend_hash': 'D54CF9E23D08230976451A78161C34C47AAE433535668E89333E7039B8F7F720', 'are_deterministic_algorithms_enabled': False, 'assert_indirect_indexing': True, 'autotune_local_cache': True, 'autotune_pointwise': True, 'autotune_remote_cache': None, 'force_disable_caches': False, 'dynamic_scale_rblock': True, 'max_autotune': False, 'max_autotune_pointwise': False, 'min_split_scan_rblock': 256, 'spill_threshold': 16, 'store_cubin': False, 'tiling_scores': {'x': 8192000}},
    min_elem_per_thread=0
)
@triton.jit
...
# kernel path: /mnt/g/GitHub/VAE_ca_proj/Thermal/.compile_cache/bw/cbwbryxqkehs3a2m4fxlk7eapeygnzzgrqkmx73nlemt3ncynwft.py
...
#   return %add_219
triton_poi_fused_add_93 = async_compile.triton('triton_poi_fused_add_93', '''
import triton
import triton.language as tl
...
@triton_heuristics.pointwise(
    ...
    inductor_meta={'grid_type': 'Grid2D', 'autotune_hints': set(), 'kernel_name': 'triton_poi_fused_add_93', 'mutated_arg_names': ['in_out_ptr0'], 'optimize_mem': True, 'no_x_dim': False, 'num_load': 2, 'num_reduction': 0, 'backend_hash': 'D54CF9E23D08230976451A78161C34C47AAE433535668E89333E7039B8F7F720', 'are_deterministic_algorithms_enabled': False, 'assert_indirect_indexing': True, 'autotune_local_cache': True, 'autotune_pointwise': True, 'autotune_remote_cache': None, 'force_disable_caches': False, 'dynamic_scale_rblock': True, 'max_autotune': False, 'max_autotune_pointwise': False, 'min_split_scan_rblock': 256, 'spill_threshold': 16, 'store_cubin': False, 'tiling_scores': {'y': 33554432, 'x': 100663296}},
    min_elem_per_thread=0
)
@triton.jit
def triton_poi_fused_add_93(in_out_ptr0, in_ptr0, ynumel, xnumel, YBLOCK : tl.constexpr, XBLOCK : tl.constexpr):
    ynumel = 16384
    xnumel = 1024
    yoffset = tl.program_id(1) * YBLOCK
    yindex = yoffset + tl.arange(0, YBLOCK)[:, None]
...
class Runner:
    ...
    def call(self, args):
        ...
        with torch.cuda._DeviceGuard(0):
            ...
            buf733 = empty_strided_cuda((4, 256), (256, 1), torch.float32)
            # Topologically Sorted Source Nodes: [], Original ATen: [aten.embedding_dense_backward]
            stream0 = get_raw_stream(0)
            triton_poi_fused_embedding_dense_backward_0.run(buf733, 1024, stream=stream0)
            buf0 = empty_strided_cuda((4, 1024), (1, 4), torch.float32)
            # Topologically Sorted Source Nodes: [], Original ATen: [aten.convolution_backward]
            stream0 = get_raw_stream(0)
            triton_red_fused_convolution_backward_1.run(tangents_1, buf0, 4096, 128, stream=stream0)
            buf6 = empty_strided_cuda((4, ), (1, ), torch.float32)
            # Topologically Sorted Source Nodes: [], Original ATen: [aten.convolution_backward, aten._to_copy]
            stream0 = get_raw_stream(0)
            triton_red_fused__to_copy_convolution_backward_2.run(buf0, buf6, 4, 1024, stream=stream0)
            # Topologically Sorted Source Nodes: [], Original ATen: [aten.convolution_backward]
            ...
            # Topologically Sorted Source Nodes: [], Original ATen: [aten._to_copy]
            stream0 = get_raw_stream(0)
            triton_poi_fused__to_copy_3.run(buf4, buf5, 4608, stream=stream0)
            del buf4
            buf7 = empty_strided_cuda((128, 128, 32, 32), (131072, 1, 4096, 128), torch.float32)
            # Topologically Sorted Source Nodes: [h_22, input_42], Original ATen: [aten.silu, aten.clone, aten.native_group_norm]
            stream0 = get_raw_stream(0)
            triton_poi_fused_clone_native_group_norm_silu_4.run(add_79, getitem_121, rsqrt_18, primals_151, primals_152, buf7, 16777216, stream=stream0)
            del primals_152
            buf8 = empty_strided_cuda((128, 128), (128, 1), torch.float32)
            buf9 = empty_strided_cuda((128, 128), (128, 1), torch.float32)
            # Topologically Sorted Source Nodes: [h_22, input_42, input_43], Original ATen: [aten._to_copy, aten.fill, aten.silu, aten.clone, aten.sub, aten.mul, aten.add, aten.native_group_norm_backward]
            stream0 = get_raw_stream(0)
            triton_red_fused__to_copy_add_clone_fill_mul_native_group_norm_backward_silu_sub_5.run(buf3, buf7, add_79, buf8, buf9, 16384, 1024, stream=stream0)
            buf13 = empty_strided_cuda((32, 4), (4, 1), torch.float32)
            buf14 = empty_strided_cuda((128, ), (1, ), torch.float32)
            # Topologically Sorted Source Nodes: [input_42], Original ATen: [aten.native_group_norm, aten.native_group_norm_backward]
            stream0 = get_raw_stream(0)
            triton_red_fused_native_group_norm_native_group_norm_backward_6.run(buf8, buf9, getitem_121, rsqrt_18, buf13, buf14, 128, 128, stream=stream0)
            buf10 = reinterpret_tensor(buf0, (128, 32), (32, 1), 0); del buf0  # reuse
            buf11 = empty_strided_cuda((128, 32), (32, 1), torch.float32)
            # Topologically Sorted Source Nodes: [input_42], Original ATen: [aten.native_group_norm, aten.native_group_norm_backward]
            stream0 = get_raw_stream(0)
            triton_poi_fused_native_group_norm_native_group_norm_backward_7.run(buf9, primals_151, getitem_121, buf8, buf10, buf11, 4096, stream=stream0)
            del buf8
            del buf9
            buf15 = empty_strided_cuda((128, 128, 32, 32), (131072, 1024, 32, 1), torch.bfloat16)
            # Topologically Sorted Source Nodes: [h_22, input_42, input_43], Original ATen: [aten._to_copy, aten.fill, aten.silu, aten.clone, aten.native_group_norm, aten.sub, aten.mul, aten.add, aten.native_group_norm_backward, aten.sigmoid]
            stream0 = get_raw_stream(0)
            triton_poi_fused__to_copy_add_clone_fill_mul_native_group_norm_native_group_norm_backward_sigmoid_silu_sub_8.run(buf3, buf7, rsqrt_18, primals_151, add_79, buf11, getitem_121, buf10, buf15, 131072, 128, stream=stream0)
            del add_79
            del buf10
            del buf7
            del getitem_121
            ...
            # Topologically Sorted Source Nodes: [], Original ATen: [aten.convolution_backward, aten._to_copy]
            stream0 = get_raw_stream(0)
            triton_red_fused__to_copy_convolution_backward_9.run(buf15, buf21, 128, 131072, stream=stream0)
            buf20 = empty_strided_cuda((128, 128, 1, 1), (128, 1, 128, 128), torch.float32)
            # Topologically Sorted Source Nodes: [], Original ATen: [aten._to_copy]
            stream0 = get_raw_stream(0)
            triton_poi_fused__to_copy_10.run(buf19, buf20, 16384, stream=stream0)
            del buf19
            ...
            # Topologically Sorted Source Nodes: [], Original ATen: [aten._to_copy, aten.mul, aten.sum, aten.view]
            stream0 = get_raw_stream(0)
            triton_red_fused__to_copy_mul_sum_view_11.run(buf18, mul_99, buf22, buf23, 16384, 1024, stream=stream0)
            ...
            # Topologically Sorted Source Nodes: [x_norm_16], Original ATen: [aten._to_copy, aten.mul, aten.view, aten.add, aten.clone, aten.native_group_norm_backward]
            stream0 = get_raw_stream(0)
            triton_red_fused__to_copy_add_clone_mul_native_group_norm_backward_view_12.run(buf18, mul_99, buf26, convolution_35, buf28, buf29, 16384, 1024, stream=stream0)
            buf30 = buf11; del buf11  # reuse
            buf31 = squeeze_30; del squeeze_30  # reuse
            # Topologically Sorted Source Nodes: [], Original ATen: [aten.native_group_norm_backward]
            stream0 = get_raw_stream(0)
            triton_poi_fused_native_group_norm_backward_13.run(buf31, buf29, buf28, squeeze_31, buf30, 4096, stream=stream0)
            buf32 = reinterpret_tensor(buf26, (128, 128, 32, 32), (131072, 1024, 32, 1), 0); del buf26  # reuse
            # Topologically Sorted Source Nodes: [x_norm_16], Original ATen: [aten._to_copy, aten.mul, aten.view, aten.add, aten.clone, aten.native_group_norm_backward, aten.native_group_norm]
            stream0 = get_raw_stream(0)
            triton_poi_fused__to_copy_add_clone_mul_native_group_norm_native_group_norm_backward_view_14.run(buf32, buf18, mul_99, squeeze_31, convolution_35, buf30, buf31, 16384, 1024, stream=stream0)
            del buf18
            del buf30
            del convolution_35
            del mul_99
            ...
            # Topologically Sorted Source Nodes: [], Original ATen: [aten.convolution_backward, aten._to_copy]
            stream0 = get_raw_stream(0)
            triton_red_fused__to_copy_convolution_backward_9.run(buf32, buf38, 128, 131072, stream=stream0)
            del buf32
            buf35 = buf34[0]
            ...
            # Topologically Sorted Source Nodes: [], Original ATen: [aten.add, aten.mul]
            stream0 = get_raw_stream(0)
            triton_poi_fused_add_mul_15.run(buf39, buf35, mul_114, 16384, 1024, stream=stream0)
            del mul_114
            buf36 = buf34[1]
            ...
            # Topologically Sorted Source Nodes: [], Original ATen: [aten.convolution_backward, aten._to_copy]
            stream0 = get_raw_stream(0)
            triton_red_fused__to_copy_convolution_backward_9.run(buf39, buf45, 128, 131072, stream=stream0)
            buf44 = reinterpret_tensor(buf29, (128, 128, 1, 1), (128, 1, 128, 128), 0); del buf29  # reuse
            # Topologically Sorted Source Nodes: [], Original ATen: [aten._to_copy]
            stream0 = get_raw_stream(0)
            triton_poi_fused__to_copy_10.run(buf43, buf44, 16384, stream=stream0)
            del buf43
            buf37 = empty_strided_cuda((128, 128, 3, 3), (1152, 1, 384, 128), torch.float32)
            # Topologically Sorted Source Nodes: [], Original ATen: [aten._to_copy]
            stream0 = get_raw_stream(0)
            triton_poi_fused__to_copy_16.run(buf36, buf37, 147456, stream=stream0)
            del buf36
            ...
            # Topologically Sorted Source Nodes: [], Original ATen: [aten._to_copy, aten.mul, aten.sum, aten.view]
            stream0 = get_raw_stream(0)
            triton_red_fused__to_copy_mul_sum_view_11.run(buf42, mul_117, buf46, buf47, 16384, 1024, stream=stream0)
            ...
            stream0 = get_raw_stream(0)
            triton_red_fused__to_copy_add_clone_mul_native_group_norm_backward_view_12.run(buf42, mul_117, buf50, convolution_33, buf53, buf54, 16384, 1024, stream=stream0)
            buf55 = buf31; del buf31  # reuse
            buf56 = squeeze_28; del squeeze_28  # reuse
            # Topologically Sorted Source Nodes: [], Original ATen: [aten.native_group_norm_backward]
            stream0 = get_raw_stream(0)
            triton_poi_fused_native_group_norm_backward_13.run(buf56, buf54, buf53, squeeze_29, buf55, 4096, stream=stream0)
            ...
            stream0 = get_raw_stream(0)
            triton_poi_fused__to_copy_add_clone_mul_native_group_norm_native_group_norm_backward_view_14.run(buf57, buf42, mul_117, squeeze_29, convolution_33, buf55, buf56, 16384, 1024, stream=stream0)
            del buf42
            del buf55
            del convolution_33
            del mul_117
            ...
            # Topologically Sorted Source Nodes: [], Original ATen: [aten.convolution_backward, aten._to_copy]
            stream0 = get_raw_stream(0)
            triton_red_fused__to_copy_convolution_backward_9.run(buf57, buf63, 128, 131072, stream=stream0)
            del buf57
            buf60 = buf59[0]
            ...
            # Topologically Sorted Source Nodes: [], Original ATen: [aten.add, aten.mul]
            stream0 = get_raw_stream(0)
            triton_poi_fused_add_mul_15.run(buf64, buf60, mul_132, 16384, 1024, stream=stream0)
            del mul_132
            # Topologically Sorted Source Nodes: [], Original ATen: [aten.convolution_backward]
            ...
            # Topologically Sorted Source Nodes: [], Original ATen: [aten.convolution_backward, aten._to_copy]
            stream0 = get_raw_stream(0)
            triton_red_fused__to_copy_convolution_backward_9.run(buf64, buf70, 128, 131072, stream=stream0)
            buf69 = reinterpret_tensor(buf54, (128, 128, 1, 1), (128, 1, 128, 128), 0); del buf54  # reuse
            # Topologically Sorted Source Nodes: [], Original ATen: [aten._to_copy]
            stream0 = get_raw_stream(0)
            triton_poi_fused__to_copy_10.run(buf68, buf69, 16384, stream=stream0)
            del buf68
            buf62 = empty_strided_cuda((128, 128, 3, 3), (1152, 1, 384, 128), torch.float32)
            # Topologically Sorted Source Nodes: [], Original ATen: [aten._to_copy]
            stream0 = get_raw_stream(0)
            triton_poi_fused__to_copy_16.run(buf61, buf62, 147456, stream=stream0)
            del buf61
            ...
            # Topologically Sorted Source Nodes: [], Original ATen: [aten._to_copy, aten.mul, aten.sum, aten.view]
            stream0 = get_raw_stream(0)
            triton_red_fused__to_copy_mul_sum_view_11.run(buf67, mul_135, buf71, buf72, 16384, 1024, stream=stream0)
            ...
            stream0 = get_raw_stream(0)
            triton_red_fused__to_copy_add_clone_mul_native_group_norm_backward_view_12.run(buf67, mul_135, buf75, convolution_31, buf77, buf78, 16384, 1024, stream=stream0)
            buf79 = buf56; del buf56  # reuse
            buf80 = squeeze_26; del squeeze_26  # reuse
            # Topologically Sorted Source Nodes: [], Original ATen: [aten.native_group_norm_backward]
            stream0 = get_raw_stream(0)
            triton_poi_fused_native_group_norm_backward_13.run(buf80, buf78, buf77, squeeze_27, buf79, 4096, stream=stream0)
            ...
            stream0 = get_raw_stream(0)
            triton_poi_fused__to_copy_add_clone_mul_native_group_norm_native_group_norm_backward_view_14.run(buf81, buf67, mul_135, squeeze_27, convolution_31, buf79, buf80, 16384, 1024, stream=stream0)
            del buf67
            del buf79
            del convolution_31
            del mul_135
            ...
            # Topologically Sorted Source Nodes: [], Original ATen: [aten.convolution_backward, aten._to_copy]
            stream0 = get_raw_stream(0)
            triton_red_fused__to_copy_convolution_backward_9.run(buf81, buf87, 128, 131072, stream=stream0)
            del buf81
            buf84 = buf83[0]
            ...
            # Topologically Sorted Source Nodes: [], Original ATen: [aten.add, aten.mul]
            stream0 = get_raw_stream(0)
            triton_poi_fused_add_mul_15.run(buf88, buf84, mul_150, 16384, 1024, stream=stream0)
            del mul_150
            # Topologically Sorted Source Nodes: [], Original ATen: [aten.convolution_backward]
            ...
            # Topologically Sorted Source Nodes: [], Original ATen: [aten.convolution_backward, aten._to_copy]
            stream0 = get_raw_stream(0)
            triton_red_fused__to_copy_convolution_backward_9.run(buf88, buf94, 128, 131072, stream=stream0)
            buf93 = reinterpret_tensor(buf78, (128, 128, 1, 1), (128, 1, 128, 128), 0); del buf78  # reuse
            # Topologically Sorted Source Nodes: [], Original ATen: [aten._to_copy]
            stream0 = get_raw_stream(0)
            triton_poi_fused__to_copy_10.run(buf92, buf93, 16384, stream=stream0)
            del buf92
            buf86 = empty_strided_cuda((128, 128, 3, 3), (1152, 1, 384, 128), torch.float32)
            # Topologically Sorted Source Nodes: [], Original ATen: [aten._to_copy]
            stream0 = get_raw_stream(0)
            triton_poi_fused__to_copy_16.run(buf85, buf86, 147456, stream=stream0)
            del buf85
            ...
            # Topologically Sorted Source Nodes: [], Original ATen: [aten._to_copy, aten.mul, aten.sum, aten.view]
            stream0 = get_raw_stream(0)
            triton_red_fused__to_copy_mul_sum_view_11.run(buf91, mul_153, buf95, buf96, 16384, 1024, stream=stream0)
            ...
            stream0 = get_raw_stream(0)
            triton_red_fused__to_copy_add_clone_mul_native_group_norm_backward_view_12.run(buf91, mul_153, buf99, convolution_29, buf102, buf103, 16384, 1024, stream=stream0)
            buf104 = buf80; del buf80  # reuse
            buf105 = squeeze_24; del squeeze_24  # reuse
            # Topologically Sorted Source Nodes: [], Original ATen: [aten.native_group_norm_backward]
            stream0 = get_raw_stream(0)
            triton_poi_fused_native_group_norm_backward_13.run(buf105, buf103, buf102, squeeze_25, buf104, 4096, stream=stream0)
            ...
            stream0 = get_raw_stream(0)
            triton_poi_fused__to_copy_add_clone_mul_native_group_norm_native_group_norm_backward_view_14.run(buf106, buf91, mul_153, squeeze_25, convolution_29, buf104, buf105, 16384, 1024, stream=stream0)
            del buf104
            del buf91
            del convolution_29
            del mul_153
            ...
            # Topologically Sorted Source Nodes: [], Original ATen: [aten.convolution_backward, aten._to_copy]
            stream0 = get_raw_stream(0)
            triton_red_fused__to_copy_convolution_backward_9.run(buf106, buf112, 128, 131072, stream=stream0)
            del buf106
            buf109 = buf108[0]
            ...
            # Topologically Sorted Source Nodes: [], Original ATen: [aten.add, aten.mul]
            stream0 = get_raw_stream(0)
            triton_poi_fused_add_mul_15.run(buf113, buf109, mul_168, 16384, 1024, stream=stream0)
            del mul_168
            # Topologically Sorted Source Nodes: [], Original ATen: [aten.convolution_backward]
            ...
            # Topologically Sorted Source Nodes: [], Original ATen: [aten.convolution_backward, aten._to_copy]
            stream0 = get_raw_stream(0)
            triton_red_fused__to_copy_convolution_backward_9.run(buf113, buf119, 128, 131072, stream=stream0)
            buf118 = reinterpret_tensor(buf103, (128, 128, 1, 1), (128, 1, 128, 128), 0); del buf103  # reuse
            # Topologically Sorted Source Nodes: [], Original ATen: [aten._to_copy]
            stream0 = get_raw_stream(0)
            triton_poi_fused__to_copy_10.run(buf117, buf118, 16384, stream=stream0)
            buf111 = empty_strided_cuda((128, 128, 3, 3), (1152, 1, 384, 128), torch.float32)
            # Topologically Sorted Source Nodes: [], Original ATen: [aten._to_copy]
            stream0 = get_raw_stream(0)
            triton_poi_fused__to_copy_16.run(buf110, buf111, 147456, stream=stream0)
            del buf110
            ...
            # Topologically Sorted Source Nodes: [], Original ATen: [aten._to_copy, aten.mul, aten.sum, aten.view]
            stream0 = get_raw_stream(0)
            triton_red_fused__to_copy_mul_sum_view_11.run(buf116, mul_171, buf120, buf121, 16384, 1024, stream=stream0)
            ...
            stream0 = get_raw_stream(0)
            triton_red_fused__to_copy_add_clone_mul_native_group_norm_backward_view_12.run(buf116, mul_171, buf124, convolution_27, buf126, buf127, 16384, 1024, stream=stream0)
            buf128 = buf105; del buf105  # reuse
            buf129 = squeeze_22; del squeeze_22  # reuse
            # Topologically Sorted Source Nodes: [], Original ATen: [aten.native_group_norm_backward]
            stream0 = get_raw_stream(0)
            triton_poi_fused_native_group_norm_backward_13.run(buf129, buf127, buf126, squeeze_23, buf128, 4096, stream=stream0)
            ...
            stream0 = get_raw_stream(0)
            triton_poi_fused__to_copy_add_clone_mul_native_group_norm_native_group_norm_backward_view_14.run(buf130, buf116, mul_171, squeeze_23, convolution_27, buf128, buf129, 16384, 1024, stream=stream0)
            del buf116
            del convolution_27
            del mul_171
            del squeeze_23
            ...
            # Topologically Sorted Source Nodes: [], Original ATen: [aten.convolution_backward, aten._to_copy]
            stream0 = get_raw_stream(0)
            triton_red_fused__to_copy_convolution_backward_9.run(buf130, buf137, 128, 131072, stream=stream0)
            del buf130
            buf133 = buf132[0]
            ...
            # Topologically Sorted Source Nodes: [input_41], Original ATen: [aten.add, aten.mul, aten.sigmoid, aten.sum, aten._to_copy, aten.squeeze, aten.sigmoid_backward]
            stream0 = get_raw_stream(0)
            triton_red_fused__to_copy_add_mul_sigmoid_sigmoid_backward_squeeze_sum_17.run(buf135, buf133, convert_element_type_90, addmm_24, buf139, 16384, 1024, stream=stream0)
            del buf133
            # Topologically Sorted Source Nodes: [], Original ATen: [aten.convolution_backward]
            ...
            # Topologically Sorted Source Nodes: [], Original ATen: [aten.mul]
            stream0 = get_raw_stream(0)
            triton_poi_fused_mul_18.run(buf155, mul_193, 8388608, stream=stream0)
            del mul_193
            # Topologically Sorted Source Nodes: [], Original ATen: [aten.convolution_backward]
            ...
            # Topologically Sorted Source Nodes: [], Original ATen: [aten.sigmoid, aten.fill, aten.sub, aten.mul, aten.add]
            stream0 = get_raw_stream(0)
            triton_poi_fused_add_fill_mul_sigmoid_sub_19.run(buf144, addmm_23, 32768, stream=stream0)
            del addmm_23
            ...
            # Topologically Sorted Source Nodes: [], Original ATen: [aten.sum]
            stream0 = get_raw_stream(0)
            triton_red_fused_sum_20.run(buf139, buf142, 128, 128, stream=stream0)
            del buf139
            buf152 = buf150[1]
            ...
            # Topologically Sorted Source Nodes: [], Original ATen: [aten.convolution_backward, aten._to_copy]
            stream0 = get_raw_stream(0)
            triton_red_fused__to_copy_convolution_backward_9.run(buf135, buf154, 128, 131072, stream=stream0)
            buf147 = empty_strided_cuda((1, 256), (256, 1), torch.float32)
            # Topologically Sorted Source Nodes: [], Original ATen: [aten.sum]
            stream0 = get_raw_stream(0)
            triton_red_fused_sum_21.run(buf144, buf147, 256, 128, stream=stream0)
            buf143 = empty_strided_cuda((128, 256), (256, 1), torch.float32)
            # Topologically Sorted Source Nodes: [], Original ATen: [aten._to_copy]
            stream0 = get_raw_stream(0)
            triton_poi_fused__to_copy_22.run(buf141, buf143, 32768, stream=stream0)
            ...
            # Topologically Sorted Source Nodes: [], Original ATen: [aten._to_copy]
            stream0 = get_raw_stream(0)
            triton_poi_fused__to_copy_23.run(buf146, buf148, 65536, stream=stream0)
            buf156 = empty_strided_cuda((256, 128), (1, 256), torch.float32)
            # Topologically Sorted Source Nodes: [], Original ATen: [aten.convolution_backward]
            stream0 = get_raw_stream(0)
            triton_red_fused_convolution_backward_24.run(buf155, buf156, 32768, 256, stream=stream0)
            buf162 = empty_strided_cuda((256, ), (1, ), torch.float32)
            # Topologically Sorted Source Nodes: [], Original ATen: [aten.convolution_backward, aten._to_copy]
            stream0 = get_raw_stream(0)
            triton_red_fused__to_copy_convolution_backward_25.run(buf156, buf162, 256, 128, stream=stream0)
            buf161 = empty_strided_cuda((256, 256, 1, 1), (256, 1, 256, 256), torch.float32)
            # Topologically Sorted Source Nodes: [], Original ATen: [aten._to_copy]
            stream0 = get_raw_stream(0)
            triton_poi_fused__to_copy_23.run(buf160, buf161, 65536, stream=stream0)
            buf136 = empty_strided_cuda((128, 128, 3, 3), (1152, 1, 384, 128), torch.float32)
            # Topologically Sorted Source Nodes: [], Original ATen: [aten._to_copy]
            stream0 = get_raw_stream(0)
            triton_poi_fused__to_copy_16.run(buf134, buf136, 147456, stream=stream0)
            del buf134
            buf153 = empty_strided_cuda((256, 128, 4, 4), (2048, 1, 512, 128), torch.float32)
            # Topologically Sorted Source Nodes: [], Original ATen: [aten._to_copy]
            stream0 = get_raw_stream(0)
            triton_poi_fused__to_copy_26.run(buf152, buf153, 524288, stream=stream0)
            del buf152
            ...
            # Topologically Sorted Source Nodes: [], Original ATen: [aten._to_copy, aten.mul, aten.sum, aten.view]
            stream0 = get_raw_stream(0)
            triton_red_fused__to_copy_mul_sum_view_27.run(buf159, mul_196, buf163, buf164, 32768, 256, stream=stream0)
            ...
            # Topologically Sorted Source Nodes: [x_norm_11], Original ATen: [aten._to_copy, aten.mul, aten.view, aten.add, aten.clone, aten.native_group_norm_backward]
            stream0 = get_raw_stream(0)
            triton_red_fused__to_copy_add_clone_mul_native_group_norm_backward_view_28.run(buf159, mul_196, buf167, convolution_24, buf169, buf170, 32768, 256, stream=stream0)
            buf171 = buf129; del buf129  # reuse
            # Topologically Sorted Source Nodes: [], Original ATen: [aten.native_group_norm_backward]
            stream0 = get_raw_stream(0)
            triton_per_fused_native_group_norm_backward_29.run(buf169, buf171, 4096, 8, stream=stream0)
            buf172 = buf128; del buf128  # reuse
            # Topologically Sorted Source Nodes: [], Original ATen: [aten.native_group_norm_backward]
            stream0 = get_raw_stream(0)
            triton_per_fused_native_group_norm_backward_29.run(buf170, buf172, 4096, 8, stream=stream0)
            buf174 = empty_strided_cuda((128, 256, 16, 16), (65536, 256, 16, 1), torch.bfloat16)
            # Topologically Sorted Source Nodes: [x_norm_11], Original ATen: [aten._to_copy, aten.mul, aten.view, aten.add, aten.clone, aten.native_group_norm_backward, aten.native_group_norm]
            stream0 = get_raw_stream(0)
            triton_poi_fused__to_copy_add_clone_mul_native_group_norm_native_group_norm_backward_view_30.run(buf159, mul_196, buf167, squeeze_21, convolution_24, buf172, squeeze_20, buf171, buf174, 8388608, stream=stream0)
            del buf159
            del convolution_24
            del mul_196
            del squeeze_20
            ...
            # Topologically Sorted Source Nodes: [], Original ATen: [aten.convolution_backward, aten._to_copy]
            stream0 = get_raw_stream(0)
            triton_red_fused__to_copy_convolution_backward_31.run(buf174, buf180, 256, 32768, stream=stream0)
            buf177 = buf176[0]
            ...
            # Topologically Sorted Source Nodes: [], Original ATen: [aten._to_copy]
            stream0 = get_raw_stream(0)
            triton_poi_fused__to_copy_32.run(buf178, buf179, 589824, stream=stream0)
            del buf178
            buf181 = reinterpret_tensor(buf174, (128, 256, 256), (65536, 256, 1), 0); del buf174  # reuse
            # Topologically Sorted Source Nodes: [], Original ATen: [aten.view, aten.transpose, aten.native_dropout_backward]
            stream0 = get_raw_stream(0)
            triton_poi_fused_native_dropout_backward_transpose_view_33.run(buf177, getitem_89, buf181, 8388608, stream=stream0)
            del getitem_89
            ...
            # Topologically Sorted Source Nodes: [], Original ATen: [aten.view, aten.transpose, aten.native_dropout_backward, aten.sum]
            stream0 = get_raw_stream(0)
            triton_red_fused_native_dropout_backward_sum_transpose_view_34.run(buf181, buf184, 32768, 256, stream=stream0)
            ...
            # Topologically Sorted Source Nodes: [], Original ATen: [aten.view, aten.transpose, aten.native_dropout_backward, aten.sum]
            stream0 = get_raw_stream(0)
            triton_red_fused_native_dropout_backward_sum_transpose_view_35.run(buf184, buf185, 256, 128, stream=stream0)
            buf187 = reinterpret_tensor(buf181, (128, 4, 256, 64), (65536, 16384, 64, 1), 0); del buf181  # reuse
            # Topologically Sorted Source Nodes: [], Original ATen: [aten.view, aten.transpose, aten.clone]
            stream0 = get_raw_stream(0)
            triton_poi_fused_clone_transpose_view_36.run(buf182, buf187, 8388608, stream=stream0)
            ...
            # Topologically Sorted Source Nodes: [matmul_18, attn_19], Original ATen: [aten.view, aten._to_copy, aten.mul, aten.amax, aten.sub, aten._softmax, aten._softmax_backward_data]
            stream0 = get_raw_stream(0)
            triton_poi_fused__softmax__softmax_backward_data__to_copy_amax_mul_sub_view_37.run(buf190, buf189, 131072, stream=stream0)
            ...
            # Topologically Sorted Source Nodes: [], Original ATen: [aten.view, aten.transpose, aten.cat]
            stream0 = get_raw_stream(0)
            triton_poi_fused_cat_transpose_view_38.run(buf191, buf188, buf193, 65536, stream=stream0)
            ...
            # Topologically Sorted Source Nodes: [], Original ATen: [aten._to_copy]
            stream0 = get_raw_stream(0)
            triton_poi_fused__to_copy_23.run(buf183, buf186, 65536, stream=stream0)
            del buf183
            ...
            # Topologically Sorted Source Nodes: [], Original ATen: [aten._to_copy]
            stream0 = get_raw_stream(0)
            triton_poi_fused__to_copy_39.run(buf194, buf196, 131072, stream=stream0)
            del buf194
            ...
            # Topologically Sorted Source Nodes: [], Original ATen: [aten.view, aten.transpose, aten.clone, aten._unsafe_view]
            stream0 = get_raw_stream(0)
            triton_poi_fused__unsafe_view_clone_transpose_view_40.run(buf192, buf197, 8388608, stream=stream0)
            ...
            # Topologically Sorted Source Nodes: [], Original ATen: [aten.add, aten.view, aten.transpose, aten.mul]
            stream0 = get_raw_stream(0)
            triton_poi_fused_add_mul_transpose_view_41.run(buf201, buf177, buf199, mul_215, 8388608, stream=stream0)
            del mul_215
            # Topologically Sorted Source Nodes: [], Original ATen: [aten.convolution_backward]
            ...
            # Topologically Sorted Source Nodes: [], Original ATen: [aten._to_copy]
            stream0 = get_raw_stream(0)
            triton_poi_fused__to_copy_23.run(buf198, buf200, 65536, stream=stream0)
            buf202 = reinterpret_tensor(buf184, (256, 128), (1, 256), 0); del buf184  # reuse
            # Topologically Sorted Source Nodes: [], Original ATen: [aten.convolution_backward]
            stream0 = get_raw_stream(0)
            triton_red_fused_convolution_backward_24.run(buf201, buf202, 32768, 256, stream=stream0)
            buf208 = empty_strided_cuda((256, ), (1, ), torch.float32)
            # Topologically Sorted Source Nodes: [], Original ATen: [aten.convolution_backward, aten._to_copy]
            stream0 = get_raw_stream(0)
            triton_red_fused__to_copy_convolution_backward_25.run(buf202, buf208, 256, 128, stream=stream0)
            buf207 = empty_strided_cuda((256, 256, 1, 1), (256, 1, 256, 256), torch.float32)
            # Topologically Sorted Source Nodes: [], Original ATen: [aten._to_copy]
            stream0 = get_raw_stream(0)
            triton_poi_fused__to_copy_23.run(buf206, buf207, 65536, stream=stream0)
            ...
            # Topologically Sorted Source Nodes: [], Original ATen: [aten._to_copy, aten.mul, aten.sum, aten.view]
            stream0 = get_raw_stream(0)
            triton_red_fused__to_copy_mul_sum_view_27.run(buf205, mul_218, buf209, buf210, 32768, 256, stream=stream0)
            ...
            stream0 = get_raw_stream(0)
            triton_red_fused__to_copy_add_clone_mul_native_group_norm_backward_view_28.run(buf205, mul_218, buf213, convolution_22, buf216, buf217, 32768, 256, stream=stream0)
            buf218 = buf172; del buf172  # reuse
            # Topologically Sorted Source Nodes: [], Original ATen: [aten.native_group_norm_backward]
            stream0 = get_raw_stream(0)
            triton_per_fused_native_group_norm_backward_29.run(buf216, buf218, 4096, 8, stream=stream0)
            buf219 = buf171; del buf171  # reuse
            # Topologically Sorted Source Nodes: [], Original ATen: [aten.native_group_norm_backward]
            stream0 = get_raw_stream(0)
            triton_per_fused_native_group_norm_backward_29.run(buf217, buf219, 4096, 8, stream=stream0)
            ...
            stream0 = get_raw_stream(0)
            triton_poi_fused__to_copy_add_clone_mul_native_group_norm_native_group_norm_backward_view_30.run(buf205, mul_218, buf213, squeeze_19, convolution_22, buf219, squeeze_18, buf218, buf221, 8388608, stream=stream0)
            del buf205
            del convolution_22
            del mul_218
            del squeeze_18
            ...
            # Topologically Sorted Source Nodes: [], Original ATen: [aten.convolution_backward, aten._to_copy]
            stream0 = get_raw_stream(0)
            triton_red_fused__to_copy_convolution_backward_31.run(buf221, buf227, 256, 32768, stream=stream0)
            buf224 = buf223[0]
            ...
            # Topologically Sorted Source Nodes: [], Original ATen: [aten._to_copy]
            stream0 = get_raw_stream(0)
            triton_poi_fused__to_copy_32.run(buf225, buf226, 589824, stream=stream0)
            del buf225
            buf228 = reinterpret_tensor(buf221, (128, 256, 256), (65536, 256, 1), 0); del buf221  # reuse
            # Topologically Sorted Source Nodes: [], Original ATen: [aten.view, aten.transpose, aten.native_dropout_backward]
            stream0 = get_raw_stream(0)
            triton_poi_fused_native_dropout_backward_transpose_view_33.run(buf224, getitem_80, buf228, 8388608, stream=stream0)
            del getitem_80
            ...
            # Topologically Sorted Source Nodes: [], Original ATen: [aten.view, aten.transpose, aten.native_dropout_backward, aten.sum]
            stream0 = get_raw_stream(0)
            triton_red_fused_native_dropout_backward_sum_transpose_view_34.run(buf228, buf231, 32768, 256, stream=stream0)
            ...
            # Topologically Sorted Source Nodes: [], Original ATen: [aten.view, aten.transpose, aten.native_dropout_backward, aten.sum]
            stream0 = get_raw_stream(0)
            triton_red_fused_native_dropout_backward_sum_transpose_view_35.run(buf231, buf232, 256, 128, stream=stream0)
            buf234 = reinterpret_tensor(buf228, (128, 4, 256, 64), (65536, 16384, 64, 1), 0); del buf228  # reuse
            # Topologically Sorted Source Nodes: [], Original ATen: [aten.view, aten.transpose, aten.clone]
            stream0 = get_raw_stream(0)
            triton_poi_fused_clone_transpose_view_36.run(buf229, buf234, 8388608, stream=stream0)
            ...
            stream0 = get_raw_stream(0)
            triton_poi_fused__softmax__softmax_backward_data__to_copy_amax_mul_sub_view_37.run(buf237, buf236, 131072, stream=stream0)
            ...
            # Topologically Sorted Source Nodes: [], Original ATen: [aten.view, aten.transpose, aten.cat]
            stream0 = get_raw_stream(0)
            triton_poi_fused_cat_transpose_view_38.run(buf238, buf235, buf240, 65536, stream=stream0)
            ...
            # Topologically Sorted Source Nodes: [], Original ATen: [aten._to_copy]
            stream0 = get_raw_stream(0)
            triton_poi_fused__to_copy_23.run(buf230, buf233, 65536, stream=stream0)
            del buf230
            ...
            # Topologically Sorted Source Nodes: [], Original ATen: [aten._to_copy]
            stream0 = get_raw_stream(0)
            triton_poi_fused__to_copy_39.run(buf241, buf243, 131072, stream=stream0)
            del buf241
            ...
            # Topologically Sorted Source Nodes: [], Original ATen: [aten.view, aten.transpose, aten.clone, aten._unsafe_view]
            stream0 = get_raw_stream(0)
            triton_poi_fused__unsafe_view_clone_transpose_view_40.run(buf239, buf244, 8388608, stream=stream0)
            ...
            # Topologically Sorted Source Nodes: [], Original ATen: [aten.add, aten.view, aten.transpose, aten.mul]
            stream0 = get_raw_stream(0)
            triton_poi_fused_add_mul_transpose_view_41.run(buf248, buf224, buf246, mul_237, 8388608, stream=stream0)
            del mul_237
            # Topologically Sorted Source Nodes: [], Original ATen: [aten.convolution_backward]
            ...
            # Topologically Sorted Source Nodes: [], Original ATen: [aten._to_copy]
            stream0 = get_raw_stream(0)
            triton_poi_fused__to_copy_23.run(buf245, buf247, 65536, stream=stream0)
            buf249 = reinterpret_tensor(buf231, (256, 128), (1, 256), 0); del buf231  # reuse
            # Topologically Sorted Source Nodes: [], Original ATen: [aten.convolution_backward]
            stream0 = get_raw_stream(0)
            triton_red_fused_convolution_backward_24.run(buf248, buf249, 32768, 256, stream=stream0)
            buf255 = empty_strided_cuda((256, ), (1, ), torch.float32)
            # Topologically Sorted Source Nodes: [], Original ATen: [aten.convolution_backward, aten._to_copy]
            stream0 = get_raw_stream(0)
            triton_red_fused__to_copy_convolution_backward_25.run(buf249, buf255, 256, 128, stream=stream0)
            buf254 = empty_strided_cuda((256, 256, 1, 1), (256, 1, 256, 256), torch.float32)
            # Topologically Sorted Source Nodes: [], Original ATen: [aten._to_copy]
            stream0 = get_raw_stream(0)
            triton_poi_fused__to_copy_23.run(buf253, buf254, 65536, stream=stream0)
            ...
            # Topologically Sorted Source Nodes: [], Original ATen: [aten._to_copy, aten.mul, aten.sum, aten.view]
            stream0 = get_raw_stream(0)
            triton_red_fused__to_copy_mul_sum_view_27.run(buf252, mul_240, buf256, buf257, 32768, 256, stream=stream0)
            ...
            stream0 = get_raw_stream(0)
            triton_red_fused__to_copy_add_clone_mul_native_group_norm_backward_view_28.run(buf252, mul_240, buf260, convolution_20, buf262, buf263, 32768, 256, stream=stream0)
            buf264 = buf219; del buf219  # reuse
            # Topologically Sorted Source Nodes: [], Original ATen: [aten.native_group_norm_backward]
            stream0 = get_raw_stream(0)
            triton_per_fused_native_group_norm_backward_29.run(buf262, buf264, 4096, 8, stream=stream0)
            buf265 = buf218; del buf218  # reuse
            # Topologically Sorted Source Nodes: [], Original ATen: [aten.native_group_norm_backward]
            stream0 = get_raw_stream(0)
            triton_per_fused_native_group_norm_backward_29.run(buf263, buf265, 4096, 8, stream=stream0)
            ...
            stream0 = get_raw_stream(0)
            triton_poi_fused__to_copy_add_clone_mul_native_group_norm_native_group_norm_backward_view_30.run(buf252, mul_240, buf260, squeeze_17, convolution_20, buf265, squeeze_16, buf264, buf267, 8388608, stream=stream0)
            del buf252
            del convolution_20
            del mul_240
            del squeeze_16
            ...
            # Topologically Sorted Source Nodes: [], Original ATen: [aten.convolution_backward, aten._to_copy]
            stream0 = get_raw_stream(0)
            triton_red_fused__to_copy_convolution_backward_31.run(buf267, buf273, 256, 32768, stream=stream0)
            buf270 = buf269[0]
            ...
            # Topologically Sorted Source Nodes: [], Original ATen: [aten._to_copy]
            stream0 = get_raw_stream(0)
            triton_poi_fused__to_copy_32.run(buf271, buf272, 589824, stream=stream0)
            del buf271
            buf274 = reinterpret_tensor(buf267, (128, 256, 256), (65536, 256, 1), 0); del buf267  # reuse
            # Topologically Sorted Source Nodes: [], Original ATen: [aten.view, aten.transpose, aten.native_dropout_backward]
            stream0 = get_raw_stream(0)
            triton_poi_fused_native_dropout_backward_transpose_view_33.run(buf270, getitem_71, buf274, 8388608, stream=stream0)
            del getitem_71
            ...
            # Topologically Sorted Source Nodes: [], Original ATen: [aten.view, aten.transpose, aten.native_dropout_backward, aten.sum]
            stream0 = get_raw_stream(0)
            triton_red_fused_native_dropout_backward_sum_transpose_view_34.run(buf274, buf277, 32768, 256, stream=stream0)
            ...
            # Topologically Sorted Source Nodes: [], Original ATen: [aten.view, aten.transpose, aten.native_dropout_backward, aten.sum]
            stream0 = get_raw_stream(0)
            triton_red_fused_native_dropout_backward_sum_transpose_view_35.run(buf277, buf278, 256, 128, stream=stream0)
            buf280 = reinterpret_tensor(buf274, (128, 4, 256, 64), (65536, 16384, 64, 1), 0); del buf274  # reuse
            # Topologically Sorted Source Nodes: [], Original ATen: [aten.view, aten.transpose, aten.clone]
            stream0 = get_raw_stream(0)
            triton_poi_fused_clone_transpose_view_36.run(buf275, buf280, 8388608, stream=stream0)
            ...
            stream0 = get_raw_stream(0)
            triton_poi_fused__softmax__softmax_backward_data__to_copy_amax_mul_sub_view_37.run(buf283, buf282, 131072, stream=stream0)
            ...
            # Topologically Sorted Source Nodes: [], Original ATen: [aten.view, aten.transpose, aten.cat]
            stream0 = get_raw_stream(0)
            triton_poi_fused_cat_transpose_view_38.run(buf284, buf281, buf286, 65536, stream=stream0)
            ...
            # Topologically Sorted Source Nodes: [], Original ATen: [aten._to_copy]
            stream0 = get_raw_stream(0)
            triton_poi_fused__to_copy_23.run(buf276, buf279, 65536, stream=stream0)
            del buf276
            ...
            # Topologically Sorted Source Nodes: [], Original ATen: [aten._to_copy]
            stream0 = get_raw_stream(0)
            triton_poi_fused__to_copy_39.run(buf287, buf289, 131072, stream=stream0)
            del buf287
            ...
            # Topologically Sorted Source Nodes: [], Original ATen: [aten.view, aten.transpose, aten.clone, aten._unsafe_view]
            stream0 = get_raw_stream(0)
            triton_poi_fused__unsafe_view_clone_transpose_view_40.run(buf285, buf290, 8388608, stream=stream0)
            ...
            # Topologically Sorted Source Nodes: [], Original ATen: [aten.add, aten.view, aten.transpose, aten.mul]
            stream0 = get_raw_stream(0)
            triton_poi_fused_add_mul_transpose_view_41.run(buf294, buf270, buf292, mul_259, 8388608, stream=stream0)
            del mul_259
            # Topologically Sorted Source Nodes: [], Original ATen: [aten.convolution_backward]
            ...
            # Topologically Sorted Source Nodes: [], Original ATen: [aten._to_copy]
            stream0 = get_raw_stream(0)
            triton_poi_fused__to_copy_23.run(buf291, buf293, 65536, stream=stream0)
            buf295 = reinterpret_tensor(buf277, (256, 128), (1, 256), 0); del buf277  # reuse
            # Topologically Sorted Source Nodes: [], Original ATen: [aten.convolution_backward]
            stream0 = get_raw_stream(0)
            triton_red_fused_convolution_backward_24.run(buf294, buf295, 32768, 256, stream=stream0)
            buf301 = empty_strided_cuda((256, ), (1, ), torch.float32)
            # Topologically Sorted Source Nodes: [], Original ATen: [aten.convolution_backward, aten._to_copy]
            stream0 = get_raw_stream(0)
            triton_red_fused__to_copy_convolution_backward_25.run(buf295, buf301, 256, 128, stream=stream0)
            buf300 = empty_strided_cuda((256, 256, 1, 1), (256, 1, 256, 256), torch.float32)
            # Topologically Sorted Source Nodes: [], Original ATen: [aten._to_copy]
            stream0 = get_raw_stream(0)
            triton_poi_fused__to_copy_23.run(buf299, buf300, 65536, stream=stream0)
            ...
            # Topologically Sorted Source Nodes: [], Original ATen: [aten._to_copy, aten.mul, aten.sum, aten.view]
            stream0 = get_raw_stream(0)
            triton_red_fused__to_copy_mul_sum_view_27.run(buf298, mul_262, buf302, buf303, 32768, 256, stream=stream0)
            ...
            stream0 = get_raw_stream(0)
            triton_red_fused__to_copy_add_clone_mul_native_group_norm_backward_view_28.run(buf298, mul_262, buf306, convolution_18, buf309, buf310, 32768, 256, stream=stream0)
            buf311 = buf265; del buf265  # reuse
            # Topologically Sorted Source Nodes: [], Original ATen: [aten.native_group_norm_backward]
            stream0 = get_raw_stream(0)
            triton_per_fused_native_group_norm_backward_29.run(buf309, buf311, 4096, 8, stream=stream0)
            buf312 = buf264; del buf264  # reuse
            # Topologically Sorted Source Nodes: [], Original ATen: [aten.native_group_norm_backward]
            stream0 = get_raw_stream(0)
            triton_per_fused_native_group_norm_backward_29.run(buf310, buf312, 4096, 8, stream=stream0)
            ...
            stream0 = get_raw_stream(0)
            triton_poi_fused__to_copy_add_clone_mul_native_group_norm_native_group_norm_backward_view_30.run(buf298, mul_262, buf306, squeeze_15, convolution_18, buf312, squeeze_14, buf311, buf314, 8388608, stream=stream0)
            del buf298
            del convolution_18
            del mul_262
            del squeeze_14
            ...
            # Topologically Sorted Source Nodes: [], Original ATen: [aten.convolution_backward, aten._to_copy]
            stream0 = get_raw_stream(0)
            triton_red_fused__to_copy_convolution_backward_31.run(buf314, buf320, 256, 32768, stream=stream0)
            buf317 = buf316[0]
            ...
            # Topologically Sorted Source Nodes: [], Original ATen: [aten._to_copy]
            stream0 = get_raw_stream(0)
            triton_poi_fused__to_copy_32.run(buf318, buf319, 589824, stream=stream0)
            del buf318
            buf321 = reinterpret_tensor(buf314, (128, 256, 256), (65536, 256, 1), 0); del buf314  # reuse
            # Topologically Sorted Source Nodes: [], Original ATen: [aten.view, aten.transpose, aten.native_dropout_backward]
            stream0 = get_raw_stream(0)
            triton_poi_fused_native_dropout_backward_transpose_view_33.run(buf317, getitem_62, buf321, 8388608, stream=stream0)
            del getitem_62
            ...
            # Topologically Sorted Source Nodes: [], Original ATen: [aten.view, aten.transpose, aten.native_dropout_backward, aten.sum]
            stream0 = get_raw_stream(0)
            triton_red_fused_native_dropout_backward_sum_transpose_view_34.run(buf321, buf324, 32768, 256, stream=stream0)
            ...
            # Topologically Sorted Source Nodes: [], Original ATen: [aten.view, aten.transpose, aten.native_dropout_backward, aten.sum]
            stream0 = get_raw_stream(0)
            triton_red_fused_native_dropout_backward_sum_transpose_view_35.run(buf324, buf325, 256, 128, stream=stream0)
            buf327 = reinterpret_tensor(buf321, (128, 4, 256, 64), (65536, 16384, 64, 1), 0); del buf321  # reuse
            # Topologically Sorted Source Nodes: [], Original ATen: [aten.view, aten.transpose, aten.clone]
            stream0 = get_raw_stream(0)
            triton_poi_fused_clone_transpose_view_36.run(buf322, buf327, 8388608, stream=stream0)
            ...
            stream0 = get_raw_stream(0)
            triton_poi_fused__softmax__softmax_backward_data__to_copy_amax_mul_sub_view_37.run(buf330, buf329, 131072, stream=stream0)
            ...
            # Topologically Sorted Source Nodes: [], Original ATen: [aten.view, aten.transpose, aten.cat]
            stream0 = get_raw_stream(0)
            triton_poi_fused_cat_transpose_view_38.run(buf331, buf328, buf333, 65536, stream=stream0)
            ...
            # Topologically Sorted Source Nodes: [], Original ATen: [aten._to_copy]
            stream0 = get_raw_stream(0)
            triton_poi_fused__to_copy_23.run(buf323, buf326, 65536, stream=stream0)
            del buf323
            ...
            # Topologically Sorted Source Nodes: [], Original ATen: [aten._to_copy]
            stream0 = get_raw_stream(0)
            triton_poi_fused__to_copy_39.run(buf334, buf336, 131072, stream=stream0)
            del buf334
            ...
            # Topologically Sorted Source Nodes: [], Original ATen: [aten.view, aten.transpose, aten.clone, aten._unsafe_view]
            stream0 = get_raw_stream(0)
            triton_poi_fused__unsafe_view_clone_transpose_view_40.run(buf332, buf337, 8388608, stream=stream0)
            ...
            # Topologically Sorted Source Nodes: [], Original ATen: [aten.add, aten.view, aten.transpose, aten.mul]
            stream0 = get_raw_stream(0)
            triton_poi_fused_add_mul_transpose_view_41.run(buf341, buf317, buf339, mul_281, 8388608, stream=stream0)
            del mul_281
            # Topologically Sorted Source Nodes: [], Original ATen: [aten.convolution_backward]
            ...
            # Topologically Sorted Source Nodes: [], Original ATen: [aten._to_copy]
            stream0 = get_raw_stream(0)
            triton_poi_fused__to_copy_23.run(buf338, buf340, 65536, stream=stream0)
            buf342 = reinterpret_tensor(buf324, (256, 128), (1, 256), 0); del buf324  # reuse
            # Topologically Sorted Source Nodes: [], Original ATen: [aten.convolution_backward]
            stream0 = get_raw_stream(0)
            triton_red_fused_convolution_backward_24.run(buf341, buf342, 32768, 256, stream=stream0)
            buf348 = empty_strided_cuda((256, ), (1, ), torch.float32)
            # Topologically Sorted Source Nodes: [], Original ATen: [aten.convolution_backward, aten._to_copy]
            stream0 = get_raw_stream(0)
            triton_red_fused__to_copy_convolution_backward_25.run(buf342, buf348, 256, 128, stream=stream0)
            buf347 = empty_strided_cuda((256, 256, 1, 1), (256, 1, 256, 256), torch.float32)
            # Topologically Sorted Source Nodes: [], Original ATen: [aten._to_copy]
            stream0 = get_raw_stream(0)
            triton_poi_fused__to_copy_23.run(buf346, buf347, 65536, stream=stream0)
            ...
            # Topologically Sorted Source Nodes: [], Original ATen: [aten._to_copy, aten.mul, aten.sum, aten.view]
            stream0 = get_raw_stream(0)
            triton_red_fused__to_copy_mul_sum_view_27.run(buf345, mul_284, buf349, buf350, 32768, 256, stream=stream0)
            ...
            stream0 = get_raw_stream(0)
            triton_red_fused__to_copy_add_clone_mul_native_group_norm_backward_view_28.run(buf345, mul_284, buf353, convolution_16, buf355, buf356, 32768, 256, stream=stream0)
            buf357 = buf312; del buf312  # reuse
            # Topologically Sorted Source Nodes: [], Original ATen: [aten.native_group_norm_backward]
            stream0 = get_raw_stream(0)
            triton_per_fused_native_group_norm_backward_29.run(buf355, buf357, 4096, 8, stream=stream0)
            buf358 = buf311; del buf311  # reuse
            # Topologically Sorted Source Nodes: [], Original ATen: [aten.native_group_norm_backward]
            stream0 = get_raw_stream(0)
            triton_per_fused_native_group_norm_backward_29.run(buf356, buf358, 4096, 8, stream=stream0)
            ...
            stream0 = get_raw_stream(0)
            triton_poi_fused__to_copy_add_clone_mul_native_group_norm_native_group_norm_backward_view_30.run(buf345, mul_284, buf353, squeeze_13, convolution_16, buf358, squeeze_12, buf357, buf360, 8388608, stream=stream0)
            del buf345
            del convolution_16
            del mul_284
            del squeeze_12
            ...
            # Topologically Sorted Source Nodes: [], Original ATen: [aten.convolution_backward, aten._to_copy]
            stream0 = get_raw_stream(0)
            triton_red_fused__to_copy_convolution_backward_31.run(buf360, buf366, 256, 32768, stream=stream0)
            buf363 = buf362[0]
            ...
            # Topologically Sorted Source Nodes: [], Original ATen: [aten._to_copy]
            stream0 = get_raw_stream(0)
            triton_poi_fused__to_copy_32.run(buf364, buf365, 589824, stream=stream0)
            del buf364
            buf367 = reinterpret_tensor(buf360, (128, 256, 256), (65536, 256, 1), 0); del buf360  # reuse
            # Topologically Sorted Source Nodes: [], Original ATen: [aten.view, aten.transpose, aten.native_dropout_backward]
            stream0 = get_raw_stream(0)
            triton_poi_fused_native_dropout_backward_transpose_view_33.run(buf363, getitem_53, buf367, 8388608, stream=stream0)
            del getitem_53
            ...
            # Topologically Sorted Source Nodes: [], Original ATen: [aten.view, aten.transpose, aten.native_dropout_backward, aten.sum]
            stream0 = get_raw_stream(0)
            triton_red_fused_native_dropout_backward_sum_transpose_view_34.run(buf367, buf370, 32768, 256, stream=stream0)
            ...
            # Topologically Sorted Source Nodes: [], Original ATen: [aten.view, aten.transpose, aten.native_dropout_backward, aten.sum]
            stream0 = get_raw_stream(0)
            triton_red_fused_native_dropout_backward_sum_transpose_view_35.run(buf370, buf371, 256, 128, stream=stream0)
            buf373 = reinterpret_tensor(buf367, (128, 4, 256, 64), (65536, 16384, 64, 1), 0); del buf367  # reuse
            # Topologically Sorted Source Nodes: [], Original ATen: [aten.view, aten.transpose, aten.clone]
            stream0 = get_raw_stream(0)
            triton_poi_fused_clone_transpose_view_36.run(buf368, buf373, 8388608, stream=stream0)
            ...
            stream0 = get_raw_stream(0)
            triton_poi_fused__softmax__softmax_backward_data__to_copy_amax_mul_sub_view_37.run(buf376, buf375, 131072, stream=stream0)
            ...
            # Topologically Sorted Source Nodes: [], Original ATen: [aten.view, aten.transpose, aten.cat]
            stream0 = get_raw_stream(0)
            triton_poi_fused_cat_transpose_view_38.run(buf377, buf374, buf379, 65536, stream=stream0)
            ...
            # Topologically Sorted Source Nodes: [], Original ATen: [aten._to_copy]
            stream0 = get_raw_stream(0)
            triton_poi_fused__to_copy_23.run(buf369, buf372, 65536, stream=stream0)
            ...
            # Topologically Sorted Source Nodes: [], Original ATen: [aten._to_copy]
            stream0 = get_raw_stream(0)
            triton_poi_fused__to_copy_39.run(buf380, buf382, 131072, stream=stream0)
            del buf380
            ...
            # Topologically Sorted Source Nodes: [], Original ATen: [aten.view, aten.transpose, aten.clone, aten._unsafe_view]
            stream0 = get_raw_stream(0)
            triton_poi_fused__unsafe_view_clone_transpose_view_40.run(buf378, buf383, 8388608, stream=stream0)
            ...
            # Topologically Sorted Source Nodes: [], Original ATen: [aten.add, aten.view, aten.transpose]
            stream0 = get_raw_stream(0)
            triton_poi_fused_add_transpose_view_42.run(buf387, buf363, buf385, 8388608, stream=stream0)
            del buf363
            # Topologically Sorted Source Nodes: [], Original ATen: [aten.convolution_backward]
            ...
            # Topologically Sorted Source Nodes: [], Original ATen: [aten._to_copy]
            stream0 = get_raw_stream(0)
            triton_poi_fused__to_copy_23.run(buf384, buf386, 65536, stream=stream0)
            buf399 = reinterpret_tensor(buf370, (256, 128), (1, 256), 0); del buf370  # reuse
            buf389 = buf335; del buf335  # reuse
            # Topologically Sorted Source Nodes: [input_27], Original ATen: [aten.mul, aten.sigmoid, aten.sum, aten._to_copy, aten.squeeze, aten.sigmoid_backward, aten.convolution_backward]
            stream0 = get_raw_stream(0)
            triton_red_fused__to_copy_convolution_backward_mul_sigmoid_sigmoid_backward_squeeze_sum_43.run(buf387, convert_element_type_152, addmm_17, buf399, buf389, 32768, 256, stream=stream0)
            buf405 = empty_strided_cuda((256, ), (1, ), torch.float32)
            # Topologically Sorted Source Nodes: [], Original ATen: [aten.convolution_backward, aten._to_copy]
            stream0 = get_raw_stream(0)
            triton_red_fused__to_copy_convolution_backward_25.run(buf399, buf405, 256, 128, stream=stream0)
            ...
            stream0 = get_raw_stream(0)
            triton_poi_fused_add_fill_mul_sigmoid_sub_19.run(buf394, addmm_16, 32768, stream=stream0)
            del addmm_16
            ...
            # Topologically Sorted Source Nodes: [], Original ATen: [aten.sum]
            stream0 = get_raw_stream(0)
            triton_red_fused_sum_21.run(buf389, buf392, 256, 128, stream=stream0)
            ...
            # Topologically Sorted Source Nodes: [], Original ATen: [aten.sum]
            stream0 = get_raw_stream(0)
            triton_red_fused_sum_21.run(buf394, buf396, 256, 128, stream=stream0)
            ...
            # Topologically Sorted Source Nodes: [], Original ATen: [aten._to_copy]
            stream0 = get_raw_stream(0)
            triton_poi_fused__to_copy_23.run(buf391, buf393, 65536, stream=stream0)
            buf398 = empty_strided_cuda((256, 256), (256, 1), torch.float32)
            # Topologically Sorted Source Nodes: [], Original ATen: [aten._to_copy]
            stream0 = get_raw_stream(0)
            triton_poi_fused__to_copy_23.run(buf395, buf398, 65536, stream=stream0)
            ...
            # Topologically Sorted Source Nodes: [out_24], Original ATen: [aten._to_copy, aten.view, aten.transpose, aten.native_layer_norm, aten.native_layer_norm_backward]
            stream0 = get_raw_stream(0)
            triton_red_fused__to_copy_native_layer_norm_native_layer_norm_backward_transpose_view_44.run(buf402, add_30, getitem_49, rsqrt_7, buf408, buf410, 32768, 128, stream=stream0)
            buf412 = reinterpret_tensor(buf402, (128, 64, 512), (32768, 512, 1), 0); del buf402  # reuse
            # Topologically Sorted Source Nodes: [out_24], Original ATen: [aten._to_copy, aten.view, aten.transpose, aten.native_layer_norm_backward, aten.native_layer_norm]
            stream0 = get_raw_stream(0)
            triton_per_fused__to_copy_native_layer_norm_native_layer_norm_backward_transpose_view_45.run(buf412, primals_77, add_30, getitem_49, rsqrt_7, 8192, 512, stream=stream0)
            del add_30
            del getitem_49
            del primals_77
            del rsqrt_7
            ...
            # Topologically Sorted Source Nodes: [out_24], Original ATen: [aten._to_copy, aten.view, aten.transpose, aten.native_layer_norm, aten.native_layer_norm_backward]
            stream0 = get_raw_stream(0)
            triton_per_fused__to_copy_native_layer_norm_native_layer_norm_backward_transpose_view_46.run(buf408, buf409, 512, 64, stream=stream0)
            ...
            stream0 = get_raw_stream(0)
            triton_per_fused__to_copy_native_layer_norm_native_layer_norm_backward_transpose_view_46.run(buf410, buf411, 512, 64, stream=stream0)
            buf415 = reinterpret_tensor(buf410, (1, 512, 64), (32768, 1, 512), 0); del buf410  # reuse
            # Topologically Sorted Source Nodes: [], Original ATen: [aten.view, aten.sum]
            stream0 = get_raw_stream(0)
            triton_red_fused_sum_view_47.run(buf412, buf415, 32768, 128, stream=stream0)
            buf416 = empty_strided_cuda((1, 512), (512, 1), torch.float32)
            # Topologically Sorted Source Nodes: [], Original ATen: [aten.view, aten.sum]
            stream0 = get_raw_stream(0)
            triton_per_fused__to_copy_native_layer_norm_native_layer_norm_backward_transpose_view_46.run(buf415, buf416, 512, 64, stream=stream0)
            buf417 = empty_strided_cuda((512, 512), (512, 1), torch.float32)
            # Topologically Sorted Source Nodes: [], Original ATen: [aten._to_copy]
            stream0 = get_raw_stream(0)
            triton_poi_fused__to_copy_48.run(buf414, buf417, 262144, stream=stream0)
            buf404 = empty_strided_cuda((512, 256, 4, 4), (4096, 1, 1024, 256), torch.float32)
            # Topologically Sorted Source Nodes: [], Original ATen: [aten._to_copy]
            stream0 = get_raw_stream(0)
            triton_poi_fused__to_copy_49.run(buf403, buf404, 2097152, stream=stream0)
            del buf403
            ...
            # Topologically Sorted Source Nodes: [], Original ATen: [aten.view, aten.transpose, aten.clone]
            stream0 = get_raw_stream(0)
            triton_poi_fused_clone_transpose_view_50.run(buf413, buf418, 4194304, stream=stream0)
            ...
            # Topologically Sorted Source Nodes: [matmul_8, attn_9], Original ATen: [aten.view, aten._to_copy, aten.mul, aten.sub, aten._softmax, aten._softmax_backward_data]
            stream0 = get_raw_stream(0)
            triton_per_fused__softmax__softmax_backward_data__to_copy_mul_sub_view_51.run(buf422, buf420, amax_default_5, sum_5, 65536, 64, stream=stream0)
            del amax_default_5
            del sum_5
            ...
            # Topologically Sorted Source Nodes: [], Original ATen: [aten.view, aten.transpose, aten.select_backward, aten.add, aten.permute, aten.clone]
            stream0 = get_raw_stream(0)
            triton_poi_fused_add_clone_permute_select_backward_transpose_view_52.run(buf419, buf423, buf424, buf425, 8192, 1536, stream=stream0)
            del buf419
            ...
            # Topologically Sorted Source Nodes: [], Original ATen: [aten.view, aten.transpose, aten.select_backward, aten.add, aten.permute, aten.clone, aten._unsafe_view, aten.sum]
            stream0 = get_raw_stream(0)
            triton_red_fused__unsafe_view_add_clone_permute_select_backward_sum_transpose_view_53.run(buf425, buf428, 36864, 342, stream=stream0)
            ...
            # Topologically Sorted Source Nodes: [], Original ATen: [aten.view, aten.transpose, aten.select_backward, aten.add, aten.permute, aten.clone, aten._unsafe_view, aten.sum]
            stream0 = get_raw_stream(0)
            triton_per_fused__unsafe_view_add_clone_permute_select_backward_sum_transpose_view_54.run(buf428, buf429, 1536, 24, stream=stream0)
            del buf428
            buf437 = reinterpret_tensor(buf412, (128, 512, 8, 8), (32768, 1, 4096, 512), 0); del buf412  # reuse
            # Topologically Sorted Source Nodes: [h_8, view_50, x_flat_6, x_norm_6], Original ATen: [aten.view, aten._to_copy, aten.native_layer_norm_backward, aten.silu, aten.transpose, aten.native_layer_norm, aten.add, aten.sigmoid, aten.fill, aten.sub, aten.mul]
            stream0 = get_raw_stream(0)
            triton_per_fused__to_copy_add_fill_mul_native_layer_norm_native_layer_norm_backward_sigmoid_silu_sub_transpose_view_55.run(buf437, buf426, primals_71, add_27, getitem_47, rsqrt_6, 8192, 512, stream=stream0)
            del primals_71
            buf433 = reinterpret_tensor(buf415, (512, 64), (1, 512), 0); del buf415  # reuse
            buf435 = buf408; del buf408  # reuse
            # Topologically Sorted Source Nodes: [h_8, view_50, x_flat_6, x_norm_6], Original ATen: [aten.view, aten._to_copy, aten.silu, aten.transpose, aten.native_layer_norm, aten.native_layer_norm_backward]
            stream0 = get_raw_stream(0)
            triton_red_fused__to_copy_native_layer_norm_native_layer_norm_backward_silu_transpose_view_56.run(buf426, add_27, getitem_47, rsqrt_6, buf433, buf435, 32768, 128, stream=stream0)
            del add_27
            del getitem_47
            del rsqrt_6
            ...
            # Topologically Sorted Source Nodes: [h_8, view_50, x_flat_6, x_norm_6], Original ATen: [aten.view, aten._to_copy, aten.silu, aten.transpose, aten.native_layer_norm, aten.native_layer_norm_backward]
            stream0 = get_raw_stream(0)
            triton_per_fused__to_copy_native_layer_norm_native_layer_norm_backward_transpose_view_46.run(buf433, buf434, 512, 64, stream=stream0)
            ...
            stream0 = get_raw_stream(0)
            triton_per_fused__to_copy_native_layer_norm_native_layer_norm_backward_transpose_view_46.run(buf435, buf436, 512, 64, stream=stream0)
            # Topologically Sorted Source Nodes: [], Original ATen: [aten.convolution_backward]
            ...
            # Topologically Sorted Source Nodes: [], Original ATen: [aten.convolution_backward]
            stream0 = get_raw_stream(0)
            triton_red_fused_convolution_backward_57.run(buf437, buf438, 32768, 128, stream=stream0)
            buf444 = empty_strided_cuda((512, ), (1, ), torch.float32)
            # Topologically Sorted Source Nodes: [], Original ATen: [aten.convolution_backward, aten._to_copy]
            stream0 = get_raw_stream(0)
            triton_per_fused__to_copy_convolution_backward_58.run(buf438, buf444, 512, 64, stream=stream0)
            buf443 = empty_strided_cuda((512, 512, 1, 1), (512, 1, 512, 512), torch.float32)
            # Topologically Sorted Source Nodes: [], Original ATen: [aten._to_copy]
            stream0 = get_raw_stream(0)
            triton_poi_fused__to_copy_48.run(buf442, buf443, 262144, stream=stream0)
            buf430 = empty_strided_cuda((1536, 512), (512, 1), torch.float32)
            # Topologically Sorted Source Nodes: [], Original ATen: [aten._to_copy]
            stream0 = get_raw_stream(0)
            triton_poi_fused__to_copy_59.run(buf427, buf430, 786432, stream=stream0)
            ...
            # Topologically Sorted Source Nodes: [], Original ATen: [aten._to_copy, aten.mul, aten.sum, aten.view]
            stream0 = get_raw_stream(0)
            triton_per_fused__to_copy_mul_sum_view_60.run(buf441, mul_329, buf445, buf446, 65536, 64, stream=stream0)
            ...
            # Topologically Sorted Source Nodes: [x_norm_5], Original ATen: [aten._to_copy, aten.mul, aten.view, aten.add, aten.clone, aten.native_group_norm_backward]
            stream0 = get_raw_stream(0)
            triton_per_fused__to_copy_add_clone_mul_native_group_norm_backward_view_61.run(buf441, mul_329, buf449, convolution_13, buf451, buf452, 65536, 64, stream=stream0)
            buf453 = buf358; del buf358  # reuse
            # Topologically Sorted Source Nodes: [], Original ATen: [aten.native_group_norm_backward]
            stream0 = get_raw_stream(0)
            triton_per_fused_native_group_norm_backward_62.run(buf451, buf453, 4096, 16, stream=stream0)
            buf454 = buf357; del buf357  # reuse
            # Topologically Sorted Source Nodes: [], Original ATen: [aten.native_group_norm_backward]
            stream0 = get_raw_stream(0)
            triton_per_fused_native_group_norm_backward_62.run(buf452, buf454, 4096, 16, stream=stream0)
            buf456 = reinterpret_tensor(buf423, (128, 512, 8, 8), (32768, 64, 8, 1), 0); del buf423  # reuse
            # Topologically Sorted Source Nodes: [x_norm_5], Original ATen: [aten._to_copy, aten.mul, aten.view, aten.add, aten.clone, aten.native_group_norm_backward, aten.native_group_norm]
            stream0 = get_raw_stream(0)
            triton_poi_fused__to_copy_add_clone_mul_native_group_norm_native_group_norm_backward_view_63.run(buf441, mul_329, buf449, squeeze_11, convolution_13, buf454, squeeze_10, buf453, buf456, 4194304, stream=stream0)
            del buf441
            del convolution_13
            del mul_329
            del squeeze_10
            ...
            # Topologically Sorted Source Nodes: [], Original ATen: [aten.convolution_backward, aten._to_copy]
            stream0 = get_raw_stream(0)
            triton_red_fused__to_copy_convolution_backward_64.run(buf456, buf462, 512, 8192, stream=stream0)
            buf459 = buf458[0]
            ...
            # Topologically Sorted Source Nodes: [], Original ATen: [aten.view, aten.transpose, aten.native_dropout_backward]
            stream0 = get_raw_stream(0)
            triton_poi_fused_native_dropout_backward_transpose_view_65.run(buf459, getitem_40, buf463, 4194304, stream=stream0)
            del getitem_40
            ...
            # Topologically Sorted Source Nodes: [], Original ATen: [aten.view, aten.transpose, aten.native_dropout_backward, aten.sum]
            stream0 = get_raw_stream(0)
            triton_red_fused_sum_view_47.run(buf463, buf466, 32768, 128, stream=stream0)
            ...
            # Topologically Sorted Source Nodes: [], Original ATen: [aten.view, aten.transpose, aten.native_dropout_backward, aten.sum]
            stream0 = get_raw_stream(0)
            triton_per_fused__to_copy_native_layer_norm_native_layer_norm_backward_transpose_view_46.run(buf466, buf467, 512, 64, stream=stream0)
            buf469 = reinterpret_tensor(buf463, (128, 8, 64, 64), (32768, 4096, 64, 1), 0); del buf463  # reuse
            # Topologically Sorted Source Nodes: [], Original ATen: [aten.view, aten.transpose, aten.clone]
            stream0 = get_raw_stream(0)
            triton_poi_fused_clone_transpose_view_50.run(buf464, buf469, 4194304, stream=stream0)
            ...
            # Topologically Sorted Source Nodes: [matmul_6, attn_7], Original ATen: [aten.view, aten._to_copy, aten.mul, aten.amax, aten.sub, aten._softmax, aten._softmax_backward_data]
            stream0 = get_raw_stream(0)
            triton_poi_fused__softmax__softmax_backward_data__to_copy_amax_mul_sub_view_66.run(buf472, buf471, 65536, stream=stream0)
            ...
            # Topologically Sorted Source Nodes: [], Original ATen: [aten.view, aten.transpose, aten.cat]
            stream0 = get_raw_stream(0)
            triton_poi_fused_cat_transpose_view_67.run(buf473, buf470, buf475, 131072, stream=stream0)
            del buf470
            ...
            # Topologically Sorted Source Nodes: [], Original ATen: [aten._to_copy]
            stream0 = get_raw_stream(0)
            triton_poi_fused__to_copy_48.run(buf465, buf468, 262144, stream=stream0)
            buf478 = empty_strided_cuda((1024, 256), (256, 1), torch.float32)
            # Topologically Sorted Source Nodes: [], Original ATen: [aten._to_copy]
            stream0 = get_raw_stream(0)
            triton_poi_fused__to_copy_48.run(buf476, buf478, 262144, stream=stream0)
            buf461 = empty_strided_cuda((512, 512, 3, 3), (4608, 1, 1536, 512), torch.float32)
            # Topologically Sorted Source Nodes: [], Original ATen: [aten._to_copy]
            stream0 = get_raw_stream(0)
            triton_poi_fused__to_copy_68.run(buf460, buf461, 2359296, stream=stream0)
            del buf460
            ...
            # Topologically Sorted Source Nodes: [], Original ATen: [aten.view, aten.transpose, aten.clone, aten._unsafe_view]
            stream0 = get_raw_stream(0)
            triton_poi_fused__unsafe_view_clone_transpose_view_69.run(buf474, buf479, 4194304, stream=stream0)
            ...
            # Topologically Sorted Source Nodes: [add_17], Original ATen: [aten.fill, aten.add, aten.view, aten.transpose, aten.sigmoid, aten.sub, aten.mul]
            stream0 = get_raw_stream(0)
            triton_poi_fused_add_fill_mul_sigmoid_sub_transpose_view_70.run(buf483, buf459, buf481, convolution_12, convolution_10, 4194304, stream=stream0)
            del convolution_12
            # Topologically Sorted Source Nodes: [], Original ATen: [aten.convolution_backward]
            ...
            # Topologically Sorted Source Nodes: [], Original ATen: [aten.convolution_backward]
            stream0 = get_raw_stream(0)
            triton_red_fused_convolution_backward_57.run(buf483, buf484, 32768, 128, stream=stream0)
            buf490 = empty_strided_cuda((512, ), (1, ), torch.float32)
            # Topologically Sorted Source Nodes: [], Original ATen: [aten.convolution_backward, aten._to_copy]
            stream0 = get_raw_stream(0)
            triton_per_fused__to_copy_convolution_backward_58.run(buf484, buf490, 512, 64, stream=stream0)
            buf482 = empty_strided_cuda((512, 512), (512, 1), torch.float32)
            # Topologically Sorted Source Nodes: [], Original ATen: [aten._to_copy]
            stream0 = get_raw_stream(0)
            triton_poi_fused__to_copy_48.run(buf480, buf482, 262144, stream=stream0)
            buf489 = empty_strided_cuda((512, 512, 1, 1), (512, 1, 512, 512), torch.float32)
            # Topologically Sorted Source Nodes: [], Original ATen: [aten._to_copy]
            stream0 = get_raw_stream(0)
            triton_poi_fused__to_copy_48.run(buf488, buf489, 262144, stream=stream0)
            ...
            # Topologically Sorted Source Nodes: [], Original ATen: [aten._to_copy, aten.mul, aten.sum, aten.view]
            stream0 = get_raw_stream(0)
            triton_per_fused__to_copy_mul_sum_view_60.run(buf487, mul_351, buf491, buf492, 65536, 64, stream=stream0)
            ...
            # Topologically Sorted Source Nodes: [], Original ATen: [aten._to_copy, aten.transpose, aten.view, aten.clone, aten._unsafe_view, aten.cat, aten.add]
            stream0 = get_raw_stream(0)
            triton_poi_fused__to_copy__unsafe_view_add_cat_clone_transpose_view_71.run(buf448, buf450, buf445, buf494, buf496, buf491, buf497, 1638400, stream=stream0)
            del buf448
            del buf450
            del buf494
            del buf496
            ...
            # Topologically Sorted Source Nodes: [], Original ATen: [aten.fill, aten.sigmoid, aten.sub, aten.mul, aten.add]
            stream0 = get_raw_stream(0)
            triton_poi_fused_add_fill_mul_sigmoid_sub_19.run(buf700, addmm_8, 32768, stream=stream0)
            del addmm_8
            buf702 = empty_strided_cuda((1, 256), (256, 1), torch.float32)
            # Topologically Sorted Source Nodes: [], Original ATen: [aten.sum]
            stream0 = get_raw_stream(0)
            triton_red_fused_sum_21.run(buf700, buf702, 256, 128, stream=stream0)
            buf698 = empty_strided_cuda((1, 12800), (12800, 1), torch.float32)
            # Topologically Sorted Source Nodes: [], Original ATen: [aten.sum]
            stream0 = get_raw_stream(0)
            triton_red_fused_sum_72.run(buf497, buf698, 12800, 128, stream=stream0)
            ...
            # Topologically Sorted Source Nodes: [], Original ATen: [aten._to_copy]
            stream0 = get_raw_stream(0)
            triton_poi_fused__to_copy_23.run(buf701, buf704, 65536, stream=stream0)
            ...
            # Topologically Sorted Source Nodes: [], Original ATen: [aten._to_copy]
            stream0 = get_raw_stream(0)
            triton_poi_fused__to_copy_73.run(buf697, buf699, 3276800, stream=stream0)
            del buf697
            ...
            stream0 = get_raw_stream(0)
            triton_per_fused__to_copy_add_clone_mul_native_group_norm_backward_view_61.run(buf487, mul_351, buf495, convolution_11, buf498, buf499, 65536, 64, stream=stream0)
            buf500 = buf454; del buf454  # reuse
            # Topologically Sorted Source Nodes: [], Original ATen: [aten.native_group_norm_backward]
            stream0 = get_raw_stream(0)
            triton_per_fused_native_group_norm_backward_62.run(buf498, buf500, 4096, 16, stream=stream0)
            buf501 = buf453; del buf453  # reuse
            # Topologically Sorted Source Nodes: [], Original ATen: [aten.native_group_norm_backward]
            stream0 = get_raw_stream(0)
            triton_per_fused_native_group_norm_backward_62.run(buf499, buf501, 4096, 16, stream=stream0)
            ...
            stream0 = get_raw_stream(0)
            triton_poi_fused__to_copy_add_clone_mul_native_group_norm_native_group_norm_backward_view_63.run(buf487, mul_351, buf495, squeeze_9, convolution_11, buf501, squeeze_8, buf500, buf503, 4194304, stream=stream0)
            del buf487
            del convolution_11
            del mul_351
            del squeeze_8
            ...
            # Topologically Sorted Source Nodes: [], Original ATen: [aten.convolution_backward, aten._to_copy]
            stream0 = get_raw_stream(0)
            triton_red_fused__to_copy_convolution_backward_64.run(buf503, buf509, 512, 8192, stream=stream0)
            buf506 = buf505[0]
            ...
            # Topologically Sorted Source Nodes: [], Original ATen: [aten.view, aten.transpose, aten.native_dropout_backward]
            stream0 = get_raw_stream(0)
            triton_poi_fused_native_dropout_backward_transpose_view_65.run(buf506, getitem_31, buf510, 4194304, stream=stream0)
            del getitem_31
            ...
            # Topologically Sorted Source Nodes: [], Original ATen: [aten.view, aten.transpose, aten.native_dropout_backward, aten.sum]
            stream0 = get_raw_stream(0)
            triton_red_fused_sum_view_47.run(buf510, buf513, 32768, 128, stream=stream0)
            ...
            # Topologically Sorted Source Nodes: [], Original ATen: [aten.view, aten.transpose, aten.native_dropout_backward, aten.sum]
            stream0 = get_raw_stream(0)
            triton_per_fused__to_copy_native_layer_norm_native_layer_norm_backward_transpose_view_46.run(buf513, buf514, 512, 64, stream=stream0)
            buf516 = reinterpret_tensor(buf510, (128, 8, 64, 64), (32768, 4096, 64, 1), 0); del buf510  # reuse
            # Topologically Sorted Source Nodes: [], Original ATen: [aten.view, aten.transpose, aten.clone]
            stream0 = get_raw_stream(0)
            triton_poi_fused_clone_transpose_view_50.run(buf511, buf516, 4194304, stream=stream0)
            ...
            stream0 = get_raw_stream(0)
            triton_poi_fused__softmax__softmax_backward_data__to_copy_amax_mul_sub_view_66.run(buf519, buf518, 65536, stream=stream0)
            ...
            # Topologically Sorted Source Nodes: [], Original ATen: [aten.view, aten.transpose, aten.cat]
            stream0 = get_raw_stream(0)
            triton_poi_fused_cat_transpose_view_67.run(buf520, buf517, buf522, 131072, stream=stream0)
            del buf517
            del buf520
            ...
            # Topologically Sorted Source Nodes: [], Original ATen: [aten._to_copy]
            stream0 = get_raw_stream(0)
            triton_poi_fused__to_copy_48.run(buf512, buf515, 262144, stream=stream0)
            buf525 = empty_strided_cuda((1024, 256), (256, 1), torch.float32)
            # Topologically Sorted Source Nodes: [], Original ATen: [aten._to_copy]
            stream0 = get_raw_stream(0)
            triton_poi_fused__to_copy_48.run(buf523, buf525, 262144, stream=stream0)
            buf508 = empty_strided_cuda((512, 512, 3, 3), (4608, 1, 1536, 512), torch.float32)
            # Topologically Sorted Source Nodes: [], Original ATen: [aten._to_copy]
            stream0 = get_raw_stream(0)
            triton_poi_fused__to_copy_68.run(buf507, buf508, 2359296, stream=stream0)
            del buf507
            ...
            # Topologically Sorted Source Nodes: [], Original ATen: [aten.view, aten.transpose, aten.clone, aten._unsafe_view]
            stream0 = get_raw_stream(0)
            triton_poi_fused__unsafe_view_clone_transpose_view_69.run(buf521, buf526, 4194304, stream=stream0)
            ...
            # Topologically Sorted Source Nodes: [], Original ATen: [aten.add, aten.view, aten.transpose]
            stream0 = get_raw_stream(0)
            triton_poi_fused_add_transpose_view_74.run(buf530, buf506, buf528, 4194304, stream=stream0)
            del buf506
            del buf528
            # Topologically Sorted Source Nodes: [], Original ATen: [aten.convolution_backward]
            ...
            # Topologically Sorted Source Nodes: [], Original ATen: [aten.convolution_backward]
            stream0 = get_raw_stream(0)
            triton_red_fused_convolution_backward_57.run(buf530, buf531, 32768, 128, stream=stream0)
            del buf530
            buf537 = empty_strided_cuda((512, ), (1, ), torch.float32)
            # Topologically Sorted Source Nodes: [], Original ATen: [aten.convolution_backward, aten._to_copy]
            stream0 = get_raw_stream(0)
            triton_per_fused__to_copy_convolution_backward_58.run(buf531, buf537, 512, 64, stream=stream0)
            buf534 = buf533[0]
            ...
            # Topologically Sorted Source Nodes: [input_27, unsqueeze_4, gate], Original ATen: [aten.sigmoid, aten.unsqueeze, aten.mul, aten.add]
            stream0 = get_raw_stream(0)
            triton_poi_fused_add_mul_sigmoid_unsqueeze_75.run(buf538, addmm_17, buf534, mul_370, 8388608, stream=stream0)
            del addmm_17
            del mul_370
            # Topologically Sorted Source Nodes: [], Original ATen: [aten.convolution_backward]
            ...
            # Topologically Sorted Source Nodes: [], Original ATen: [aten.convolution_backward]
            stream0 = get_raw_stream(0)
            triton_red_fused_convolution_backward_24.run(buf538, buf539, 32768, 256, stream=stream0)
            buf545 = empty_strided_cuda((256, ), (1, ), torch.float32)
            # Topologically Sorted Source Nodes: [], Original ATen: [aten.convolution_backward, aten._to_copy]
            stream0 = get_raw_stream(0)
            triton_red_fused__to_copy_convolution_backward_25.run(buf539, buf545, 256, 128, stream=stream0)
            buf544 = reinterpret_tensor(buf499, (256, 256, 1, 1), (256, 1, 256, 256), 0); del buf499  # reuse
            # Topologically Sorted Source Nodes: [], Original ATen: [aten._to_copy]
            stream0 = get_raw_stream(0)
            triton_poi_fused__to_copy_23.run(buf543, buf544, 65536, stream=stream0)
            buf529 = empty_strided_cuda((512, 512), (512, 1), torch.float32)
            # Topologically Sorted Source Nodes: [], Original ATen: [aten._to_copy]
            stream0 = get_raw_stream(0)
            triton_poi_fused__to_copy_48.run(buf527, buf529, 262144, stream=stream0)
            buf536 = empty_strided_cuda((512, 256, 3, 3), (2304, 1, 768, 256), torch.float32)
            # Topologically Sorted Source Nodes: [], Original ATen: [aten._to_copy]
            stream0 = get_raw_stream(0)
            triton_poi_fused__to_copy_76.run(buf535, buf536, 1179648, stream=stream0)
            del buf535
            ...
            # Topologically Sorted Source Nodes: [], Original ATen: [aten._to_copy, aten.mul, aten.sum, aten.view]
            stream0 = get_raw_stream(0)
            triton_red_fused__to_copy_mul_sum_view_27.run(buf542, mul_373, buf546, buf547, 32768, 256, stream=stream0)
            ...
            stream0 = get_raw_stream(0)
            triton_red_fused__to_copy_add_clone_mul_native_group_norm_backward_view_28.run(buf542, mul_373, buf550, convolution_8, buf553, buf554, 32768, 256, stream=stream0)
            buf555 = buf501; del buf501  # reuse
            # Topologically Sorted Source Nodes: [], Original ATen: [aten.native_group_norm_backward]
            stream0 = get_raw_stream(0)
            triton_per_fused_native_group_norm_backward_29.run(buf553, buf555, 4096, 8, stream=stream0)
            del buf553
            buf556 = buf500; del buf500  # reuse
            # Topologically Sorted Source Nodes: [], Original ATen: [aten.native_group_norm_backward]
            stream0 = get_raw_stream(0)
            triton_per_fused_native_group_norm_backward_29.run(buf554, buf556, 4096, 8, stream=stream0)
            ...
            stream0 = get_raw_stream(0)
            triton_poi_fused__to_copy_add_clone_mul_native_group_norm_native_group_norm_backward_view_30.run(buf542, mul_373, buf550, squeeze_7, convolution_8, buf556, squeeze_6, buf555, buf558, 8388608, stream=stream0)
            del buf542
            del convolution_8
            del mul_373
            del squeeze_6
            ...
            # Topologically Sorted Source Nodes: [], Original ATen: [aten.convolution_backward, aten._to_copy]
            stream0 = get_raw_stream(0)
            triton_red_fused__to_copy_convolution_backward_31.run(buf558, buf564, 256, 32768, stream=stream0)
            buf561 = buf560[0]
            ...
            # Topologically Sorted Source Nodes: [], Original ATen: [aten._to_copy]
            stream0 = get_raw_stream(0)
            triton_poi_fused__to_copy_32.run(buf562, buf563, 589824, stream=stream0)
            del buf562
            buf565 = reinterpret_tensor(buf558, (128, 256, 256), (65536, 256, 1), 0); del buf558  # reuse
            # Topologically Sorted Source Nodes: [], Original ATen: [aten.view, aten.transpose, aten.native_dropout_backward]
            stream0 = get_raw_stream(0)
            triton_poi_fused_native_dropout_backward_transpose_view_33.run(buf561, getitem_22, buf565, 8388608, stream=stream0)
            del getitem_22
            ...
            # Topologically Sorted Source Nodes: [], Original ATen: [aten.view, aten.transpose, aten.native_dropout_backward, aten.sum]
            stream0 = get_raw_stream(0)
            triton_red_fused_native_dropout_backward_sum_transpose_view_34.run(buf565, buf568, 32768, 256, stream=stream0)
            ...
            # Topologically Sorted Source Nodes: [], Original ATen: [aten.view, aten.transpose, aten.native_dropout_backward, aten.sum]
            stream0 = get_raw_stream(0)
            triton_red_fused_native_dropout_backward_sum_transpose_view_35.run(buf568, buf569, 256, 128, stream=stream0)
            buf571 = reinterpret_tensor(buf565, (128, 4, 256, 64), (65536, 16384, 64, 1), 0); del buf565  # reuse
            # Topologically Sorted Source Nodes: [], Original ATen: [aten.view, aten.transpose, aten.clone]
            stream0 = get_raw_stream(0)
            triton_poi_fused_clone_transpose_view_36.run(buf566, buf571, 8388608, stream=stream0)
            ...
            stream0 = get_raw_stream(0)
            triton_poi_fused__softmax__softmax_backward_data__to_copy_amax_mul_sub_view_37.run(buf574, buf573, 131072, stream=stream0)
            ...
            # Topologically Sorted Source Nodes: [], Original ATen: [aten.view, aten.transpose, aten.cat]
            stream0 = get_raw_stream(0)
            triton_poi_fused_cat_transpose_view_38.run(buf575, buf572, buf577, 65536, stream=stream0)
            ...
            # Topologically Sorted Source Nodes: [], Original ATen: [aten._to_copy]
            stream0 = get_raw_stream(0)
            triton_poi_fused__to_copy_23.run(buf567, buf570, 65536, stream=stream0)
            del buf567
            ...
            # Topologically Sorted Source Nodes: [], Original ATen: [aten._to_copy]
            stream0 = get_raw_stream(0)
            triton_poi_fused__to_copy_39.run(buf578, buf580, 131072, stream=stream0)
            del buf578
            ...
            # Topologically Sorted Source Nodes: [], Original ATen: [aten.view, aten.transpose, aten.clone, aten._unsafe_view]
            stream0 = get_raw_stream(0)
            triton_poi_fused__unsafe_view_clone_transpose_view_40.run(buf576, buf581, 8388608, stream=stream0)
            ...
            # Topologically Sorted Source Nodes: [add_9], Original ATen: [aten.fill, aten.add, aten.view, aten.transpose, aten.sigmoid, aten.sub, aten.mul]
            stream0 = get_raw_stream(0)
            triton_poi_fused_add_fill_mul_sigmoid_sub_transpose_view_77.run(buf585, buf561, buf583, convolution_7, convolution_5, 8388608, stream=stream0)
            del convolution_7
            # Topologically Sorted Source Nodes: [], Original ATen: [aten.convolution_backward]
            ...
            # Topologically Sorted Source Nodes: [], Original ATen: [aten._to_copy]
            stream0 = get_raw_stream(0)
            triton_poi_fused__to_copy_23.run(buf582, buf584, 65536, stream=stream0)
            buf586 = reinterpret_tensor(buf568, (256, 128), (1, 256), 0); del buf568  # reuse
            # Topologically Sorted Source Nodes: [], Original ATen: [aten.convolution_backward]
            stream0 = get_raw_stream(0)
            triton_red_fused_convolution_backward_24.run(buf585, buf586, 32768, 256, stream=stream0)
            buf592 = empty_strided_cuda((256, ), (1, ), torch.float32)
            # Topologically Sorted Source Nodes: [], Original ATen: [aten.convolution_backward, aten._to_copy]
            stream0 = get_raw_stream(0)
            triton_red_fused__to_copy_convolution_backward_25.run(buf586, buf592, 256, 128, stream=stream0)
            buf591 = empty_strided_cuda((256, 256, 1, 1), (256, 1, 256, 256), torch.float32)
            # Topologically Sorted Source Nodes: [], Original ATen: [aten._to_copy]
            stream0 = get_raw_stream(0)
            triton_poi_fused__to_copy_23.run(buf590, buf591, 65536, stream=stream0)
            ...
            # Topologically Sorted Source Nodes: [], Original ATen: [aten._to_copy, aten.mul, aten.sum, aten.view]
            stream0 = get_raw_stream(0)
            triton_red_fused__to_copy_mul_sum_view_27.run(buf589, mul_395, buf593, buf594, 32768, 256, stream=stream0)
            ...
            # Topologically Sorted Source Nodes: [], Original ATen: [aten._to_copy, aten.transpose, aten.view, aten.clone, aten._unsafe_view, aten.cat, aten.add]
            stream0 = get_raw_stream(0)
            triton_poi_fused__to_copy__unsafe_view_add_cat_clone_transpose_view_78.run(buf599, buf166, buf168, buf163, buf212, buf214, buf209, buf259, buf261, buf256, buf305, buf307, buf302, buf352, buf354, buf349, buf549, buf551, buf546, buf596, buf598, buf593, 819200, stream=stream0)
            del buf163
            del buf166
            del buf168
            del buf209
            ...
            # Topologically Sorted Source Nodes: [], Original ATen: [aten.fill, aten.sigmoid, aten.sub, aten.mul, aten.add]
            stream0 = get_raw_stream(0)
            triton_poi_fused_add_fill_mul_sigmoid_sub_19.run(buf709, addmm_6, 32768, stream=stream0)
            del addmm_6
            buf711 = empty_strided_cuda((1, 256), (256, 1), torch.float32)
            # Topologically Sorted Source Nodes: [], Original ATen: [aten.sum]
            stream0 = get_raw_stream(0)
            triton_red_fused_sum_21.run(buf709, buf711, 256, 128, stream=stream0)
            buf707 = empty_strided_cuda((1, 6400), (6400, 1), torch.float32)
            # Topologically Sorted Source Nodes: [], Original ATen: [aten.sum]
            stream0 = get_raw_stream(0)
            triton_red_fused_sum_79.run(buf599, buf707, 6400, 128, stream=stream0)
            ...
            # Topologically Sorted Source Nodes: [], Original ATen: [aten._to_copy]
            stream0 = get_raw_stream(0)
            triton_poi_fused__to_copy_23.run(buf710, buf713, 65536, stream=stream0)
            ...
            # Topologically Sorted Source Nodes: [], Original ATen: [aten._to_copy]
            stream0 = get_raw_stream(0)
            triton_poi_fused__to_copy_80.run(buf706, buf708, 1638400, stream=stream0)
            del buf706
            ...
            stream0 = get_raw_stream(0)
            triton_red_fused__to_copy_add_clone_mul_native_group_norm_backward_view_28.run(buf589, mul_395, buf597, convolution_6, buf600, buf601, 32768, 256, stream=stream0)
            buf602 = buf556; del buf556  # reuse
            # Topologically Sorted Source Nodes: [], Original ATen: [aten.native_group_norm_backward]
            stream0 = get_raw_stream(0)
            triton_per_fused_native_group_norm_backward_29.run(buf600, buf602, 4096, 8, stream=stream0)
            del buf600
            buf603 = buf555; del buf555  # reuse
            # Topologically Sorted Source Nodes: [], Original ATen: [aten.native_group_norm_backward]
            stream0 = get_raw_stream(0)
            triton_per_fused_native_group_norm_backward_29.run(buf601, buf603, 4096, 8, stream=stream0)
            ...
            stream0 = get_raw_stream(0)
            triton_poi_fused__to_copy_add_clone_mul_native_group_norm_native_group_norm_backward_view_30.run(buf589, mul_395, buf597, squeeze_5, convolution_6, buf603, squeeze_4, buf602, buf605, 8388608, stream=stream0)
            del buf589
            del buf602
            del convolution_6
            del mul_395
            ...
            # Topologically Sorted Source Nodes: [], Original ATen: [aten.convolution_backward, aten._to_copy]
            stream0 = get_raw_stream(0)
            triton_red_fused__to_copy_convolution_backward_31.run(buf605, buf611, 256, 32768, stream=stream0)
            buf608 = buf607[0]
            ...
            # Topologically Sorted Source Nodes: [], Original ATen: [aten._to_copy]
            stream0 = get_raw_stream(0)
            triton_poi_fused__to_copy_32.run(buf609, buf610, 589824, stream=stream0)
            del buf609
            buf612 = reinterpret_tensor(buf605, (128, 256, 256), (65536, 256, 1), 0); del buf605  # reuse
            # Topologically Sorted Source Nodes: [], Original ATen: [aten.view, aten.transpose, aten.native_dropout_backward]
            stream0 = get_raw_stream(0)
            triton_poi_fused_native_dropout_backward_transpose_view_33.run(buf608, getitem_13, buf612, 8388608, stream=stream0)
            del getitem_13
            ...
            # Topologically Sorted Source Nodes: [], Original ATen: [aten.view, aten.transpose, aten.native_dropout_backward, aten.sum]
            stream0 = get_raw_stream(0)
            triton_red_fused_native_dropout_backward_sum_transpose_view_34.run(buf612, buf615, 32768, 256, stream=stream0)
            ...
            # Topologically Sorted Source Nodes: [], Original ATen: [aten.view, aten.transpose, aten.native_dropout_backward, aten.sum]
            stream0 = get_raw_stream(0)
            triton_red_fused_native_dropout_backward_sum_transpose_view_35.run(buf615, buf616, 256, 128, stream=stream0)
            buf618 = reinterpret_tensor(buf612, (128, 4, 256, 64), (65536, 16384, 64, 1), 0); del buf612  # reuse
            # Topologically Sorted Source Nodes: [], Original ATen: [aten.view, aten.transpose, aten.clone]
            stream0 = get_raw_stream(0)
            triton_poi_fused_clone_transpose_view_36.run(buf613, buf618, 8388608, stream=stream0)
            ...
            stream0 = get_raw_stream(0)
            triton_poi_fused__softmax__softmax_backward_data__to_copy_amax_mul_sub_view_37.run(buf621, buf620, 131072, stream=stream0)
            ...
            # Topologically Sorted Source Nodes: [], Original ATen: [aten.view, aten.transpose, aten.cat]
            stream0 = get_raw_stream(0)
            triton_poi_fused_cat_transpose_view_38.run(buf622, buf619, buf624, 65536, stream=stream0)
            del buf619
            ...
            # Topologically Sorted Source Nodes: [], Original ATen: [aten._to_copy]
            stream0 = get_raw_stream(0)
            triton_poi_fused__to_copy_23.run(buf614, buf617, 65536, stream=stream0)
            ...
            # Topologically Sorted Source Nodes: [], Original ATen: [aten._to_copy]
            stream0 = get_raw_stream(0)
            triton_poi_fused__to_copy_39.run(buf625, buf627, 131072, stream=stream0)
            ...
            # Topologically Sorted Source Nodes: [], Original ATen: [aten.view, aten.transpose, aten.clone, aten._unsafe_view]
            stream0 = get_raw_stream(0)
            triton_poi_fused__unsafe_view_clone_transpose_view_40.run(buf623, buf628, 8388608, stream=stream0)
            ...
            # Topologically Sorted Source Nodes: [], Original ATen: [aten.add, aten.view, aten.transpose]
            stream0 = get_raw_stream(0)
            triton_poi_fused_add_transpose_view_42.run(buf632, buf608, buf630, 8388608, stream=stream0)
            del buf608
            del buf630
            # Topologically Sorted Source Nodes: [], Original ATen: [aten.convolution_backward]
            ...
            # Topologically Sorted Source Nodes: [], Original ATen: [aten.convolution_backward]
            stream0 = get_raw_stream(0)
            triton_red_fused_convolution_backward_24.run(buf632, buf633, 32768, 256, stream=stream0)
            del buf632
            buf639 = empty_strided_cuda((256, ), (1, ), torch.float32)
            # Topologically Sorted Source Nodes: [], Original ATen: [aten.convolution_backward, aten._to_copy]
            stream0 = get_raw_stream(0)
            triton_red_fused__to_copy_convolution_backward_25.run(buf633, buf639, 256, 128, stream=stream0)
            del buf633
            buf636 = buf635[0]
            ...
            # Topologically Sorted Source Nodes: [input_41, unsqueeze_11, gate_1], Original ATen: [aten.sigmoid, aten.unsqueeze, aten.mul, aten.add]
            stream0 = get_raw_stream(0)
            triton_poi_fused_add_mul_sigmoid_unsqueeze_81.run(buf640, addmm_24, buf636, mul_414, 16384, 1024, stream=stream0)
            del addmm_24
            del mul_414
            # Topologically Sorted Source Nodes: [], Original ATen: [aten.convolution_backward]
            ...
            # Topologically Sorted Source Nodes: [], Original ATen: [aten.convolution_backward, aten._to_copy]
            stream0 = get_raw_stream(0)
            triton_red_fused__to_copy_convolution_backward_9.run(buf640, buf646, 128, 131072, stream=stream0)
            buf645 = reinterpret_tensor(buf127, (128, 128, 1, 1), (128, 1, 128, 128), 0); del buf127  # reuse
            # Topologically Sorted Source Nodes: [], Original ATen: [aten._to_copy]
            stream0 = get_raw_stream(0)
            triton_poi_fused__to_copy_10.run(buf644, buf645, 16384, stream=stream0)
            del buf644
            buf631 = empty_strided_cuda((256, 256), (256, 1), torch.float32)
            # Topologically Sorted Source Nodes: [], Original ATen: [aten._to_copy]
            stream0 = get_raw_stream(0)
            triton_poi_fused__to_copy_23.run(buf629, buf631, 65536, stream=stream0)
            buf638 = empty_strided_cuda((256, 128, 3, 3), (1152, 1, 384, 128), torch.float32)
            # Topologically Sorted Source Nodes: [], Original ATen: [aten._to_copy]
            stream0 = get_raw_stream(0)
            triton_poi_fused__to_copy_82.run(buf637, buf638, 294912, stream=stream0)
            del buf637
            ...
            # Topologically Sorted Source Nodes: [], Original ATen: [aten._to_copy, aten.mul, aten.sum, aten.view]
            stream0 = get_raw_stream(0)
            triton_red_fused__to_copy_mul_sum_view_11.run(buf643, mul_417, buf647, buf648, 16384, 1024, stream=stream0)
            ...
            stream0 = get_raw_stream(0)
            triton_red_fused__to_copy_add_clone_mul_native_group_norm_backward_view_12.run(buf643, mul_417, buf651, convolution_3, buf654, buf655, 16384, 1024, stream=stream0)
            buf656 = buf603; del buf603  # reuse
            buf657 = squeeze_2; del squeeze_2  # reuse
            # Topologically Sorted Source Nodes: [], Original ATen: [aten.native_group_norm_backward]
            stream0 = get_raw_stream(0)
            triton_poi_fused_native_group_norm_backward_13.run(buf657, buf655, buf654, squeeze_3, buf656, 4096, stream=stream0)
            ...
            stream0 = get_raw_stream(0)
            triton_poi_fused__to_copy_add_clone_mul_native_group_norm_native_group_norm_backward_view_14.run(buf658, buf643, mul_417, squeeze_3, convolution_3, buf656, buf657, 16384, 1024, stream=stream0)
            del buf643
            del buf656
            del convolution_3
            del mul_417
            ...
            # Topologically Sorted Source Nodes: [], Original ATen: [aten.convolution_backward, aten._to_copy]
            stream0 = get_raw_stream(0)
            triton_red_fused__to_copy_convolution_backward_9.run(buf658, buf664, 128, 131072, stream=stream0)
            del buf658
            buf661 = buf660[0]
            ...
            # Topologically Sorted Source Nodes: [add_2], Original ATen: [aten.fill, aten.add, aten.sigmoid, aten.sub, aten.mul]
            stream0 = get_raw_stream(0)
            triton_poi_fused_add_fill_mul_sigmoid_sub_83.run(buf665, buf661, convolution_2, convolution, 131072, 128, stream=stream0)
            del convolution_2
            # Topologically Sorted Source Nodes: [], Original ATen: [aten.convolution_backward]
            ...
            # Topologically Sorted Source Nodes: [], Original ATen: [aten.convolution_backward, aten._to_copy]
            stream0 = get_raw_stream(0)
            triton_red_fused__to_copy_convolution_backward_9.run(buf665, buf671, 128, 131072, stream=stream0)
            buf670 = reinterpret_tensor(buf655, (128, 128, 1, 1), (128, 1, 128, 128), 0); del buf655  # reuse
            # Topologically Sorted Source Nodes: [], Original ATen: [aten._to_copy]
            stream0 = get_raw_stream(0)
            triton_poi_fused__to_copy_10.run(buf669, buf670, 16384, stream=stream0)
            del buf669
            buf663 = empty_strided_cuda((128, 128, 3, 3), (1152, 1, 384, 128), torch.float32)
            # Topologically Sorted Source Nodes: [], Original ATen: [aten._to_copy]
            stream0 = get_raw_stream(0)
            triton_poi_fused__to_copy_16.run(buf662, buf663, 147456, stream=stream0)
            del buf662
            ...
            # Topologically Sorted Source Nodes: [], Original ATen: [aten._to_copy, aten.mul, aten.sum, aten.view]
            stream0 = get_raw_stream(0)
            triton_red_fused__to_copy_mul_sum_view_11.run(buf668, mul_435, buf672, buf673, 16384, 1024, stream=stream0)
            ...
            # Topologically Sorted Source Nodes: [], Original ATen: [aten._to_copy, aten.transpose, aten.view, aten.clone, aten._unsafe_view, aten.cat, aten.add]
            stream0 = get_raw_stream(0)
            triton_poi_fused__to_copy__unsafe_view_add_cat_clone_transpose_view_84.run(buf678, buf25, buf27, buf22, buf49, buf51, buf46, buf74, buf76, buf71, buf98, buf100, buf95, buf123, buf125, buf120, buf650, buf652, buf647, buf675, buf677, buf672, 409600, stream=stream0)
            del buf100
            del buf120
            del buf123
            del buf125
            ...
            # Topologically Sorted Source Nodes: [], Original ATen: [aten.fill, aten.sigmoid, aten.sub, aten.mul, aten.add]
            stream0 = get_raw_stream(0)
            triton_poi_fused_add_fill_mul_sigmoid_sub_19.run(buf718, addmm_4, 32768, stream=stream0)
            del addmm_4
            ...
            # Topologically Sorted Source Nodes: [], Original ATen: [aten.sigmoid, aten.fill, aten.sub, aten.mul, aten.add]
            stream0 = get_raw_stream(0)
            triton_poi_fused_add_fill_mul_sigmoid_sub_85.run(buf727, addmm_2, 65536, stream=stream0)
            del addmm_2
            ...
            # Topologically Sorted Source Nodes: [], Original ATen: [aten._to_copy, aten.slice, aten.embedding_dense_backward]
            stream0 = get_raw_stream(0)
            triton_poi_fused__to_copy_embedding_dense_backward_slice_86.run(primals_7, buf728, buf733, 32768, stream=stream0)
            del primals_7
            buf732 = buf712; del buf712  # reuse
            # Topologically Sorted Source Nodes: [], Original ATen: [aten._to_copy, aten.slice]
            stream0 = get_raw_stream(0)
            triton_poi_fused__to_copy_slice_87.run(buf728, buf732, 32768, stream=stream0)
            buf735 = reinterpret_tensor(buf621, (128, 1024), (1024, 1), 0); del buf621  # reuse
            # Topologically Sorted Source Nodes: [], Original ATen: [aten.mm]
            extern_kernels.mm(buf732, permute_534, out=buf735)
            del permute_534
            buf739 = buf735; del buf735  # reuse
            # Topologically Sorted Source Nodes: [], Original ATen: [aten.sigmoid, aten.fill, aten.sub, aten.mul, aten.add]
            stream0 = get_raw_stream(0)
            triton_poi_fused_add_fill_mul_sigmoid_sub_88.run(buf739, addmm, 131072, stream=stream0)
            del addmm
            buf720 = empty_strided_cuda((1, 256), (256, 1), torch.float32)
            # Topologically Sorted Source Nodes: [], Original ATen: [aten.sum]
            stream0 = get_raw_stream(0)
            triton_red_fused_sum_21.run(buf718, buf720, 256, 128, stream=stream0)
            ...
            # Topologically Sorted Source Nodes: [], Original ATen: [aten.sum]
            stream0 = get_raw_stream(0)
            triton_red_fused_sum_21.run(buf721, buf725, 256, 128, stream=stream0)
            buf737 = empty_strided_cuda((1, 256), (256, 1), torch.float32)
            # Topologically Sorted Source Nodes: [], Original ATen: [aten.sum]
            stream0 = get_raw_stream(0)
            triton_red_fused_sum_21.run(buf732, buf737, 256, 128, stream=stream0)
            buf730 = empty_strided_cuda((1, 512), (512, 1), torch.float32)
            # Topologically Sorted Source Nodes: [], Original ATen: [aten.sum]
            stream0 = get_raw_stream(0)
            triton_red_fused_sum_89.run(buf727, buf730, 512, 128, stream=stream0)
            buf741 = empty_strided_cuda((1, 1024), (1024, 1), torch.float32)
            # Topologically Sorted Source Nodes: [], Original ATen: [aten.sum]
            stream0 = get_raw_stream(0)
            triton_red_fused_sum_90.run(buf739, buf741, 1024, 128, stream=stream0)
            buf716 = empty_strided_cuda((1, 3200), (3200, 1), torch.float32)
            # Topologically Sorted Source Nodes: [], Original ATen: [aten.sum]
            stream0 = get_raw_stream(0)
            triton_red_fused_sum_91.run(buf678, buf716, 3200, 128, stream=stream0)
            ...
            # Topologically Sorted Source Nodes: [], Original ATen: [aten._to_copy]
            stream0 = get_raw_stream(0)
            triton_poi_fused__to_copy_23.run(buf719, buf722, 65536, stream=stream0)
            del buf719
            buf736 = reinterpret_tensor(buf527, (256, 1024), (1024, 1), 0); del buf527  # reuse
            # Topologically Sorted Source Nodes: [], Original ATen: [aten.t, aten.mm]
            extern_kernels.mm(reinterpret_tensor(buf732, (256, 128), (1, 256), 0), convert_element_type_7, out=buf736)
            del buf732
            del convert_element_type_7
            buf740 = reinterpret_tensor(buf512, (1024, 256), (256, 1), 0); del buf512  # reuse
            # Topologically Sorted Source Nodes: [], Original ATen: [aten.sigmoid, aten.fill, aten.sub, aten.mul, aten.add, aten.t, aten.mm]
            extern_kernels.mm(reinterpret_tensor(buf739, (1024, 128), (1, 1024), 0), convert_element_type_2, out=buf740)
            del buf739
            del convert_element_type_2
            buf726 = empty_strided_cuda((256, 512), (512, 1), torch.float32)
            # Topologically Sorted Source Nodes: [], Original ATen: [aten._to_copy]
            stream0 = get_raw_stream(0)
            triton_poi_fused__to_copy_39.run(buf724, buf726, 131072, stream=stream0)
            del buf724
            ...
            # Topologically Sorted Source Nodes: [], Original ATen: [aten._to_copy]
            stream0 = get_raw_stream(0)
            triton_poi_fused__to_copy_48.run(buf729, buf731, 262144, stream=stream0)
            del buf729
            buf738 = empty_strided_cuda((256, 1024), (1024, 1), torch.float32)
            # Topologically Sorted Source Nodes: [], Original ATen: [aten._to_copy]
            stream0 = get_raw_stream(0)
            triton_poi_fused__to_copy_48.run(buf736, buf738, 262144, stream=stream0)
            del buf736
            buf742 = empty_strided_cuda((1024, 256), (256, 1), torch.float32)
            # Topologically Sorted Source Nodes: [], Original ATen: [aten._to_copy]
            stream0 = get_raw_stream(0)
            triton_poi_fused__to_copy_48.run(buf740, buf742, 262144, stream=stream0)
            del buf740
            ...
            # Topologically Sorted Source Nodes: [], Original ATen: [aten._to_copy]
            stream0 = get_raw_stream(0)
            triton_poi_fused__to_copy_92.run(buf715, buf717, 819200, stream=stream0)
            del buf715
            ...
            stream0 = get_raw_stream(0)
            triton_red_fused__to_copy_add_clone_mul_native_group_norm_backward_view_12.run(buf668, mul_435, buf676, convolution_1, buf679, buf680, 16384, 1024, stream=stream0)
            buf681 = buf657; del buf657  # reuse
            buf682 = squeeze; del squeeze  # reuse
            # Topologically Sorted Source Nodes: [], Original ATen: [aten.native_group_norm_backward]
            stream0 = get_raw_stream(0)
            triton_poi_fused_native_group_norm_backward_13.run(buf682, buf680, buf679, squeeze_1, buf681, 4096, stream=stream0)
            del buf679
            del buf680
            ...
            stream0 = get_raw_stream(0)
            triton_poi_fused__to_copy_add_clone_mul_native_group_norm_native_group_norm_backward_view_14.run(buf683, buf668, mul_435, squeeze_1, convolution_1, buf681, buf682, 16384, 1024, stream=stream0)
            del buf668
            del buf681
            del buf682
            del convolution_1
            ...
            # Topologically Sorted Source Nodes: [], Original ATen: [aten.convolution_backward, aten._to_copy]
            stream0 = get_raw_stream(0)
            triton_red_fused__to_copy_convolution_backward_9.run(buf683, buf690, 128, 131072, stream=stream0)
            del buf683
            buf686 = buf685[0]
            ...
            # Topologically Sorted Source Nodes: [], Original ATen: [aten.add]
            stream0 = get_raw_stream(0)
            triton_poi_fused_add_93.run(buf688, buf686, 16384, 1024, stream=stream0)
            del buf686
            # Topologically Sorted Source Nodes: [], Original ATen: [aten.convolution_backward]
            ...
            # Topologically Sorted Source Nodes: [], Original ATen: [aten.convolution_backward, aten._to_copy]
            stream0 = get_raw_stream(0)
            triton_red_fused__to_copy_convolution_backward_9.run(buf688, buf695, 128, 131072, stream=stream0)
            del buf688
            buf687 = buf685[1]
