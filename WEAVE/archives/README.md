...
- `legacy-tools-docs-pre-relative-20260715/`
  - retired machine-specific infrastructure and dataset registry docs that still prescribed old `src/` and absolute-path workflows
