...
$outDir = "exp\630_random20_heun_5ep\repro_r20_local\epoch_0005"
...
Write-Output "=== LOCAL REPRO R20 EVAL START $(Get-Date -Format 'yyyy-MM-dd HH:mm:ss') ==="
...
python -u src\utils\run_evaluation.py `
    ...
    --eval_only_lpips_clip_style --eval_lpips_chunk_size 4 2>&1 | Tee-Object -FilePath "G:\GitHub\Latent_Style\SchrodingerBridge\repro_r20_eval_local.log"

$evalEc = $LASTEXITCODE
Write-Output "=== LOCAL REPRO R20 EVAL DONE exit=$evalEc $(Get-Date -Format 'yyyy-MM-dd HH:mm:ss') ==="
