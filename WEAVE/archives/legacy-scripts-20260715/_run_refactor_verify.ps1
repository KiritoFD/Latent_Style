...
# Run evaluation with T1 ASG checkpoint to verify refactor doesn't break performance
python run_evaluation.py `
    --checkpoint "I:\Github\Latent_Style\SchrodingerBridge\exp\t1_asg_5ep\epoch_0005.pt" `
    --output "I:\Github\Latent_Style\SchrodingerBridge\exp\refactor_verify\t1_asg_5ep" `
    --batch_size 2 `
    --ref_feature_batch_size 2 `
    --vae_decode_batch_size 16 `
    --test_dir "I:\datasets\wikiart_distinct5_samam_512_classview\test" `
    *>&1 | Tee-Object -FilePath "C:\Users\Administrator\logs\refactor_verify_eval.log"
