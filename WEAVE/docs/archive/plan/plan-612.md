...
> - runtime/device anchoring now comes from an explicit `style_code_anchor`, not from any legacy null tokenizer shell
> - the pure-latent runtime no longer instantiates a legacy `style_tokenizer` module at all
