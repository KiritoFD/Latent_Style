...
| `target_hf_subband_pairstats_ft6` | target-HF plus current-vs-target HF statistics | 0.483765 | 0.794304 | 0.718318 | 0.297092 | 0.399385 | Reject: safe but too coarse. |
...
| Current-target global HF statistics | Safe and available at train/inference time, but weaker than target-only subband pooling. |
