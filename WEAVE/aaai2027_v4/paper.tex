...
CUT & 0.471 & 0.714 & 0.374 & 0.795 & 0.539 & 0.754 & 0.494 & 0.702 & 0.441 & 0.710$^{\dagger}$ & 0.620 & 0.795 & 7.0 & 322.6 & 5\,m \\
...
SaMam & 0.477 & 0.582$^{\dagger}$ & \underline{0.243} & 0.812 & 0.505 & 0.677 & \underline{0.205} & 0.870 & 0.503 & 0.712$^{\dagger}$ & \underline{0.227} & 0.925 & 8.8 & 436.0 & 17.6\,m \\
...
\midrule
\textbf{Ours} & \textbf{0.4915} & 0.7126 & 0.2596 & 0.8103 & 0.4801 & 0.6681 & 0.3116 & 0.8612 & \underline{0.5226} & 0.7747 & 0.2895 & 0.7717 & \textbf{1.04$^{+84}$} & \textbf{1.4} & \textbf{106\,s} \\
\bottomrule
\end{tabular}%
}
\caption{Main comparison. DINO-S, CLIP-S, and DINO-C are higher better; LPIPS is lower better. IDT and TGT are empirical references, not theoretical bounds. $\dagger$: style value does not exceed IDT. $\ddagger$: content value does not remain inside TGT. The D5 row uses the oriented-HF route and internal-dynamics epoch selection; P2A and R5 report the base WEAVE checkpoints. Params are in millions and superscripts denote frozen parameters. Train is wall time on one RTX~3060; Infer is generation-only time for 750 images.}
\label{tab:main}
\end{table*}
