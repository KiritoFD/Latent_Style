...
Z-STAR & 0.449 & 0.784 & 0.347 & 0.549 & 0.514 & \textbf{0.786} & 0.332 & 0.526 & 0.514 & \underline{0.822} & 0.384 & 0.526 & 0$^{+1100}$ & free & 3\,h\\
StyleShot & \underline{0.563} & \underline{0.787} & 0.765$^{\ddagger}$ & 0.377 & \underline{0.552} & \underline{0.774} & 0.713 & 0.335 & 0.484 & 0.787 & 0.795$^{\ddagger}$ & 0.380 & 0$^{+2400}$ & free & 5.1\,h \\
StyleID & 0.548 & \textbf{0.822} & 0.552 & 0.416 & 0.256$^{\dagger}$ & 0.648$^{\dagger}$ & 0.691 & 0.147$^{\ddagger}$ & \underline{0.571} & 0.815 & 0.493 & 0.374 & 0$^{+1100}$ & free & 63\,m \\
CUT & 0.471 & 0.714 & 0.374 & 0.795 & 0.539 & 0.754 & 0.494 & 0.702 & 0.441 & 0.710$^{\dagger}$ & 0.620 & \underline{0.795} & 7.0 & 322.6 & 5\,m \\
SaMST & 0.271$^{\dagger}$ & 0.618$^{\dagger}$ & 0.749$^{\ddagger}$ & 0.145$^{\ddagger}$ & 0.501 & 0.709 & 0.398 & 0.838 & 0.461 & 0.667$^{\dagger}$ & 0.612 & 0.615 & 8.3 & 39.5 & 10\,m \\
...
\midrule
\textbf{Ours} & 0.4915 & 0.7126 & 0.2596 & 0.8103 & 0.4801 & 0.6681 & 0.3116 & \underline{0.8612} & 0.5226 & 0.7747 & \underline{0.2895} & 0.7717 & \textbf{1.04$^{+84}$} & \textbf{1.4} & \textbf{106\,s} \\
\bottomrule
\end{tabular}%
}
\caption{Main comparison. DINO-S, CLIP-S, and DINO-C are higher better; LPIPS is lower better. Among methods, excluding the IDT/TGT references, the best and second-best quality values are bold and underlined. $\dagger$: style does not exceed IDT. $\ddagger$: content does not remain inside TGT. The D5 row uses the oriented-HF route and internal-dynamics epoch selection; P2A and R5 use the base checkpoints. Params are in millions; superscripts denote frozen parameters. Train is wall time on one RTX~3060; Infer is generation-only time for 750 images.}
\label{tab:main}
\end{table*}
