...
def _run(cmd: list[str]) -> int:
    print("[launch_remote_knee_spatial_carriergate_bodydecoder_qedgegated_dualpath_spatial_fresh_eval_watcher] " + " ".join(cmd), flush=True)
...
def main() -> int:
    ...
    command = [
        ...
        str(launch),
        "--task-name",
        "knee-spatial-carriergate-bodydecoder-qedgegated-dualpath-spatial-fresh-eval-watcher",
        "--remote-log-path",
        "/mnt/i/Github/Latent_Style/exp/inmortal-exp/knee_spatial_carriergate_bodydecoder_qedgegated_dualpath_spatial_fresh_eval_watcher.log",
        "--remote-wsl-cwd",
        ...
        (
            ...
            "--run-dir /mnt/i/Github/Latent_Style/exp/inmortal-exp/aaai2027_inmortal_knee_e13_spatial_carriergate_bodydecoder_qedgegated_dualpath_spatial_seed42_b8a2 "
            "--train-pattern aaai2027_inmortal_knee_e13_spatial_carriergate_bodydecoder_qedgegated_dualpath_spatial_seed42_b8a2 "
