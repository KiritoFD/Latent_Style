...
def _run(cmd: list[str]) -> int:
    print("[launch_remote_carriergate_fresh_eval_watcher] " + " ".join(cmd), flush=True)
...
def main() -> int:
    ...
    command = [
        ...
        str(launch),
        "--task-name",
        "carriergate-fresh-eval-watcher",
        "--remote-log-path",
        "/mnt/i/Github/Latent_Style/SchrodingerBridge/exp/inmortal-exp/carriergate_fresh_eval_watcher.log",
        "--remote-wsl-cwd",
        ...
        (
            ...
            "--run-dir /mnt/i/Github/Latent_Style/SchrodingerBridge/exp/inmortal-exp/aaai2027_inmortal_hold4mid_e8_carriergate_injection_seed42_b8a2 "
            "--train-pattern aaai2027_inmortal_hold4mid_e8_carriergate_injection_seed42_b8a2 "
