...
def _run(cmd: list[str]) -> int:
    print("[launch_remote_knee_spatial_carriergate_bodydecoder_qedgegated_dualpath_fresh_eval_watcher] " + " ".join(cmd), flush=True)
...
def main() -> int:
    ...
    command = [
        ...
        "--remote-log-path",
        "/mnt/i/Github/Latent_Style/exp/inmortal-exp/knee_spatial_carriergate_bodydecoder_qedgegated_dualpath_fresh_eval_watcher.log",
        "--remote-wsl-cwd",
        ...
        "--sync-path",
        "SchrodingerBridge/docs/experiments/2026-06-09-knee-e13-spatial-carriergate-bodydecoder-qedgegated-dualpath.md",
        "--verify-python-file",
        ...
        (
            ...
            "--run-dir /mnt/i/Github/Latent_Style/exp/inmortal-exp/aaai2027_inmortal_knee_e13_spatial_carriergate_bodydecoder_qedgegated_dualpath_seed42_b8a2 "
            "--train-pattern aaai2027_inmortal_knee_e13_spatial_carriergate_bodydecoder_qedgegated_dualpath_seed42_b8a2 "
