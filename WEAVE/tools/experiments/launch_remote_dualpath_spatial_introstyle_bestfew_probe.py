...
def _run(cmd: list[str]) -> int:
    print("[launch_remote_dualpath_spatial_introstyle_bestfew_probe] " + " ".join(cmd), flush=True)
...
def main() -> int:
    ...
    command = [
        ...
        str(launch),
        "--task-name",
        "dualpath-spatial-introstyle-bestfew-probe",
        "--remote-log-path",
        "/mnt/i/Github/Latent_Style/exp/inmortal-exp/dualpath_spatial_introstyle_bestfew_probe.log",
        "--remote-wsl-cwd",
        ...
        (
            ...
            "--method LBM "
            "--label-prefix DualPathSpatialBestFew "
