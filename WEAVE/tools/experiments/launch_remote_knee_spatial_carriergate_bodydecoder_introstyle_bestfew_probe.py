...
def _run(cmd: list[str]) -> int:
    print("[launch_remote_knee_spatial_carriergate_bodydecoder_introstyle_bestfew_probe] " + " ".join(cmd), flush=True)
...
def main() -> int:
    ...
    command = [
        ...
        str(launch),
        "--task-name",
        "knee-spatial-carriergate-bodydecoder-introstyle-bestfew-probe",
        "--remote-log-path",
        "/mnt/i/Github/Latent_Style/SchrodingerBridge/exp/inmortal-exp/knee_spatial_carriergate_bodydecoder_introstyle_bestfew_probe.log",
        "--remote-wsl-cwd",
        ...
        (
            ...
            "--run-name aaai2027_inmortal_knee_e13_spatial_carriergate_bodydecoder_seed42_b8a2 "
            ...
            "--method LBM "
            "--label-prefix KneeSpatialCarrierBestFew "
