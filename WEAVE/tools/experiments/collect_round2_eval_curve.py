...
def _row_from_summary(path: Path) -> dict[str, Any]:
    ...
    return {
        ...
        "transfer_clip_s_delta_idt": _metric(transfer, "clip_s_delta_idt"),
        "transfer_clip_t": _metric(transfer, "clip_t"),
        "transfer_content_lpips": _metric(transfer, "content_lpips"),
        "all_pairs_clip_style": _metric(all_pairs, "clip_style"),
        "all_pairs_clip_s_delta_idt": _metric(all_pairs, "clip_s_delta_idt"),
        "all_pairs_clip_t": _metric(all_pairs, "clip_t"),
        "all_pairs_content_lpips": _metric(all_pairs, "content_lpips"),
        "identity_clip_style": _metric(identity, "clip_style"),
        "identity_clip_t": _metric(identity, "clip_t"),
...
def _write_csv(path: Path, rows: list[dict[str, Any]]) -> None:
    fieldnames = [
        ...
        "timestamp",
        "transfer_clip_style",
        "transfer_clip_s_delta_idt",
        "transfer_clip_t",
        "transfer_content_lpips",
        "all_pairs_clip_style",
        "all_pairs_clip_s_delta_idt",
        "all_pairs_clip_t",
