...
class AdaCUTTrainer:
    ...
    def train_epoch(self, dataloader: DataLoader, epoch: int) -> Dict[str, float]:
        ...
        expected_keys = [
            ...
            "push", "delta_tv", "nce", "idt", "w_cycle_eff", "w_struct_eff",
        ...
        if self.use_tqdm:
            tqdm.write(
                ...
                f"gram={metrics['gram']:.4f} gramw={metrics['gram_w']:.4f} moment={metrics['moment']:.4f} "
                f"push={metrics['push']:.4f} dtv={metrics['delta_tv']:.4f} "
