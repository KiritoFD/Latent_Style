...
class LatentDataset(Dataset):
    """
    Balanced latent dataset with deterministic sampling.
    """
    def __init__(
        self, 
        data_root: str, 
        ...
        self.virtual_len = max_len * num_styles *4
    ...
    def sample_style_batch(self, target_style_ids: torch.Tensor, device: torch.device) -> torch.Tensor:
        ...
        for style_id, indices in self.style_indices.items():
            ...
            # Keep random style sampling behavior.
