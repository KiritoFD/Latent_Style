...
- Path: `experiments-cycle/experiments/overfit50-style-distill-struct-v2`
- Family: `overfit50`
- Tier: `A_strict`
- Strict comparable: `yes`
- Strict rank: `5/25`
- Family rank (metric runs): `5/25`

## Metrics

| metric | value |
|---|---|
| best_transfer_clip_style | 0.534868 |
| best_transfer_clip_style_epoch | 20 |
| best_transfer_classifier_acc | 0.880000 |
| latest_transfer_content_lpips | 0.645370 |
...
- Delta vs global strict best: `-0.016665`
- Family best: `overfit50-upscale` (0.593255)
- Delta vs family best: `-0.058388`
