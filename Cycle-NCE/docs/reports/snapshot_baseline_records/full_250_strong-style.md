...
- 实验路径：`experiments-cycle/full_250_strong-style`
- 分析口径：`基线=src_snapshot_20260210_141451` -> `最终=src_snapshot_20260210_141451`（仅看最后快照）
- 快照数量：`1`
- 实验画像：`单快照（基线=最终）`
...
| best_transfer_classifier_acc | 0.460000 |
