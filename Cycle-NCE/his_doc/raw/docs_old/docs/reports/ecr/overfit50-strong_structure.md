# Run Record: overfit50-strong_structure

- Generated: 2026-02-13 15:56:59
- Path: `experiments-cycle/overfit50-strong_structure`
- Family: `overfit50`
- Tier: `A_strict`
- Strict comparable: `yes`
- Strict rank: `6/25`
- Family rank (metric runs): `6/25`

## Metrics

| metric | value |
|---|---|
| best_transfer_clip_style | 0.534638 |
| best_transfer_clip_style_epoch | 40 |
| best_transfer_classifier_acc | 0.120000 |
| latest_transfer_content_lpips | 0.581129 |
...
- Delta vs global strict best: `-0.016895`
- Family best: `overfit50-upscale` (0.593255)
- Delta vs family best: `-0.058617`
...
| latest_train_loss | 8.369815 |
| latest_train_lr | 0.000173 |
| checkpoint_count | 4 |
| snapshot_count | 1 |
