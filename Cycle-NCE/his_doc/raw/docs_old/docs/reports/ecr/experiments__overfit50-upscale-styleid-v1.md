# Run Record: overfit50-upscale-styleid-v1

- Generated: 2026-02-13 15:56:59
- Path: `experiments-cycle/experiments/overfit50-upscale-styleid-v1`
- Family: `overfit50`
- Tier: `A_strict`
- Strict comparable: `yes`
- Strict rank: `18/25`
- Family rank (metric runs): `17/25`

## Metrics

| metric | value |
|---|---|
| best_transfer_clip_style | 0.482200 |
| best_transfer_clip_style_epoch | 40 |
| best_transfer_classifier_acc | 0.450000 |
| latest_transfer_content_lpips | 0.366808 |
...
- Delta vs global strict best: `-0.069333`
- Family best: `overfit50-upscale` (0.593255)
- Delta vs family best: `-0.111056`
- Style band: `low(<0.50)`
