# Run Record: overfit50-no-idt

- Generated: 2026-02-13 15:56:59
- Path: `experiments-cycle/experiments/overfit50-no-idt`
- Family: `overfit50`
- Tier: `B_partial`
- Strict comparable: `no`
- Strict rank: `-`
- Family rank (metric runs): `18/25`

## Metrics

| metric | value |
|---|---|
| best_transfer_clip_style | 0.478453 |
| best_transfer_clip_style_epoch | 30 |
| best_transfer_classifier_acc | 0.430000 |
...
- Delta vs global strict best: `-0.073080`
- Family best: `overfit50-upscale` (0.593255)
- Delta vs family best: `-0.114802`
- Style band: `low(<0.50)`
...
| latest_epoch | 30 |
| train_csv_count | 3 |
| latest_train_epoch | 30 |
| latest_train_loss | 0.311353 |
